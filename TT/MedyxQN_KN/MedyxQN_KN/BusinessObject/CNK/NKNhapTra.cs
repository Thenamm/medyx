...
{
    [Serializable()]
    public partial class NKNhapTra : BusinessBase<NKNhapTra>
    {
       ...
       // private SmartDate _ngayXuatTT = new SmartDate(false);
        ...
        NKNhapTra_Cs _NKNhapTraCs = NKNhapTra_Cs.NewNKNhapTra_Cs();
        public NKNhapTra_Cs NKNhapTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _NKNhapTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _NKNhapTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<NKNhapTra>(StringRequired<NKNhapTra>, "NoiXuat");
            ...
            ValidationRules.AddRule<NKNhapTra>(StringRequiredNoiNhap<NKNhapTra>, "Noinhap");


        }
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : NKNhapTra
        {
        ...
        private static bool StringRequiredNoiNhap<T>(T target, Csla.Validation.RuleArgs e) where T : NKNhapTra
        {
        ...
        public static NKNhapTra NewNKNhapTra()
        { 
            return DataPortal.Create<NKNhapTra>();
        }

        public static NKNhapTra GetNKNhapTra(String MaPNT,byte loaiphieu,byte daphat,Boolean qadmin)
        {
            return DataPortal.Fetch<NKNhapTra>(new Criteria(MaPNT,loaiphieu ,daphat,qadmin  ));
        }

        public static NKNhapTra GetNKNhapTra(SafeDataReader dr)
        {
            NKNhapTra obj = new NKNhapTra();
            obj.Fetch(dr);
            return obj;
            
        }

        public static void DeleteNKNhapTra(String MaPNT, string mamay, string nguoihuy)
        {
        ...
        protected internal NKNhapTra()
        { 
            //
        }
        internal NKNhapTra( int OrderNumber,
                            String MaPNT,
                            String noiXuat,
                            //SmartDate ngayXuat,
        ...
        { 
            using (SafeDataReader dr=new SafeDataReader(DataProvider.Instance().GetNKNhapTra(crit.MaPNT,crit.qadmin,crit.LoaiPhieu,crit.daphat)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
                    if (dr.NextResult())
                    {
                        _NKNhapTraCs = NKNhapTra_Cs.GetNKNhapTra_Cs(dr);  
                    } 
                }
            }
        }
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _MaPNT = DataProvider.Instance().InsertNKNhapTra(_noiNhap, _ngayNhap, _ngayNhapTT, _noiXuat, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _nguoiLap, _BNTra,_maMay, _daPhat);

            _NKNhapTraCs.Update(this);
        ...
        protected override void DataPortal_Update()
        {
            ...
            DataProvider.Instance().UpdateNKNhapTra(_MaPNT, _noiXuat, _ngayNhap, _ngayNhapTT, _noiNhap, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _huy, _maMay, _nguoiSD, _daPhat, _BNTra);
        ...
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            ...
            DataProvider.Instance().DeleteNKNhapTra(crit.MaPNT, crit.MaMay, crit.NguoiSD);
