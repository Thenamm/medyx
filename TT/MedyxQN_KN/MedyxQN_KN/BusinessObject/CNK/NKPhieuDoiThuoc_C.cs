...
//
// Ten file        :	NKPhieuDoiThuoc_C
// Kieu doi tuong  :	NKPhieuDoiThuoc_C
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="NKPhieuDoiThuoc_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class NKPhieuDoiThuoc_C : BusinessBase<NKPhieuDoiThuoc_C>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="NKPhieuDoiThuoc_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static NKPhieuDoiThuoc_C NewNKPhieuDoiThuoc_C()
        {
            return new NKPhieuDoiThuoc_C();

        }

        public static NKPhieuDoiThuoc_C NewNKPhieuDoiThuoc_C(string idDMCNK)
        {
            return new NKPhieuDoiThuoc_C(DMCNK.GetDMCNK(idDMCNK));
        }

        public static NKPhieuDoiThuoc_C NewNKPhieuDoiThuoc_C(DMCNK _DMCNK)
        {
            return new NKPhieuDoiThuoc_C(_DMCNK);
        }

		public static NKPhieuDoiThuoc_C GetNKPhieuDoiThuoc_C(String maDThuoc, Decimal sTT)
		{
			return DataPortal.Fetch<NKPhieuDoiThuoc_C>(new Criteria(maDThuoc, sTT));
		}

        public static NKPhieuDoiThuoc_C GetNKPhieuDoiThuoc_C(SafeDataReader dr)
        {
            return new NKPhieuDoiThuoc_C(dr);
        }

		/// <summary>
		/// Marks the <see cref="NKPhieuDoiThuoc_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
		...
		protected internal NKPhieuDoiThuoc_C()
		{	
			// Prevent direct creation
		}
		
        protected NKPhieuDoiThuoc_C(DMCNK pro)
        {
            MarkAsChild();
            _mavt = pro.MaVT;
            _tenTM = pro.TenTM;
        }
        protected NKPhieuDoiThuoc_C(string maDThuoc, DMCNK pro)
        {
            MarkAsChild();
            _maDThuoc = maDThuoc;            
            _mavt = pro.MaVT;
        ...
        protected NKPhieuDoiThuoc_C(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="NKPhieuDoiThuoc_C" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetNKPhieuDoiThuoc_C(crit.MaDThuoc, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="NKPhieuDoiThuoc_C" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="NKPhieuDoiThuoc_C" /> Object to underlying database.
		/// </summary>
        /// 
        ...
        internal virtual void Insert(NKPhieuDoiThuoc bill)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertNKPhieuDoiThuoc_C
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
            bill.MaDThuoc = DataProvider.Instance().InsertNKPhieuDoiThuoc_C(bill.MaDThuoc, _mavt, _soluong, _hanSD, _hanSDCu, _donGia, _soLo, _soLoCu, _ghichu, _nguoiSD, _maMay);
            MarkOld();	// public abstract String InsertNKPhieuDoiThuoc_C(String _maDThuoc, String _mavt, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, String _ghichu, String _nguoiSD, String _maMay);
			// public override String InsertNKPhieuDoiThuoc_C(String _maDThuoc, String _mavt, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, String _ghichu, String _nguoiSD, String _maMay)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spNKPhieuDoiThuoc_C_CREATE", _maDThuoc, _mavt, _soluong, _hanSD.DBValue, _hanSDCu.DBValue, _donGia, _soLo, _soLoCu, _ghichu, _nguoiSD, _maMay));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="NKPhieuDoiThuoc_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Update(NKPhieuDoiThuoc bill)
        {
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateNKPhieuDoiThuoc_C
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateNKPhieuDoiThuoc_C(bill.MaDThuoc, _sTT, _mavt, _soluong, _hanSD, _hanSDCu, _donGia, _soLo, _soLoCu, _huy, _ghichu, _nguoiSD, _maMay);
				// public abstract void UpdateNKPhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT, String _mavt, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, Boolean _huy, String _ghichu, String _nguoiSD, String _maMay);
				// public override void UpdateNKPhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT, String _mavt, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, Boolean _huy, String _ghichu, String _nguoiSD, String _maMay);
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spNKPhieuDoiThuoc_C_UPDATE", _maDThuoc, _sTT, _mavt, _soluong, _hanSD.DBValue, _hanSDCu.DBValue, _donGia, _soLo, _soLoCu, _huy, _ghichu, _nguoiSD, _maMay);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="NKPhieuDoiThuoc_C" />.
		/// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateNKPhieuDoiThuoc_C
        //    DataProvider.Instance().DeleteNKPhieuDoiThuoc_C(crit.MaDThuoc, crit.STT);
        //    // public abstract void DeleteNKPhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT);
        //    // public override void DeleteNKPhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spNKPhieuDoiThuoc_C_DELETED", _maDThuoc, _sTT);
        //    // }
        //}
        internal void DeleteSelf(NKPhieuDoiThuoc packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
            ...
            DataProvider.Instance().DeleteNKPhieuDoiThuoc_C(_maMay, _nguoiSD, _maDThuoc, _sTT);
            MarkNew();
