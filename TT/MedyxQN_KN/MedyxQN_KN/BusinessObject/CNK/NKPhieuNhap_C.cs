...
{	
	...
	[Serializable()]
	public partial class NKPhieuNhap_C : BusinessBase<NKPhieuNhap_C>
	{
        ...
        public static NKPhieuNhap_C NewNKPhieuNhap_C()
        {
            return new NKPhieuNhap_C();
            
        }

        public static NKPhieuNhap_C NewNKPhieuNhap_C(string idDMCNK)
        {
            return new NKPhieuNhap_C(DMCNK.GetDMCNK(idDMCNK));
        }

        public static NKPhieuNhap_C NewNKPhieuNhap_C(DMCNK _DMCNK)
        {
            return new NKPhieuNhap_C(_DMCNK);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        
        public static NKPhieuNhap_C GetNKPhieuNhap_C(String maNKPhieuNhap, decimal sTT)
        {
            return DataPortal.Fetch<NKPhieuNhap_C>(new Criteria(maNKPhieuNhap, sTT));
        }

        public static NKPhieuNhap_C GetNKPhieuNhap_C(SafeDataReader dr)
        {
            return new NKPhieuNhap_C(dr);
        }

        public static void DeleteNKPhieuNhap_C(String _maPN, decimal _sTT, string nguoisd, string mamay)
        {
        ...
        protected internal NKPhieuNhap_C()
        { 
            //
        }
        protected NKPhieuNhap_C(DMCNK pro)
        {
            MarkAsChild();
            _maVT = pro.MaVT;
            _tenTM = pro.TenTM;
        }
        protected NKPhieuNhap_C(string _idMaPN, DMCNK pro)
        {
            MarkAsChild();
            _maPN = _idMaPN;            
            _maVT = pro.MaVT;
        ...
        protected NKPhieuNhap_C(SafeDataReader dr)
        {
            MarkAsChild();
        ...
        {
            //using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetNKPhieuNhap_C(crit.MaPN, crit.STT))) 
            //{
            //    if (dr.Read())
            //    {
            //        Fetch(dr);
        ...
        internal virtual void Insert(NKPhieuNhap bill)
        {
            
              
            bill.MaPN = DataProvider.Instance().InsertNKPhieuNhap_C(bill.MaPN, _maVT, _soLuong, _hanSD, _soLo, _donGia, _soLuongYC, _giaBan, _ghiChu, _nguoiSD, _maMay);
            MarkOld();
        }

        internal virtual void Update(NKPhieuNhap bill)
        {
            if(IsDirty)
            {      
            
              
            DataProvider.Instance().UpdateNKPhieuNhap_C(bill.MaPN, _sTT, _maVT, _soLuong, _hanSD, _soLo, _donGia,  _soLuongYC, _giaBan,  _huy,  _ghiChu,  _nguoiSD,  _maMay);
            }
        }
        internal void DeleteSelf(NKPhieuNhap packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
            ...
            DataProvider.Instance().DeleteNKPhieuNhap_C(_maPN,_sTT,_nguoiSD,_maMay);
            MarkNew();
