...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="NKXuatTra" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class NKXuatTra : BusinessBase<NKXuatTra>
	{
        ...
        NKXuatTra_C_List _NKXuatTraCs = NKXuatTra_C_List.NewNKXuatTra_C_List();
        public NKXuatTra_C_List NKXuatTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _NKXuatTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _NKXuatTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<NKXuatTra>(StringRequired<NKXuatTra>, "TenNCC");
        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : NKXuatTra
        {
		...
		/// <summary>
		/// Factory method. New <see cref="NKXuatTra" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static NKXuatTra NewNKXuatTra()
        {
            return DataPortal.Create<NKXuatTra>();
        }
		public static NKXuatTra GetNKXuatTra(String maPXT)
		{
			return DataPortal.Fetch<NKXuatTra>(new Criteria(maPXT));
		}
        public static NKXuatTra GetNKXuatTra(SafeDataReader dr)
        {
            NKXuatTra obj = new NKXuatTra();
            obj.Fetch(dr);
            return obj;

        }
		/// <summary>
		/// Marks the <see cref="NKXuatTra" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteNKXuatTra(String maPXT, string mamay, string nguoihuy)
		{
		...
		/// <summary>
		/// Retrieve an existing <see cref="NKXuatTra" /> Object based on data in the database.
		/// </summary>
        /// 

		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetNKXuatTra(String _maPXT);
			// public override IDataReader GetNKXuatTra(String _maPXT)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spNKXuatTra_GET", _maPXT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetNKXuatTra(crit.MaPXT, crit.Qadmin  )))
			{
				if (dr.Read()){
					Fetch(dr);
                    //MarkOld();
                    ...
                    if (dr.NextResult())
                    {
                        _NKXuatTraCs = NKXuatTra_C_List.GetNKXuatTra_C_List(dr);
                    } 
				}
			}
		}
		/// <summary>
		/// Load a <see cref="NKXuatTra" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="NKXuatTra" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertNKXuatTra
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
			_maPXT = DataProvider.Instance().InsertNKXuatTra( _maNCC, _soCT, _ngayXT, _makho,  _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu,  _maMay,  _nguoiLap, _ngayLap, _nVXuat, _nVNhan, _vAT);
            _NKXuatTraCs.Update(this);
			// public abstract String InsertNKXuatTra(String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, String _maMay, String _nguoiLap, SmartDate _ngayLap, String _nVXuat, String _nVNhan, Decimal _vAT);
			// public override String InsertNKXuatTra(String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, String _maMay, String _nguoiLap, SmartDate _ngayLap, String _nVXuat, String _nVNhan, Decimal _vAT)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spNKXuatTra_CREATE", _maNCC, _soCT, _ngayXT, _makho,  _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu,  _maMay,  _nguoiLap, _ngayLap, _nVXuat, _nVNhan, _vAT);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="NKXuatTra" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateNKXuatTra
			if (IsDirty){
                
                  
				DataProvider.Instance().UpdateNKXuatTra(_maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy,  _nguoiSD, _maMay, _nVXuat, _nVNhan, _vAT);
                _NKXuatTraCs.Update(this);
				// public abstract void UpdateNKXuatTra(String _maPXT, String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay, String _nVXuat, String _nVNhan, Decimal _vAT);
				// public override void UpdateNKXuatTra(String _maPXT, String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay, String _nVXuat, String _nVNhan, Decimal _vAT)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spNKXuatTra_UPDATE", _maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy,  _nguoiSD, _maMay, _nVXuat, _nVNhan, _vAT);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="NKXuatTra" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateNKXuatTra
            DataProvider.Instance().DeleteNKXuatTra(crit.MaMay, crit.NguoiSD, crit.MaPXT);
			// public abstract void DeleteNKXuatTra(String _maPXT);
			// public override void DeleteNKXuatTra(String _maPXT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spNKXuatTra_DELETED", _maPXT);
			// }
		}
