...
{
    [Serializable()]
    public partial class MauNhapTra : BusinessBase<MauNhapTra>
    {
        ...
        //private SmartDate _ngayXuat = new SmartDate(DateTime.Today);
       // private SmartDate _ngayXuatTT = new SmartDate(DateTime.Today);
        ...
        MauNhapTra_Cs _MauNhapTraCs = MauNhapTra_Cs.NewMauNhapTra_Cs();
        public MauNhapTra_Cs MauNhapTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                return _MauNhapTraCs;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                if (!_MauNhapTraCs.Equals(value))
                {
                    _MauNhapTraCs = value;
                    PropertyHasChanged();
                }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _MauNhapTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _MauNhapTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<MauNhapTra>(StringRequired<MauNhapTra>, "NoiXuat");
            ...
            ValidationRules.AddRule<MauNhapTra>(StringRequiredNoiNhap<MauNhapTra>, "Noinhap");


        }
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : MauNhapTra
        {
        ...
        private static bool StringRequiredNoiNhap<T>(T target, Csla.Validation.RuleArgs e) where T : MauNhapTra
        {
        ...
        public static MauNhapTra NewMauNhapTra()
        { 
            return DataPortal.Create<MauNhapTra>();
        }

        public static MauNhapTra GetMauNhapTra(String MaPNT,byte loaiphieu,byte daphat,Boolean qadmin)
        {
            return DataPortal.Fetch<MauNhapTra>(new Criteria(MaPNT,loaiphieu ,daphat,qadmin  ));
        }

        public static MauNhapTra GetMauNhapTra(SafeDataReader dr)
        {
            MauNhapTra obj = new MauNhapTra();
            obj.Fetch(dr);
            return obj;
            
        }

        public static void DeleteMauNhapTra(String MaPNT, string mamay, string nguoihuy)
        {
            DataPortal.Delete(new OtherCriteria(  MaPNT,mamay,nguoihuy));
        }
        ...
        protected internal MauNhapTra()
        { 
            //
        }
        internal MauNhapTra( int OrderNumber,
                            String MaPNT,
                            String noiXuat,
                            //SmartDate ngayXuat,
        ...
        { 
            using (SafeDataReader dr=new SafeDataReader(DataProvider.Instance().GetMauNhapTra(crit.MaPNT,crit.qadmin,crit.LoaiPhieu,crit.daphat)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
                    if (dr.NextResult())
                    {
                        _MauNhapTraCs = MauNhapTra_Cs.GetMauNhapTra_Cs(dr);  
                    } 
                }
            }
        }
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _MaPNT = DataProvider.Instance().InsertMauNhapTra(_noiNhap, _ngayNhap, _ngayNhapTT, _noiXuat, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _nguoiSD , _BNTra,_maMay, _daPhat);

            _MauNhapTraCs.Update(this);
        ...
        protected override void DataPortal_Update()
        {
            ...
            DataProvider.Instance().UpdateMauNhapTra(_MaPNT, _noiXuat, _ngayNhap, _ngayNhapTT, _noiNhap, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _huy, _maMay, _nguoiSD , _daPhat);
        ...
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            ...
            DataProvider.Instance().DeleteMauNhapTra(crit.MaPNT, crit.MaMay, crit.NguoiSD);
