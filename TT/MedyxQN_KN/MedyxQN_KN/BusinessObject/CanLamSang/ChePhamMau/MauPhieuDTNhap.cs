...
//
// Ten file        :	MauPhieuDTNhap
// Kieu doi tuong  :	MauPhieuDTNhap
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="MauPhieuDTNhap" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class MauPhieuDTNhap : BusinessBase<MauPhieuDTNhap>
	{
        ...
        MauPhieuDTNhap_C_List _MauPhieuDTNhap_Cs = MauPhieuDTNhap_C_List.NewMauPhieuDTNhap_C_List();

        public MauPhieuDTNhap_C_List MauPhieuDTNhap_Cs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                //CanReadProperty(true);
                return _MauPhieuDTNhap_Cs;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                //CanWriteProperty(true);
                if (!_MauPhieuDTNhap_Cs.Equals(value))
                {
                    _MauPhieuDTNhap_Cs = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _MauPhieuDTNhap_Cs.IsDirty;
            }
        }
        ...
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _MauPhieuDTNhap_Cs.IsValid;
            }
        }
		#endregion
		#endregion
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<MauPhieuDTNhap>(StringRequired<MauPhieuDTNhap>, "MaKho");
            ValidationRules.AddRule<MauPhieuDTNhap>(ValidationDateTT<MauPhieuDTNhap>, "NgayPhieu");
            ValidationRules.AddRule<MauPhieuDTNhap>(ValidationDateNow<MauPhieuDTNhap>, "NgayPhieu");
        }
        private static bool ValidationDateTT<T>(T target, Csla.Validation.RuleArgs e) where T : MauPhieuDTNhap
        {
        ...
        private static bool ValidationDateNow<T>(T target, Csla.Validation.RuleArgs e) where T : MauPhieuDTNhap
        {
        ...
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : MauPhieuDTNhap
        {
		...
		/// <summary>
		/// Factory method. New <see cref="MauPhieuDTNhap" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static MauPhieuDTNhap NewMauPhieuDTNhap()
        {
            return DataPortal.Create<MauPhieuDTNhap>();
        }
		public static MauPhieuDTNhap GetMauPhieuDTNhap(String maDuTru)
		{
			return DataPortal.Fetch<MauPhieuDTNhap>(new Criteria(maDuTru));
		}
        public static MauPhieuDTNhap GetMauPhieuDTNhap(SafeDataReader dr)
        {
            MauPhieuDTNhap obj = new MauPhieuDTNhap();
            obj.Fetch(dr);
            return obj;
        }
		/// <summary>
		/// Marks the <see cref="MauPhieuDTNhap" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteMauPhieuDTNhap(String maDuTru, string mamay, string nguoihuy)
		{
		...
		protected internal MauPhieuDTNhap()
		{	
			// Prevent direct creation
		}
        internal MauPhieuDTNhap(
  int OrderNumber,
  String maDuTru ,
  String maNCC, 
  string tenNCC,   
 ...
 _tenNguoiHuy = tenNguoiHuy;
		...
		/// <summary>
		/// Retrieve an existing <see cref="MauPhieuDTNhap" /> Object based on data in the database.
		/// </summary>
        /// 

		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetMauPhieuDTNhap(String _maDuTru);
			// public override IDataReader GetMauPhieuDTNhap(String _maDuTru)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDuTru));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetMauPhieuDTNhap(crit.MaDuTru,crit.qadmin  )))
			{
				if (dr.Read()){
					Fetch(dr);
                    if (dr.NextResult())
                    {
                        _MauPhieuDTNhap_Cs = MauPhieuDTNhap_C_List.GetMauPhieuDTNhap_C_List(dr);
                    }
                    //MarkOld();
		...
		/// <summary>
		/// Load a <see cref="MauPhieuDTNhap" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="MauPhieuDTNhap" /> Object to underlying database.
		/// </summary>
        /// 
		...
		/// <summary>
		/// Update all changes made on <see cref="MauPhieuDTNhap" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateMauPhieuDTNhap
			if (IsDirty){
                
                
				DataProvider.Instance().UpdateMauPhieuDTNhap(_maDuTru, _soCT, _ngayPhieu, _makho, _nguoiDuTru, _tong, _ghichu, _huy, _nguoiSD , _maMay ,_maNCC );
                _MauPhieuDTNhap_Cs.Update(this);
				// public abstract void UpdateMauPhieuDTNhap(String _maDuTru, String _soCT, SmartDate _ngayPhieu, String _makho, String _nguoiDuTru, Decimal _tong, String _ghichu, Boolean _huy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngayHuy, String _nguoiHuy, SmartDate _ngaySD, String _nguoiSD, SmartDate _ngaySD1, String _nguoiSD1, String _maMay);
				// public override void UpdateMauPhieuDTNhap(String _maDuTru, String _soCT, SmartDate _ngayPhieu, String _makho, String _nguoiDuTru, Decimal _tong, String _ghichu, Boolean _huy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngayHuy, String _nguoiHuy, SmartDate _ngaySD, String _nguoiSD, SmartDate _ngaySD1, String _nguoiSD1, String _maMay);
				// {
		...
		/// <summary>
		/// Delete the <see cref="MauPhieuDTNhap" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateMauPhieuDTNhap
            DataProvider.Instance().DeleteMauPhieuDTNhap(crit.MaMay, crit.NguoiSD, crit.MaDuTru);
			// public abstract void DeleteMauPhieuDTNhap(String _maDuTru);
			// public override void DeleteMauPhieuDTNhap(String _maDuTru);
			// {
