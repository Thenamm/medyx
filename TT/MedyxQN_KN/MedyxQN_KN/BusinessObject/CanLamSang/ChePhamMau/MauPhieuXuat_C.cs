...
{	
	...
	[Serializable()]
	public partial class MauPhieuXuat_C : BusinessBase<MauPhieuXuat_C>
	{
        ...
        public static MauPhieuXuat_C NewMauPhieuXuat_C()
        {
            return new MauPhieuXuat_C();
            
        }

        public static MauPhieuXuat_C NewMauPhieuXuat_C(string idDMChePhamMau)
        {
            return new MauPhieuXuat_C(DMChePhamMau.GetDMChePhamMau(idDMChePhamMau));
        }

        public static MauPhieuXuat_C NewMauPhieuXuat_C(DMChePhamMau _DMChePhamMau)
        {
            return new MauPhieuXuat_C(_DMChePhamMau);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        
        public static MauPhieuXuat_C GetMauPhieuXuat_C(String maMauPhieuXuat, decimal sTT)
        {
            return DataPortal.Fetch<MauPhieuXuat_C>(new Criteria(maMauPhieuXuat, sTT));
        }

        public static MauPhieuXuat_C GetMauPhieuXuat_C(SafeDataReader dr)
        {
            return new MauPhieuXuat_C(dr);
        }

        public static void DeleteMauPhieuXuat_C(String _maPN, decimal _sTT, string nguoisd, string mamay)
        {
        ...
        protected internal MauPhieuXuat_C()
        { 
            //
        }
        protected MauPhieuXuat_C(DMChePhamMau pro)
        {
            MarkAsChild();
            _maCPMau = pro.MaCPMau;
            _tenTM = pro.TenCPMau;
        }
        protected MauPhieuXuat_C(string _idMaPX, DMChePhamMau pro)
        {
            MarkAsChild();
            _maPX = _idMaPX;            
            _maCPMau = pro.MaCPMau;
        ...
        protected MauPhieuXuat_C(SafeDataReader dr)
        {
            MarkAsChild();
        ...
        {
            //using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetMauPhieuXuat_C(crit.MaPX, crit.STT))) 
            //{
            //    if (dr.Read())
            //    {
            //        Fetch(dr);
        ...
        internal virtual void Insert(MauPhieuXuat bill)
        {
            
              
            bill.MaPX = DataProvider.Instance().InsertMauPhieuXuat_C(bill.MaPX, _maCPMau, _soLuong, _hanSD, _soLo, _donGia, _soLuongYC, _giaBan, _ghiChu, _nguoiSD , _maMay);
        }

        internal virtual void Update(MauPhieuXuat bill)
        {
            if(IsDirty)
            {      
            
              
            DataProvider.Instance().UpdateMauPhieuXuat_C(bill.MaPX, _sTT, _maCPMau, _soLuong, _hanSD, _soLo, _donGia,  _soLuongYC, _giaBan,  _huy,  _ghiChu, _nguoiSD ,  _maMay);
            }
        }
        internal void DeleteSelf(MauPhieuXuat packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
                return;
            DataProvider.Instance().DeleteMauPhieuXuat_C(_maPX,_sTT,_nguoiSD,_maMay);
            MarkNew();
