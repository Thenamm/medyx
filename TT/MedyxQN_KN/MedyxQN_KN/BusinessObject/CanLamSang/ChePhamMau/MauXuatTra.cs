...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="MauXuatTra" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class MauXuatTra : BusinessBase<MauXuatTra>
	{
        ...
        MauXuatTra_C_List _MauXuatTraCs = MauXuatTra_C_List.NewMauXuatTra_C_List();
        public MauXuatTra_C_List MauXuatTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                return _MauXuatTraCs;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                if (!_MauXuatTraCs.Equals(value))
                {
                    _MauXuatTraCs = value;
                    PropertyHasChanged();
                }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _MauXuatTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _MauXuatTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<MauXuatTra>(StringRequired<MauXuatTra>, "TenNCC");
        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : MauXuatTra
        {
		...
		/// <summary>
		/// Factory method. New <see cref="MauXuatTra" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static MauXuatTra NewMauXuatTra()
        {
            return DataPortal.Create<MauXuatTra>();
        }
		public static MauXuatTra GetMauXuatTra(String maPXT)
		{
			return DataPortal.Fetch<MauXuatTra>(new Criteria(maPXT));
		}
        public static MauXuatTra GetMauXuatTra(SafeDataReader dr)
        {
            MauXuatTra obj = new MauXuatTra();
            obj.Fetch(dr);
            return obj;

        }
		/// <summary>
		/// Marks the <see cref="MauXuatTra" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteMauXuatTra(String maPXT, string mamay, string nguoihuy)
		{
		...
		/// <summary>
		/// Retrieve an existing <see cref="MauXuatTra" /> Object based on data in the database.
		/// </summary>
        /// 

		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetMauXuatTra(String _maPXT);
			// public override IDataReader GetMauXuatTra(String _maPXT)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spMauXuatTra_GET", _maPXT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetMauXuatTra(crit.MaPXT, crit.Qadmin  )))
			{
				if (dr.Read()){
					Fetch(dr);
                    //MarkOld();
                    ...
                    if (dr.NextResult())
                    {
                        _MauXuatTraCs = MauXuatTra_C_List.GetMauXuatTra_C_List(dr);
                    } 
				}
			}
		}
		/// <summary>
		/// Load a <see cref="MauXuatTra" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="MauXuatTra" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertMauXuatTra
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
            _maPXT = DataProvider.Instance().InsertMauXuatTra(_maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _maMay, _nguoiSD , _ngayLap, _nVXuat, _nVNhan, _vAT, _soHoaDon, _ngayHoaDon);
            _MauXuatTraCs.Update(this);
			// public abstract String InsertMauXuatTra(String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, String _maMay, String _nguoiLap, SmartDate _ngayLap, String _nVXuat, String _nVNhan, Decimal _vAT);
			// public override String InsertMauXuatTra(String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, String _maMay, String _nguoiLap, SmartDate _ngayLap, String _nVXuat, String _nVNhan, Decimal _vAT)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spMauXuatTra_CREATE", _maNCC, _soCT, _ngayXT, _makho,  _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu,  _maMay,  _nguoiLap, _ngayLap, _nVXuat, _nVNhan, _vAT);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="MauXuatTra" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateMauXuatTra
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateMauXuatTra(_maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy, _nguoiSD , _maMay, _nVXuat, _nVNhan, _vAT, _soHoaDon, _ngayHoaDon);
                _MauXuatTraCs.Update(this);
				// public abstract void UpdateMauXuatTra(String _maPXT, String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay, String _nVXuat, String _nVNhan, Decimal _vAT);
				// public override void UpdateMauXuatTra(String _maPXT, String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay, String _nVXuat, String _nVNhan, Decimal _vAT)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spMauXuatTra_UPDATE", _maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy, _nguoiSD , _maMay, _nVXuat, _nVNhan, _vAT);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="MauXuatTra" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateMauXuatTra
            DataProvider.Instance().DeleteMauXuatTra(crit.MaMay, crit.NguoiSD, crit.MaPXT);
			// public abstract void DeleteMauXuatTra(String _maPXT);
			// public override void DeleteMauXuatTra(String _maPXT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spMauXuatTra_DELETED", _maPXT);
			// }
		}
