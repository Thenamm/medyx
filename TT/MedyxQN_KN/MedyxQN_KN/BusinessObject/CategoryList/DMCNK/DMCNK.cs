...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMCNK" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMCNK : BusinessBase<DMCNK>
	{
        ...
        public String TenTMHL
        {
            get
            {
                ...
                return _tenTM + " " + _hamLuong + " " + _tendvthl;
            }
            //set
            //{
        ...
        protected override void AddBusinessRules()
        {
            ...
            //ValidationRules.AddRule(Csla.Validation.CommonRules.StringMaxLength, new Csla.Validation.CommonRules.MaxLengthRuleArgs("TenTM", 350));
            ValidationRules.AddRule<DMCNK>(StringRequiredDVT<DMCNK>, "MaDVT");
        ...
        private static bool StringRequiredDVT<T>(T target, Csla.Validation.RuleArgs e) where T : DMCNK
        {
		...
		/// <summary>
		/// Factory method. New <see cref="DMCNK" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMCNK NewDMCNK()
        {
            return DataPortal.Create<DMCNK>();
        }
		public static DMCNK GetDMCNK(String maVT)
		{
			return DataPortal.Fetch<DMCNK>(new Criteria(maVT));
		}
		
		/// <summary>
		/// Marks the <see cref="DMCNK" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMCNK(String maVT, string mamay, string nguoihuy)
		{
		...
		protected internal DMCNK()
		{	
			// Prevent direct creation
		}
        internal DMCNK(     int OrderNumber,
                             String maVT ,
		                     String maNhom ,
                             String maChungLoai,
		                     String tenTM ,
        ...
        protected class OtherCriteria
        {
            ...
            public OtherCriteria(String Mamay, String Nguoisd, String maCNK)
            {
                _maVT = maCNK;
                _maMay = Mamay;
                _NguoiSD = Nguoisd;
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMCNK" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMCNK(crit.MaVT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMCNK" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="DMCNK" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMCNK
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
            _maVT = DataProvider.Instance().InsertDMCNK(_maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _nguoiLap, _vTNoiT, _maLH, _hamLuong, _maDVTHL,_KhongSD,_maql  ,_quyCach );
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMCNK_CREATE", _maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _nguoiLap, _vTNoiT, _maLH));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="DMCNK" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMCNK
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateDMCNK(_maVT, _maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _huy, _nguoiSD, _vTNoiT, _maLH, _hamLuong, _maDVTHL, _KhongSD, _maql, _quyCach);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMCNK_UPDATE", _maVT, _maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _huy, _nguoiSD, _vTNoiT, _maLH);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="DMCNK" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMCNK
            DataProvider.Instance().DeleteDMCNK(crit.MaMay, crit.NguoiSD, crit.maVT);
			// public abstract void DeleteDMCNK(String _maVT);
			// public override void DeleteDMCNK(String _maVT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMCNK_DELETED", _maVT);
			// }
		}
