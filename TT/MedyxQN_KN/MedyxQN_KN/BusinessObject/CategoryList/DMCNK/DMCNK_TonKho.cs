...
//
// Ten file        :	DMCNK_TonKho
// Kieu doi tuong  :	DMCNK_TonKho
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMCNK_TonKho" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMCNK_TonKho : BusinessBase<DMCNK_TonKho>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMCNK_TonKho" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        //public static DMCNK_TonKho NewDMCNK_TonKho()
        //{
        //    //return new DMNhomThuoc();
        //    return DataPortal.Create<DMCNK_TonKho>();
        //}
        public static DMCNK_TonKho GetDMCNKTonKho(String maKho, DateTime thang, String MaVT)
		{
			return DataPortal.Fetch<DMCNK_TonKho>(new Criteria(maKho, thang , MaVT));
		}
		
		/// <summary>
		/// Marks the <see cref="DMCNK_TonKho" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMCNK_TonKho(String maChungLoai)
        //{
		...
		protected internal DMCNK_TonKho()
		{	
			// Prevent direct creation
		}
        internal DMCNK_TonKho( 
  int STT,
  String MaVT ,
		                             String TenTM ,
  String TenDVT ,
  ...
  //String Tengoc
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMCNK_TonKho" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetDMCNK_TonKho(String _maChungLoai);
			// public override IDataReader GetDMCNK_TonKho(String _maChungLoai)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMCNKTonKho(crit.maKho ,crit.thang ,crit.MaVT    )))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMCNK_TonKho" /> Object from given SafeDataReader.
		/// </summary>
