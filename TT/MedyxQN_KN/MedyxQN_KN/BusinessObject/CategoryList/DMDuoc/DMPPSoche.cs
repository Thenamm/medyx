...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMPPSoche" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMPPSoche : BusinessBase<DMPPSoche>
	{
        ...
        private String _ppSoche = String.Empty;
        ...
        public String PPSoche
        {
            get
            {
                CanReadProperty("PPSoche", true);
                return _ppSoche;
            }
            set
            {
                CanWriteProperty("PPSoche", true);
                if (_ppSoche != value)
                {
                    _ppSoche = value;
                    PropertyHasChanged("PPSoche");
                }
            }
        }
		...
		/// <summary>
		/// Factory method. New <see cref="DMPPSoche" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMPPSoche NewDMPPSoche()
        {
            return new DMPPSoche();
        }
        //public static DMPPSoche GetDMPPSoche(String maDT, String maThuoc)
        //{
        //    return DataPortal.Fetch<DMPPSoche>(new Criteria(maDT, maThuoc));
        //}
        internal static DMPPSoche GetDMPPSoche(SafeDataReader dr)
        {
            return new DMPPSoche (dr);
        }
         public DMPPSoche()
        {
            MarkAsChild();
		...
		/// <summary>
		/// Marks the <see cref="DMPPSoche" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMPPSoche(String maDT, Decimal  sTT)
        //{
        ...
        //protected internal DMPPSoche()
        //{	
        //    // Prevent direct creation
        //}
        //internal DMPPSoche( int ordernumber, 
        //                     String maDT,
        //                     Decimal STT,
        //                     String maThuoc ,
        //                     String tenThuoc,
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMPPSoche" /> Object based on data in the database.
		/// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetDMPPSoche(String _maDT, String _maThuoc);
        //    // public override IDataReader GetDMPPSoche(String _maDT, String _maThuoc)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maThuoc));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMPPSoche(crit.MaDT, crit.MaThuoc)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        ///// <summary>
        ///// Load a <see cref="DMPPSoche" /> Object from given SafeDataReader.
        ///// </summary>
        ...
        //}
		  private  DMPPSoche(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
               // if (dr.GetString("MaDT") != null) 
			   _maDT = ""; //dr.GetString("MaDT");
            if (dr.GetString("TENTM") != null)    _tenTM = dr.GetString("TENTM");
            if (dr.GetDecimal("STT") != null) _STT = dr.GetDecimal("STT");
			if (dr.GetString("MaThuoc") != null) _maThuoc = dr.GetString("MaThuoc");
			if (dr.GetString("PPSoche") != null) _ppSoche = dr.GetString("PPSoche");

			//if (dr.GetString("TenDVT") != null) 
			_TenDVT = ""; //dr.GetString("TenDVT");
			//if (dr.GetDecimal("DonGia") != null) 
			_donGia =  0; //dr.GetDecimal("DonGia");
			//if (dr.GetDecimal("DonGiaThuT") != null) 
			_donGiaThuT = 0; //dr.GetDecimal("DonGiaThuT");
			//if (dr.GetDecimal("DonGiaPhauT") != null) 
			_donGiaPhauT = 0; //dr.GetDecimal("DonGiaPhauT");
			//if (dr.GetDecimal("DonGiaCLS") != null) 
			_donGiaCLS = 0; //dr.GetDecimal("DonGiaCLS");
			//if (dr.GetDecimal("GiaChenhLech") != null) 
			_giachenhlech = 0; //dr.GetDecimal("GiaChenhLech");
			//if (dr.GetBoolean("ADChenhLech") != null) 
			_aDChenhlech =  false; //dr.GetBoolean("ADChenhLech");
			//if (dr.GetBoolean("DTBH") != null) 
			_DTBH =  false ; //dr.GetBoolean("DTBH");
			//if (dr.GetByte("ADPhongMo") != null) 
			_aDPhongMo = 0;// dr.GetByte("ADPhongMo");
			//if (dr.GetDecimal("DonGia1") != null) 
			_donGia1 = 0; // dr.GetDecimal("DonGia1");
			//if (dr.GetDecimal("GiachenhLech1") != null) 
			_giachenhlech1 = 0; // dr.GetDecimal("GiachenhLech1");
		...
		/// <summary>
		/// Insert the new <see cref="DMPPSoche" /> Object to underlying database.
		/// </summary>
        internal void Insert()
        {
            ...
            if (!this.IsDirty)
                return;
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMPPSoche
			// Copy & paste ham duoi day vao file DataProvider.cs
              
            
            //_maDT = 
			DataProvider.Instance().InsertDMPPSoche(_maThuoc, _ppSoche, _ghichu, _maMay, _nguoiSD);
			// public abstract String InsertDMPPSoche(String _maDT, String _maThuoc, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// public override String InsertDMPPSoche(String _maDT, String _maThuoc, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// {
		...
		/// <summary>
		/// Update all changes made on <see cref="DMPPSoche" /> Object to underlying database.
		/// </summary>
		 internal void Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMThuoc_KhoKhoa
			 if (!this.IsDirty)
				...
				DataProvider.Instance().UpdateDMPPSoche( _maThuoc,_ppSoche,_STT ,_ghichu, _maMay, _nguoiSD ,_huy );
				// public abstract void UpdateDMPPSoche(String _maDT, String _maThuoc, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// public override void UpdateDMPPSoche(String _maDT, String _maThuoc, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// {
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMPPSoche
            DataProvider.Instance().DeleteDMPPSoche(crit.MaMay, crit.NguoiSD, crit.MaDT, crit.STT);
			// public abstract void DeleteDMPPSoche(String _maDT, String _maThuoc);
			// public override void DeleteDMPPSoche(String _maDT, String _maThuoc);
			// {
