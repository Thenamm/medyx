...
//
// Ten file        :	DMThuoc_Gia
// Kieu doi tuong  :	DMThuoc_Gia
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMThuoc_Gia" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMThuoc_Gia : BusinessBase<DMThuoc_Gia>
	{
        ...
        public Decimal DonGiaBH1
        {
            get
            {
                CanReadProperty("DonGiaBH1", true);
                return _donGiaBH1;
            }
            set
            {
                CanWriteProperty("DonGiaBH1", true);
                if (_donGiaBH1 != value)
                {
                    _donGiaBH1 = value;
                    PropertyHasChanged("DonGiaBH1");
                }
            }
        }
		...
		/// <summary>
		/// Factory method. New <see cref="DMThuoc_Gia" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMThuoc_Gia NewDMThuoc_Gia()
        {
            return new DMThuoc_Gia();
        }
        //public static DMThuoc_Gia GetDMThuoc_Gia(String maDT, String maThuoc)
        //{
        //    return DataPortal.Fetch<DMThuoc_Gia>(new Criteria(maDT, maThuoc));
        //}
        internal static DMThuoc_Gia GetDMThuoc_Gia(SafeDataReader dr)
        {
            return new DMThuoc_Gia (dr);
        }
         public DMThuoc_Gia()
        {
            MarkAsChild();
		...
		/// <summary>
		/// Marks the <see cref="DMThuoc_Gia" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMThuoc_Gia(String maDT, Decimal  sTT)
        //{
        ...
        //protected internal DMThuoc_Gia()
        //{	
        //    // Prevent direct creation
        //}
        //internal DMThuoc_Gia( int ordernumber, 
        //                     String maDT,
        //                     Decimal STT,
        //                     String maThuoc ,
        //                     String tenThuoc,
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMThuoc_Gia" /> Object based on data in the database.
		/// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetDMThuoc_Gia(String _maDT, String _maThuoc);
        //    // public override IDataReader GetDMThuoc_Gia(String _maDT, String _maThuoc)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maThuoc));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMThuoc_Gia(crit.MaDT, crit.MaThuoc)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        ///// <summary>
        ///// Load a <see cref="DMThuoc_Gia" /> Object from given SafeDataReader.
        ///// </summary>
        ...
        //}
		  private  DMThuoc_Gia(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
                if (dr.GetString("MaDT") != null) _maDT = dr.GetString("MaDT");
		...
		/// <summary>
		/// Insert the new <see cref="DMThuoc_Gia" /> Object to underlying database.
		/// </summary>
        internal void Insert()
        {
            ...
            if (!this.IsDirty)
                return;
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMThuoc_Gia
			// Copy & paste ham duoi day vao file DataProvider.cs
              
            
            //_maDT = 
                DataProvider.Instance().InsertDMThuoc_Gia(_maDT, _maThuoc, _donGia, _donGiaThuT, _donGiaPhauT, _donGiaCLS, _giachenhlech, _aDChenhlech, _DTBH, _aDPhongMo, _donGia1, _giachenhlech1, _ngay1 , _ghichu, _maMay, _nguoiSD);
			// public abstract String InsertDMThuoc_Gia(String _maDT, String _maThuoc, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// public override String InsertDMThuoc_Gia(String _maDT, String _maThuoc, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// {
		...
		/// <summary>
		/// Update all changes made on <see cref="DMThuoc_Gia" /> Object to underlying database.
		/// </summary>
		 internal void Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMThuoc_KhoKhoa
			 if (!this.IsDirty)
				...
				DataProvider.Instance().UpdateDMThuoc_Gia(_maDT,_STT,  _maThuoc, _donGia, _donGiaThuT, _donGiaPhauT, _donGiaCLS, _giachenhlech , _aDChenhlech , _DTBH, _aDPhongMo, _ghichu, _maMay, _nguoiSD ,_huy );
				// public abstract void UpdateDMThuoc_Gia(String _maDT, String _maThuoc, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// public override void UpdateDMThuoc_Gia(String _maDT, String _maThuoc, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// {
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMThuoc_Gia
            DataProvider.Instance().DeleteDMThuoc_Gia(crit.MaMay, crit.NguoiSD, crit.MaDT, crit.STT);
			// public abstract void DeleteDMThuoc_Gia(String _maDT, String _maThuoc);
			// public override void DeleteDMThuoc_Gia(String _maDT, String _maThuoc);
			// {
