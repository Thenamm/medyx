...
//
// Ten file        :	DMThuoc_GiaQuay56
// Kieu doi tuong  :	DMThuoc_GiaQuay56
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMThuoc_GiaQuay56" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMThuoc_GiaQuay56 : BusinessBase<DMThuoc_GiaQuay56>
	{
		...
		private SmartDate _NgayGia56 = new SmartDate(true);
        private SmartDate _NgayGia56D = new SmartDate(true);
		private String _nguoiQuay56 = String.Empty;
		private SmartDate _ngayHuy = new SmartDate(true);
		private String _nguoiHuy = String.Empty;
        private String _malh = String.Empty;
        private String _tennguoiQuay56 = String.Empty;
        private int _OrderNumber;

		#endregion
		
		#region Business Properties and Methods
        public String TenNguoiQuay56
        {
            get
            {
                CanReadProperty("TenNguoiQuay56", true);
                return _tennguoiQuay56;
            }
            set
            {
                CanWriteProperty("TenNguoiQuay56", true);
                if (_tennguoiQuay56 != value)
                {
                    _tennguoiQuay56 = value;
                    PropertyHasChanged("TenNguoiQuay56");
                }
            }
        }
        ...
        public string GiaQuay56
        {
            ...
            set
            {
                ...
                if (_giaQuay56.ToString() != value)
                {
                    _giaQuay56 = decimal.Parse(value);
                    PropertyHasChanged("GiaQuay56");
                }
            }
        }
		...
		public string NgayGia56
		{
			get 
			{
				CanReadProperty("NgayGia56", true);
				return _NgayGia56.Text;
			}
			set 
			{
				CanWriteProperty("NgayGia56", true);
				if (_NgayGia56.Text != value) 
				{
					_NgayGia56.Text = value;
					PropertyHasChanged("NgayGia56");
				}
			}
		}
        public String NgayGia56D
        {
            get
            {
                CanReadProperty("NgayGia56D", true);
                _NgayGia56D = _NgayGia56;
                this._NgayGia56D.FormatString = "dd/MM/yyyy HH:mm";
                return _NgayGia56D.Text;
            }
           
        }
		
		public String NguoiQuay56
		{
			get 
			{
				CanReadProperty("NguoiQuay56", true);
				return _nguoiQuay56;
			}
			set 
			{
				CanWriteProperty("NguoiQuay56", true);
				if (_nguoiQuay56 != value) 
				{
					_nguoiQuay56 = value;
					PropertyHasChanged("NguoiQuay56");
				}
			}
		}
        ...
        protected override void AddBusinessRules()
        {
            ...
            //ValidationRules.AddRule<DMThuoc_GiaQuay56>(StringRequired<DMThuoc_GiaQuay56>, "TenTM");
            ////ValidationRules.AddRule(Csla.Validation.CommonRules.StringMaxLength, new Csla.Validation.CommonRules.MaxLengthRuleArgs("TenTM", 350));
            //ValidationRules.AddRule<DMThuoc_GiaQuay56>(StringRequiredDVT<DMThuoc_GiaQuay56>, "MaDVT");

        }

        //private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : DMThuoc_GiaQuay56
        //{
        ...
        //private static bool StringRequiredDVT<T>(T target, Csla.Validation.RuleArgs e) where T : DMThuoc_GiaQuay56
        //{
		...
		/// <summary>
		/// Factory method. New <see cref="DMThuoc_GiaQuay56" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMThuoc_GiaQuay56 NewDMThuoc_GiaQuay56()
        {
            //return new DMNhomThuoc();
            return DataPortal.Create<DMThuoc_GiaQuay56>();
        }
		public static DMThuoc_GiaQuay56 GetDMThuoc_GiaQuay56(String maThuoc)
		{
			return DataPortal.Fetch<DMThuoc_GiaQuay56>(new Criteria(maThuoc));
		}
		
		/// <summary>
		/// Marks the <see cref="DMThuoc_GiaQuay56" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMThuoc_GiaQuay56(String maThuoc, string mamay, string nguoihuy)
		{
		...
		protected internal DMThuoc_GiaQuay56( )
		{	
			// Prevent direct creation
		}
        internal DMThuoc_GiaQuay56(        int OrderNumber,
                                 String maThuoc ,
		                         String parent ,
		                         String maNhom ,
                                 String maPL,
...
string tennguoiquay56
            )
        {
              ...
              _tennguoiQuay56 = tennguoiquay56;
		      _tenGoc = tenGoc;
		      _tenTC = tenTC ;
		      _tenTM = tenTM ;
		      _tenTM1 = tenTM1 ;
		      ...
		      _ngaySD1 = ngaySD1  ;
		      _nguoiSD1 = nguoiSD1  ;
		      _NgayGia56 = NgayGia56 ;
		      _nguoiQuay56 = nguoiQuay56 ;
		      _ngayHuy = ngayHuy  ;
		      _nguoiHuy = nguoiHuy ;
              _malh = malh;
              _tendvt = tendvt;
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMThuoc_GiaQuay56" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMThuoc_GiaQuay56(crit.MaThuoc)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMThuoc_GiaQuay56" /> Object from given SafeDataReader.
		/// </summary>
		private void Fetch(SafeDataReader dr)
		{
			...
			if (dr.GetSmartDate("NgayGia56", true) != null) _NgayGia56 = dr.GetSmartDate("NgayGia56", true);
			//if (dr.GetString("NguoiQuay56") != null) _nguoiQuay56 = dr.GetString("NguoiQuay56");
            ...
            if (dr.GetString("TenNguoiquay56") != null) _tennguoiQuay56 = dr.GetString("TenNguoiquay56");
            
		}
		
		/// <summary>
		/// Insert the new <see cref="DMThuoc_GiaQuay56" /> Object to underlying database.
		/// </summary>
        /// 
		...
		/// <summary>
		/// Update all changes made on <see cref="DMThuoc_GiaQuay56" /> Object to underlying database.
		/// </summary>
        internal void Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMThuoc_GiaQuay56
			if (!this.IsDirty)
                return;
		...
		/// <summary>
		/// Delete the <see cref="DMThuoc_GiaQuay56" />.
		/// </summary>
