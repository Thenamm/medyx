...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMBenhDanh" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMBenhDanh : BusinessBase<DMBenhDanh>
	{
        ...
        public String MaICDTen
        {
            get
            {
                   return _maICD+"             "+_tenBenh ;
            }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<DMBenhDanh>(StringRequired<DMBenhDanh>, "TenBenh");


        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : DMBenhDanh
        {
		...
		/// <summary>
		/// Factory method. New <see cref="DMBenhDanh" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMBenhDanh NewDMBenhDanh()
        {
            return DataPortal.Create<DMBenhDanh>();
        }
        public static DMBenhDanh NewDMBenhDanh(string idparent)
        {
            return DataPortal.Create<DMBenhDanh>(new Criteria(idparent));
        }
        
		public static DMBenhDanh GetDMBenhDanh(String maBenhID)
		{
			return DataPortal.Fetch<DMBenhDanh>(new Criteria(maBenhID));
		}
		
		/// <summary>
		/// Marks the <see cref="DMBenhDanh" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMBenhDanh(String maBenhID, string mamay, string nguoihuy)
		{
            DataPortal.Delete(new OtherCriteria(mamay,nguoihuy ,maBenhID));
		}
        private DMBenhDanh(string idparent)
        {
            _idparent = idparent;
        }
		#endregion
		...
		protected internal DMBenhDanh()
		{	
			// Prevent direct creation
		}
        internal DMBenhDanh(int ordernumber, String maBenhID, String maICD,String maNhomICD, String tenBenh, String tenBenhICD, String maNhom, String maBHXH, String maVN, Byte cap, String maMay, Boolean huy, SmartDate ngaySD, String nguoiSD, string idparent, string _tenta, Boolean _khongsd)
        {
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMBenhDanh" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetDMBenhDanh(String _maBenhID);
			// public override IDataReader GetDMBenhDanh(String _maBenhID)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maBenhID));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMBenhDanh(crit.MaBenhID)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMBenhDanh" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="DMBenhDanh" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMBenhDanh
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
			_maBenhID = DataProvider.Instance().InsertDMBenhDanh(_maICD, _tenBenh, _tenBenhICD, _maNhom, _maVN, _maMay, _nguoiSD , _idparent,_tenta,_khongsd, _maBHXH,_maNhomICD   );
			// public abstract String InsertDMBenhDanh(String _maBenhID, String _maICD, String _tenBenh, String _tenBenhICD, String _maNhom, String _maVN, Byte _cap, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// public override String InsertDMBenhDanh(String _maBenhID, String _maICD, String _tenBenh, String _tenBenhICD, String _maNhom, String _maVN, Byte _cap, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// {
		...
		/// <summary>
		/// Update all changes made on <see cref="DMBenhDanh" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMBenhDanh
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateDMBenhDanh(_maBenhID, _maICD, _tenBenh, _tenBenhICD, _maNhom, _maVN, _cap, _maMay, _nguoiSD , _tenta, _khongsd, _maBHXH,_maNhomICD );
				// public abstract void UpdateDMBenhDanh(String _maBenhID, String _maICD, String _tenBenh, String _tenBenhICD, String _maNhom, String _maVN, Byte _cap, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// public override void UpdateDMBenhDanh(String _maBenhID, String _maICD, String _tenBenh, String _tenBenhICD, String _maNhom, String _maVN, Byte _cap, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// {
		...
		/// <summary>
		/// Delete the <see cref="DMBenhDanh" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMBenhDanh
			DataProvider.Instance().DeleteDMBenhDanh(crit.MaMay,crit.NguoiSD,crit.maBenhID );
			// public abstract void DeleteDMBenhDanh(String _maBenhID);
			// public override void DeleteDMBenhDanh(String _maBenhID);
			// {
