...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMBenhTat" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMBenhTat : BusinessBase<DMBenhTat>
	{
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<DMBenhTat>(StringRequired<DMBenhTat>, "TenBenh");


        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : DMBenhTat
        {
		...
		/// <summary>
		/// Factory method. New <see cref="DMBenhTat" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMBenhTat NewDMBenhTat()
        {
            return DataPortal.Create<DMBenhTat>();
        }
        public static DMBenhTat NewDMBenhTat(string idparent)
        {
            return DataPortal.Create<DMBenhTat>(new Criteria(idparent));
        }
        
		public static DMBenhTat GetDMBenhTat(String maBenhID)
		{
			return DataPortal.Fetch<DMBenhTat>(new Criteria(maBenhID));
		}
		
		/// <summary>
		/// Marks the <see cref="DMBenhTat" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMBenhTat(String maBenhID, string mamay, string nguoihuy)
		{
            DataPortal.Delete(new OtherCriteria(mamay,nguoihuy ,maBenhID));
		}
        private DMBenhTat(string idparent)
        {
            _idparent = idparent;
        }
		#endregion
		...
		protected internal DMBenhTat()
		{	
			// Prevent direct creation
		}
        internal DMBenhTat(int ordernumber, String maBenhID, String maICD,String maNhomICD, String tenBenh, String tenBenhICD, String maNhom, String maBHXH, String maVN, Byte cap, String maMay, Boolean huy, SmartDate ngaySD, String nguoiSD, string idparent, string _tenta, Boolean _khongsd)
        {
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMBenhTat" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetDMBenhTat(String _maBenhID);
			// public override IDataReader GetDMBenhTat(String _maBenhID)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maBenhID));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMBenhTat(crit.MaBenhID)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMBenhTat" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="DMBenhTat" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMBenhTat
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
			_maBenhID = DataProvider.Instance().InsertDMBenhTat(_maICD, _tenBenh, _tenBenhICD, _maNhom, _maVN, _maMay, _nguoiSD , _idparent,_tenta,_khongsd, _maBHXH,_maNhomICD   );
			// public abstract String InsertDMBenhTat(String _maBenhID, String _maICD, String _tenBenh, String _tenBenhICD, String _maNhom, String _maVN, Byte _cap, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// public override String InsertDMBenhTat(String _maBenhID, String _maICD, String _tenBenh, String _tenBenhICD, String _maNhom, String _maVN, Byte _cap, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// {
		...
		/// <summary>
		/// Update all changes made on <see cref="DMBenhTat" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMBenhTat
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateDMBenhTat(_maBenhID, _maICD, _tenBenh, _tenBenhICD, _maNhom, _maVN, _cap, _maMay, _nguoiSD , _tenta, _khongsd, _maBHXH,_maNhomICD );
				// public abstract void UpdateDMBenhTat(String _maBenhID, String _maICD, String _tenBenh, String _tenBenhICD, String _maNhom, String _maVN, Byte _cap, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// public override void UpdateDMBenhTat(String _maBenhID, String _maICD, String _tenBenh, String _tenBenhICD, String _maNhom, String _maVN, Byte _cap, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// {
		...
		/// <summary>
		/// Delete the <see cref="DMBenhTat" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMBenhTat
			DataProvider.Instance().DeleteDMBenhTat(crit.MaMay,crit.NguoiSD,crit.maBenhID );
			// public abstract void DeleteDMBenhTat(String _maBenhID);
			// public override void DeleteDMBenhTat(String _maBenhID);
			// {
