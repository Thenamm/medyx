...
{	
	...
	[Serializable()]
    public partial class DMChucDanh : BusinessBase<DMChucDanh>
	{
		...
		/// </summary> 
        public static DMChucDanh NewDMChucDanh()
        {
            //return DataPortal.Create<DMVungLanhTho>();
            return new DMChucDanh();
        }
        public static DMChucDanh GetDMChucDanh(String maCD)
		{
            return DataPortal.Fetch<DMChucDanh>(new Criteria(maCD));
		}
		
		/// <summary>
		/// Marks the <see cref="CslaObject" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMChucDanh(String _maCD, string mamay, string nguoihuy)
		{
            DataPortal.Delete(new OtherCriteria(mamay,nguoihuy, _maCD));
		}
		...
		protected internal DMChucDanh()
		{	
			// Prevent direct creation
		}
		
        internal DMChucDanh(int ordernumber, string MaQG, string TenQG, string idmay, bool huy, SmartDate ngaySD, string NguoiSD)
        {
		...
		protected class Criteria
		{
			...
			{
				return string.Concat("Criteria", _maCD.ToString()).GetHashCode();
			}
		}
        [Serializable()]
        protected class OtherCriteria
        {
            ...
            public OtherCriteria(String Mamay, String Nguoisd, String maCD)
            {
                _maCD = maCD;
                _maMay = Mamay;
                _NguoiSD = Nguoisd;
		...
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMChucDanh(crit.MaCD)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		protected override void DataPortal_Insert()
		{
            ...
            _maCD = DataProvider.Instance().InsertDMChucDanh(_tenCD, _maMay, _nguoiSD);
		...
		protected override void DataPortal_Update()
		{
			...
			if (IsDirty){
                ...
                DataProvider.Instance().UpdateDMChucDanh(_maCD, _tenCD, _maMay, _nguoiSD);
		...
		{
			DataPortal_Delete(new OtherCriteria(_maMay,_nguoiSD,_maCD ));
		}
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateCslaObject
            DataProvider.Instance().DeleteDMChucDanh(crit.MaMay, crit.NguoiSD, crit.MaCD);
