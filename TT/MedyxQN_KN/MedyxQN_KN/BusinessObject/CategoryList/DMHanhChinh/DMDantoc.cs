...
{	
	...
	[Serializable()]
    public partial class DMDantoc : BusinessBase<DMDantoc>
	{
		...
		/// </summary> 
        public static DMDantoc NewDMDantoc()
        {
            //return DataPortal.Create<DMVungLanhTho>();
            return new DMDantoc();
        }
		public static DMDantoc GetDMDantoc(String maDanToc)
		{
            return DataPortal.Fetch<DMDantoc>(new Criteria(maDanToc));
		}
		
		/// <summary>
		/// Marks the <see cref="CslaObject" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMDantoc(String _maDanToc,string mamay,string nguoihuy)
		{
            DataPortal.Delete(new OtherCriteria(mamay,nguoihuy, _maDanToc));
		}
		...
		protected internal DMDantoc()
		{	
			// Prevent direct creation
		}
		
        internal DMDantoc(int ordernumber, string MaQG, string TenQG, string idmay, bool huy, SmartDate ngaySD, string NguoiSD)
        {
		...
		protected class Criteria
		{
			...
			public Criteria(String maDanToc)
			{
                _maDanToc = maDanToc;
			}
			...
			public override bool Equals(object obj)
			{
				if (obj is Criteria)
				{
					...
					if (!_maDanToc.Equals(c._maDanToc)) 
						return false;
					return true;
				}
				return false;
			...
			{
				return string.Concat("Criteria", _maDanToc.ToString()).GetHashCode();
			}
		}
        [Serializable()]
        protected class OtherCriteria
        {
            ...
            public OtherCriteria(String Mamay, String Nguoisd, String maDanToc)
            {
                _maDanToc = maDanToc;
                _maMay = Mamay;
                _NguoiSD = Nguoisd;
		...
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMDantoc(crit.MaDanToc)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		protected override void DataPortal_Insert()
		{
            ...
            _maDanToc = DataProvider.Instance().InsertDMDantoc(_tenDanToc, _maMay, _nguoiSD);
		...
		protected override void DataPortal_Update()
		{
			...
			if (IsDirty){
                ...
                DataProvider.Instance().UpdateDMDantoc(_maDanToc, _tenDanToc, _maMay, _nguoiSD);
		...
		{
			DataPortal_Delete(new OtherCriteria(_maMay,_nguoiSD,_maDanToc ));
		}
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateCslaObject
            DataProvider.Instance().DeleteDMDantoc(crit.MaMay, crit.NguoiSD, crit.MaDanToc );
