...
namespace HTC.Business.CategoryList
{
    ...
    [Serializable()]
    public partial class DMQuanHeQD : BusinessBase<DMQuanHeQD>
    {
        ...
        private String _tenQuanHeQD = String.Empty;
        ...
        public String TenQuanHeQD
        {
            get
            {
                CanReadProperty("TenQuanHeQD", true);
                return _tenQuanHeQD;
            }
            set
            {
                CanWriteProperty("TenQuanHeQD", true);
                if (_tenQuanHeQD != value)
                {
                    _tenQuanHeQD = value;
                    PropertyHasChanged("TenQuanHeQD");
                }
            }
        }
        ...
        /// </summary> 
        public static DMQuanHeQD NewDMQuanHeQD()
        {
            //return DataPortal.Create<DMVungLanhTho>();
            return new DMQuanHeQD();
        }
        public static DMQuanHeQD GetDMQuanHeQD(String maQuanHeQD)
        {
            return DataPortal.Fetch<DMQuanHeQD>(new Criteria(maQuanHeQD));
        }

        /// <summary>
        /// Marks the <see cref="CslaObject" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteDMQuanHeQD(String _maQuanHeQD, string mamay, string nguoihuy)
        {
            DataPortal.Delete(new OtherCriteria(mamay,nguoihuy, _maQuanHeQD));
        }
        ...
        protected internal DMQuanHeQD()
        {
            // Prevent direct creation
        }

        internal DMQuanHeQD(int ordernumber, string MaQuanHeQD, string TenQuanHeQD, string ghichu, string nhom, string idmay, bool huy, SmartDate ngaySD, string NguoiSD)
        {
            _OrderNumber = ordernumber;
            _maQuanHeQD = MaQuanHeQD;
            _tenQuanHeQD = TenQuanHeQD;
            _ghichu = ghichu;
            _nhom = nhom;
            _maMay = idmay;
            _huy = huy;
        ...
        protected class Criteria
        {
            ...
            public Criteria(String maQuanHeQD)
            {
                _maQuanHeQD = maQuanHeQD;
            }
            ...
            public override bool Equals(object obj)
            {
                if (obj is Criteria)
                {
                    ...
                    if (!_maQuanHeQD.Equals(c._maQuanHeQD))
                        return false;
                    return true;
                }
                return false;
            ...
            {
                return string.Concat("Criteria", _maQuanHeQD.ToString()).GetHashCode();
            }
        }
        [Serializable()]
        protected class OtherCriteria
        {
            ...
            public OtherCriteria(String Mamay, String Nguoisd, String maQuanHeQD)
            {
                _maQuanHeQD = maQuanHeQD;
                _maMay = Mamay;
                _NguoiSD = Nguoisd;
        ...
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMQuanHeQD(crit.MaQuanHeQD)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            if (dr.GetString("TenQuanHeQD") != null) _tenQuanHeQD = dr.GetString("TenQuanHeQD");
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _maQuanHeQD = DataProvider.Instance().InsertDMQuanHeQD(_tenQuanHeQD, _ghichu, _nhom, _maMay, _nguoiSD);
        ...
        protected override void DataPortal_Update()
        {
            ...
            if (IsDirty)
            {
                ...
                DataProvider.Instance().UpdateDMQuanHeQD(_maQuanHeQD, _tenQuanHeQD, _ghichu, _nhom, _maMay, _nguoiSD,_huy);
        ...
        {
            DataPortal_Delete(new OtherCriteria(_maMay, _nguoiSD, _maQuanHeQD));
        }
        ...
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateCslaObject
            DataProvider.Instance().DeleteDMQuanHeQD(crit.MaMay, crit.NguoiSD, crit.MaQuanHeQD);
