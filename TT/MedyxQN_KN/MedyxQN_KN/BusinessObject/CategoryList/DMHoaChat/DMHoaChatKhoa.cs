...
//
// Ten file        :	DMHoaChatKhoa
// Kieu doi tuong  :	DMHoaChatKhoa
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMHoaChatKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
    public partial class DMHoaChatKhoa : BusinessBase<DMHoaChatKhoa>
	{
        ...
        public static DMHoaChatKhoa GetDMHoaChatKhoa(String maKhoa, String maDT, String MaHC, byte loai)
        {
            return DataPortal.Fetch<DMHoaChatKhoa>(new Criteria(maKhoa, maDT, MaHC,loai));
        }
        public static DMHoaChatKhoa GetDMHoaChatKhoa(SafeDataReader dr, int i)
        {
            return new DMHoaChatKhoa(dr, i);
        }
        #endregion
		...
		protected internal DMHoaChatKhoa()
		{	
			// Prevent direct creation
		}
        protected DMHoaChatKhoa(SafeDataReader dr, int i)
        {
            MarkAsChild();
        ...
        internal DMHoaChatKhoa(Int32 STT,
                                 String MaHC ,
		                         String TenTM ,
                                 String TenDVT ,
                                 decimal TonCK ,
  ...
  _adphongmo = adphongmo;
        ...
        protected class Criteria
        {
            ...
            public Criteria(String maKhoa, String maDT, String MaHC,byte loai)
            {
                _maKhoa = maKhoa;
                _maDT = maDT;
                _MaHC = MaHC;
        ...
        /// <summary>
        /// Retrieve an existing <see cref="DMHoaChatKhoa" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            // public abstract IDataReader GetDMHoaChatKhoa(String _maChungLoai);
            // public override IDataReader GetDMHoaChatKhoa(String _maChungLoai)
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMHoaChatKhoa(crit.MaKhoa ,crit.MaDT ,crit.MaHC ,crit.Loai    )))
            {
                int i = 1;
                if (dr.Read()){
                    Fetch(dr,i);
        ...
        /// <summary>
        /// Load a <see cref="DMHoaChatKhoa" /> Object from given SafeDataReader.
        /// </summary>
        private void Fetch(SafeDataReader dr, int i)
        {
            ...
            if (dr.GetBoolean("HCThuT") != null) _ThuocThuT = dr.GetBoolean("HCThuT");
            if (dr.GetBoolean("HCphauT") != null) _ThuocphauT = dr.GetBoolean("HCphauT");
            if (dr.GetBoolean("HCCLS") != null) _ThuocCLS = dr.GetBoolean("HCCLS");
