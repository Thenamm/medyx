...
//
// Ten file        :	DMHoaChat_Gia
// Kieu doi tuong  :	DMHoaChat_Gia
...
namespace HTC.Business.CategoryList
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="DMHoaChat_Gia" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class DMHoaChat_Gia : BusinessBase<DMHoaChat_Gia>
    {
        ...
        {
            return _maDT.ToString() + "!" + _maHC.ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString();
        }
        ...
        /// <summary>
        /// Factory method. New <see cref="DMHoaChat_Gia" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static DMHoaChat_Gia NewDMHoaChat_Gia()
        {
            return new DMHoaChat_Gia();
        }
        //public static DMHoaChat_Gia GetDMHoaChat_Gia(String maDT, String MaHC)
        //{
        //    return DataPortal.Fetch<DMHoaChat_Gia>(new Criteria(maDT, MaHC));
        //}
        internal static DMHoaChat_Gia GetDMHoaChat_Gia(SafeDataReader dr)
        {
            return new DMHoaChat_Gia(dr);
        }
        public DMHoaChat_Gia()
        {
            MarkAsChild();
        }
        /// <summary>
        /// Marks the <see cref="DMHoaChat_Gia" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        //public static void DeleteDMHoaChat_Gia(String maDT, Decimal  sTT)
        //{
        ...
        //protected internal DMHoaChat_Gia()
        //{	
        //    // Prevent direct creation
        //}
        //internal DMHoaChat_Gia( int ordernumber, 
        //                     String maDT,
        //                     Decimal STT,
        //                     String MaHC ,
        //                     String tenThuoc,
        ...
        protected class Criteria
        {
            ...
            public Criteria(String maDT, String MaHC)
            {
                _maDT = maDT;
                _maHC = MaHC;
            }
            ...
            {
                return string.Concat("Criteria", _maDT.ToString(), _maHC.ToString()).GetHashCode();
            }
        }
        ...
        /// <summary>
        /// Retrieve an existing <see cref="DMHoaChat_Gia" /> Object based on data in the database.
        /// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetDMHoaChat_Gia(String _maDT, String _maHC);
        //    // public override IDataReader GetDMHoaChat_Gia(String _maDT, String _maHC)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maHC));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMHoaChat_Gia(crit.MaDT, crit.MaHC)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        ///// <summary>
        ///// Load a <see cref="DMHoaChat_Gia" /> Object from given SafeDataReader.
        ///// </summary>
        ...
        //}
        private DMHoaChat_Gia(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
            if (dr.GetString("MaDT") != null) _maDT = dr.GetString("MaDT");
        ...
        /// <summary>
        /// Insert the new <see cref="DMHoaChat_Gia" /> Object to underlying database.
        /// </summary>
        internal void Insert()
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMHoaChat_KhoKhoa
            // Copy & paste ham duoi day vao file DataProvider.cs
            if (!this.IsDirty)
                return;
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMHoaChat_Gia
            // Copy & paste ham duoi day vao file DataProvider.cs
            
              
            //_maDT = 
                DataProvider.Instance().InsertDMHoaChat_Gia(_maDT, _maHC, _donGia, _donGiaThuT, _donGiaPhauT, _donGiaCLS, _giachenhlech, _aDChenhlech, _DTBH, _aDPhongMo, _donGia1, _giachenhlech1, _ngay1, _ghichu, _maMay, _nguoiSD);
            // public abstract String InsertDMHoaChat_Gia(String _maDT, String _maHC, Decimal _donGiaBH, Decimal _donGiaBH1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // public override String InsertDMHoaChat_Gia(String _maDT, String _maHC, Decimal _donGiaBH, Decimal _donGiaBH1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maHC, _donGiaBH, _donGiaBH1, _ngayBH1.DBValue, _ghichu, _maMay, _huy, _ngaySD.DBValue, _nguoiSD), String);
            // }
            MarkOld();
        }

        /// <summary>
        /// Update all changes made on <see cref="DMHoaChat_Gia" /> Object to underlying database.
        /// </summary>
        internal void Update()
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMHoaChat_KhoKhoa
            if (!this.IsDirty)
                return;
            
              
            DataProvider.Instance().UpdateDMHoaChat_Gia(_maDT, _STT, _maHC, _donGia, _donGiaThuT, _donGiaPhauT, _donGiaCLS, _giachenhlech, _aDChenhlech, _DTBH, _aDPhongMo, _ghichu, _maMay, _nguoiSD , _huy);
            // public abstract void UpdateDMHoaChat_Gia(String _maDT, String _maHC, Decimal _donGiaBH, Decimal _donGiaBH1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // public override void UpdateDMHoaChat_Gia(String _maDT, String _maHC, Decimal _donGiaBH, Decimal _donGiaBH1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maHC, _donGiaBH, _donGiaBH1, _ngayBH1.DBValue, _ghichu, _maMay, _huy, _ngaySD.DBValue, _nguoiSD);
            // }				
            MarkOld();
        }
        ...
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMHoaChat_Gia
            DataProvider.Instance().DeleteDMHoaChat_Gia(crit.MaMay, crit.NguoiSD, crit.MaDT, crit.STT);
            // public abstract void DeleteDMHoaChat_Gia(String _maDT, String _maHC);
            // public override void DeleteDMHoaChat_Gia(String _maDT, String _maHC);
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maHC);
            // }
        }
