...
//
// Ten file        :	DMHoaChat_KhoKhoa
// Kieu doi tuong  :	DMHoaChat_KhoKhoa
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMHoaChat_KhoKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMHoaChat_KhoKhoa : BusinessBase<DMHoaChat_KhoKhoa>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMHoaChat_KhoKhoa" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMHoaChat_KhoKhoa NewDMHoaChat_KhoKhoa()
        {
            return new DMHoaChat_KhoKhoa();
            //return DataPortal.Create<DMHoaChat_KhoKhoa>();
        }
        ////public static DMHoaChat_KhoKhoa GetDMHoaChat_KhoKhoa(String makho, Decimal sTT, String makhoa)
        ////{
        ////    return DataPortal.Fetch<DMHoaChat_KhoKhoa>(new Criteria(makho, sTT, makhoa));
        ////}
        internal static DMHoaChat_KhoKhoa GetDMHoaChat_KhoKhoa(SafeDataReader dr)
        {
            return new DMHoaChat_KhoKhoa(dr);
        }
		/// <summary>
		/// Marks the <see cref="DMHoaChat_KhoKhoa" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMHoaChat_KhoKhoa(String makho, Decimal sTT, String makhoa)
        //{
        //    DataPortal.Delete(new OtherCriteria(mamay,nguoihuy ,makho, sTT, makhoa));
        //}
        public DMHoaChat_KhoKhoa()
        {
            MarkAsChild();
        }
        ...
        ////protected internal DMHoaChat_KhoKhoa()
        ////{	
        ////     Prevent direct creation
        ////}

        ////internal DMHoaChat_KhoKhoa(Decimal ordernumber, String makho,
        ////                             String makhoa ,
        ////                             String maHC ,
        ////                             Boolean huy ,
        ////                             SmartDate ngaySD ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMHoaChat_KhoKhoa" /> Object based on data in the database.
		/// </summary>
        ...
        ////    // }
        ////    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMHoaChat_KhoKhoa(crit.Makho, crit.STT, crit.Makhoa)))
        ////    {
        ////        if (dr.Read()){
        ////            Fetch(dr);
        ////            MarkOld();
        ...
        ////}
		/// <summary>
		/// Load a <see cref="DMHoaChat_KhoKhoa" /> Object from given SafeDataReader.
		/// </summary>
        ...
        ////}
        private  DMHoaChat_KhoKhoa(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
            if (dr.GetString("Makho") != null) _makho = dr.GetString("Makho");
		...
		/// <summary>
		/// Insert the new <see cref="DMHoaChat_KhoKhoa" /> Object to underlying database.
		/// </summary>
        /// 
        ...
        internal void Insert()
		{
			...
			_makho = DataProvider.Instance().InsertDMHoaChat_KhoKhoa(_makho, _makhoa, _maHC, _nguoiSD , _maMay);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMHoaChat_KhoKhoa_Create", _makho, _makhoa, _maHC, _nguoiSD , _maMay), String);
			// }
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="DMHoaChat_KhoKhoa" /> Object to underlying database.
		/// </summary>
        internal void Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMHoaChat_KhoKhoa
			 if (!this.IsDirty)
                ...
                //
                //  
				DataProvider.Instance().UpdateDMHoaChat_KhoKhoa(_makho, _sTT, _makhoa, _maHC, _huy, _nguoiSD , _maMay);
        ...
        //    
        //      
        //    DataProvider.Instance().DeleteDMHoaChat_KhoKhoa(_makho, _sTT, _makhoa);
        //    // public abstract void UpdateDMHoaChat_KhoKhoa(String _makho, Decimal _sTT, String _makhoa, String _maHC, Boolean _huy, String _nguoiSD, String _maMay);
        //    // public override void UpdateDMHoaChat_KhoKhoa(String _makho, Decimal _sTT, String _makhoa, String _maHC, Boolean _huy, String _nguoiSD, String _maMay)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMHoaChat_KhoKhoa_Update", _makho, _sTT, _makhoa, _maHC, _huy, _nguoiSD , _maMay);
        ...
        /// <summary>
        /// Delete the <see cref="DMHoaChat_KhoKhoa" />.
        /// </summary>
        //internal void DataPortal_Delete(OtherCriteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMHoaChat_KhoKhoa
        //    DataProvider.Instance().DeleteDMHoaChat_KhoKhoa(crit.MaMay, crit.NguoiSD, crit.Makho, crit.STT, crit.Makhoa);
        //    // public abstract void DeleteDMHoaChat_KhoKhoa(String _makho, Decimal _sTT, String _makhoa);
        //    // public override void DeleteDMHoaChat_KhoKhoa(String _makho, Decimal _sTT, String _makhoa)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMHoaChat_KhoKhoa_Deleted", _makho, _sTT, _makhoa);
        //    // }
        //}
