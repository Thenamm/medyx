...
//
// Ten file        :	DMHoaChat_TonKhoHD
// Kieu doi tuong  :	DMHoaChat_TonKhoHD
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMHoaChat_TonKhoHD" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMHoaChat_TonKhoHD : BusinessBase<DMHoaChat_TonKhoHD>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMHoaChat_TonKhoHD" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        //public static DMHoaChat_TonKhoHD NewDMHoaChat_TonKhoHD()
        //{
        //    //return new DMNhomThuoc();
        //    return DataPortal.Create<DMHoaChat_TonKhoHD>();
        //}
        public static DMHoaChat_TonKhoHD GetDMHoaChatTonKho(String maKho, DateTime thang, String MaHC)
		{
			return DataPortal.Fetch<DMHoaChat_TonKhoHD>(new Criteria(maKho, thang , MaHC,"",DateTime.Parse("01/01/1900")  ));
		}
        public static DMHoaChat_TonKhoHD GetDMHoaChatTonKho(String maKho, DateTime thang, String MaHC,string solo, DateTime hansd)
        {
            return DataPortal.Fetch<DMHoaChat_TonKhoHD>(new Criteria(maKho, thang, MaHC,solo,hansd ));
        }
		/// <summary>
		/// Marks the <see cref="DMHoaChat_TonKhoHD" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMHoaChat_TonKhoHD(String maChungLoai)
        //{
		...
		protected internal DMHoaChat_TonKhoHD()
		{	
			// Prevent direct creation
		}
        internal DMHoaChat_TonKhoHD( 
  int STT,
  String MaHC ,
		                             String TenTM ,
  String TenDVT ,
  ...
  Decimal nguong   
		...
		protected class Criteria
		{
            ...
            public Criteria(String maKho, DateTime thang, String MaHC, string solo, DateTime hansd)
			{
				_maKho = maKho  ;
                _thang = thang ;
                _MaHC = MaHC ;
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMHoaChat_TonKhoHD" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetDMHoaChat_TonKhoHD(String _maChungLoai);
			// public override IDataReader GetDMHoaChat_TonKhoHD(String _maChungLoai)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
			// }

            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMHoaChatTonKhoHD(crit.maKho, crit.thang, crit.MaHC, crit.solo, crit.hansd)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMHoaChat_TonKhoHD" /> Object from given SafeDataReader.
		/// </summary>
