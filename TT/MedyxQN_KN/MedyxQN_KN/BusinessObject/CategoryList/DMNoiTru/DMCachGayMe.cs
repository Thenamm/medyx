...
{	
	...
	[Serializable()]
    public partial class DMCachGayMe : BusinessBase<DMCachGayMe>
	{
		...
		public String MaCGM
		{
			get 
			{
                CanReadProperty("MaCGM", true);
				return _maCGM;
			}
			set 
			{
                CanWriteProperty("MaCGM", true);
                if (_maCGM != value) 
				{
                    _maCGM = value;
                    PropertyHasChanged("MaCGM");
				}
			}
		}
		...
		public String TenCGM
		{
			get 
			{
                CanReadProperty("TenCGM", true);
				return _tenCGM;
			}
			set 
			{
                CanWriteProperty("TenCGM", true);
                if (_tenCGM != value) 
				{
                    _tenCGM = value;
                    PropertyHasChanged("TenCGM");
				}
			}
		}
		...
		/// </summary> 
        public static DMCachGayMe NewDMCachGayMe()
        {
            //return DataPortal.Create<DMVungLanhTho>();
            return new DMCachGayMe();
        }
        public static DMCachGayMe GetDMCachGayMe(String maCGM)
		{
            return DataPortal.Fetch<DMCachGayMe>(new Criteria(maCGM));
		}
		
		/// <summary>
		/// Marks the <see cref="CslaObject" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMCachGayMe(String _maCGM, string mamay, string nguoihuy)
		{
            DataPortal.Delete(new OtherCriteria(mamay,nguoihuy , _maCGM));
		}
		...
		protected internal DMCachGayMe()
		{	
			// Prevent direct creation
		}
		
        internal DMCachGayMe(int ordernumber, string MaQG, string TenQG, string idmay, bool huy, SmartDate ngaySD, string NguoiSD)
        {
		...
		protected class Criteria
		{
			...
			{
				return string.Concat("Criteria", _maCGM.ToString()).GetHashCode();
			}
		}
        [Serializable()]
        protected class OtherCriteria
        {
            ...
            public OtherCriteria(String Mamay, String Nguoisd, String maCGM)
            {
                _maCGM = maCGM;
                _maMay = Mamay;
                _NguoiSD = Nguoisd;
		...
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMCachGayMe(crit.MaCGM)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		{
			// Value properties
            if (dr.GetString("MaCGM") != null) _maCGM = dr.GetString("MaCGM");
            if (dr.GetString("TenCGM") != null) _tenCGM = dr.GetString("TenCGM");
		...
		protected override void DataPortal_Insert()
		{
            ...
            _maCGM = DataProvider.Instance().InsertDMCachGayMe(_tenCGM, _maMay, _nguoiSD);
		...
		protected override void DataPortal_Update()
		{
			...
			if (IsDirty){
                ...
                DataProvider.Instance().UpdateDMCachGayMe(_maCGM, _tenCGM, _maMay, _nguoiSD);
		...
		{
			DataPortal_Delete(new OtherCriteria(_maMay,_nguoiSD,_maCGM ));
		}
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateCslaObject
            DataProvider.Instance().DeleteDMCachGayMe(crit.MaMay, crit.NguoiSD, crit.MaCGM);
