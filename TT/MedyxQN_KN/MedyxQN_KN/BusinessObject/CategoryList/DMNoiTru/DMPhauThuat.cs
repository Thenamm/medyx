...
//
// Ten file        :	DMPhauThuat
// Kieu doi tuong  :	DMPhauThuat
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMPhauThuat" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMPhauThuat : BusinessBase<DMPhauThuat>
	{
        ...
        private String _TenPTBH = String.Empty;
       ...
       private String _MaBH = String.Empty; private string _MaTDuong = String.Empty;
        ...
        public String TenPTBH
        {
            get
            {
                CanReadProperty("TenPTBH", true);
                return _TenPTBH;
            }
            set
            {
                CanWriteProperty("TenPTBH", true);
                if (_TenPTBH != value)
                {
                    _TenPTBH = value;
                    PropertyHasChanged("TenPTBH");
                }
            }
        }
        public String TenPTDu
        {
            get
            {
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<DMPhauThuat>(StringRequired<DMPhauThuat>, "TenPT");

        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : DMPhauThuat
        {
		...
		/// <summary>
		/// Factory method. New <see cref="DMPhauThuat" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMPhauThuat NewDMPhauThuat()
        {
            return DataPortal.Create<DMPhauThuat>();
        }
		public static DMPhauThuat GetDMPhauThuat(String maPT)
		{
			return DataPortal.Fetch<DMPhauThuat>(new Criteria(maPT));
		}
		
		/// <summary>
		/// Marks the <see cref="DMPhauThuat" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMPhauThuat(String maPT, string mamay, string nguoihuy)
		{
		...
		protected internal DMPhauThuat()
		{	
			// Prevent direct creation
		}
        internal DMPhauThuat(
                         int OrderNumber,
                         String maPT ,
		                 String tenPT ,
		                 String maNHOM ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMPhauThuat" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMPhauThuat(crit.MaPT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMPhauThuat" /> Object from given SafeDataReader.
		/// </summary>
		private void Fetch(SafeDataReader dr)
		{
		   ...
		   if (dr.GetString("MaBYTe") != null) _maBYTe = dr.GetString("MaBYTe");
            ...
            if (dr.GetString("TenPTBH") != null) _TenPTBH = dr.GetString("TenPTBH");
		...
		/// <summary>
		/// Insert the new <see cref="DMPhauThuat" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMPhauThuat
			// Copy & paste ham duoi day vao file DataProvider.cs


            _maPT = DataProvider.Instance().InsertDMPhauThuat(_tenPT, _maNHOM, _tenTA, _maBYTe, _QuyetDinh, _TenPTBH, _nhapSL, _tenTat, _maLH, _dongiaTT, _dongiaTT1, _ngayTT1, _maChungloai, _kTCao, _ghichu, _maMay, _nguoiSD, _apdungGoi, _dichVuGui, _hoaHong, _gTHoaHong, _bCThu, _inThu, _goidichvu, _MaBH,_MaTDuong, _QuyetDinhBH, _TenBYTe);
			// public abstract String InsertDMPhauThuat(String _tenPT, String _maNHOM, String _tenTA, String _maBYTe, Boolean _nhapSL, String _tenTat, String _maLH, Decimal _dongiaTT, Decimal _dongiaTT1, SmartDate _ngayTT1, String _maChungloai, Boolean _kTCao, String _ghichu, String _maMay, String _nguoiLap, Boolean _apdungGoi, Boolean _dichVuGui, Decimal _hoaHong, Decimal _gTHoaHong, Boolean _bCThu, Boolean _inThu);
            // public override String InsertDMPhauThuat(String _tenPT, String _maNHOM, String _tenTA, String _maBYTe, Boolean _nhapSL, String _tenTat, String _maLH, Decimal _dongiaTT, Decimal _dongiaTT1, SmartDate _ngayTT1, String _maChungloai, Boolean _kTCao, String _ghichu, String _maMay, String _nguoiLap, Boolean _apdungGoi, Boolean _dichVuGui, Decimal _hoaHong, Decimal _gTHoaHong, Boolean _bCThu, Boolean _inThu)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMPHAUTHUAT_CREATE", _tenPT, _maNHOM, _tenTA, _maBYTe, _nhapSL, _tenTat, _maLH, _dongiaTT, _dongiaTT1, _ngayTT1.DBValue, _maChungloai, _kTCao, _ghichu, _maMay, _nguoiSD , _apdungGoi, _dichVuGui, _hoaHong, _gTHoaHong, _bCThu, _inThu));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="DMPhauThuat" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMPhauThuat
			if (IsDirty){


                DataProvider.Instance().UpdateDMPhauThuat(_maPT, _tenPT, _maNHOM, _tenTA, _maBYTe, _QuyetDinh, _TenPTBH, _nhapSL, _tenTat, _maLH, _dongiaTT, _dongiaTT1, _ngayTT1, _maChungloai, _kTCao, _ghichu, _maMay, _nguoiSD, _huy, _apdungGoi, _dichVuGui, _hoaHong, _gTHoaHong, _bCThu, _inThu, _goidichvu, _MaBH,_MaTDuong, _QuyetDinhBH, _TenBYTe);
				// public abstract void UpdateDMPhauThuat(String _maPT, String _tenPT, String _maNHOM, String _tenTA, String _maBYTe, Boolean _nhapSL, String _tenTat, String _maLH, Decimal _dongiaTT, Decimal _dongiaTT1, SmartDate _ngayTT1, String _maChungloai, Boolean _kTCao, String _ghichu, String _maMay, String _nguoiSD, Boolean _huy, Boolean _apdungGoi, Boolean _dichVuGui, Decimal _hoaHong, Decimal _gTHoaHong, Boolean _bCThu, Boolean _inThu);
				// public override void UpdateDMPhauThuat(String _maPT, String _tenPT, String _maNHOM, String _tenTA, String _maBYTe, Boolean _nhapSL, String _tenTat, String _maLH, Decimal _dongiaTT, Decimal _dongiaTT1, SmartDate _ngayTT1, String _maChungloai, Boolean _kTCao, String _ghichu, String _maMay, String _nguoiSD, Boolean _huy, Boolean _apdungGoi, Boolean _dichVuGui, Decimal _hoaHong, Decimal _gTHoaHong, Boolean _bCThu, Boolean _inThu)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMPHAUTHUAT_UPDATE", _maPT, _tenPT, _maNHOM, _tenTA, _maBYTe, _nhapSL, _tenTat, _maLH, _dongiaTT, _dongiaTT1, _ngayTT1.DBValue, _maChungloai, _kTCao, _ghichu, _maMay, _ngayHuy.DBValue, _nguoiSD , _ngayLap.DBValue, _nguoiSD , _ngaySD.DBValue, _nguoiSD , _huy, _ngaySD1.DBValue, _nguoiSD1, _aDGiaUSD, _ngayGia.DBValue, _apdungGoi, _dichVuGui, _hoaHong, _gTHoaHong, _bCThu, _inThu);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="DMPhauThuat" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMPhauThuat
            DataProvider.Instance().DeleteDMPhauThuat(crit.MaMay, crit.NguoiSD, crit.MaPT);
			// public abstract void DeleteDMPhauThuat(String _maPT);
			// public override void DeleteDMPhauThuat(String _maPT)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMPHAUTHUAT_DELETED", _maPT);
			// }
		}
