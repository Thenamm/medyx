...
//
// Ten file        :	DMTienLuong
// Kieu doi tuong  :	DMTienLuong
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMTienLuong" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMTienLuong : BusinessBase<DMTienLuong>
	{
	 ...
	 protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<DMTienLuong>(StringRequired<DMTienLuong>, "TenTienluong");


        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : DMTienLuong
        {
		...
		/// <summary>
		/// Factory method. New <see cref="DMTienLuong" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMTienLuong NewDMTienLuong()
        {
            return DataPortal.Create<DMTienLuong>();
        }
		public static DMTienLuong GetDMTienLuong(String maTienluong)
		{
			return DataPortal.Fetch<DMTienLuong>(new Criteria(maTienluong));
		}
		
		/// <summary>
		/// Marks the <see cref="DMTienLuong" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMTienLuong(String maTienluong, string mamay, string nguoihuy)
		{
		...
		protected internal DMTienLuong()
		{	
			// Prevent direct creation
		}

        internal DMTienLuong(    int OrderNumber,
                                 String maTienluong ,
		                         String tenTienluong ,
		                         String maMay ,
		                         Boolean huy ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMTienLuong" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMTienLuong(crit.MaTienluong)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMTienLuong" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="DMTienLuong" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMTienLuong
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
			_maTienluong = DataProvider.Instance().InsertDMTienLuong(_tenTienluong, _maMay, _nguoiSD , _ghiChu);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMTienluong_CREATE", _tenTienluong, _maMay, _nguoiSD , _ghiChu));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="DMTienLuong" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMTienLuong
			if (IsDirty){
                
                  
				DataProvider.Instance().UpdateDMTienLuong(_maTienluong, _tenTienluong, _maMay, _huy, _nguoiSD , _ghiChu);
		...
		/// <summary>
		/// Delete the <see cref="DMTienLuong" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMTienLuong
            DataProvider.Instance().DeleteDMTienLuong(crit.MaMay, crit.NguoiSD, crit.MaTienluong);
			// public abstract void DeleteDMTienLuong(String _maTienluong);
			// public override void DeleteDMTienLuong(String _maTienluong)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMTienluong_DELETED", _maTienluong);
			// }
		}
