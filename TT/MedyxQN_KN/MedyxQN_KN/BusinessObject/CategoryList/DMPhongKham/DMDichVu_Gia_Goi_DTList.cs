...
namespace HTC.Business.CategoryList
{
    ...
    public class DMDichVu_Gia_Goi_DTList : BusinessListBase<DMDichVu_Gia_Goi_DTList, DMDichVu_Gia_DT>
    {
        #region Factory Methods
        public static DMDichVu_Gia_Goi_DTList FindDMDichVu_Gia_Goi_DTByTen(string TenDV, string madt)
        {
            return DataPortal.Fetch<DMDichVu_Gia_Goi_DTList>(new OtherCriteria(2, TenDV, madt));
        }
        public static DMDichVu_Gia_Goi_DTList FindDMDichVu_Gia_Goi_DTByTenD(string TenDV, string madt)
        {
            return DataPortal.Fetch<DMDichVu_Gia_Goi_DTList>(new OtherCriteria(3, TenDV, madt));
        }
        public static DMDichVu_Gia_Goi_DTList FindDMDichVu_Gia_Goi_DTByMa(string MaDV, string madt)
        {
            return DataPortal.Fetch<DMDichVu_Gia_Goi_DTList>(new OtherCriteria(1, MaDV, madt));
        }
        ...
        public static DMDichVu_Gia_Goi_DTList GetAllDMDichVu_Gia_Goi_DT(String madt)
        {
            return DataPortal.Fetch<DMDichVu_Gia_Goi_DTList>(new Criteria(madt));
        }
        private DMDichVu_Gia_Goi_DTList()
        ...
        private void DataPortal_Fetch(Criteria criteria)
        {
            ...
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetAllDMDichVu_Gia_Goi_DT(criteria.MaDT, criteria.qadmin)))
            {
                int i = 1;
                while (dr.Read())
                {
        ...
        {
            this.RaiseListChangedEvents = false;
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().FindDMDichVu_Gia_Goi_DT(criteria.DK, criteria.MaDT, criteria.qadmin)))
            {
                int i = 1;
                while (dr.Read())
                {
        ...
        public override DMDichVu_Gia_Goi_DTList Save()
        {
            ...
            DMDichVu_Gia_Goi_DTList result;
            result = base.Save();
            return result;
        }
