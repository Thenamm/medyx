...
namespace HTC.Business.CategoryList
{
    ...
    [Serializable()]
    public partial class DMTGTVong : BusinessBase<DMTGTVong>
    {
        ...
        private String _tenTGTVong = String.Empty;
        ...
        public String TenTGTVong
        {
            get
            {
                CanReadProperty("TenTGTVong", true);
                return _tenTGTVong;
            }
            set
            {
                CanWriteProperty("TenTGTVong", true);
                if (_tenTGTVong != value)
                {
                    _tenTGTVong = value;
                    PropertyHasChanged("TenTGTVong");
                }
            }
        }
        ...
        /// </summary> 
        /// 
        public static DMTGTVong NewDMTGTVong()
        {

            return DataPortal.Create<DMTGTVong>();
        }
        public static DMTGTVong GetDMTGTVong(String maTGTVong)
        {
            return DataPortal.Fetch<DMTGTVong>(new Criteria(maTGTVong));
        }

        /// <summary>
        /// Marks the <see cref="DMLoaiBA" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteDMTGTVong(String maTGTVong, string mamay, string nguoihuy)
        {
            DataPortal.Delete(new OtherCriteria(mamay,nguoihuy ,maTGTVong));
        }
        ...
        protected internal DMTGTVong()
        {
            // Prevent direct creation
        }
        internal DMTGTVong(int ordernumber, string MaTGTVong, string TenTGTVong, string idmay, bool huy, SmartDate ngaySD, string NguoiSD, string ghichu, String hoten)
        {
            _OrderNumber = ordernumber;
            _maTGTVong = MaTGTVong;
            _tenTGTVong = TenTGTVong;
            _maMay = idmay;
            _huy = huy;
            _ngaySD = ngaySD;
            _nguoiSD = NguoiSD;
        ...
        protected class Criteria
        {
            ...
            public Criteria(String maTGTVong)
            {
                _maTGTVong = maTGTVong;
            }
            ...
            public override bool Equals(object obj)
            {
                if (obj is Criteria)
                {
                    ...
                    if (!_maTGTVong.Equals(c._maTGTVong))
                        return false;
                    return true;
                }
                return false;
            ...
            {
                return string.Concat("Criteria", _maTGTVong.ToString()).GetHashCode();
            }
        }
        ...
        protected class OtherCriteria
        {
            ...
            public OtherCriteria(String Mamay, String Nguoisd, String maTGTVong)
            {
                _maTGTVong = maTGTVong;
                _maMay = Mamay;
                _NguoiSD = Nguoisd;
        ...
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMTGTVong(crit.MaTGTVong)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            if (dr.GetString("TenTGTVong") != null) _tenTGTVong = dr.GetString("TenTGTVong");
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _maTGTVong = DataProvider.Instance().InsertDMTGTVong(_tenTGTVong, _ghiChu, _maMay, _nguoiSD);
        ...
        protected override void DataPortal_Update()
        {
            ...
            if (IsDirty)
            {
                ...
                DataProvider.Instance().UpdateDMTGTVong(_maTGTVong, _tenTGTVong, _ghiChu, _maMay, _nguoiSD , _huy );
        ...
        {
            DataPortal_Delete(new OtherCriteria(_maMay, _nguoiSD , _maTGTVong));
        }
        ...
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMLoaiBA
            DataProvider.Instance().DeleteDMTGTVong(crit.MaMay, crit.NguoiSD, crit.MaTGTVong);
