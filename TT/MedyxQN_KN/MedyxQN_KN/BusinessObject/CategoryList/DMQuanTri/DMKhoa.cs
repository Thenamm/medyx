...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMKhoa : BusinessBase<DMKhoa>
	{
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<DMKhoa>(StringRequired<DMKhoa>, "TenKhoa");


        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : DMKhoa
        {
		...
		/// <summary>
		/// Factory method. New <see cref="DMKhoa" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        public static DMKhoa NewDMKhoa()
        {
            return DataPortal.Create<DMKhoa>();
            //return new DMKhoa();
        }
        public static DMKhoa NewDMKhoa(string idparent)
        {
            //return new DMNhom(idparent);
            return DataPortal.Create<DMKhoa>(new Criteria(idparent));
        }
		public static DMKhoa GetDMKhoa(String maKhoa)
		{
			return DataPortal.Fetch<DMKhoa>(new Criteria(maKhoa));
		}
		
		/// <summary>
		/// Marks the <see cref="DMKhoa" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteDMKhoa(String maKhoa, string mamay, string nguoihuy)
		{
            DataPortal.Delete(new OtherCriteria(mamay,nguoihuy ,maKhoa));
		}
        private DMKhoa(string idparent)
        {
            _idparent = idparent;
        }
		#endregion
		...
		protected internal DMKhoa()
		{	
			// Prevent direct creation
		}
        internal DMKhoa(int ordernumber, string MaQG, string TenQG, Byte loai,
            Byte cap, Decimal sogiuong, string machuyenkhoa, string idmay, bool huy,
            SmartDate ngaySD, string NguoiSD, string idparent, string tenta, string hoten,
            Boolean chon, string diadiem, string ghichu, Boolean khonghd,string manhom, string tennhom
            ,string madv,string makhoaql)
        {
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMKhoa" /> Object based on data in the database.
		/// </summary>
        /// 
		...
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMKhoa(crit.MaKhoa)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMKhoa" /> Object from given SafeDataReader.
		/// </summary>
		private void Fetch(SafeDataReader dr)
		{
			// Value properties
			if (dr.GetString("MaKhoa") != null) _maKhoa = dr.GetString("MaKhoa");
            if (dr.GetString("MaKhoaQL") != null) _MaKhoaQL = dr.GetString("MaKhoaQL");
		...
		/// <summary>
		/// Insert the new <see cref="DMKhoa" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Insert()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMKhoa
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
           
			_maKhoa = DataProvider.Instance().InsertDMKhoa(_tenKhoa, _loai, _sogiuong, _machuyenkhoa, _maMay, _nguoiSD ,_idparent ,_tenta,_diadiem ,_ghichu,_KhongHD, _maNhom ,_MaKhoaQL );
			// public abstract String InsertDMKhoa(String _maKhoa, String _tenKhoa, String _loai, Byte _cap, Decimal _sogiuong, String _machuyenkhoa, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// public override String InsertDMKhoa(String _maKhoa, String _tenKhoa, String _loai, Byte _cap, Decimal _sogiuong, String _machuyenkhoa, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
			// {
		...
		/// <summary>
		/// Update all changes made on <see cref="DMKhoa" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMKhoa
			if (IsDirty){


                DataProvider.Instance().UpdateDMKhoa(_maKhoa, _tenKhoa, _loai, _cap, _sogiuong, _machuyenkhoa, _maMay, _nguoiSD, _tenta, _huy, _diadiem, _ghichu, _KhongHD, _maNhom, _MaKhoaQL);
				// public abstract void UpdateDMKhoa(String _maKhoa, String _tenKhoa, String _loai, Byte _cap, Decimal _sogiuong, String _machuyenkhoa, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// public override void UpdateDMKhoa(String _maKhoa, String _tenKhoa, String _loai, Byte _cap, Decimal _sogiuong, String _machuyenkhoa, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
				// {
		...
		/// <summary>
		/// Delete the <see cref="DMKhoa" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMKhoa
            DataProvider.Instance().DeleteDMKhoa(crit.MaMay, crit.NguoiSD, crit.MaKhoa);
			// public abstract void DeleteDMKhoa(String _maKhoa);
			// public override void DeleteDMKhoa(String _maKhoa);
			// {
