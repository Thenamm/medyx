...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMTBVTYT" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMTBVTYT : BusinessBase<DMTBVTYT>
	{
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<DMTBVTYT>(StringRequired<DMTBVTYT>, "TenTM");
            //ValidationRules.AddRule(Csla.Validation.CommonRules.StringMaxLength, new Csla.Validation.CommonRules.MaxLengthRuleArgs("TenTM", 350));
            ValidationRules.AddRule<DMTBVTYT>(StringRequiredDVT<DMTBVTYT>, "MaDVT");

        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : DMTBVTYT
        {
        ...
        private static bool StringRequiredDVT<T>(T target, Csla.Validation.RuleArgs e) where T : DMTBVTYT
        {
		...
		/// <summary>
		/// Factory method. New <see cref="DMTBVTYT" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMTBVTYT NewDMTBVTYT()
        {
            return DataPortal.Create<DMTBVTYT>();
        }
		public static DMTBVTYT GetDMTBVTYT(String maVT)
		{
			return DataPortal.Fetch<DMTBVTYT>(new Criteria(maVT));
		}
		
		/// <summary>
		/// Marks the <see cref="DMTBVTYT" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
		public static void DeleteDMTBVTYT(String maVT, String MaMay, String MaNSD)
		{
            DataPortal.Delete(new OtherCriteria(MaMay, MaNSD, maVT));
		}
		...
		protected internal DMTBVTYT()
		{	
			// Prevent direct creation
		}
        internal DMTBVTYT(     int OrderNumber,
            ...
            Boolean KhongSD,
                                 string maql,
                                string quycach, String maDVT2, Decimal quydoi, String tenDVT2
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMTBVTYT" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMTBVTYT(crit.MaVT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMTBVTYT" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="DMTBVTYT" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMTBVTYT
			// Copy & paste ham duoi day vao file DataProvider.cs
            _maVT = DataProvider.Instance().InsertDMTBVTYT(_maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _nguoiSD , _vTNoiT, _maLH, _hamLuong, _maDVTHL,_KhongSD,_maql,_quycach,_maDVT2 ,_quydoi ,_loai   );
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMTBVTYT_CREATE", _maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, (_nguoiSD !=""?_nguoiSD : HTC.ShareVariables.pub_sNguoiSD ) , _vTNoiT, _maLH));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="DMTBVTYT" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMTBVTYT
			if (IsDirty){
                 DataProvider.Instance().UpdateDMTBVTYT(_maVT, _maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _huy,_nguoiSD , _vTNoiT, _maLH, _hamLuong, _maDVTHL, _KhongSD, _maql, _quycach, _maDVT2, _quydoi);
				// public abstract void UpdateDMTBVTYT(String _maVT, String _maNhom, String _maChungLoai, String _tenTM, String _tenTA, String _maNSX, Decimal _nguong, String _maDVT, Boolean _apDungGoi, Boolean _handung, String _khoban, String _khophat, Boolean _vTThuT, Boolean _vTPhauT, Boolean _vTCLS, Boolean _vTDuoc, Boolean _vTBan, Boolean _duyetNgoaiT, Boolean _duyetNoiT, String _ghichu, String _maMay, Boolean _huy, String _nguoiSD, Boolean _vTNoiT, String _maLH);
				// public override void UpdateDMTBVTYT(String _maVT, String _maNhom, String _maChungLoai, String _tenTM, String _tenTA, String _maNSX, Decimal _nguong, String _maDVT, Boolean _apDungGoi, Boolean _handung, String _khoban, String _khophat, Boolean _vTThuT, Boolean _vTPhauT, Boolean _vTCLS, Boolean _vTDuoc, Boolean _vTBan, Boolean _duyetNgoaiT, Boolean _duyetNoiT, String _ghichu, String _maMay, Boolean _huy, String _nguoiSD, Boolean _vTNoiT, String _maLH)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMTBVTYT_UPDATE", _maVT, _maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _huy, (_nguoiSD !=""?_nguoiSD : HTC.ShareVariables.pub_sNguoiSD ) , _vTNoiT, _maLH);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="DMTBVTYT" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMTBVTYT
            DataProvider.Instance().DeleteDMTBVTYT(crit.MaMay, crit.NguoiSD, crit.maVT);
			// public abstract void DeleteDMTBVTYT(String _maVT);
			// public override void DeleteDMTBVTYT(String _maVT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMTBVTYT_DELETED", _maVT);
			// }
		}
