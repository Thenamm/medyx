...
//
// Ten file        :	DMTBVTYTKhoa
// Kieu doi tuong  :	DMTBVTYTKhoa
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMTBVTYTKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
    public partial class DMTBVTYTKhoa : BusinessBase<DMTBVTYTKhoa>
	{
        ...
        public static DMTBVTYTKhoa GetDMTBVTYTKhoa(String maKhoa, String maDT, String MaVT, byte loai)
        {
            return DataPortal.Fetch<DMTBVTYTKhoa>(new Criteria(maKhoa, maDT, MaVT,loai));
        }
        public static DMTBVTYTKhoa GetDMTBVTYTKhoa(SafeDataReader dr, int i)
        {
            return new DMTBVTYTKhoa(dr, i);
        }
        #endregion
		...
		protected internal DMTBVTYTKhoa()
		{	
			// Prevent direct creation
		}
        protected DMTBVTYTKhoa(SafeDataReader dr, int i)
        {
            MarkAsChild();
        ...
        internal DMTBVTYTKhoa(Int32 STT,
                                 String MaVT ,
		                         String TenTM ,
                                 String TenDVT ,
                                 decimal TonCK ,
  ...
  _adphongmo = adphongmo;
        ...
        /// <summary>
        /// Retrieve an existing <see cref="DMTBVTYTKhoa" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            // public abstract IDataReader GetDMTBVTYTKhoa(String _maChungLoai);
            // public override IDataReader GetDMTBVTYTKhoa(String _maChungLoai)
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMTBVTYTKhoa(crit.MaKhoa ,crit.MaDT ,crit.MaVT ,crit.Loai    )))
            {
                int i = 1;
                if (dr.Read()){
                    Fetch(dr,i);
        ...
        /// <summary>
        /// Load a <see cref="DMTBVTYTKhoa" /> Object from given SafeDataReader.
        /// </summary>
