...
//
// Ten file        :	DMTBVTYT_TonKho
// Kieu doi tuong  :	DMTBVTYT_TonKho
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMTBVTYT_TonKho" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMTBVTYT_TonKho : BusinessBase<DMTBVTYT_TonKho>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMTBVTYT_TonKho" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        //public static DMTBVTYT_TonKho NewDMTBVTYT_TonKho()
        //{
        //    //return new DMNhomThuoc();
        //    return DataPortal.Create<DMTBVTYT_TonKho>();
        //}
        public static DMTBVTYT_TonKho GetDMTBVTYTTonKho(String maKho, DateTime thang, String MaVT)
		{
			return DataPortal.Fetch<DMTBVTYT_TonKho>(new Criteria(maKho, thang , MaVT));
		}
		
		/// <summary>
		/// Marks the <see cref="DMTBVTYT_TonKho" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMTBVTYT_TonKho(String maChungLoai)
        //{
		...
		protected internal DMTBVTYT_TonKho()
		{	
			// Prevent direct creation
		}
        internal DMTBVTYT_TonKho( 
  int STT,
  String MaVT ,
		                             String TenTM ,
  String TenDVT ,
  ...
  //String Tengoc
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMTBVTYT_TonKho" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetDMTBVTYT_TonKho(String _maChungLoai);
			// public override IDataReader GetDMTBVTYT_TonKho(String _maChungLoai)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMTBVTYTTonKho(crit.maKho ,crit.thang ,crit.MaVT    )))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMTBVTYT_TonKho" /> Object from given SafeDataReader.
		/// </summary>
