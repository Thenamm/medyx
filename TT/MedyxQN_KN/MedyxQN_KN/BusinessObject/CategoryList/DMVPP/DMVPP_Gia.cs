...
namespace HTC.Business.CategoryList
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="DMVPP_Gia" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class DMVPP_Gia : BusinessBase<DMVPP_Gia>
    {
        ...
        /// <summary>
        /// Factory method. New <see cref="DMVPP_Gia" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static DMVPP_Gia NewDMVPP_Gia()
        {
            return new DMVPP_Gia();
        }
        //public static DMVPP_Gia GetDMVPP_Gia(String maDT, String maVT)
        //{
        //    return DataPortal.Fetch<DMVPP_Gia>(new Criteria(maDT, maVT));
        //}
        internal static DMVPP_Gia GetDMVPP_Gia(SafeDataReader dr)
        {
            return new DMVPP_Gia(dr);
        }
        public DMVPP_Gia()
        {
            MarkAsChild();
        ...
        /// <summary>
        /// Marks the <see cref="DMVPP_Gia" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        //public static void DeleteDMVPP_Gia(String maDT, Decimal  sTT)
        //{
        ...
        //protected internal DMVPP_Gia()
        //{	
        //    // Prevent direct creation
        //}
        //internal DMVPP_Gia( int ordernumber, 
        //                     String maDT,
        //                     Decimal STT,
        //                     String maVT ,
        //                     String tenThuoc,
        ...
        /// <summary>
        /// Retrieve an existing <see cref="DMVPP_Gia" /> Object based on data in the database.
        /// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetDMVPP_Gia(String _maDT, String _maVT);
        //    // public override IDataReader GetDMVPP_Gia(String _maDT, String _maVT)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maVT));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVPP_Gia(crit.MaDT, crit.maVT)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        ///// <summary>
        ///// Load a <see cref="DMVPP_Gia" /> Object from given SafeDataReader.
        ///// </summary>
        ...
        //}
        private DMVPP_Gia(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
            if (dr.GetString("MaDT") != null) _maDT = dr.GetString("MaDT");
        ...
        /// <summary>
        /// Insert the new <see cref="DMVPP_Gia" /> Object to underlying database.
        /// </summary>
        internal void Insert()
        {
            ...
            if (!this.IsDirty)
                return;
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMVPP_Gia
            // Copy & paste ham duoi day vao file DataProvider.cs
            
              
            //_maDT = 
                DataProvider.Instance().InsertDMVPP_Gia(_maDT, _maVT, _donGiaBH, _donGiaThuT, _donGiaPhauT, _donGiaCLS, _giachenhlech, _aDChenhlech, _DTBH, _aDPhongMo, _donGia1, _giachenhlech1, _ngay1, _ghichu, _maMay, _nguoiSD);
            // public abstract String InsertDMVPP_Gia(String _maDT, String _maVT, Decimal _donGiaBH, Decimal _donGiaBH1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // public override String InsertDMVPP_Gia(String _maDT, String _maVT, Decimal _donGiaBH, Decimal _donGiaBH1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // {
        ...
        /// <summary>
        /// Update all changes made on <see cref="DMVPP_Gia" /> Object to underlying database.
        /// </summary>
        internal void Update()
        {
            ...
            DataProvider.Instance().UpdateDMVPP_Gia(_maDT, _STT, _maVT, _donGiaBH, _donGiaThuT, _donGiaPhauT, _donGiaCLS, _giachenhlech, _aDChenhlech, _DTBH, _aDPhongMo, _ghichu, _maMay, _nguoiSD , _huy);
            // public abstract void UpdateDMVPP_Gia(String _maDT, String _maVT, Decimal _donGiaBH, Decimal _donGiaBH1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // public override void UpdateDMVPP_Gia(String _maDT, String _maVT, Decimal _donGiaBH, Decimal _donGiaBH1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // {
        ...
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMVPP_Gia
            DataProvider.Instance().DeleteDMVPP_Gia(crit.MaMay, crit.NguoiSD, crit.MaDT, crit.STT);
            // public abstract void DeleteDMVPP_Gia(String _maDT, String _maVT);
            // public override void DeleteDMVPP_Gia(String _maDT, String _maVT);
            // {
