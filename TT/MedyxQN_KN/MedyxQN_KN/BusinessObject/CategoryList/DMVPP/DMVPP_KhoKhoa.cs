...
//
// Ten file        :	DMVPP_KhoKhoa
// Kieu doi tuong  :	DMVPP_KhoKhoa
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMVPP_KhoKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMVPP_KhoKhoa : BusinessBase<DMVPP_KhoKhoa>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMVPP_KhoKhoa" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMVPP_KhoKhoa NewDMVPP_KhoKhoa()
        {
            return new DMVPP_KhoKhoa();
            //return DataPortal.Create<DMVPP_KhoKhoa>();
        }
        ////public static DMVPP_KhoKhoa GetDMVPP_KhoKhoa(String makho, Decimal sTT, String makhoa)
        ////{
        ////    return DataPortal.Fetch<DMVPP_KhoKhoa>(new Criteria(makho, sTT, makhoa));
        ////}
        internal static DMVPP_KhoKhoa GetDMVPP_KhoKhoa(SafeDataReader dr)
        {
            return new DMVPP_KhoKhoa(dr);
        }
		/// <summary>
		/// Marks the <see cref="DMVPP_KhoKhoa" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMVPP_KhoKhoa(String makho, Decimal sTT, String makhoa)
        //{
        //    DataPortal.Delete(new OtherCriteria(mamay,nguoihuy ,makho, sTT, makhoa));
        //}
        public DMVPP_KhoKhoa()
        {
            MarkAsChild();
        }
        ...
        ////protected internal DMVPP_KhoKhoa()
        ////{	
        ////     Prevent direct creation
        ////}

        ////internal DMVPP_KhoKhoa(Decimal ordernumber, String makho,
        ////                             String makhoa ,
        ////                             String maVT ,
        ////                             Boolean huy ,
        ////                             SmartDate ngaySD ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMVPP_KhoKhoa" /> Object based on data in the database.
		/// </summary>
        ...
        ////    // }
        ////    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVPP_KhoKhoa(crit.Makho, crit.STT, crit.Makhoa)))
        ////    {
        ////        if (dr.Read()){
        ////            Fetch(dr);
        ////            MarkOld();
        ...
        ////}
		/// <summary>
		/// Load a <see cref="DMVPP_KhoKhoa" /> Object from given SafeDataReader.
		/// </summary>
        ...
        ////}
        private  DMVPP_KhoKhoa(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
            if (dr.GetString("Makho") != null) _makho = dr.GetString("Makho");
		...
		/// <summary>
		/// Insert the new <see cref="DMVPP_KhoKhoa" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMVPP_KhoKhoa
			// Copy & paste ham duoi day vao file DataProvider.cs
            if (!this.IsDirty)
                return;
            
              
			_makho = DataProvider.Instance().InsertDMVPP_KhoKhoa(_makho, _makhoa, _maVT, _nguoiSD , _maMay);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVPP_KhoKhoa_Create", _makho, _makhoa, _maVT, _nguoiSD , _maMay), String);
			// }
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="DMVPP_KhoKhoa" /> Object to underlying database.
		/// </summary>
        internal void Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMVPP_KhoKhoa
			 if (!this.IsDirty)
                return;
                //
                //  
				DataProvider.Instance().UpdateDMVPP_KhoKhoa(_makho, _sTT, _makhoa, _maVT, _huy, _nguoiSD , _maMay);
        ...
        //    
        //      
        //    DataProvider.Instance().DeleteDMVPP_KhoKhoa(_makho, _sTT, _makhoa);
        //    // public abstract void UpdateDMVPP_KhoKhoa(String _makho, Decimal _sTT, String _makhoa, String _maVT, Boolean _huy, String _nguoiSD, String _maMay);
        //    // public override void UpdateDMVPP_KhoKhoa(String _makho, Decimal _sTT, String _makhoa, String _maVT, Boolean _huy, String _nguoiSD, String _maMay)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVPP_KhoKhoa_Update", _makho, _sTT, _makhoa, _maVT, _huy, _nguoiSD , _maMay);
        ...
        /// <summary>
        /// Delete the <see cref="DMVPP_KhoKhoa" />.
        /// </summary>
        //internal void DataPortal_Delete(OtherCriteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMVPP_KhoKhoa
        //    DataProvider.Instance().DeleteDMVPP_KhoKhoa(crit.MaMay, crit.NguoiSD, crit.Makho, crit.STT, crit.Makhoa);
        //    // public abstract void DeleteDMVPP_KhoKhoa(String _makho, Decimal _sTT, String _makhoa);
        //    // public override void DeleteDMVPP_KhoKhoa(String _makho, Decimal _sTT, String _makhoa)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVPP_KhoKhoa_Deleted", _makho, _sTT, _makhoa);
        //    // }
        //}
