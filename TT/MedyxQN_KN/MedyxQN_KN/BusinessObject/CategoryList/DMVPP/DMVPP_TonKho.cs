...
//
// Ten file        :	DMVPP_TonKho
// Kieu doi tuong  :	DMVPP_TonKho
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMVPP_TonKho" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMVPP_TonKho : BusinessBase<DMVPP_TonKho>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMVPP_TonKho" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        //public static DMVPP_TonKho NewDMVPP_TonKho()
        //{
        //    //return new DMNhomThuoc();
        //    return DataPortal.Create<DMVPP_TonKho>();
        //}
        public static DMVPP_TonKho GetDMVPPTonKho(String maKho, DateTime thang, String MaVT)
		{
			return DataPortal.Fetch<DMVPP_TonKho>(new Criteria(maKho, thang , MaVT));
		}
		
		/// <summary>
		/// Marks the <see cref="DMVPP_TonKho" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMVPP_TonKho(String maChungLoai)
        //{
		...
		protected internal DMVPP_TonKho()
		{	
			// Prevent direct creation
		}
        internal DMVPP_TonKho( 
  int STT,
  String MaVT ,
		                             String TenTM ,
  String TenDVT ,
  ...
  //String Tengoc
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMVPP_TonKho" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetDMVPP_TonKho(String _maChungLoai);
			// public override IDataReader GetDMVPP_TonKho(String _maChungLoai)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVPPTonKho(crit.maKho ,crit.thang ,crit.MaVT    )))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMVPP_TonKho" /> Object from given SafeDataReader.
		/// </summary>
