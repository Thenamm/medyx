...
//
// Ten file        :	DMVPP_TonKhoHD
// Kieu doi tuong  :	DMVPP_TonKhoHD
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMVPP_TonKhoHD" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMVPP_TonKhoHD : BusinessBase<DMVPP_TonKhoHD>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMVPP_TonKhoHD" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        //public static DMVPP_TonKhoHD NewDMVPP_TonKhoHD()
        //{
        //    //return new DMNhomThuoc();
        //    return DataPortal.Create<DMVPP_TonKhoHD>();
        //}
        public static DMVPP_TonKhoHD GetDMVPPTonKho(String maKho, DateTime thang, String MaVT)
		{
			return DataPortal.Fetch<DMVPP_TonKhoHD>(new Criteria(maKho, thang , MaVT,"",DateTime.Parse("01/01/1900")  ));
		}
        public static DMVPP_TonKhoHD GetDMVPPTonKho(String maKho, DateTime thang, String MaVT,string solo, DateTime hansd)
        {
            return DataPortal.Fetch<DMVPP_TonKhoHD>(new Criteria(maKho, thang, MaVT,solo,hansd ));
        }
		/// <summary>
		/// Marks the <see cref="DMVPP_TonKhoHD" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMVPP_TonKhoHD(String maChungLoai)
        //{
		...
		protected internal DMVPP_TonKhoHD()
		{	
			// Prevent direct creation
		}
        internal DMVPP_TonKhoHD( 
  int STT,
  String MaVT ,
		                             String TenTM ,
  String TenDVT ,
 ...
 // String Tengoc,
  ...
  Decimal nguong   
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMVPP_TonKhoHD" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetDMVPP_TonKhoHD(String _maChungLoai);
			// public override IDataReader GetDMVPP_TonKhoHD(String _maChungLoai)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
			// }

            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVPPTonKhoHD(crit.maKho, crit.thang, crit.MaVT, crit.solo, crit.hansd)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMVPP_TonKhoHD" /> Object from given SafeDataReader.
		/// </summary>
