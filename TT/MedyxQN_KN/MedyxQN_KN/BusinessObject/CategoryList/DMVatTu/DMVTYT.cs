...
{	
	...
	[Serializable()]
	public partial class DMVTYT : BusinessBase<DMVTYT>
	{
       ...
       private String _MaBH = String.Empty; private string _MaTDuong = String.Empty;
		...
		protected override void DataPortal_Insert()
		{
            ...
            _maVT = DataProvider.Instance().InsertDMVTYT(_maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _nguoiSD , _vTNoiT, _maLH, _hamLuong, _maDVTHL,_KhongSD,_maql,_quycach,_maDVT2 ,_quydoi ,_loai,_maBYTe,_QuyetDinh,_TenTMBH, _MaBH , _MaTDuong , _QuyetDinhBH ,_TenBYTe  ,_bh50  );
		...
		protected override void DataPortal_Update()
		{
			...
			if (IsDirty){
                ...
                DataProvider.Instance().UpdateDMVTYT(_maVT, _maNhom, _maChungLoai, _tenTM, _tenTA, _maNSX, _nguong, _maDVT, _apDungGoi, _handung, _khoban, _khophat, _vTThuT, _vTPhauT, _vTCLS, _vTDuoc, _vTBan, _duyetNgoaiT, _duyetNoiT, _ghichu, _maMay, _huy, _nguoiSD, _vTNoiT, _maLH, _hamLuong, _maDVTHL, _KhongSD, _maql, _quycach, _maDVT2, _quydoi, _maBYTe, _QuyetDinh, _TenTMBH, _MaBH, _MaTDuong, _QuyetDinhBH, _TenBYTe, _bh50);
