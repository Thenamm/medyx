...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMVTYTKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
    public partial class DMVTYTKhoa : BusinessBase<DMVTYTKhoa>
	{
        ...
        public static DMVTYTKhoa GetDMVTYTKhoa(String maKhoa, String maDT, String MaVT, byte loai)
        {
            return DataPortal.Fetch<DMVTYTKhoa>(new Criteria(maKhoa, maDT, MaVT,loai));
        }
        public static DMVTYTKhoa GetDMVTYTKhoa(SafeDataReader dr, int i)
        {
            return new DMVTYTKhoa(dr, i);
        }
        #endregion
		...
		protected internal DMVTYTKhoa()
		{	
			// Prevent direct creation
		}
        protected DMVTYTKhoa(SafeDataReader dr, int i)
        {
            MarkAsChild();
  ...
  _adphongmo = adphongmo;
        ...
        /// <summary>
        /// Retrieve an existing <see cref="DMVTYTKhoa" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            // public abstract IDataReader GetDMVTYTKhoa(String _maChungLoai);
            // public override IDataReader GetDMVTYTKhoa(String _maChungLoai)
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVTYTKhoa(crit.MaKhoa ,crit.MaDT ,crit.MaVT ,crit.Loai    )))
            {
                int i = 1;
                if (dr.Read()){
                    Fetch(dr,i);
        ...
        /// <summary>
        /// Load a <see cref="DMVTYTKhoa" /> Object from given SafeDataReader.
        /// </summary>
