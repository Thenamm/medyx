...
namespace HTC.Business.CategoryList
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="DMVTYT_Gia" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class DMVTYT_Gia : BusinessBase<DMVTYT_Gia>
    {
        ...
        /// <summary>
        /// Factory method. New <see cref="DMVTYT_Gia" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static DMVTYT_Gia NewDMVTYT_Gia()
        {
            return new DMVTYT_Gia();
        }
        //public static DMVTYT_Gia GetDMVTYT_Gia(String maDT, String maVT)
        //{
        //    return DataPortal.Fetch<DMVTYT_Gia>(new Criteria(maDT, maVT));
        //}
        internal static DMVTYT_Gia GetDMVTYT_Gia(SafeDataReader dr)
        {
            return new DMVTYT_Gia(dr);
        }
        public DMVTYT_Gia()
        {
            MarkAsChild();
        ...
        /// <summary>
        /// Marks the <see cref="DMVTYT_Gia" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        //public static void DeleteDMVTYT_Gia(String maDT, Decimal  sTT)
        //{
        ...
        //protected internal DMVTYT_Gia()
        //{	
        //    // Prevent direct creation
        //}
        //internal DMVTYT_Gia( int ordernumber, 
        //                     String maDT,
        //                     Decimal STT,
        //                     String maVT ,
        //                     String tenThuoc,
        ...
        /// <summary>
        /// Retrieve an existing <see cref="DMVTYT_Gia" /> Object based on data in the database.
        /// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetDMVTYT_Gia(String _maDT, String _maVT);
        //    // public override IDataReader GetDMVTYT_Gia(String _maDT, String _maVT)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maVT));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVTYT_Gia(crit.MaDT, crit.maVT)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        ///// <summary>
        ///// Load a <see cref="DMVTYT_Gia" /> Object from given SafeDataReader.
        ///// </summary>
        ...
        //}
        private DMVTYT_Gia(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
            if (dr.GetString("MaDT") != null) _maDT = dr.GetString("MaDT");
        ...
        /// <summary>
        /// Insert the new <see cref="DMVTYT_Gia" /> Object to underlying database.
        /// </summary>
        internal void Insert()
        {
            ...
            if (!this.IsDirty)
                return;
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMVTYT_Gia
            // Copy & paste ham duoi day vao file DataProvider.cs
            
              
            //_maDT = 
                DataProvider.Instance().InsertDMVTYT_Gia(_maDT, _maVT, _donGia, _donGiaThuT, _donGiaPhauT, _donGiaCLS, _giachenhlech, _aDChenhlech, _DTBH, _aDPhongMo, _donGia1, _giachenhlech1, _ngay1, _ghichu, _maMay, _nguoiSD);
            // public abstract String InsertDMVTYT_Gia(String _maDT, String _maVT, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // public override String InsertDMVTYT_Gia(String _maDT, String _maVT, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maVT, _donGia, _donGia1, _ngayBH1.DBValue, _ghichu, _maMay, _huy, _ngaySD.DBValue, _nguoiSD), String);
            // }
            MarkOld();
        }

        /// <summary>
        /// Update all changes made on <see cref="DMVTYT_Gia" /> Object to underlying database.
        /// </summary>
        internal void Update()
        {
            ...
            DataProvider.Instance().UpdateDMVTYT_Gia(_maDT, _STT, _maVT, _donGia, _donGiaThuT, _donGiaPhauT, _donGiaCLS, _giachenhlech, _aDChenhlech, _DTBH, _aDPhongMo, _ghichu, _maMay, _nguoiSD , _huy);
            // public abstract void UpdateDMVTYT_Gia(String _maDT, String _maVT, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // public override void UpdateDMVTYT_Gia(String _maDT, String _maVT, Decimal _donGia, Decimal _donGia1, SmartDate _ngayBH1, String _ghichu, String _maMay, Boolean _huy,SmartDate _ngaySD, String _nguoiSD);
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDT, _maVT, _donGia, _donGia1, _ngayBH1.DBValue, _ghichu, _maMay, _huy, _ngaySD.DBValue, _nguoiSD);
            // }				
            MarkOld();
        }
        ...
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMVTYT_Gia
            DataProvider.Instance().DeleteDMVTYT_Gia(crit.MaMay, crit.NguoiSD, crit.MaDT, crit.STT);
            // public abstract void DeleteDMVTYT_Gia(String _maDT, String _maVT);
            // public override void DeleteDMVTYT_Gia(String _maDT, String _maVT);
            // {
