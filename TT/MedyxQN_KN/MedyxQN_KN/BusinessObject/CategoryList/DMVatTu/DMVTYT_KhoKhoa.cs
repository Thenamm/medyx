...
//
// Ten file        :	DMVTYT_KhoKhoa
// Kieu doi tuong  :	DMVTYT_KhoKhoa
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMVTYT_KhoKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMVTYT_KhoKhoa : BusinessBase<DMVTYT_KhoKhoa>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMVTYT_KhoKhoa" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMVTYT_KhoKhoa NewDMVTYT_KhoKhoa()
        {
            return new DMVTYT_KhoKhoa();
            //return DataPortal.Create<DMVTYT_KhoKhoa>();
        }
        ////public static DMVTYT_KhoKhoa GetDMVTYT_KhoKhoa(String makho, Decimal sTT, String makhoa)
        ////{
        ////    return DataPortal.Fetch<DMVTYT_KhoKhoa>(new Criteria(makho, sTT, makhoa));
        ////}
        internal static DMVTYT_KhoKhoa GetDMVTYT_KhoKhoa(SafeDataReader dr)
        {
            return new DMVTYT_KhoKhoa(dr);
        }
		/// <summary>
		/// Marks the <see cref="DMVTYT_KhoKhoa" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMVTYT_KhoKhoa(String makho, Decimal sTT, String makhoa)
        //{
        //    DataPortal.Delete(new OtherCriteria(mamay,nguoihuy ,makho, sTT, makhoa));
        //}
        public DMVTYT_KhoKhoa()
        {
            MarkAsChild();
        }
        ...
        ////protected internal DMVTYT_KhoKhoa()
        ////{	
        ////     Prevent direct creation
        ////}

        ////internal DMVTYT_KhoKhoa(Decimal ordernumber, String makho,
        ////                             String makhoa ,
        ////                             String maVT ,
        ////                             Boolean huy ,
        ////                             SmartDate ngaySD ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMVTYT_KhoKhoa" /> Object based on data in the database.
		/// </summary>
        ...
        ////    // }
        ////    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVTYT_KhoKhoa(crit.Makho, crit.STT, crit.Makhoa)))
        ////    {
        ////        if (dr.Read()){
        ////            Fetch(dr);
        ////            MarkOld();
        ...
        ////}
		/// <summary>
		/// Load a <see cref="DMVTYT_KhoKhoa" /> Object from given SafeDataReader.
		/// </summary>
        ...
        ////}
        private  DMVTYT_KhoKhoa(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
            if (dr.GetString("Makho") != null) _makho = dr.GetString("Makho");
		...
		/// <summary>
		/// Insert the new <see cref="DMVTYT_KhoKhoa" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMVTYT_KhoKhoa
			// Copy & paste ham duoi day vao file DataProvider.cs
            if (!this.IsDirty)
                return;
            
              
			_makho = DataProvider.Instance().InsertDMVTYT_KhoKhoa(_makho, _makhoa, _maVT, _nguoiSD , _maMay);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVTYT_KhoKhoa_Create", _makho, _makhoa, _maVT, _nguoiSD , _maMay), String);
			// }
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="DMVTYT_KhoKhoa" /> Object to underlying database.
		/// </summary>
        internal void Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMVTYT_KhoKhoa
			 if (!this.IsDirty)
                return;
                //
                //  
				DataProvider.Instance().UpdateDMVTYT_KhoKhoa(_makho, _sTT, _makhoa, _maVT, _huy, _nguoiSD , _maMay);
        ...
        //    
        //      
        //    DataProvider.Instance().DeleteDMVTYT_KhoKhoa(_makho, _sTT, _makhoa);
        //    // public abstract void UpdateDMVTYT_KhoKhoa(String _makho, Decimal _sTT, String _makhoa, String _maVT, Boolean _huy, String _nguoiSD, String _maMay);
        //    // public override void UpdateDMVTYT_KhoKhoa(String _makho, Decimal _sTT, String _makhoa, String _maVT, Boolean _huy, String _nguoiSD, String _maMay)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVTYT_KhoKhoa_Update", _makho, _sTT, _makhoa, _maVT, _huy, _nguoiSD , _maMay);
        ...
        /// <summary>
        /// Delete the <see cref="DMVTYT_KhoKhoa" />.
        /// </summary>
        //internal void DataPortal_Delete(OtherCriteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMVTYT_KhoKhoa
        //    DataProvider.Instance().DeleteDMVTYT_KhoKhoa(crit.MaMay, crit.NguoiSD, crit.Makho, crit.STT, crit.Makhoa);
        //    // public abstract void DeleteDMVTYT_KhoKhoa(String _makho, Decimal _sTT, String _makhoa);
        //    // public override void DeleteDMVTYT_KhoKhoa(String _makho, Decimal _sTT, String _makhoa)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVTYT_KhoKhoa_Deleted", _makho, _sTT, _makhoa);
        //    // }
        //}
