...
//
// Ten file        :	DMVTYT_KhoKhoaG
// Kieu doi tuong  :	DMVTYT_KhoKhoaG
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMVTYT_KhoKhoaG" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMVTYT_KhoKhoaG : BusinessBase<DMVTYT_KhoKhoaG>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMVTYT_KhoKhoaG" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static DMVTYT_KhoKhoaG NewDMVTYT_KhoKhoaG()
        {
            return new DMVTYT_KhoKhoaG();
            //return DataPortal.Create<DMVTYT_KhoKhoaG>();
        }
        ////public static DMVTYT_KhoKhoaG GetDMVTYT_KhoKhoaG(String makho, Decimal sTT, String makhoa)
        ////{
        ////    return DataPortal.Fetch<DMVTYT_KhoKhoaG>(new Criteria(makho, sTT, makhoa));
        ////}
        internal static DMVTYT_KhoKhoaG GetDMVTYT_KhoKhoaG(SafeDataReader dr)
        {
            return new DMVTYT_KhoKhoaG(dr);
        }
		/// <summary>
		/// Marks the <see cref="DMVTYT_KhoKhoaG" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMVTYT_KhoKhoaG(String makho, Decimal sTT, String makhoa)
        //{
        //    DataPortal.Delete(new OtherCriteria(mamay,nguoihuy ,makho, sTT, makhoa));
        //}
        public DMVTYT_KhoKhoaG()
        {
            MarkAsChild();
        }
        ...
        ////protected internal DMVTYT_KhoKhoaG()
        ////{	
        ////     Prevent direct creation
        ////}

        ////internal DMVTYT_KhoKhoaG(Decimal ordernumber, String makho,
        ////                             String makhoa ,
        ////                             String maVT ,
        ////                             Boolean huy ,
        ////                             SmartDate ngaySD ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMVTYT_KhoKhoaG" /> Object based on data in the database.
		/// </summary>
        ...
        ////    // }
        ////    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVTYT_KhoKhoaG(crit.Makho, crit.STT, crit.Makhoa)))
        ////    {
        ////        if (dr.Read()){
        ////            Fetch(dr);
        ////            MarkOld();
        ...
        ////}
		/// <summary>
		/// Load a <see cref="DMVTYT_KhoKhoaG" /> Object from given SafeDataReader.
		/// </summary>
        ...
        ////}
        private  DMVTYT_KhoKhoaG(SafeDataReader dr)
        {
            MarkAsChild();
            // Value properties
            if (dr.GetString("Makho") != null) _makho = dr.GetString("Makho");
		...
		/// <summary>
		/// Insert the new <see cref="DMVTYT_KhoKhoaG" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertDMVTYT_KhoKhoaG
			// Copy & paste ham duoi day vao file DataProvider.cs
            if (!this.IsDirty)
                return;
            
              
			_makho = DataProvider.Instance().InsertDMVTYT_KhoKhoaG(_makho, _makhoa, _maVT, _nguoiSD , _maMay);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVTYT_KhoKhoaG_Create", _makho, _makhoa, _maVT, _nguoiSD , _maMay), String);
			// }
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="DMVTYT_KhoKhoaG" /> Object to underlying database.
		/// </summary>
        internal void Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMVTYT_KhoKhoaG
			 if (!this.IsDirty)
                return;
                //
                //  
				DataProvider.Instance().UpdateDMVTYT_KhoKhoaG(_makho, _sTT, _makhoa, _maVT, _huy, _nguoiSD , _maMay);
        ...
        //    
        //      
        //    DataProvider.Instance().DeleteDMVTYT_KhoKhoaG(_makho, _sTT, _makhoa);
        //    // public abstract void UpdateDMVTYT_KhoKhoaG(String _makho, Decimal _sTT, String _makhoa, String _maVT, Boolean _huy, String _nguoiSD, String _maMay);
        //    // public override void UpdateDMVTYT_KhoKhoaG(String _makho, Decimal _sTT, String _makhoa, String _maVT, Boolean _huy, String _nguoiSD, String _maMay)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVTYT_KhoKhoaG_Update", _makho, _sTT, _makhoa, _maVT, _huy, _nguoiSD , _maMay);
        ...
        /// <summary>
        /// Delete the <see cref="DMVTYT_KhoKhoaG" />.
        /// </summary>
        //internal void DataPortal_Delete(OtherCriteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateDMVTYT_KhoKhoaG
        //    DataProvider.Instance().DeleteDMVTYT_KhoKhoaG(crit.MaMay, crit.NguoiSD, crit.Makho, crit.STT, crit.Makhoa);
        //    // public abstract void DeleteDMVTYT_KhoKhoaG(String _makho, Decimal _sTT, String _makhoa);
        //    // public override void DeleteDMVTYT_KhoKhoaG(String _makho, Decimal _sTT, String _makhoa)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMVTYT_KhoKhoaG_Deleted", _makho, _sTT, _makhoa);
        //    // }
        //}
