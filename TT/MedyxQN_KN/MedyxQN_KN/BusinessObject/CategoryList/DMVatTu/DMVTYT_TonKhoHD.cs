...
//
// Ten file        :	DMVTYT_TonKhoHD
// Kieu doi tuong  :	DMVTYT_TonKhoHD
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="DMVTYT_TonKhoHD" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class DMVTYT_TonKhoHD : BusinessBase<DMVTYT_TonKhoHD>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="DMVTYT_TonKhoHD" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        //public static DMVTYT_TonKhoHD NewDMVTYT_TonKhoHD()
        //{
        //    //return new DMNhomThuoc();
        //    return DataPortal.Create<DMVTYT_TonKhoHD>();
        //}
        public static DMVTYT_TonKhoHD GetDMVTYTTonKho(String maKho, DateTime thang, String MaVT)
		{
			return DataPortal.Fetch<DMVTYT_TonKhoHD>(new Criteria(maKho, thang , MaVT,"",DateTime.Parse("01/01/1900")  ));
		}
        public static DMVTYT_TonKhoHD GetDMVTYTTonKho(String maKho, DateTime thang, String MaVT,string solo, DateTime hansd)
        {
            return DataPortal.Fetch<DMVTYT_TonKhoHD>(new Criteria(maKho, thang, MaVT,solo,hansd ));
        }
		/// <summary>
		/// Marks the <see cref="DMVTYT_TonKhoHD" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteDMVTYT_TonKhoHD(String maChungLoai)
        //{
		...
		protected internal DMVTYT_TonKhoHD()
		{	
			// Prevent direct creation
		}
        internal DMVTYT_TonKhoHD( 
  int STT,
  String MaVT ,
		                             String TenTM ,
  String TenDVT ,
 ...
 // String Tengoc,
  ...
  Decimal nguong   
		...
		/// <summary>
		/// Retrieve an existing <see cref="DMVTYT_TonKhoHD" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetDMVTYT_TonKhoHD(String _maChungLoai);
			// public override IDataReader GetDMVTYT_TonKhoHD(String _maChungLoai)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maChungLoai));
			// }

            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetDMVTYTTonKhoHD(crit.maKho, crit.thang, crit.MaVT, crit.solo, crit.hansd)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="DMVTYT_TonKhoHD" /> Object from given SafeDataReader.
		/// </summary>
