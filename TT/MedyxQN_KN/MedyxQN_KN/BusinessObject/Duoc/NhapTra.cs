...
{
    [Serializable()]
    public partial class NhapTra : BusinessBase<NhapTra>
    {
       ...
       // private SmartDate _ngayXuatTT = new SmartDate(false);
        ...
        private NhapTra_Cs _NhapTraCs = NhapTra_Cs.NewNhapTra_Cs();
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<NhapTra>(StringRequired<NhapTra>, "NoiXuat");
            ...
            ValidationRules.AddRule<NhapTra>(StringRequiredNoiNhap<NhapTra>, "Noinhap");


        }
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : NhapTra
        {
        ...
        private static bool StringRequiredNoiNhap<T>(T target, Csla.Validation.RuleArgs e) where T : NhapTra
        {
        ...
        public static NhapTra NewNhapTra()
        { 
            return DataPortal.Create<NhapTra>();
        }

        public static NhapTra GetNhapTra(String MaPNT,byte loaiphieu,byte daphat,Boolean qadmin)
        {
            return DataPortal.Fetch<NhapTra>(new Criteria(MaPNT,loaiphieu ,daphat,qadmin ));
        }

        public static NhapTra GetNhapTra(SafeDataReader dr)
        {
            NhapTra obj = new NhapTra();
            obj.Fetch(dr);
            return obj;
        ...
        protected internal NhapTra()
        { 
            //
        }
        internal NhapTra( int OrderNumber,
                            String MaPNT,
                            String noiXuat,
                            //SmartDate ngayXuat,
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _MaPNT = DataProvider.Instance().InsertNhapTra(_noiNhap, _ngayNhap, _ngayNhapTT, _noiXuat, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _nguoiSD , _BNTra,_maMay,_daPhat,_daDuyet  );
            MarkOld();
