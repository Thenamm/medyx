...
{
    [Serializable()]
    public partial class NhapTraDT : BusinessBase<NhapTraDT>
    {
       ...
       // private SmartDate _ngayXuatTT = new SmartDate(false);
        ...
        NhapTra_Cs _NhapTraCs = NhapTra_Cs.NewNhapTra_Cs();
        public NhapTra_Cs NhapTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _NhapTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _NhapTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<NhapTraDT>(StringRequired<NhapTraDT>, "NoiXuat");
            ...
            ValidationRules.AddRule<NhapTraDT>(StringRequiredNoiNhap<NhapTraDT>, "Noinhap");


        }
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : NhapTraDT
        {
        ...
        private static bool StringRequiredNoiNhap<T>(T target, Csla.Validation.RuleArgs e) where T : NhapTraDT
        {
        ...
        public static NhapTraDT NewNhapTra()
        { 
            return DataPortal.Create<NhapTraDT>();
        }

        public static NhapTraDT GetNhapTra(String MaPNT,byte loaiphieu,byte daphat,Boolean qadmin)
        {
            return DataPortal.Fetch<NhapTraDT>(new Criteria(MaPNT,loaiphieu ,daphat,qadmin  ));
        }

        public static NhapTraDT GetNhapTra(SafeDataReader dr)
        {
            NhapTraDT obj = new NhapTraDT();
            obj.Fetch(dr);
            return obj;
            
        }

        public static void DeleteNhapTra(String MaPNT, string mamay, string nguoihuy)
        {
        ...
        protected internal NhapTraDT()
        { 
            //
        }
        internal NhapTraDT( int OrderNumber,
                            String MaPNT,
                            String noiXuat,
                            //SmartDate ngayXuat,
        ...
        { 
            using (SafeDataReader dr=new SafeDataReader(DataProvider.Instance().GetNhapTra(crit.MaPNT,crit.qadmin,crit.LoaiPhieu,crit.daphat)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
                    if (dr.NextResult())
                    {
                        _NhapTraCs = NhapTra_Cs.GetNhapTra_Cs(dr);  
                    } 
                }
            }
        }
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _MaPNT = DataProvider.Instance().InsertNhapTra(_noiNhap, _ngayNhap, _ngayNhapTT, _noiXuat, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _nguoiSD , _BNTra, _maMay, _daPhat, _daDuyet, _Khongsua, _MaDT,_SLThang );
            MarkOld();
            _NhapTraCs.Update(this);
        ...
        protected override void DataPortal_Update()
        {
            ...
            DataProvider.Instance().UpdateNhapTra(_MaPNT, _noiXuat, _ngayNhap, _ngayNhapTT, _noiNhap, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _huy, _maMay, _nguoiSD , _daPhat,_BNTra,_daDuyet   );
        ...
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            ...
            DataProvider.Instance().DeleteNhapTra(crit.MaPNT, crit.MaMay, crit.NguoiSD);
