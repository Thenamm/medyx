...
//
// Ten file        :	PhieuDTNhap_C
// Kieu doi tuong  :	PhieuDTNhap_C
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="PhieuDTNhap_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class PhieuDTNhap_C : BusinessBase<PhieuDTNhap_C>
	{
        ...
        protected override void AddBusinessRules()
        {
            ...
            ////ValidationRules.AddRule<PhieuDTNhap_C>(StringRequired<PhieuDTNhap_C>, "TenTM");
            //ValidationRules.AddRule<PhieuDTNhap_C>(NumberRequired<PhieuDTNhap_C>, "Dongia");
        }
        //private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : PhieuDTNhap_C
        //{
        ...
        //        return true;
        //}
        //private static bool NumberRequired<T>(T target, Csla.Validation.RuleArgs e) where T : PhieuDTNhap_C
        //{
        ...
        //        if (target._donGia ==0)
        //      {
        //          e.Description = "Ðơn giá phải khác 0";
        //          return false;
        //      }
		...
		/// <summary>
		/// Factory method. New <see cref="PhieuDTNhap_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static PhieuDTNhap_C NewPhieuDTNhap_C()
        {
           //return new PhieuDTNhap_C();
            return DataPortal.Create<PhieuDTNhap_C>();
        }

        public static PhieuDTNhap_C NewPhieuDTNhap_C(string idDMThuoc)
        {
            return new PhieuDTNhap_C(DMThuoc.GetDMThuoc(idDMThuoc));
        }

        public static PhieuDTNhap_C NewPhieuDTNhap_C(DMThuoc _DMThuoc)
        {
            return new PhieuDTNhap_C(_DMThuoc);
        }
		public static PhieuDTNhap_C GetPhieuDTNhap_C(String maDuTru, Decimal sTT)
		{
			return DataPortal.Fetch<PhieuDTNhap_C>(new Criteria(maDuTru, sTT));
		}
        public static PhieuDTNhap_C GetPhieuDTNhap_C(SafeDataReader dr)
        {
            return new PhieuDTNhap_C(dr);
        }
		/// <summary>
		/// Marks the <see cref="PhieuDTNhap_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeletePhieuDTNhap_C(String maDuTru, Decimal sTT)
        //{
		...
		protected internal PhieuDTNhap_C()
		{	
			// Prevent direct creation
            //ValidationRules.CheckRules();  
		}
		protected PhieuDTNhap_C(DMThuoc pro)
        {
            MarkAsChild();
            _mathuoc = pro.MaThuoc;
            _tenTM = pro.TenTM;
        }
        protected PhieuDTNhap_C(string madutru, DMThuoc pro)
        {
            MarkAsChild();
            _maDuTru = madutru;            
            _mathuoc = pro.MaThuoc;
        ...
        protected PhieuDTNhap_C(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="PhieuDTNhap_C" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetPhieuDTNhap_C(String _maDuTru, Decimal _sTT);
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetPhieuDTNhap_C(crit.MaDuTru, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="PhieuDTNhap_C" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="PhieuDTNhap_C" /> Object to underlying database.
		/// </summary>
        /// 
        ...
        internal virtual void Insert(PhieuDTNhap bill)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertPhieuDTNhap_C
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
            _maDuTru = bill.MaDuTru;
            DataProvider.Instance().InsertPhieuDTNhap_C(bill.MaDuTru, _mathuoc, _soluong, _donGia, _ghichu, _nguoiSD , _maMay);
            MarkOld();// public abstract String InsertPhieuDTNhap_C(String _maDuTru, String _mathuoc, Decimal _soluong, Decimal _donGia, String _ghichu, String _nguoiSD, String _maMay);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDTNhap_C_CREATE", _maDuTru, _mathuoc, _soluong, _donGia, _ghichu, _nguoiSD , _maMay));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="PhieuDTNhap_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Update(PhieuDTNhap bill)
        {
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdatePhieuDTNhap_C
			if (IsDirty){
                
                  
				DataProvider.Instance().UpdatePhieuDTNhap_C(bill.MaDuTru , _sTT, _mathuoc, _soluong, _donGia, _huy, _ghichu, _nguoiSD , _maMay);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDTNhap_C_UPDATE", _maDuTru, _sTT, _mathuoc, _soluong, _donGia, _huy, _ghichu, _nguoiSD , _maMay);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="PhieuDTNhap_C" />.
		/// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdatePhieuDTNhap_C
        //    DataProvider.Instance().DeletePhieuDTNhap_C(crit.MaDuTru, crit.STT);
        //    // public abstract void DeletePhieuDTNhap_C(String _maDuTru, Decimal _sTT);
        //    // public override void DeletePhieuDTNhap_C(String _maDuTru, Decimal _sTT);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDTNhap_C_DELETED", _maDuTru, _sTT);
        //    // }
        //}
        internal void DeleteSelf(PhieuDTNhap packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
            ...
            DataProvider.Instance().DeletePhieuDTNhap_C(_maMay, _nguoiSD , _maDuTru, _sTT);
            MarkNew();
