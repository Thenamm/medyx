...
//
// Ten file        :	PhieuDoiThuoc
// Kieu doi tuong  :	PhieuDoiThuoc
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="PhieuDoiThuoc" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class PhieuDoiThuoc : BusinessBase<PhieuDoiThuoc>
	{
        ...
        PhieuDoiThuoc_C_List _PhieuDoiThuoc_C_List = PhieuDoiThuoc_C_List.NewPhieuDoiThuoc_C_List();
        public PhieuDoiThuoc_C_List PhieuDoiThuoc_C_List
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                return _PhieuDoiThuoc_C_List;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                if (!_PhieuDoiThuoc_C_List.Equals(value))
                {
                    _PhieuDoiThuoc_C_List = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _PhieuDoiThuoc_C_List.IsDirty ;
            }
        }
        public override bool IsValid
        {
            ...
            {
                return base.IsValid && _PhieuDoiThuoc_C_List.IsValid ;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<PhieuDoiThuoc>(StringRequired<PhieuDoiThuoc>, "MaNCC");
            //ValidationRules.AddRule(Csla.Validation.CommonRules.StringMaxLength, new Csla.Validation.CommonRules.MaxLengthRuleArgs("TenTM", 350));
            //ValidationRules.AddRule<PhieuDoiThuoc>(StringRequiredCT<PhieuDoiThuoc>, "SoCT");

        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : PhieuDoiThuoc
        {
        ...
        private static bool StringRequiredCT<T>(T target, Csla.Validation.RuleArgs e) where T : PhieuDoiThuoc
        {
		...
		/// <summary>
		/// Factory method. New <see cref="PhieuDoiThuoc" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static PhieuDoiThuoc NewPhieuDoiThuoc()
        {
            return DataPortal.Create<PhieuDoiThuoc>();
        }

		public static PhieuDoiThuoc GetPhieuDoiThuoc(String maDThuoc)
		{
			return DataPortal.Fetch<PhieuDoiThuoc>(new Criteria(maDThuoc));
		}
        public static PhieuDoiThuoc GetPhieuDoiThuoc(SafeDataReader dr)
        {
            PhieuDoiThuoc obj = new PhieuDoiThuoc();
            obj.Fetch(dr);
            return obj;

        }
		/// <summary>
		/// Marks the <see cref="PhieuDoiThuoc" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeletePhieuDoiThuoc(String maDThuoc, string mamay, string nguoihuy)
		{
		...
		protected internal PhieuDoiThuoc()
		{	
			// Prevent direct creation
		}
        internal PhieuDoiThuoc( 
                                int OrderNumber,
                                String maDThuoc,
		                     String maNCC ,
		                     String soCT ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="PhieuDoiThuoc" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetPhieuDoiThuoc(String _maDThuoc);
			// public override IDataReader GetPhieuDoiThuoc(String _maDThuoc)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDThuoc));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetPhieuDoiThuoc(crit.MaDThuoc,crit.qadmin )))
			{
				if (dr.Read()){
					Fetch(dr);
                    if (dr.NextResult())
                    {
                        _PhieuDoiThuoc_C_List = PhieuDoiThuoc_C_List.GetPhieuDoiThuoc_C_List(dr);
                    }
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="PhieuDoiThuoc" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="PhieuDoiThuoc" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertPhieuDoiThuoc
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
			_maDThuoc = DataProvider.Instance().InsertPhieuDoiThuoc(_maNCC, _soCT, _ngayDThuoc, _makho, _ghichu, _nguoiSD , _maMay);
            MarkOld();
            _PhieuDoiThuoc_C_List.Update(this);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDoiThuoc_CREATE", _maNCC, _soCT, _ngayDThuoc.DBValue, _makho, _ghichu, _nguoiSD , _maMay));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="PhieuDoiThuoc" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdatePhieuDoiThuoc
			if (IsDirty){
                
                  
				DataProvider.Instance().UpdatePhieuDoiThuoc(_maDThuoc, _maNCC, _soCT, _ngayDThuoc, _makho, _ghichu, _huy, _nguoiSD , _maMay);
                _PhieuDoiThuoc_C_List.Update(this);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDoiThuoc_UPDATE", _maDThuoc, _maNCC, _soCT, _ngayDThuoc.DBValue, _makho, _ghichu, _huy, _nguoiSD , _maMay);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="PhieuDoiThuoc" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdatePhieuDoiThuoc
            DataProvider.Instance().DeletePhieuDoiThuoc(crit.MaMay, crit.NguoiSD, crit.MaDThuoc);
			// public abstract void DeletePhieuDoiThuoc(String _maDThuoc);
			// public override void DeletePhieuDoiThuoc(String _maDThuoc);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDoiThuoc_DELETED", _maDThuoc);
			// }
		}
