...
//
// Ten file        :	PhieuDoiThuoc_C
// Kieu doi tuong  :	PhieuDoiThuoc_C
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="PhieuDoiThuoc_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class PhieuDoiThuoc_C : BusinessBase<PhieuDoiThuoc_C>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="PhieuDoiThuoc_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static PhieuDoiThuoc_C NewPhieuDoiThuoc_C()
        {
            return new PhieuDoiThuoc_C();

        }

        public static PhieuDoiThuoc_C NewPhieuDoiThuoc_C(string idDMThuoc)
        {
            return new PhieuDoiThuoc_C(DMThuoc.GetDMThuoc(idDMThuoc));
        }

        public static PhieuDoiThuoc_C NewPhieuDoiThuoc_C(DMThuoc _DMThuoc)
        {
            return new PhieuDoiThuoc_C(_DMThuoc);
        }

		public static PhieuDoiThuoc_C GetPhieuDoiThuoc_C(String maDThuoc, Decimal sTT)
		{
			return DataPortal.Fetch<PhieuDoiThuoc_C>(new Criteria(maDThuoc, sTT));
		}

        public static PhieuDoiThuoc_C GetPhieuDoiThuoc_C(SafeDataReader dr)
        {
            return new PhieuDoiThuoc_C(dr);
        }

		/// <summary>
		/// Marks the <see cref="PhieuDoiThuoc_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
		...
		protected internal PhieuDoiThuoc_C()
		{	
			// Prevent direct creation
		}
		
        protected PhieuDoiThuoc_C(DMThuoc pro)
        {
            MarkAsChild();
            _mathuoc = pro.MaThuoc;
            _tenTM = pro.TenTM;
        }
        protected PhieuDoiThuoc_C(string maDThuoc, DMThuoc pro)
        {
            MarkAsChild();
            _maDThuoc = maDThuoc;            
            _mathuoc = pro.MaThuoc;
        ...
        protected PhieuDoiThuoc_C(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="PhieuDoiThuoc_C" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDoiThuoc_C_GET", _maDThuoc, _sTT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetPhieuDoiThuoc_C(crit.MaDThuoc, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="PhieuDoiThuoc_C" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="PhieuDoiThuoc_C" /> Object to underlying database.
		/// </summary>
        /// 
        ...
        internal virtual void Insert(PhieuDoiThuoc bill)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertPhieuDoiThuoc_C
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
            _maDThuoc = bill.MaDThuoc;
             DataProvider.Instance().InsertPhieuDoiThuoc_C(bill.MaDThuoc, _mathuoc, _soluong, _hanSD, _hanSDCu, _donGia, _soLo, _soLoCu, _ghichu, _nguoiSD , _maMay);
             MarkOld();// public abstract String InsertPhieuDoiThuoc_C(String _maDThuoc, String _mathuoc, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, String _ghichu, String _nguoiSD, String _maMay);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDoiThuoc_C_CREATE", _maDThuoc, _mathuoc, _soluong, _hanSD.DBValue, _hanSDCu.DBValue, _donGia, _soLo, _soLoCu, _ghichu, _nguoiSD , _maMay));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="PhieuDoiThuoc_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Update(PhieuDoiThuoc bill)
        {
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdatePhieuDoiThuoc_C
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdatePhieuDoiThuoc_C(bill.MaDThuoc, _sTT, _mathuoc, _soluong, _hanSD, _hanSDCu, _donGia, _soLo, _soLoCu, _huy, _ghichu, _nguoiSD , _maMay);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDoiThuoc_C_UPDATE", _maDThuoc, _sTT, _mathuoc, _soluong, _hanSD.DBValue, _hanSDCu.DBValue, _donGia, _soLo, _soLoCu, _huy, _ghichu, _nguoiSD , _maMay);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="PhieuDoiThuoc_C" />.
		/// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdatePhieuDoiThuoc_C
        //    DataProvider.Instance().DeletePhieuDoiThuoc_C(crit.MaDThuoc, crit.STT);
        //    // public abstract void DeletePhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT);
        //    // public override void DeletePhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spPhieuDoiThuoc_C_DELETED", _maDThuoc, _sTT);
        //    // }
        //}
        internal void DeleteSelf(PhieuDoiThuoc packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
            ...
            DataProvider.Instance().DeletePhieuDoiThuoc_C(_maMay, _nguoiSD , _maDThuoc, _sTT);
            MarkNew();
