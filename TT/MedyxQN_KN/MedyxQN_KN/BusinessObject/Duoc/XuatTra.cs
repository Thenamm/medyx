...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="XuatTra" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class XuatTra : BusinessBase<XuatTra>
	{
		...
		private SmartDate _ngayXuatTT = new SmartDate(DateTime.Today);
        private SmartDate _ngayXuatTTD = new SmartDate(DateTime.Today);
        ...
        XuatTra_C_List _XuatTraCs = XuatTra_C_List.NewXuatTra_C_List();
        public XuatTra_C_List XuatTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _XuatTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _XuatTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<XuatTra>(StringRequired<XuatTra>, "TenNCC");
        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : XuatTra
        {
		...
		/// <summary>
		/// Factory method. New <see cref="XuatTra" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static XuatTra NewXuatTra()
        {
            return DataPortal.Create<XuatTra>();
        }
		public static XuatTra GetXuatTra(String maPXT)
		{
			return DataPortal.Fetch<XuatTra>(new Criteria(maPXT));
		}
        public static XuatTra GetXuatTra(SafeDataReader dr)
        {
            XuatTra obj = new XuatTra();
            obj.Fetch(dr);
            return obj;

        }
		/// <summary>
		/// Marks the <see cref="XuatTra" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteXuatTra(String maPXT, string mamay, string nguoihuy)
		{
		...
		/// <summary>
		/// Retrieve an existing <see cref="XuatTra" /> Object based on data in the database.
		/// </summary>
        /// 

		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetXuatTra(String _maPXT);
			// public override IDataReader GetXuatTra(String _maPXT)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spXUATTRA_GET", _maPXT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetXuatTra(crit.MaPXT, crit.Qadmin  )))
			{
				if (dr.Read()){
					Fetch(dr);
                    //MarkOld();
                    ...
                    if (dr.NextResult())
                    {
                        _XuatTraCs = XuatTra_C_List.GetXuatTra_C_List(dr);
                    } 
				}
			}
		}
		/// <summary>
		/// Load a <see cref="XuatTra" /> Object from given SafeDataReader.
		/// </summary>
		private void Fetch(SafeDataReader dr)
		{
			...
			if (dr.GetSmartDate("NgayXuatTT", true) != null) _ngayXuatTT = dr.GetSmartDate("NgayXuatTT");
		...
		/// <summary>
		/// Insert the new <see cref="XuatTra" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertXuatTra
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
            _maPXT = DataProvider.Instance().InsertXuatTra(_maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _maMay, _nguoiSD , _ngayLap, _nVXuat, _nVNhan, _vAT, _soHoaDon, _ngayHoaDon);
            MarkOld();
            _XuatTraCs.Update(this);
			// public abstract String InsertXuatTra(String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, String _maMay, String _nguoiLap, SmartDate _ngayLap, String _nVXuat, String _nVNhan, Decimal _vAT);
			// public override String InsertXuatTra(String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, String _maMay, String _nguoiLap, SmartDate _ngayLap, String _nVXuat, String _nVNhan, Decimal _vAT)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spXUATTRA_CREATE", _maNCC, _soCT, _ngayXT, _makho,  _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu,  _maMay,  _nguoiLap, _ngayLap, _nVXuat, _nVNhan, _vAT);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="XuatTra" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateXuatTra
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateXuatTra(_maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy, _nguoiSD , _maMay, _nVXuat, _nVNhan, _vAT, _soHoaDon, _ngayHoaDon);
                _XuatTraCs.Update(this);
				// public abstract void UpdateXuatTra(String _maPXT, String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay, String _nVXuat, String _nVNhan, Decimal _vAT);
				// public override void UpdateXuatTra(String _maPXT, String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay, String _nVXuat, String _nVNhan, Decimal _vAT)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spXUATTRA_UPDATE", _maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy, _nguoiSD , _maMay, _nVXuat, _nVNhan, _vAT);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="XuatTra" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateXuatTra
            DataProvider.Instance().DeleteXuatTra(crit.MaMay, crit.NguoiSD, crit.MaPXT);
			// public abstract void DeleteXuatTra(String _maPXT);
			// public override void DeleteXuatTra(String _maPXT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spXUATTRA_DELETED", _maPXT);
			// }
		}
