...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="XuatTra_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class XuatTra_C : BusinessBase<XuatTra_C>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="XuatTra_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static XuatTra_C NewXuatTra_C()
        {
            return new XuatTra_C();

        }

        public static XuatTra_C NewXuatTra_C(string idDMThuoc)
        {
            return new XuatTra_C(DMThuoc.GetDMThuoc(idDMThuoc));
        }

        public static XuatTra_C NewXuatTra_C(DMThuoc _DMThuoc)
        {
            return new XuatTra_C(_DMThuoc);
        }
        //public static XuatTra_C GetXuatTra_C(String maPN)
        //{
        //    return DataPortal.Fetch<XuatTra_C>(new Criteria(maPN,qadmin ))

        //}
        public static XuatTra_C GetXuatTra_C(String maThuoc, Decimal sTT)
        {
            return DataPortal.Fetch<XuatTra_C>(new Criteria(maThuoc, sTT));
        }
        public static XuatTra_C GetXuatTra_C(SafeDataReader dr)
        {
            return new XuatTra_C(dr);
        }
		/// <summary>
		/// Marks the <see cref="XuatTra_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteXuatTra_C(String maPN)
        //{
		...
		protected internal XuatTra_C()
		{	
			// Prevent direct creation
		}
		protected XuatTra_C(DMThuoc pro)
        {
            MarkAsChild();
            _mathuoc = pro.MaThuoc;
            _tenTM = pro.TenTM;
        }
        protected XuatTra_C(string _idMaPXT, DMThuoc pro)
        {
            MarkAsChild();
            _maPXT = _idMaPXT;            
            _mathuoc = pro.MaThuoc;
        ...
        protected XuatTra_C(SafeDataReader dr)
        {
            MarkAsChild();
            ...
            _handung = dr.GetBoolean("handung");
		...
		/// <summary>
		/// Retrieve an existing <see cref="XuatTra_C" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetXuatTra_C(String _maPXT, Byte STT);
            // public override IDataReader GetXuatTra_C(String _maPXT, Byte STT)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spXUATTRA_C_GET", _maPXT,STT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetXuatTra_C(crit.MaPXT, crit.STT  )))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="XuatTra_C" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="XuatTra_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Insert(XuatTra bill)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertXuatTra_C
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
            _maPXT = bill.MaPXT;
             DataProvider.Instance().InsertXuatTra_C(_mathuoc, _soluong, _hanSD, _donGia, _soLo, _ghichu, _nguoiSD , _maMay, bill.MaPXT, _vAT);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spXUATTRA_C_CREATE", _mathuoc, _soluong, _hanSD.DBValue, _donGia,  _soLo, _ghichu, _nguoiSD , _maMay, _maPXT, _vAT));
			// }
             MarkOld();
        }
		
		/// <summary>
		/// Update all changes made on <see cref="XuatTra_C" /> Object to underlying database.
		/// </summary>
        internal virtual void  Update(XuatTra bill)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateXuatTra_C
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateXuatTra_C(_sTT, _mathuoc, _soluong, _hanSD, _donGia, _soLo, _huy, _ghichu, _nguoiSD , _maMay, bill.MaPXT, _vAT);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spXUATTRA_C_UPDATE", _sTT, _mathuoc, _soluong, _hanSD.DBValue, _donGia, _soLo, _huy, _ghichu, _nguoiSD , _maMay, _maPXT, _vAT);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="XuatTra_C" />.
		/// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateXuatTra_C
        //    DataProvider.Instance().DeleteXuatTra_C(crit.MaPN);
        //    // public abstract void DeleteXuatTra_C(String _maPN);
        //    // public override void DeleteXuatTra_C(String _maPN);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spXUATTRA_C_DELETED", _maPN);
        //    // }
        //}

        internal void DeleteSelf(XuatTra bill)
        {
            ...
            DataProvider.Instance().DeleteXuatTra_C(_maMay, _nguoiSD , bill.MaPXT, _sTT);
            MarkNew();
        }
