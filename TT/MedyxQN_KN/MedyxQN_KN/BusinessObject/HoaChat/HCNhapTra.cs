...
{
    [Serializable()]
    public partial class HCNhapTra : BusinessBase<HCNhapTra>
    {
       ...
       // private SmartDate _ngayXuatTT = new SmartDate(false);
        ...
        HCNhapTra_Cs _HCNhapTraCs = HCNhapTra_Cs.NewHCNhapTra_Cs();
        public HCNhapTra_Cs HCNhapTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _HCNhapTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _HCNhapTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<HCNhapTra>(StringRequired<HCNhapTra>, "NoiXuat");
            ...
            ValidationRules.AddRule<HCNhapTra>(StringRequiredNoiNhap<HCNhapTra>, "Noinhap");


        }
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : HCNhapTra
        {
        ...
        private static bool StringRequiredNoiNhap<T>(T target, Csla.Validation.RuleArgs e) where T : HCNhapTra
        {
        ...
        public static HCNhapTra NewHCNhapTra()
        { 
            return DataPortal.Create<HCNhapTra>();
        }

        public static HCNhapTra GetHCNhapTra(String MaPNT,byte loaiphieu,byte daphat,Boolean qadmin)
        {
            return DataPortal.Fetch<HCNhapTra>(new Criteria(MaPNT,loaiphieu ,daphat,qadmin  ));
        }

        public static HCNhapTra GetHCNhapTra(SafeDataReader dr)
        {
            HCNhapTra obj = new HCNhapTra();
            obj.Fetch(dr);
            return obj;
            
        }

        public static void DeleteHCNhapTra(String MaPNT, string mamay, string nguoihuy)
        {
        ...
        protected internal HCNhapTra()
        { 
            //
        }
        internal HCNhapTra( int OrderNumber,
                            String MaPNT,
                            String noiXuat,
                            //SmartDate ngayXuat,
        ...
        { 
            using (SafeDataReader dr=new SafeDataReader(DataProvider.Instance().GetHCNhapTra(crit.MaPNT,crit.qadmin,crit.LoaiPhieu,crit.daphat)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
                    if (dr.NextResult())
                    {
                        _HCNhapTraCs = HCNhapTra_Cs.GetHCNhapTra_Cs(dr);  
                    } 
                }
            }
        }
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _MaPNT = DataProvider.Instance().InsertHCNhapTra(_noiNhap, _ngayNhap, _ngayNhapTT, _noiXuat, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu,_nguoiSD , _BNTra,_maMay ,   _daPhat,_daDuyet );

            _HCNhapTraCs.Update(this);
        ...
        protected override void DataPortal_Update()
        {
            ...
            DataProvider.Instance().UpdateHCNhapTra(_MaPNT, _noiXuat, _ngayNhap, _ngayNhapTT, _noiNhap, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _huy,_maMay ,   _nguoiSD, _daPhat,_BNTra ,_daDuyet );
        ...
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            ...
            DataProvider.Instance().DeleteHCNhapTra(crit.MaPNT, _maMay, _nguoiSD);
