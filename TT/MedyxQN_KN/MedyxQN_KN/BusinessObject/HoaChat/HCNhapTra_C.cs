...
{	
	...
	[Serializable()]
	public partial class HCNhapTra_C : BusinessBase<HCNhapTra_C>
	{
        ...
        protected override void AddBusinessRules()
        {
           ...
           // ValidationRules.AddRule(Csla.Validation.CommonRules.StringMaxLength, new Csla.Validation.CommonRules.MaxLengthRuleArgs("MaHC", 5));
            //ValidationRules.AddRule<HCNhapTra_C>(StringRequired<HCNhapTra_C>, "MaHC");
            ...
            ValidationRules.AddRule<HCNhapTra_C>(StringRequiredTenTM<HCNhapTra_C>, "TenTM");


        }
        //private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : HCNhapTra_C
        //{
        ...
        private static bool StringRequiredTenTM<T>(T target, Csla.Validation.RuleArgs e) where T : HCNhapTra_C
        {
        ...
        public static HCNhapTra_C NewHCNhapTra_C()
        {
            return new HCNhapTra_C();
            
        }

        public static HCNhapTra_C NewHCNhapTra_C(string idDMHoaChat)
        {
            return new HCNhapTra_C(DMHoaChat.GetDMHoaChat(idDMHoaChat));
        }

        public static HCNhapTra_C NewHCNhapTra_C(DMHoaChat _DMHoaChat)
        {
            return new HCNhapTra_C(_DMHoaChat);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static HCNhapTra_C GetHCNhapTra_C(String maHC, Byte sTT)
        {
            return DataPortal.Fetch<HCNhapTra_C>(new Criteria(maHC, sTT));
        }

        public static HCNhapTra_C GetHCNhapTra_C(SafeDataReader dr)
        {
            return new HCNhapTra_C(dr);
        }
        ...
        protected internal HCNhapTra_C()
        { 
            //
        }
        protected HCNhapTra_C(DMHoaChat pro)
        {
            MarkAsChild();
            _maHC = pro.MaHC;
            _tenTM = pro.TenTM;
        }
        protected HCNhapTra_C(string _idMaPNT, DMHoaChat pro)
        {
            MarkAsChild();
            _MaPNT = _idMaPNT;            
            _maHC = pro.MaHC;
        ...
        protected HCNhapTra_C(SafeDataReader dr)
        {
            MarkAsChild();
            ...
            //_tonCk = HTC.Business.CategoryList.DMHoaChat_TonKho.GetDMHoaChatTonKho(_maHC, _ngayn).TonCK;
        ...
        {
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetHCNhapTra_C(crit.MaPNT, crit.STT))) 
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        internal virtual void Insert(HCNhapTra bill)
        {
            
              //InsertHCNhapTra_C(String _MaPNT, String _maHC, Decimal _soLuong, SmartDate _hanSD,  Decimal _donGia,String _soLo,  Boolean Huy, String _ghiChu,String _maMay, String _nguoiSD);
            _MaPNT = bill.MaPNT;
            DataProvider.Instance().InsertHCNhapTra_C(bill.MaPNT, _maHC, _soLuong, _hanSD, _donGia, _soLo,_huy, _ghiChu,  _maMay,_nguoiSD , _soLuongYC);
            MarkOld();
        }

        internal virtual void Update(HCNhapTra bill)
        {
            if(IsDirty)
            {      
            
              
            DataProvider.Instance().UpdateHCNhapTra_C(bill.MaPNT, _sTT, _maHC, _soLuong, _hanSD, _soLo, _donGia,  _soLuongYC, _giaBan,  _huy,  _ghiChu,  _nguoiSD,  _maMay);
            }
        }
        internal void DeleteSelf(HCNhapTra packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
                return;
            DataProvider.Instance().DeleteHCNhapTra_C(_MaPNT,_sTT,_nguoiSD ,_maMay);
            MarkNew();
