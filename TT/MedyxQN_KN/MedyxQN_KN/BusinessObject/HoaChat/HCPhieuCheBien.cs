...
{
    [Serializable()]
    public partial class HCPhieuCheBien : BusinessBase<HCPhieuCheBien>
    {
        ...
        HCPhieuCheBien_Cs _HCPhieuCheBienCs = HCPhieuCheBien_Cs.NewHCPhieuCheBien_Cs();
        public HCPhieuCheBien_Cs HCPhieuCheBienCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                return _HCPhieuCheBienCs;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                if (!_HCPhieuCheBienCs.Equals(value))
                {
                    _HCPhieuCheBienCs = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _HCPhieuCheBienCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _HCPhieuCheBienCs.IsValid;
            }
        }
        #endregion
        #endregion
       ...
       #region Factory Methods
		...
		/// <summary>
		/// Factory method. New <see cref="HCPhieuCheBien" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static HCPhieuCheBien NewHCPhieuCheBien()
        {
            return DataPortal.Create<HCPhieuCheBien>();
        }
       

        public static HCPhieuCheBien GetHCPhieuCheBien(String MaCB, byte loaiphieu, Boolean daphat,Boolean qadmin)
		{
            return DataPortal.Fetch<HCPhieuCheBien>(new Criteria(MaCB, loaiphieu, daphat,qadmin));
		}
		
		/// <summary>
		/// Marks the <see cref="HCPhieuCheBien" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteHCPhieuCheBien(String maBenhID, string mamay, string nguoihuy)
		{
            DataPortal.Delete(new OtherCriteria(maBenhID,mamay,nguoihuy ));
		}
        private HCPhieuCheBien(string MaCB)
        {
            _MaCB = MaCB ;
        }
		#endregion
        ...
        protected internal HCPhieuCheBien()
        {
            //
            _ngayLap.Date = DateTime.Now;
        }
        internal HCPhieuCheBien(int OrderNumber,
                            String MaCB,
                           String noiXuat,
                            SmartDate ngayXuat,
        ...
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetHCPhieuCheBien(crit.MaCB, crit.qadmin, crit.LoaiPhieu, crit.daphat)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
                    if (dr.NextResult())
                    {
                        _HCPhieuCheBienCs = HCPhieuCheBien_Cs.GetHCPhieuCheBien_Cs(dr);
                    }
                    MarkOld();
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _MaCB = DataProvider.Instance().InsertHCPhieuCheBien(_noiXuat, _ngayXuat, _ngayXuatTT, _noiNhap, _NgayNhap, _soCT, _nvXuat, _nvNhan, _mahc, _soLuong, _donGia, _soLo, _HanSD, _TienPX, _maPHC, _TienHC, _maPPL, _TienPL, _maPBB, _TienBB, _ghiChu, _TongTien, _TienCong, _DienNuoc, _Khoanthem, _TienKhac, _MaDT, _daPhat,_daDuyet,_loaiPhieu, _nguoiSD , _maMay);
            MarkOld();
           _HCPhieuCheBienCs.Update(this);
        ...
        protected override void DataPortal_Update()
        {
            if (IsDirty)
            {
                ...
                DataProvider.Instance().UpdateHCPhieuCheBien(_MaCB, _noiXuat, _ngayXuat, _ngayXuatTT, _noiNhap, _NgayNhap, _soCT, _nvXuat, _nvNhan, _mahc, _soLuong, _donGia,_giaban, _soLo, _HanSD, _TienPX, _maPHC, _TienHC, _maPPL, _TienPL, _maPBB, _TienBB, _ghiChu, _nguoiSD , _TongTien, _TienCong, _DienNuoc, _TienKhac, _Khoanthem, _MaDT, _daPhat, _daDuyet, _loaiPhieu, _huy, _maMay);
            _HCPhieuCheBienCs.Update(this);
            }
        }  
        ...
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            ...
            DataProvider.Instance().DeleteHCPhieuCheBien(crit.MaCB, crit.MaMay, crit.NguoiSD);
