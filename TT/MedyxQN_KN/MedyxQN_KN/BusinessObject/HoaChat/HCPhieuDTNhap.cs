...
//
// Ten file        :	HCPhieuDTNhap
// Kieu doi tuong  :	HCPhieuDTNhap
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="HCPhieuDTNhap" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class HCPhieuDTNhap : BusinessBase<HCPhieuDTNhap>
	{
        ...
        HCPhieuDTNhap_C_List _HCPhieuDTNhap_Cs = HCPhieuDTNhap_C_List.NewHCPhieuDTNhap_C_List();

        public HCPhieuDTNhap_C_List HCPhieuDTNhap_Cs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                //CanReadProperty(true);
                return _HCPhieuDTNhap_Cs;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                //CanWriteProperty(true);
                if (!_HCPhieuDTNhap_Cs.Equals(value))
                {
                    _HCPhieuDTNhap_Cs = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _HCPhieuDTNhap_Cs.IsDirty;
            }
        }
        ...
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _HCPhieuDTNhap_Cs.IsValid;
            }
        }
		#endregion
		#endregion
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<HCPhieuDTNhap>(StringRequired<HCPhieuDTNhap>, "MaKho");
            ValidationRules.AddRule<HCPhieuDTNhap>(ValidationDateTT<HCPhieuDTNhap>, "NgayPhieu");
            ValidationRules.AddRule<HCPhieuDTNhap>(ValidationDateNow<HCPhieuDTNhap>, "NgayPhieu");
        }
        private static bool ValidationDateTT<T>(T target, Csla.Validation.RuleArgs e) where T : HCPhieuDTNhap
        {
        ...
        private static bool ValidationDateNow<T>(T target, Csla.Validation.RuleArgs e) where T : HCPhieuDTNhap
        {
        ...
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : HCPhieuDTNhap
        {
		...
		/// <summary>
		/// Factory method. New <see cref="HCPhieuDTNhap" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static HCPhieuDTNhap NewHCPhieuDTNhap()
        {
            return DataPortal.Create<HCPhieuDTNhap>();
        }
		public static HCPhieuDTNhap GetHCPhieuDTNhap(String maDuTru)
		{
			return DataPortal.Fetch<HCPhieuDTNhap>(new Criteria(maDuTru));
		}
        public static HCPhieuDTNhap GetHCPhieuDTNhap(SafeDataReader dr)
        {
            HCPhieuDTNhap obj = new HCPhieuDTNhap();
            obj.Fetch(dr);
            return obj;
        }
		/// <summary>
		/// Marks the <see cref="HCPhieuDTNhap" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteHCPhieuDTNhap(String maDuTru, string mamay, string nguoihuy)
		{
		...
		protected internal HCPhieuDTNhap()
		{	
			// Prevent direct creation
		}
        internal HCPhieuDTNhap(
  int OrderNumber,
  String maDuTru ,
  string maNCC,
  string tenNCC,   
 ...
 _tenNguoiHuy = tenNguoiHuy;
		...
		/// <summary>
		/// Retrieve an existing <see cref="HCPhieuDTNhap" /> Object based on data in the database.
		/// </summary>
        /// 

		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetHCPhieuDTNhap(String _maDuTru);
			// public override IDataReader GetHCPhieuDTNhap(String _maDuTru)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDuTru));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetHCPhieuDTNhap(crit.MaDuTru,crit.qadmin  )))
			{
				if (dr.Read()){
					Fetch(dr);
                    if (dr.NextResult())
                    {
                        _HCPhieuDTNhap_Cs = HCPhieuDTNhap_C_List.GetHCPhieuDTNhap_C_List(dr);
                    }
                    //MarkOld();
		...
		/// <summary>
		/// Load a <see cref="HCPhieuDTNhap" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="HCPhieuDTNhap" /> Object to underlying database.
		/// </summary>
        /// 
		...
		/// <summary>
		/// Update all changes made on <see cref="HCPhieuDTNhap" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateHCPhieuDTNhap
			if (IsDirty){
                
                
				DataProvider.Instance().UpdateHCPhieuDTNhap(_maDuTru, _soCT, _ngayPhieu, _makho, _nguoiDuTru, _tong, _ghichu, _huy, _nguoiSD , _maMay, _maNCC );
                _HCPhieuDTNhap_Cs.Update(this);
				// public abstract void UpdateHCPhieuDTNhap(String _maDuTru, String _soCT, SmartDate _ngayPhieu, String _makho, String _nguoiDuTru, Decimal _tong, String _ghichu, Boolean _huy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngayHuy, String _nguoiHuy, SmartDate _ngaySD, String _nguoiSD, SmartDate _ngaySD1, String _nguoiSD1, String _maMay);
				// public override void UpdateHCPhieuDTNhap(String _maDuTru, String _soCT, SmartDate _ngayPhieu, String _makho, String _nguoiDuTru, Decimal _tong, String _ghichu, Boolean _huy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngayHuy, String _nguoiHuy, SmartDate _ngaySD, String _nguoiSD, SmartDate _ngaySD1, String _nguoiSD1, String _maMay);
				// {
		...
		/// <summary>
		/// Delete the <see cref="HCPhieuDTNhap" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateHCPhieuDTNhap
            DataProvider.Instance().DeleteHCPhieuDTNhap(crit.MaMay, crit.NguoiSD, crit.MaDuTru);
			// public abstract void DeleteHCPhieuDTNhap(String _maDuTru);
			// public override void DeleteHCPhieuDTNhap(String _maDuTru);
			// {
