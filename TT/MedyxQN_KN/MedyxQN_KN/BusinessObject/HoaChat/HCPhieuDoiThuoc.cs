...
//
// Ten file        :	HCPhieuDoiThuoc
// Kieu doi tuong  :	HCPhieuDoiThuoc
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="HCPhieuDoiThuoc" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class HCPhieuDoiThuoc : BusinessBase<HCPhieuDoiThuoc>
	{
        ...
        HCPhieuDoiThuoc_C_List _HCPhieuDoiThuoc_C_List = HCPhieuDoiThuoc_C_List.NewHCPhieuDoiThuoc_C_List();
        public HCPhieuDoiThuoc_C_List HCPhieuDoiThuoc_C_List
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                return _HCPhieuDoiThuoc_C_List;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                if (!_HCPhieuDoiThuoc_C_List.Equals(value))
                {
                    _HCPhieuDoiThuoc_C_List = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _HCPhieuDoiThuoc_C_List.IsDirty ;
            }
        }
        public override bool IsValid
        {
            ...
            {
                return base.IsValid && _HCPhieuDoiThuoc_C_List.IsValid ;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<HCPhieuDoiThuoc>(StringRequired<HCPhieuDoiThuoc>, "MaNCC");
            //ValidationRules.AddRule(Csla.Validation.CommonRules.StringMaxLength, new Csla.Validation.CommonRules.MaxLengthRuleArgs("TenTM", 350));
            //ValidationRules.AddRule<HCPhieuDoiThuoc>(StringRequiredCT<HCPhieuDoiThuoc>, "SoCT");

        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : HCPhieuDoiThuoc
        {
        ...
        private static bool StringRequiredCT<T>(T target, Csla.Validation.RuleArgs e) where T : HCPhieuDoiThuoc
        {
		...
		/// <summary>
		/// Factory method. New <see cref="HCPhieuDoiThuoc" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static HCPhieuDoiThuoc NewHCPhieuDoiThuoc()
        {
            return DataPortal.Create<HCPhieuDoiThuoc>();
        }

		public static HCPhieuDoiThuoc GetHCPhieuDoiThuoc(String maDThuoc)
		{
			return DataPortal.Fetch<HCPhieuDoiThuoc>(new Criteria(maDThuoc));
		}
        public static HCPhieuDoiThuoc GetHCPhieuDoiThuoc(SafeDataReader dr)
        {
            HCPhieuDoiThuoc obj = new HCPhieuDoiThuoc();
            obj.Fetch(dr);
            return obj;

        }
		/// <summary>
		/// Marks the <see cref="HCPhieuDoiThuoc" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteHCPhieuDoiThuoc(String maDThuoc, string mamay, string nguoihuy)
		{
		...
		protected internal HCPhieuDoiThuoc()
		{	
			// Prevent direct creation
		}
        internal HCPhieuDoiThuoc( 
                                int OrderNumber,
                                String maDThuoc,
		                     String maNCC ,
		                     String soCT ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="HCPhieuDoiThuoc" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetHCPhieuDoiThuoc(String _maDThuoc);
			// public override IDataReader GetHCPhieuDoiThuoc(String _maDThuoc)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDThuoc));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetHCPhieuDoiThuoc(crit.MaDThuoc,crit.qadmin )))
			{
				if (dr.Read()){
					Fetch(dr);
                    if (dr.NextResult())
                    {
                        _HCPhieuDoiThuoc_C_List = HCPhieuDoiThuoc_C_List.GetHCPhieuDoiThuoc_C_List(dr);
                    }
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="HCPhieuDoiThuoc" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="HCPhieuDoiThuoc" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertHCPhieuDoiThuoc
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
			_maDThuoc = DataProvider.Instance().InsertHCPhieuDoiThuoc(_maNCC, _soCT, _ngayDThuoc, _makho, _ghichu, _nguoiSD , _maMay);
            MarkOld();
            _HCPhieuDoiThuoc_C_List.Update(this);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCPhieuDoiThuoc_CREATE", _maNCC, _soCT, _ngayDThuoc.DBValue, _makho, _ghichu, _nguoiSD , _maMay));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="HCPhieuDoiThuoc" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateHCPhieuDoiThuoc
			if (IsDirty){
                
                  
				DataProvider.Instance().UpdateHCPhieuDoiThuoc(_maDThuoc, _maNCC, _soCT, _ngayDThuoc, _makho, _ghichu, _huy, _nguoiSD , _maMay);
                _HCPhieuDoiThuoc_C_List.Update(this);
		...
		/// <summary>
		/// Delete the <see cref="HCPhieuDoiThuoc" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateHCPhieuDoiThuoc
            DataProvider.Instance().DeleteHCPhieuDoiThuoc(crit.MaMay, crit.NguoiSD, crit.MaDThuoc);
			// public abstract void DeleteHCPhieuDoiThuoc(String _maDThuoc);
			// public override void DeleteHCPhieuDoiThuoc(String _maDThuoc);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCPhieuDoiThuoc_DELETED", _maDThuoc);
			// }
		}
