...
//
// Ten file        :	HCPhieuDoiThuoc_C
// Kieu doi tuong  :	HCPhieuDoiThuoc_C
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="HCPhieuDoiThuoc_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class HCPhieuDoiThuoc_C : BusinessBase<HCPhieuDoiThuoc_C>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="HCPhieuDoiThuoc_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static HCPhieuDoiThuoc_C NewHCPhieuDoiThuoc_C()
        {
            return new HCPhieuDoiThuoc_C();

        }

        public static HCPhieuDoiThuoc_C NewHCPhieuDoiThuoc_C(string idDMHoaChat)
        {
            return new HCPhieuDoiThuoc_C(DMHoaChat.GetDMHoaChat(idDMHoaChat));
        }

        public static HCPhieuDoiThuoc_C NewHCPhieuDoiThuoc_C(DMHoaChat _DMHoaChat)
        {
            return new HCPhieuDoiThuoc_C(_DMHoaChat);
        }

		public static HCPhieuDoiThuoc_C GetHCPhieuDoiThuoc_C(String maDThuoc, Decimal sTT)
		{
			return DataPortal.Fetch<HCPhieuDoiThuoc_C>(new Criteria(maDThuoc, sTT));
		}

        public static HCPhieuDoiThuoc_C GetHCPhieuDoiThuoc_C(SafeDataReader dr)
        {
            return new HCPhieuDoiThuoc_C(dr);
        }

		/// <summary>
		/// Marks the <see cref="HCPhieuDoiThuoc_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
		...
		protected internal HCPhieuDoiThuoc_C()
		{	
			// Prevent direct creation
		}
		
        protected HCPhieuDoiThuoc_C(DMHoaChat pro)
        {
            MarkAsChild();
            _mahc = pro.MaHC;
            _tenTM = pro.TenTM;
        }
        protected HCPhieuDoiThuoc_C(string maDThuoc, DMHoaChat pro)
        {
            MarkAsChild();
            _maDThuoc = maDThuoc;            
            _mahc = pro.MaHC;
        ...
        protected HCPhieuDoiThuoc_C(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="HCPhieuDoiThuoc_C" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetHCPhieuDoiThuoc_C(crit.MaDThuoc, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="HCPhieuDoiThuoc_C" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="HCPhieuDoiThuoc_C" /> Object to underlying database.
		/// </summary>
        /// 
        ...
        internal virtual void Insert(HCPhieuDoiThuoc bill)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertHCPhieuDoiThuoc_C
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
            _maDThuoc = bill.MaDThuoc;
            DataProvider.Instance().InsertHCPhieuDoiThuoc_C(bill.MaDThuoc, _mahc, _soluong, _hanSD, _hanSDCu, _donGia, _soLo, _soLoCu, _ghichu, _nguoiSD , _maMay);
            MarkOld();// public abstract String InsertHCPhieuDoiThuoc_C(String _maDThuoc, String _mahc, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, String _ghichu, String _nguoiSD, String _maMay);
			// public override String InsertHCPhieuDoiThuoc_C(String _maDThuoc, String _mahc, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, String _ghichu, String _nguoiSD, String _maMay)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCPhieuDoiThuoc_C_CREATE", _maDThuoc, _mahc, _soluong, _hanSD.DBValue, _hanSDCu.DBValue, _donGia, _soLo, _soLoCu, _ghichu, _nguoiSD , _maMay));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="HCPhieuDoiThuoc_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Update(HCPhieuDoiThuoc bill)
        {
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateHCPhieuDoiThuoc_C
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateHCPhieuDoiThuoc_C(bill.MaDThuoc, _sTT, _mahc, _soluong, _hanSD, _hanSDCu, _donGia, _soLo, _soLoCu, _huy, _ghichu, _nguoiSD , _maMay);
				// public abstract void UpdateHCPhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT, String _mahc, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, Boolean _huy, String _ghichu, String _nguoiSD, String _maMay);
				// public override void UpdateHCPhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT, String _mahc, Decimal _soluong, SmartDate _hanSD, SmartDate _hanSDCu, Decimal _donGia, String _soLo, String _soLoCu, Boolean _huy, String _ghichu, String _nguoiSD, String _maMay);
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCPhieuDoiThuoc_C_UPDATE", _maDThuoc, _sTT, _mahc, _soluong, _hanSD.DBValue, _hanSDCu.DBValue, _donGia, _soLo, _soLoCu, _huy, _ghichu, _nguoiSD , _maMay);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="HCPhieuDoiThuoc_C" />.
		/// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateHCPhieuDoiThuoc_C
        //    DataProvider.Instance().DeleteHCPhieuDoiThuoc_C(crit.MaDThuoc, crit.STT);
        //    // public abstract void DeleteHCPhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT);
        //    // public override void DeleteHCPhieuDoiThuoc_C(String _maDThuoc, Decimal _sTT);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCPhieuDoiThuoc_C_DELETED", _maDThuoc, _sTT);
        //    // }
        //}
        internal void DeleteSelf(HCPhieuDoiThuoc packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
            ...
            DataProvider.Instance().DeleteHCPhieuDoiThuoc_C(_maMay, _nguoiSD , _maDThuoc, _sTT);
            MarkNew();
