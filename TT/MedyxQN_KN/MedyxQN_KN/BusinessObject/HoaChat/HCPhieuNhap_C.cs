...
{
    [Serializable()]
    public partial class HCPhieuNhap_C : BusinessBase<HCPhieuNhap_C>
    {
        ...
        private String _tenHC = String.Empty;
        ...
        public string vat
        {
            get
            {
                ...
                else if (_chietKhau - (int)(_chietKhau) != 0)
                {
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<HCPhieuNhap_C>(StringRequired<HCPhieuNhap_C>, "TENTM");
            ValidationRules.AddRule<HCPhieuNhap_C>(ValidationSoLuong<HCPhieuNhap_C>, "Soluong");
        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : HCPhieuNhap_C
        {

            if (target._tenHC == null || target._tenHC.Trim().Length == 0)
            {
        ...
        private static bool StringRequiredSoLo<T>(T target, Csla.Validation.RuleArgs e) where T : HCPhieuNhap_C
        {
        ...
        private static bool ValidationSoLuong<T>(T target, Csla.Validation.RuleArgs e) where T : HCPhieuNhap_C
        {
		...
		/// </summary> 
        /// 
        public static HCPhieuNhap_C NewHCPhieuNhap_C()
        {
            return new HCPhieuNhap_C();
           
        }
        public static HCPhieuNhap_C NewHCPhieuNhap_C(string idDMHoaChat)
        {
            return new HCPhieuNhap_C(DMHoaChat.GetDMHoaChat(idDMHoaChat));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static HCPhieuNhap_C NewHCPhieuNhap_C(DMHoaChat _DMHoaChat)
        {
            return new HCPhieuNhap_C(_DMHoaChat);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static HCPhieuNhap_C GetHCPhieuNhap_C(String maHCPhieuNhap, decimal sTT)
        {
            return DataPortal.Fetch<HCPhieuNhap_C>(new Criteria(maHCPhieuNhap, sTT));
        }
        public static HCPhieuNhap_C GetHCPhieuNhap_C(SafeDataReader dr)
        {
            return new HCPhieuNhap_C(dr);
        }

        public static void DeleteHCPhieuNhap_C(String _maPN, decimal _sTT, string nguoisd, string mamay)
        {
        ...
        protected internal HCPhieuNhap_C()
        {
            // Prevent direct creation
            _chietKhau = 0;
        }
        protected HCPhieuNhap_C(DMHoaChat pro)
        {
            MarkAsChild();
        ...
        protected HCPhieuNhap_C(string _idMaPN, DMHoaChat pro)
        {
            MarkAsChild();
            _maPN = _idMaPN;
            _maHC = pro.MaHC;
        ...
        protected HCPhieuNhap_C(SafeDataReader dr)//lay nhung thang hien ra tren luoi
        {
            MarkAsChild();
        ...
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetHCPhieuNhap_C_Get(crit.MaPN, crit.STT)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
		...
		/// </summary>
        private void Fetch(SafeDataReader dr)//lay o chi tiet thu tuc spHCPhieuNhap_C_Get
        {
            // Value properties
            ...
            if (dr.GetString("TENTM") != null) _tenHC = dr.GetString("TENTM");
        ...
        internal virtual void Insert(HCPhieuNhap bill)
        {
            ...
            _maPN = bill.MaPN;
             DataProvider.Instance().InsertHCPhieuNhap_C(bill.MaPN, _maHC, _soLuong, _hanSD, _donGia, _chietKhau, _soLo, _huy, _ghiChu, _maMay, _nguoiSD);
             MarkOld();
        }
        ...
        internal virtual void Update(HCPhieuNhap bill)
        {
            ...
            if (IsDirty)
            {
                ...
                _maPN = bill.MaPN;
                DataProvider.Instance().UpdateHCPhieuNhap_C(bill.MaPN, _sTT, _maHC, _soLuong, _hanSD, _donGia, _chietKhau, _soLo, _huy, _ghiChu, _ngaySD, _maMay, _nguoiSD);
        ...
        internal void DeleteSelf(HCPhieuNhap bill)
        {
            ...
            DataProvider.Instance().DeleteHCPhieuNhap_C(_maPN, _sTT, _nguoiSD, _maMay) ;
            MarkNew();
        }
		#endregion
	}
