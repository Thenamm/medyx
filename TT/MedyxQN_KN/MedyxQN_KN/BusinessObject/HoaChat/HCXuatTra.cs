...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="HCXuatTra" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class HCXuatTra : BusinessBase<HCXuatTra>
	{
        ...
        HCXuatTra_C_List _HCXuatTraCs = HCXuatTra_C_List.NewHCXuatTra_C_List();
        public HCXuatTra_C_List HCXuatTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _HCXuatTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _HCXuatTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<HCXuatTra>(StringRequired<HCXuatTra>, "TenNCC");
        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : HCXuatTra
        {
		...
		/// <summary>
		/// Factory method. New <see cref="HCXuatTra" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static HCXuatTra NewHCXuatTra()
        {
            return DataPortal.Create<HCXuatTra>();
        }
		public static HCXuatTra GetHCXuatTra(String maPXT)
		{
			return DataPortal.Fetch<HCXuatTra>(new Criteria(maPXT));
		}
        public static HCXuatTra GetHCXuatTra(SafeDataReader dr)
        {
            HCXuatTra obj = new HCXuatTra();
            obj.Fetch(dr);
            return obj;

        }
		/// <summary>
		/// Marks the <see cref="HCXuatTra" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteHCXuatTra(String maPXT, string mamay, string nguoihuy)
		{
		...
		/// <summary>
		/// Retrieve an existing <see cref="HCXuatTra" /> Object based on data in the database.
		/// </summary>
        /// 

		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetHCXuatTra(String _maPXT);
			// public override IDataReader GetHCXuatTra(String _maPXT)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCXuatTra_GET", _maPXT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetHCXuatTra(crit.MaPXT, crit.Qadmin  )))
			{
				if (dr.Read()){
					Fetch(dr);
                    //MarkOld();
                    ...
                    if (dr.NextResult())
                    {
                        _HCXuatTraCs = HCXuatTra_C_List.GetHCXuatTra_C_List(dr);
                    } 
				}
			}
		}
		/// <summary>
		/// Load a <see cref="HCXuatTra" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="HCXuatTra" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertHCXuatTra
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
            _maPXT = DataProvider.Instance().InsertHCXuatTra(_maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _maMay, _nguoiSD , _ngayLap, _nVXuat, _nVNhan, _vAT, _soHoaDon, _ngayHoaDon);
            MarkOld();
            _HCXuatTraCs.Update(this);
			// public abstract String InsertHCXuatTra(String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, String _maMay, String _nguoiLap, SmartDate _ngayLap, String _nVXuat, String _nVNhan, Decimal _vAT);
			// public override String InsertHCXuatTra(String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, String _maMay, String _nguoiLap, SmartDate _ngayLap, String _nVXuat, String _nVNhan, Decimal _vAT)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCXuatTra_CREATE", _maNCC, _soCT, _ngayXT, _makho,  _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu,  _maMay,  _nguoiLap, _ngayLap, _nVXuat, _nVNhan, _vAT);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="HCXuatTra" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateHCXuatTra
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateHCXuatTra(_maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy, _nguoiSD , _maMay, _nVXuat, _nVNhan, _vAT, _soHoaDon, _ngayHoaDon);
                _HCXuatTraCs.Update(this);
				// public abstract void UpdateHCXuatTra(String _maPXT, String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay, String _nVXuat, String _nVNhan, Decimal _vAT);
				// public override void UpdateHCXuatTra(String _maPXT, String _maNCC, String _soCT, SmartDate _ngayXT, String _makho, Boolean _thanhtoan, SmartDate _ngayTToan, SmartDate _ngayXuatTT, Decimal _tong, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay, String _nVXuat, String _nVNhan, Decimal _vAT)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCXuatTra_UPDATE", _maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy, _nguoiSD , _maMay, _nVXuat, _nVNhan, _vAT);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="HCXuatTra" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateHCXuatTra
            DataProvider.Instance().DeleteHCXuatTra(crit.MaMay, crit.NguoiSD, crit.MaPXT);
			// public abstract void DeleteHCXuatTra(String _maPXT);
			// public override void DeleteHCXuatTra(String _maPXT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spHCXuatTra_DELETED", _maPXT);
			// }
		}
