...
namespace HTC.Business.HoaDon
{
    ...
    public class HDNhapTra_C
    {
        ...
        public HDNhapTra_C(String MaNT, Decimal STT, String KyHieuMau, String KyHieu, Decimal TuSo, Decimal DenSo, Decimal SLYC, Decimal GiaBan, String Ghichu, Boolean Huy, String NgayLap, String NguoiLap, String NgaySD, String NguoiSD, String MaMay, String TenNguoiLap, String TenNguoiSD, Int32 Ordernumber)
        {
            this.MaNT = MaNT;
            this.STT = STT;
        ...
        public HDNhapTra_C(IDataReader dr, Int32 Ordernumber)
        {
        ...
        public static HDNhapTra_C GetByMa(String MaNT, Byte STT)
        {
            HDNhapTra_C obj = new HDNhapTra_C();
            using (IDataReader dr = SqlHelper.ExecuteReader(strConnect, "spHDNhapTra_C_GET", MaNT, STT))
            {
                while (dr.Read())
                {
                    obj = new HDNhapTra_C(dr, 1);
                    break;
                }
            }
            return obj;
        ...
        {
            return SqlHelper.ExecuteScalar(strConnect, "spHDNhapTra_C_CREATE", MaNT, KyHieuMau, KyHieu, TuSo, DenSo, SLYC, GiaBan, Ghichu, NguoiLap, MaMay).ToString();
        }

        public string Update()
        {
            return SqlHelper.ExecuteScalar(strConnect, "spHDNhapTra_C_UPDATE", MaNT, STT, KyHieuMau, KyHieu, TuSo, DenSo, SLYC, GiaBan, Ghichu, Huy, NguoiSD, MaMay).ToString();
        }

        public string Delete()
        {
            return SqlHelper.ExecuteScalar(strConnect, "spHDNhapTra_C_DELETED", MaNT, STT, NguoiSD, MaMay).ToString();
        }
