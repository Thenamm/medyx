...
{
    [Serializable()]
    public partial class BC_KeHoachKhoa : BusinessBase<BC_KeHoachKhoa>
    {
       ...
       // private Decimal _ma = 0;
        ...
        /// </summary> 
        /// 
        public static BC_KeHoachKhoa NewBC_KeHoachKhoa()
        {
            return new BC_KeHoachKhoa();

        }
        public static BC_KeHoachKhoa NewBC_KeHoachKhoa(String nam, string makhoa)
        {
            return new BC_KeHoachKhoa(nam, makhoa);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }

        public static BC_KeHoachKhoa GetBC_KeHoachKhoa(SafeDataReader dr, int i)
        {
            return new BC_KeHoachKhoa(dr, i);
        }

        public static void DeleteBC_KeHoachKhoa(String nam, string ma)
        {
        ...
        protected internal BC_KeHoachKhoa()
        {
            // Prevent direct creation

        }

        protected BC_KeHoachKhoa(String nam, string makhoa)
        {
            MarkAsChild();
        ...
        protected BC_KeHoachKhoa(SafeDataReader dr, int i)//lay nhung nam hien ra tren luoi
        {
            MarkAsChild();
            _OrderNumber = i;
        ...
        protected class Criteria
        {
            ...
            public Criteria(String nam, string makhoa)
            {
            ...
            public override bool Equals(object obj)
            {
                if (obj is Criteria)
                {
                    ...
                    if (((!_nam.Equals(c._nam) || (!_makhoa.Equals(c._makhoa)))))
                        return false;
                    return true;
                }
                return false;
            ...
            {
                return string.Concat("Criteria", _nam.ToString(), _makhoa.ToString()).GetHashCode();
            }
        }
        ...
        /// </summary>
        private void Fetch(SafeDataReader dr, int i)//lay o chi tiet thu tuc spBC_KeHoachKhoa_Get
        {
            // Value properties
            _OrderNumber = i;
            if (dr.GetString("MaKhoa") != null) _maKhoa = dr.GetString("MaKhoa");
        ...
        internal virtual void Insert()
        {
            ...
            DataProvider.Instance().InsertBC_KeHoachKhoa(_nam, _maKhoa, _kHThang1, _tTThang1, _kHThang2, _tTThang2, _kHThang3, _tTThang3, _kHThang4, _tTThang4, _kHThang5, _tTThang5, _kHThang6, _tTThang6, _kHThang7, _tTThang7, _kHThang8, _tTThang8, _kHThang9, _tTThang9, _kHThang10, _tTThang10, _kHThang11, _tTThang11, _kHThang12, _tTThang12, _nguoiSD, _maMay);
            MarkOld();
        }
        ...
        internal virtual void Update()
        {
            ...
            if (IsDirty)
            {
                ...
                DataProvider.Instance().UpdateBC_KeHoachKhoa(_nam, _maKhoa, _kHThang1, _tTThang1, _kHThang2, _tTThang2, _kHThang3, _tTThang3, _kHThang4, _tTThang4, _kHThang5, _tTThang5, _kHThang6, _tTThang6, _kHThang7, _tTThang7, _kHThang8, _tTThang8, _kHThang9, _tTThang9, _kHThang10, _tTThang10, _kHThang11, _tTThang11, _kHThang12, _tTThang12, _nguoiSD, _huy, _maMay);
        ...
        internal void DeleteSelf()
        {
            ...
            DataProvider.Instance().DeleteBC_KeHoachKhoa(_nam, _maKhoa, _nguoiSD, _maMay);
            MarkNew();
        }
        #endregion
    }
