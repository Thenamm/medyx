...
namespace HTC.Business.Luong
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="Luong_TTTM" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class Luong_TTTM : BusinessBase<Luong_TTTM>
    {
        ...
        public string THHANHTIENK
        {
            get
            {
                ...
                _tHHANHTIENK = (_kc * _dONGIAKC) + (_kP1 * _dONGIAKP1) + (_kP2 * _dONGIAKP2);
                if (_tHHANHTIENK == 0)
                {
                    return "";
                }
        ...
        /// <summary>
        /// Factory method. New <see cref="Luong_TTTM" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static Luong_TTTM NewLuong_TTTM()
        {
            return new Luong_TTTM();
            // return DataPortal.Create<BC_DuocBV>();
        }

        internal static Luong_TTTM GetLuong_TTTM(SafeDataReader dr, int i)
        {
            return new Luong_TTTM(dr, i);
        }
        //public static Luong_TTTM GetLuong_TTTM(Int32 sTT, SmartDate thang)
        //{
        //    return DataPortal.Fetch<Luong_TTTM>(new Criteria(sTT, thang));
        //}
        public Luong_TTTM()
        {
            MarkAsChild();
        ...
        /// <summary>
        /// Marks the <see cref="Luong_TTTM" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        //public static void DeleteLuong_TTTM(Int32 sTT, SmartDate thang)
        //{
        ...
        /// <summary>
        /// Retrieve an existing <see cref="Luong_TTTM" /> Object based on data in the database.
        /// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetLuong_TTTM(Int32 _sTT, SmartDate _thang);
        //    // public override IDataReader GetLuong_TTTM(Int32 _sTT, SmartDate _thang)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _sTT, _thang));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetLuong_TTTM(crit.STT, crit.Thang.DBValue)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        /// <summary>
        /// Load a <see cref="Luong_TTTM" /> Object from given SafeDataReader.
        /// </summary>
        ...
        //    if (dr.GetDecimal("MucLuong_TTTMCB") != null) _mucLuong_TTTMCB = dr.GetDecimal("MucLuong_TTTMCB");
        //    if (dr.GetDecimal("HeSoLuong_TTTM") != null) _heSoLuong_TTTM = dr.GetDecimal("HeSoLuong_TTTM");
        ...
        //}
        private Luong_TTTM(SafeDataReader dr, int i)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
        ...
        /// <summary>
        /// Insert the new <see cref="Luong_TTTM" /> Object to underlying database.
        /// </summary>
        internal void Insert()
        {
            ...
            DataProvider.Instance().InsertLuong_TTTM(_thang, _maNV, _makhoa, _vaiTro, _dBAC, _dBAP1, _dBAP2, _dBBC, _dBBP1, _dBBP2, _dBCC, _dBCP1, _dBCP2, _ic, _dB1P1, _kc, _kP1, _dONGIADBAC, _dONGIADBAP1, _dONGIADBAP2, _dONGIADBBC, _dONGIADBBP1, _dONGIADBBP2, _dONGIADBCC, _dONGIADBCP1, _dONGIADBCP2, _dONGIAIC, _dONGIADB1P1, _dONGIAKC, _dONGIAKP1, _tong, _maMay, _nguoiSD , _dB1P2, _kP2, _dONGIADB1P2, _dONGIAKP2);
            // public abstract Int32 InsertLuong_TTTM(Int32 _sTT, SmartDate _thang, String _maNV, String _makhoa,Byte _vaiTro, Decimal _dBAC, Decimal _dBAP1, Decimal _dBAP2, Decimal _dBBC, Decimal _dBBP1, Decimal _dBBP2, Decimal _dBCC, Decimal _dBCP1, Decimal _dBCP2, Decimal _ic, Decimal _dB1P1, Decimal _kc, Decimal _kP1, Decimal _dONGIADBAC, Decimal _dONGIADBAP1, Decimal _dONGIADBAP2, Decimal _dONGIADBBC, Decimal _dONGIADBBP1, Decimal _dONGIADBBP2, Decimal _dONGIADBCC, Decimal _dONGIADBCP1, Decimal _dONGIADBCP2, Decimal _dONGIAIC, Decimal _dONGIADB1P1, Decimal _dONGIAKC, Decimal _dONGIAKP1, Decimal _tong, String _maMay, String _nguoiLap);
            // public override Int32 InsertLuong_TTTM(Int32 _sTT, SmartDate _thang, String _maNV, String _makhoa,Byte _vaiTro, Decimal _dBAC, Decimal _dBAP1, Decimal _dBAP2, Decimal _dBBC, Decimal _dBBP1, Decimal _dBBP2, Decimal _dBCC, Decimal _dBCP1, Decimal _dBCP2, Decimal _ic, Decimal _dB1P1, Decimal _kc, Decimal _kP1, Decimal _dONGIADBAC, Decimal _dONGIADBAP1, Decimal _dONGIADBAP2, Decimal _dONGIADBBC, Decimal _dONGIADBBP1, Decimal _dONGIADBBP2, Decimal _dONGIADBCC, Decimal _dONGIADBCP1, Decimal _dONGIADBCP2, Decimal _dONGIAIC, Decimal _dONGIADB1P1, Decimal _dONGIAKC, Decimal _dONGIAKP1, Decimal _tong, String _maMay, String _nguoiLap)
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spLuong_TTTM_CREATE", _sTT, _thang.DBValue, _maNV, _makhoa,_vaiTro, _dBAC, _dBAP1, _dBAP2, _dBBC, _dBBP1, _dBBP2, _dBCC, _dBCP1, _dBCP2, _ic, _dB1P1, _kc, _kP1, _dONGIADBAC, _dONGIADBAP1, _dONGIADBAP2, _dONGIADBBC, _dONGIADBBP1, _dONGIADBBP2, _dONGIADBCC, _dONGIADBCP1, _dONGIADBCP2, _dONGIAIC, _dONGIADB1P1, _dONGIAKC, _dONGIAKP1, _tong, _maMay, _nguoiSD);
            // }
            MarkOld();
        }

        /// <summary>
        /// Update all changes made on <see cref="Luong_TTTM" /> Object to underlying database.
        /// </summary>
        internal void Update()
        {
            ...
            DataProvider.Instance().UpdateLuong_TTTM(_sTT, _thang, _maNV, _makhoa, _vaiTro, _dBAC, _dBAP1, _dBAP2, _dBBC, _dBBP1, _dBBP2, _dBCC, _dBCP1, _dBCP2, _ic, _dB1P1, _kc, _kP1, _dONGIADBAC, _dONGIADBAP1, _dONGIADBAP2, _dONGIADBBC, _dONGIADBBP1, _dONGIADBBP2, _dONGIADBCC, _dONGIADBCP1, _dONGIADBCP2, _dONGIAIC, _dONGIADB1P1, _dONGIAKC, _dONGIAKP1, _tong, _maMay, _nguoiSD , _huy, _dB1P2, _kP2, _dONGIADB1P2, _dONGIAKP2);
        ...
        /// <summary>
        /// Delete the <see cref="Luong_TTTM" />.
        /// </summary>
        protected void DataPortal_Delete(CriteriaOther crit)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateLuong_TTTM
            DataProvider.Instance().DeleteLuong_TTTM(crit.MaMay, crit.NguoiSD, crit.STT, crit.Thang);
            // public abstract void DeleteLuong_TTTM(Int32 _sTT, SmartDate _thang);
            // public override void DeleteLuong_TTTM(Int32 _sTT, SmartDate _thang);
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spLuong_TTTM_DELETED", _sTT, _thang);
            // }
        }
