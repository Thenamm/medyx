...
//
// Ten file        :	NhanVien_QTPhuCap
// Kieu doi tuong  :	NhanVien_QTPhuCap
// Kieu CSLA       :	EditableRoot
// Ngay tao        :	8/12/2009 10:16:48 AM
// Nguoi tao       :	HCABXT
//
// *****************************************************************************************************
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="NhanVien_QTPhuCap" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class NhanVien_QTPhuCap : BusinessBase<NhanVien_QTPhuCap>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="NhanVien_QTPhuCap" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
         public static NhanVien_QTPhuCap NewNhanVien_QTPhuCap()
        {
            return DataPortal.Create<NhanVien_QTPhuCap>();
        }
        internal static NhanVien_QTPhuCap GetNhanVien_QTPhuCap(SafeDataReader dr, int i)
        {
            return new NhanVien_QTPhuCap(dr, i);
        }
        public NhanVien_QTPhuCap()
        {
            MarkAsChild();
        }

        //public static NhanVien_QTPhuCap GetNhanVien_QTPhuCap(String maNV, Int32 sTT)
        //{
        //    return DataPortal.Fetch<NhanVien_QTPhuCap>(new Criteria(maNV, sTT));
        //}
		
        ///// <summary>
        ///// Marks the <see cref="NhanVien_QTPhuCap" /> Object for deletion. The Object will be deleted as part of the next save operation.
        ///// </summary>
        //public static void DeleteNhanVien_QTPhuCap(String maNV, Int32 sTT)
        //{
        ...
        //protected internal NhanVien_QTPhuCap()
        //{	
		...
		/// <summary>
		/// Retrieve an existing <see cref="NhanVien_QTPhuCap" /> Object based on data in the database.
		/// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetNhanVien_QTPhuCap(String _maNV, Int32 _sTT);
        //    // public override IDataReader GetNhanVien_QTPhuCap(String _maNV, Int32 _sTT)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maNV, _sTT));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetNhanVien_QTPhuCap(crit.MaNV, crit.STT)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        ///// <summary>
        ///// Load a <see cref="NhanVien_QTPhuCap" /> Object from given SafeDataReader.
        ///// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="NhanVien_QTPhuCap" /> Object to underlying database.
		/// </summary>
        /// 

        private NhanVien_QTPhuCap(SafeDataReader dr, int i)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
        ...
        internal void Insert()
        {
			...
			_maNV = DataProvider.Instance().InsertNhanVien_QTPhuCap(_maNV, _tungay, _denngay, _maPC, _heSo, _mucLuong, _maMay, _nguoiSD);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spNhanVien_QTPhuCap_Create", _maNV, _tungay.DBValue, _denngay.DBValue, _maPC, _heSo, _mucLuong, _maMay, _nguoiSD));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="NhanVien_QTPhuCap" /> Object to underlying database.
		/// </summary>
		 internal void Update()
        {
			...
			if (!this.IsDirty)
				...
				DataProvider.Instance().UpdateNhanVien_QTPhuCap(_maNV, _sTT, _tungay, _denngay, _maPC, _heSo, _mucLuong, _huy, _maMay, _nguoiSD);
		...
		/// <summary>
		/// Delete the <see cref="NhanVien_QTPhuCap" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateNhanVien_QTPhuCap
            DataProvider.Instance().DeleteNhanVien_QTPhuCap(crit.MaMay, crit.NguoiSD, crit.MaNV, crit.STT);
			// public abstract void DeleteNhanVien_QTPhuCap(String _maNV, Int32 _sTT);
			// public override void DeleteNhanVien_QTPhuCap(String _maNV, Int32 _sTT)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spNHANVIEN_QTPhuCap_DELETED", _maNV, _sTT);
			// }
		}
