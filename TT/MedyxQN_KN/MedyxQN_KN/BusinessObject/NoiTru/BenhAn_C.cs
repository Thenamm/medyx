...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_C : BusinessBase<BenhAn_C>
	{
        ...
        private Boolean _dalaymau = false;
		...
		private String _MaBAMau = String.Empty;
        ...
        private String _soxn = String.Empty;
        private Boolean _KTC = false;
		#endregion
		
		#region Business Properties and Methods
        public string mabadvtt
        {
            get
            {
        ...
        public Boolean dalaymau
        {
            get
            {
                CanReadProperty("dalaymau", true);
                return _dalaymau;
            }
            set
            {
                CanWriteProperty("dalaymau", true);
                if (_dalaymau != value)
                {
                    _dalaymau = value;
                    PropertyHasChanged("dalaymau");
                }
            }
        }
        public SmartDate tn
        ...
        public string SLTT
        {
            get
            {
                if ((_soLuong - _sLTra) - (int)((_soLuong - _sLTra)) != 0)
                {
                    return (_soLuong - _sLTra).ToString("###,##0.###");
                }
                else
                {
                    return (_soLuong - _sLTra).ToString("###,###");
                }
        ...
        public string SoLuongTHD
        {
            get
            {
                ...
                if (((_soLuong - _sLTra) * (((_denNgay.Date - _tuNgay.Date).Days) + 1)) - (int)(((_soLuong - _sLTra) * (((_denNgay.Date - _tuNgay.Date).Days) + 1))) != 0)
                    return  ((_soLuong - _sLTra) * (((_denNgay.Date - _tuNgay.Date).Days) + 1)) .ToString("###,###.###");
                else
                    return  ((_soLuong - _sLTra) * (((_denNgay.Date - _tuNgay.Date).Days) + 1)) .ToString("###,###");
		...
		public String MaBAMau
		{
			get 
			{
				CanReadProperty("MaBAMau", true);
				return _MaBAMau;
			}
			set 
			{
				CanWriteProperty("MaBAMau", true);
				if (_MaBAMau != value) 
				{
					_MaBAMau = value;
					PropertyHasChanged("MaBAMau");
				}
			}
		}
        ...
        public string thanhtien
        {
            get
            {
                ...
                {
                    _thanhtien = (_donGiaBH * (100 - _ck) * (_soLuong - _sLTra)) * (_denNgay.CompareTo(_tuNgay) + 1) / (100)
                    + _giaChenhLech * (100 - _ck) * (_soLuong - _sLTra) * (_denNgay.CompareTo(_tuNgay) + 1) / 100;
                }

                if ((_bHTinhTien == false) || (_tinhTien != false))
                    _thanhtien = _dongiaTT * (100 - _ck) * (_soLuong - _sLTra) * (_denNgay.CompareTo(_tuNgay) + 1) / 100;
        ...
        public string thanhtientt
        {
            get
            {
                 if ((_bHTinhTien != false) && (_tinhTien == false))
                {
                    _thanhtientt =  _giaChenhLech * (100 - _ck) * (_soLuong - _sLTra) * (_denNgay.CompareTo (_tuNgay )+1)  / 100;
                }

                 else if ((_bHTinhTien == false) || (_tinhTien != false))
                     _thanhtientt = _dongiaTT * (100 - _ck) * (_soLuong - _sLTra) * (_denNgay.CompareTo(_tuNgay) + 1) / 100;
        ...
        public string thanhtienbh
        {
            get
            {
                if ((_bHTinhTien != false) && (_tinhTien == false))
                {
                    _thanhtienbh = (_donGiaBH * (100 - _ck) * (_soLuong - _sLTra)) * (_denNgay.CompareTo(_tuNgay) + 1) / (100);
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static BenhAn_C NewBenhAn_C()
        {
            return new BenhAn_C();
        }
        //public static BenhAn_C NewBenhAn_C(string idDMDichvu)
        //{
        //    return new BenhAn_C(DMDichVu.GetDMDichVu(idDMDichvu));
        //}
        public static BenhAn_C GetBenhAn_C(String maBA, Int32 sTT, Int32 sTTKhoa)
        {
            return DataPortal.Fetch<BenhAn_C>(new Criteria(maBA, sTT, sTTKhoa));
        }
        internal static BenhAn_C GetBenhAn_C(SafeDataReader dr, int i)
        {
            return new BenhAn_C(dr, i);
        }
        internal static BenhAn_C GetBenhAn_C(SafeDataReader dr, int i,int loaiphieu)
        {
            return new BenhAn_C(dr, i,loaiphieu );
        }
		/// <summary>
		/// Marks the <see cref="BenhAn_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteBenhAn_C(String maBA, Int32 sTT, Int32 sTTKhoa, string lydohuy)
        //{
       ...
       // protected internal BenhAn_C()
       // {	
       //     // Prevent direct creation
       // }
       // internal BenhAn_C(       int OrderNumber,
       //                          String maBA ,
       //                          Int32 sTT ,
       //                          Int32 sTTKhoa ,
       //                          String maDV ,
       ...
       //                           _tenKhoa = tenkhoa;
       // }
       // protected BenhAn_C(DMDichVu pro)
       // {
       //     MarkAsChild();
       ...
       // #endregion
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_C" /> Object based on data in the database.
		/// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_C(crit.MaBA, crit.STT, crit.STTKhoa)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
		...
		/// <summary>
		/// Load a <see cref="BenhAn_C" /> Object from given SafeDataReader.
		/// </summary>
        private void Fetch(SafeDataReader dr)
        {
            ...
            if (dr.GetString("MaBAMau") != null) _MaBAMau = dr.GetString("MaBAMau");
        ...
        private BenhAn_C(SafeDataReader dr, int i)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
            ...
            if (dr.GetBoolean("dalaymau") != null) _dalaymau = dr.GetBoolean("dalaymau");
            ...
            _tenKhoa = dr.GetString("TenKhoa");
            _tenKhoacd = dr.GetString("TenKhoacd");
            _khoaKham = dr.GetString("KhoaKham");
            if (dr.GetString("TenNguoiSD") != null) _tenNguoiSD = dr.GetString("TenNguoiSD");
            if (dr.GetString("TenNguoiLap") != null) _tenNguoiLap = dr.GetString("TenNguoiLap");
            if (HTC.ShareVariables.pub_spC == "PS")
            if (dr.GetString("soxn") != null) _soxn = dr.GetString("soxn");
           
            MarkOld();
           
        }
        private BenhAn_C(SafeDataReader dr, int i,int loaiphieu)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_C" /> Object to underlying database.
		/// </summary>
        /// 
        ...
        internal void Insert()
		{
			...
			// Copy & paste ham duoi day vao file DataProvider.cs
              ...
              _sTT = DataProvider.Instance().InsertBenhAn_C(_maBA, _sTTKhoa, _maDV, _maBN, _ngayDK, _soLuong, _slmua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _daTT, _ngayTToan, _bSKham, _ngayGioKham, _ngayKT, _tinhTien, _bHTinhTien, _maMay, _nguoiSD, _MaBAMau , _tyGia, _aDGiaUSD, _uuTien, _maHuongDT, _maBenh, _maKhoa, _tuNgay, _denNgay, _khoaKham, _maBS, _thuocpm, _maDT, _STTDT, _bschidinh, _ghichu);
			// public abstract String InsertBenhAn_C(String _maBA, Int32 _sTTKhoa, String _maDV, String _maBN, SmartDate _ngayDK, Decimal _soLuong, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, Byte _daTT, SmartDate _ngayTToan, String _bSKham, SmartDate _ngayGioKham, SmartDate _ngayKT, Boolean _tinhTien, Boolean _bHTinhTien, String _maMay, String _nguoiLap, String _MaBAMau, Decimal _tyGia, Boolean _aDGiaUSD, Byte _uuTien, String _maHuongDT, String _maBenh);
			// public override String InsertBenhAn_C(String _maBA, Int32 _sTTKhoa, String _maDV, String _maBN, SmartDate _ngayDK, Decimal _soLuong, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, Byte _daTT, SmartDate _ngayTToan, String _bSKham, SmartDate _ngayGioKham, SmartDate _ngayKT, Boolean _tinhTien, Boolean _bHTinhTien, String _maMay, String _nguoiLap, String _MaBAMau, Decimal _tyGia, Boolean _aDGiaUSD, Byte _uuTien, String _maHuongDT, String _maBenh)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBENHAN_C_Create", _maBA, _sTTKhoa, _maDV, _maBN, _ngayDK.DBValue, _soLuong, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _daTT, _ngayTToan.DBValue, _bSKham, _ngayGioKham.DBValue, _ngayKT.DBValue, _tinhTien, _bHTinhTien,,_maMay ,  ,   HTC.ShareVariables .pub_sNguoiSD ,_nguoiSD, _tyGia, _aDGiaUSD, _uuTien, _maHuongDT, _maBenh));
			// }
            //_PhieuNhap_Cs.Update(this);
            _BenhAn_XNList.Update(this);
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="BenhAn_C" /> Object to underlying database.
		/// </summary>
        internal void Update()
        {
			...
			if (!this.IsDirty)
              ...
              //  _nguoiSD  = HTC.ShareVariables.pub_sNguoiSD;
                DataProvider.Instance().UpdateBenhAn_C(_maBA, _sTT, _sTTKhoa, _maDV, _maBN, _ngayDK, _soLuong, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _daTT,_ngayTToan, _bSKham, _ngayGioKham, _ngayKT, _tinhTien, _bHTinhTien, _maMay , _huy,_nguoiSD , _loaihinh, _daTra, _nguoiTra, _ngaytra, _sLTra, _MaBAMau  , _tyGia, _aDGiaUSD, _uuTien, _maHuongDT, _maBenh, _maKhoa, _tuNgay, _denNgay, _khoaKham, _maBS, _thuocpm, _bschidinh, _ghichu, _mabs3, _mabs4,_kq);
				// public abstract void UpdateBenhAn_C(String _maBA, Int32 _sTT, Int32 _sTTKhoa, String _maDV, String _maBN, SmartDate _ngayDK, Decimal _soLuong, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, Byte _daTT, SmartDate _ngayTToan, String _bSKham, SmartDate _ngayGioKham, SmartDate _ngayKT, Boolean _tinhTien, Boolean _bHTinhTien, String _maMay, String _nguoiSD, String _loaihinh, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, String _MaBAMau, Decimal _tyGia, Boolean _aDGiaUSD, Byte _uuTien, String _maHuongDT, String _maBenh);
				// public override void UpdateBenhAn_C(String _maBA, Int32 _sTT, Int32 _sTTKhoa, String _maDV, String _maBN, SmartDate _ngayDK, Decimal _soLuong, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, Byte _daTT, SmartDate _ngayTToan, String _bSKham, SmartDate _ngayGioKham, SmartDate _ngayKT, Boolean _tinhTien, Boolean _bHTinhTien, String _maMay, String _nguoiSD, String _loaihinh, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, String _MaBAMau, Decimal _tyGia, Boolean _aDGiaUSD, Byte _uuTien, String _maHuongDT, String _maBenh)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBENHAN_C_Update", _maBA, _sTT, _sTTKhoa, _maDV, _maBN, _ngayDK.DBValue, _soLuong, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _daTT, _ngayTToan.DBValue, _bSKham, _ngayGioKham.DBValue, _ngayKT.DBValue, _tinhTien, _bHTinhTien, _tinhNgoai,_maMay ,   _nguoiSD, _loaihinh, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra,_nguoiSD, _tyGia, _aDGiaUSD, _uuTien, _maHuongDT, _maBenh);
				// }		
                //_PhieuNhap_Cs.Update(this);
                _BenhAn_XNList.Update(this);
            MarkOld();
        ...
        ///// <summary>
        ///// Delete the <see cref="BenhAn_C" />.
        ///// </summary>
        //protected void DataPortal_Delete(OtherCriteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_C
        //    DataProvider.Instance().DeleteBenhAn_C(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa, crit.lydohuy );
        //    // public abstract void DeleteBenhAn_C(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
        //    // public override void DeleteBenhAn_C(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
        //    // {
        ...
        internal void DeleteSelf()
        {
            ...
            DataProvider.Instance().DeleteBenhAn_C(_maMay,_nguoiSD, _maBA, _sTT, _sTTKhoa, _lyDoHuy);
            MarkNew();
        }
