...
//
// Ten file        :	BenhAn_CTCH
// Kieu doi tuong  :	BenhAn_CTCH
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_CTCH" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_CTCH : BusinessBase<BenhAn_CTCH>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_CTCH" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static BenhAn_CTCH NewBenhAn_CTCH()
        {
            return DataPortal.Create<BenhAn_CTCH>();
        }
		public static BenhAn_CTCH GetBenhAn_CTCH(String maBA, Int32 sTT, Int32 sTTKhoa)
		{
			return DataPortal.Fetch<BenhAn_CTCH>(new Criteria(maBA, sTT, sTTKhoa));
		}
		
		/// <summary>
		/// Marks the <see cref="BenhAn_CTCH" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteBenhAn_CTCH(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
		{
		...
		protected internal BenhAn_CTCH()
		{	
			// Prevent direct creation
		}

        internal BenhAn_CTCH(     int OrderNumber,
                                 String maBA ,
		                         Int32 sTT ,
		                         Int32 sTTKhoa ,
		                         SmartDate ngayKham ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_CTCH" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_CTCH_GET", _maBA, _sTT, _sTTKhoa));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_CTCH(crit.MaBA, crit.STT, crit.STTKhoa)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="BenhAn_CTCH" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_CTCH" /> Object to underlying database.
		/// </summary>
        /// 
		...
		protected override void DataPortal_Update()
		{
			...
			if (IsDirty){
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_CTCH_UPDATE", _maBA, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhngoaiKhoa, _tuanHoan, _hoHap, _tieuHoa, _thanTNSD, _thanKinh, _coXuongKhop, _taiMuiHong, _rangHamMat, _mat, _khac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="BenhAn_CTCH" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_CTCH
            DataProvider.Instance().DeleteBenhAn_CTCH(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa);
			// public abstract void DeleteBenhAn_CTCH(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
			// public override void DeleteBenhAn_CTCH(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_CTCH_Deleted", _maBA, _sTT, _sTTKhoa);
			// }
		}
