...
//
// Ten file        :	BenhAn_Chamsoc_San
// Kieu doi tuong  :	BenhAn_Chamsoc_San
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_Chamsoc_San" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_Chamsoc_San : BusinessBase<BenhAn_Chamsoc_San>
	{
        ...
        protected override void AddBusinessRules()
        {
            ...
            //ValidationRules.AddRule<BenhAn_Chamsoc_San>(ValidationNgaySinh<BenhAn_Chamsoc_San>, "TuNgay");
            ValidationRules.AddDependantProperty("TuNgay", "DenNgay");
            
        }

        //private static bool ValidationNgaySinh<T>(T target, Csla.Validation.RuleArgs e) where T : BenhAn_Chamsoc_San
        //{
        ...
        //        return true;
        //}
        private static bool ValidationNgaySinhNgayHC<T>(T target, Csla.Validation.RuleArgs e) where T : BenhAn_Chamsoc_San
        {
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_Chamsoc_San" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static BenhAn_Chamsoc_San NewBenhAn_Chamsoc_San()
        {
            return DataPortal.Create<BenhAn_Chamsoc_San>();
        }
		public static BenhAn_Chamsoc_San GetBenhAn_Chamsoc_San(String maBA, Int32 sTT, Int32 sTTKhoa)
		{
			return DataPortal.Fetch<BenhAn_Chamsoc_San>(new Criteria(maBA, sTT, sTTKhoa));
		}
		
		/// <summary>
		/// Marks the <see cref="BenhAn_Chamsoc_San" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteBenhAn_Chamsoc_San(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
		{
		...
		protected internal BenhAn_Chamsoc_San()
		{	
			// Prevent direct creation
		}

        internal BenhAn_Chamsoc_San(
  int OrderNumber,
  String maBA ,
		                             Int32 sTT ,
		                             Int32 sTTKhoa ,
  ...
  String nuoctieu
   ...
   _tennguoiSD = tennguoiSD ;
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_Chamsoc_San" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Chamsoc_San_GET", _maBA, _sTT, _sTTKhoa));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_Chamsoc_San(crit.MaBA, crit.STT, crit.STTKhoa)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="BenhAn_Chamsoc_San" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_Chamsoc_San" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertBenhAn_Chamsoc_San
			// Copy & paste ham duoi day vao file DataProvider.cs
              
			_maBA = DataProvider.Instance().InsertBenhAn_Chamsoc_San(_maBA, _sTTKhoa, _tuNgay, _denNgay, _dienbien, _yLenh, _yta, _maMay, _nguoiSD,_mach ,_apHuyet ,_nhietDo ,_TT,_NuocTieu );
            MarkOld();// public abstract String InsertBenhAn_Chamsoc_San(String _maBA, Int32 _sTTKhoa, SmartDate _tuNgay, SmartDate _denNgay, String _dienbien, String _yLenh, String _yta, String _maMay, String _nguoiSD);
			// public override String InsertBenhAn_Chamsoc_San(String _maBA, Int32 _sTTKhoa, SmartDate _tuNgay, SmartDate _denNgay, String _dienbien, String _yLenh, String _yta, String _maMay, String _nguoiSD)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Chamsoc_San_CREATE", _maBA, _sTT, _sTTKhoa, _tuNgay.DBValue, _denNgay.DBValue, _dienbien, _yLenh, _yta, _maMay, _nguoiSD));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="BenhAn_Chamsoc_San" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_Chamsoc_San
              
			if (IsDirty){
                DataProvider.Instance().UpdateBenhAn_Chamsoc_San(_maBA, _sTT, _sTTKhoa, _tuNgay, _denNgay, _dienbien, _yLenh, _yta, _huy, _maMay, _nguoiSD, _mach, _apHuyet, _nhietDo, _TT, _NuocTieu);
				// public abstract void UpdateBenhAn_Chamsoc_San(String _maBA, Int32 _sTT, Int32 _sTTKhoa, SmartDate _tuNgay, SmartDate _denNgay, String _dienbien, String _yLenh, String _yta, String _maMay, Boolean _huy, String _nguoiSD);
				// public override void UpdateBenhAn_Chamsoc_San(String _maBA, Int32 _sTT, Int32 _sTTKhoa, SmartDate _tuNgay, SmartDate _denNgay, String _dienbien, String _yLenh, String _yta, String _maMay, Boolean _huy, String _nguoiSD)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Chamsoc_San_UPDATE", _maBA, _sTT, _sTTKhoa, _tuNgay.DBValue, _denNgay.DBValue, _dienbien, _yLenh, _yta, _maMay, _huy, _nguoiSD);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="BenhAn_Chamsoc_San" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_Chamsoc_San
            DataProvider.Instance().DeleteBenhAn_Chamsoc_San(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa);
			// public abstract void DeleteBenhAn_Chamsoc_San(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
			// public override void DeleteBenhAn_Chamsoc_San(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Chamsoc_San_DELETED", _maBA, _sTT, _sTTKhoa);
			// }
		}
