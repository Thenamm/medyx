...
//
// Ten file        :	BenhAn_CoXuongKhop
// Kieu doi tuong  :	BenhAn_CoXuongKhop
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_CoXuongKhop" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_CoXuongKhop : BusinessBase<BenhAn_CoXuongKhop>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_CoXuongKhop" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static BenhAn_CoXuongKhop NewBenhAn_CoXuongKhop()
        {
            return DataPortal.Create<BenhAn_CoXuongKhop>();
        }
		public static BenhAn_CoXuongKhop GetBenhAn_CoXuongKhop(String maBA, Int32 sTT, Int32 sTTKhoa)
		{
			return DataPortal.Fetch<BenhAn_CoXuongKhop>(new Criteria(maBA, sTT, sTTKhoa));
		}
		
		/// <summary>
		/// Marks the <see cref="BenhAn_CoXuongKhop" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteBenhAn_CoXuongKhop(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
		{
		...
		protected internal BenhAn_CoXuongKhop()
		{	
			// Prevent direct creation
		}

        internal BenhAn_CoXuongKhop(     int OrderNumber,
                                 String maBA ,
		                         Int32 sTT ,
		                         Int32 sTTKhoa ,
		                         SmartDate ngayKham ,
                                ...
                                )
        {
		                          ...
		                          _chieuCao = chieuCao ;
		                            ...
		                            _tinhThan = tinhThan ;
                                  _daNiemMac = daNiemMac  ;
                                  _tTNgoaiDa = tTNgoaiDa  ;
                                  _hach = hach  ;
                                  _kNDiLai = kNDiLai  ;
                                  _ngonDuiTrong = ngonDuiTrong  ;
                                  _hCRaynand = hCRaynand  ;
                                  _coXuongKhop = coXuongKhop  ;
                                  _tuanHoan = tuanHoan  ;
                                  _hoHap = hoHap  ;
                                  _tieuHoa = tieuHoa  ;
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_CoXuongKhop" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_CoXuongKhop_GET", _maBA, _sTT, _sTTKhoa));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_CoXuongKhop(crit.MaBA, crit.STT, crit.STTKhoa)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="BenhAn_CoXuongKhop" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_CoXuongKhop" /> Object to underlying database.
		/// </summary>
        /// 
		...
		protected override void DataPortal_Update()
		{
			...
			if (IsDirty){
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_CoXuongKhop_UPDATE", _maBA, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _da, _phu, _ngonTay, _hach, _khotho, _ho, _daunguc, _tim, _ngoiXom, _ngat, _hoihop, _dauhieuKhac, _longnguc, _vitrimomtim, _tiengtim, _tiengthoitim, _tiengthoimach, _tiengthoikhac, _machtuchi, _hohap, _bung, _thanhkinh, _coquankhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="BenhAn_CoXuongKhop" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_CoXuongKhop
            DataProvider.Instance().DeleteBenhAn_CoXuongKhop(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa);
			// public abstract void DeleteBenhAn_CoXuongKhop(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
			// public override void DeleteBenhAn_CoXuongKhop(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_CoXuongKhop_Deleted", _maBA, _sTT, _sTTKhoa);
			// }
		}
