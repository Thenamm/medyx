...
//
// Ten file        :	BenhAn_HoaChat
// Kieu doi tuong  :	BenhAn_HoaChat
// Kieu CSLA       :	EditableRoot
// Ngay tao        :	7/14/2009 9:34:32 AM
// Nguoi tao       :	HCABXT
//
// *****************************************************************************************************
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_HoaChat" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_HoaChat : BusinessBase<BenhAn_HoaChat>
	{
        ...
        public string SoLuongTHD
        {
            get
            {
                ...
                if (((_sLKeDon - _sLTra) * (((_denNgay.Date - _tuNgay.Date).Days) + 1)) - (int)(((_sLKeDon - _sLTra) * (((_denNgay.Date - _tuNgay.Date).Days) + 1))) != 0)
                    return ((_sLKeDon - _sLTra) * (((_denNgay.Date - _tuNgay.Date).Days) + 1)).ToString("###,###.###");
                else
                    return ((_sLKeDon - _sLTra) * (((_denNgay.Date - _tuNgay.Date).Days) + 1)).ToString("###,###");
        ...
        public string NgayPD
        {
            get
            {
                CanReadProperty("NgayP", true);
                _ngayPD.FormatString = "dd/MM/yyyy";
                _ngayPD = _ngayP;
                return _ngayP.Text;
            }
            //set
        ...
        public string NgayDD
        {
            get
            {
                CanReadProperty("NgayDD", true);
                _ngayD.FormatString = "dd/MM/yyyy";
                _ngayDD = _ngayD;
                return _ngayD.Text;
            }
            //set
		...
		{
			return _sTT.ToString() + "!" + _maBA.ToString() + "!" + _sTTKhoa.ToString();
		}
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_HoaChat" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static BenhAn_HoaChat NewBenhAn_HoaChat()
        {
            return new BenhAn_HoaChat();
        }
        //public static BenhAn_HoaChat GetBenhAn_HoaChat(Int32 sTT, String maBA, Int32 sTTKhoa)
        //{
        //    return DataPortal.Fetch<BenhAn_HoaChat>(new Criteria(sTT, maBA, sTTKhoa));
        //}
        internal static BenhAn_HoaChat GetBenhAn_HoaChat(SafeDataReader dr, int i)
        {
            return new BenhAn_HoaChat(dr, i);
        }
		/// <summary>
		/// Marks the <see cref="BenhAn_HoaChat" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteBenhAn_HoaChat(Int32 sTT, String maBA, Int32 sTTKhoa)
        //{
        //    DataPortal.Delete(new Criteria(sTT, maBA, sTTKhoa));
        //}
        public BenhAn_HoaChat()
        {
            MarkAsChild();
        }
		#endregion
        ...
        //protected internal BenhAn_HoaChat()
        //{	
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_HoaChat" /> Object based on data in the database.
		/// </summary>
        /// 

        private BenhAn_HoaChat(SafeDataReader dr, int i)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
            ...
            if (dr.GetSmartDate("NgayDK", true) != null) _ngayDKD = dr.GetSmartDate("NgayDK", true);
            ...
            if (dr.GetSmartDate("NgayTToan", true) != null) _ngayTToanD = dr.GetSmartDate("NgayTToan", true);
            ...
            if (dr.GetSmartDate("Ngaytra", true) != null) _ngaytraD = dr.GetSmartDate("Ngaytra", true);
            ...
            if (dr.GetSmartDate("NgayP", true) != null) _ngayPD = dr.GetSmartDate("NgayP", true);
            ...
            if (dr.GetSmartDate("NgayD", true) != null) _ngayDD = dr.GetSmartDate("NgayD", true);
        ...
        internal void Insert()
        {
            ...
            if (_sLKeDon > 0)
            _sTT = DataProvider.Instance().InsertBenhAn_HoaChat(_sTT, _maBA, _sTTKhoa, _maHC, _maBN, _ngayDK, _tuNgay, _denNgay, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT, _nguoiSD , _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay , _nguoiSD , _maKhoa, _thuocpm, _thuocbx, _thuocdx, _maDT, _STTDT,_thuoctutruc );
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhan_HoaChat_Create", _sTT, _maBA, _sTTKhoa, _maHC, _maBN, _ngayDK.DBValue, _tuNgay.DBValue, _denNgay.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue,_maMay ,   _nguoiLap);
			// }
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="BenhAn_HoaChat" /> Object to underlying database.
		/// </summary>
		 internal void Update()
        {
            ...
            DataProvider.Instance().UpdateBenhAn_HoaChat(_sTT, _maBA, _sTTKhoa, _maHC, _maBN, _ngayDK, _tuNgay, _denNgay, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD,_maMay ,   _huy,_nguoiSD   , _thuocpm, _thuocdx,_thuocbx,_thuoctutruc );
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhan_HoaChat_Update", _sTT, _maBA, _sTTKhoa, _maHC, _maBN, _ngayDK.DBValue, _tuNgay.DBValue, _denNgay.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue,_maMay ,   _huy, _nguoiSD);
				// }				
                MarkOld();
		}
		...
		/// <summary>
		/// Delete the <see cref="BenhAn_HoaChat" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_HoaChat
            DataProvider.Instance().DeleteBenhAn_HoaChat(crit.MaMay, crit.NguoiSD, crit.STT, crit.MaBA, crit.STTKhoa, crit.lydohuy);
			// public abstract void DeleteBenhAn_HoaChat(Int32 _sTT, String _maBA, Int32 _sTTKhoa);
			// public override void DeleteBenhAn_HoaChat(Int32 _sTT, String _maBA, Int32 _sTTKhoa)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhan_HoaChat_Deleted", _sTT, _maBA, _sTTKhoa);
			// }
		}
