...
//
// Ten file        :	BenhAn_KeNgoai
// Kieu doi tuong  :	BenhAn_KeNgoai
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_KeNgoai" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_KeNgoai : BusinessBase<BenhAn_KeNgoai>
	{
        ...
        //{
            ...
            //ValidationRules.AddRule<BenhAn_KeNgoai>(ValidationTuNgayDenNgay<BenhAn_KeNgoai>, "TuNgay");
            //ValidationRules.AddRule<BenhAn_KeNgoai>(ValidationTuNgayDenNgay<BenhAn_KeNgoai>, "DenNgay");
            //ValidationRules.AddRule<BenhAn_KeNgoai>(ValidationNgayDKDenNgay<BenhAn_KeNgoai>, "DenNgay");
            //ValidationRules.AddRule<BenhAn_KeNgoai>(ValidationNgayDKDenNgay<BenhAn_KeNgoai>, "NgayDK");
        ...
        //        return true;
        //}
        //private static bool ValidationNgayDKDenNgay<T>(T target, Csla.Validation.RuleArgs e) where T : BenhAn_KeNgoai
        //{
        ...
        //        return true;
        //}
        //private static bool ValidationTuNgayDenNgay<T>(T target, Csla.Validation.RuleArgs e) where T : BenhAn_KeNgoai
        //{
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_KeNgoai" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static BenhAn_KeNgoai NewBenhAn_KeNgoai()
        {
           
            return new BenhAn_KeNgoai();
        }
       
        internal static BenhAn_KeNgoai GetBenhAn_KeNgoai(SafeDataReader dr, int i)
        {
            return new BenhAn_KeNgoai(dr, i);
        }
		/// <summary>
		/// Marks the <see cref="BenhAn_KeNgoai" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
       
        public BenhAn_KeNgoai()
        {
            MarkAsChild();
        }
		#endregion
        ...
        protected class OtherCriteria
        {
            ...
            public OtherCriteria(String Mamay, String Nguoisd, String maBA, Int32 sTTKhoa, Int32 sTT, String lydohuy)
            {
                _maBA = maBA;
                _sTT = sTT;
                _sTTKhoa = STTKhoa;
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_KeNgoai" /> Object based on data in the database.
		/// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetBenhAn_KeNgoai(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
        //    // public override IDataReader GetBenhAn_KeNgoai(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maBA, _sTT, _sTTKhoa));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_KeNgoai(crit.MaBA, crit.STT, crit.STTKhoa)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        ///// <summary>
        ///// Load a <see cref="BenhAn_KeNgoai" /> Object from given SafeDataReader.
        ///// </summary>
        ...
        //}
        private BenhAn_KeNgoai(SafeDataReader dr, int i)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_KeNgoai" /> Object to underlying database.
		/// </summary>
		 ...
		 internal void Update()
        {
            ...
            DataProvider.Instance().UpdateBenhAn_KeNgoai(_maBA,_STTKhoa , _sTT, _MaKe, _maBN, _ngayDK, _sLKeDon, _sLMua, _bSChiDinh, _ChanDoan, _maKhoa, _lieuDung, _cachDung  ,_maMay , _huy, _nguoiSD);
				// public abstract void UpdateBenhAn_KeNgoai(String _maBA, Int32 _sTT, Int32 _sTTKhoa, String _MaKe, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, String _lieuDung, String _cachDung, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, String _nguoiSD, String _ChanDoan);
				// public override void UpdateBenhAn_KeNgoai(String _maBA, Int32 _sTT, Int32 _sTTKhoa, String _MaKe, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, String _lieuDung, String _cachDung, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, String _nguoiSD, String _ChanDoan)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_KeNgoai_Update", _maBA, _sTT, _sTTKhoa, _MaKe, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _lieuDung, _cachDung, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue,_maMay ,   _huy,_nguoiSD   , _ChanDoan);
				// }		
                MarkOld();
        ...
        internal void DeleteSelf()
        {
            ...
            DataPortal_Delete(new OtherCriteria(_maMay,_nguoiSD, _maBA,_STTKhoa , _sTT, _lyDoHuy ));
            MarkNew();
        }

        private void DataPortal_Delete(OtherCriteria crit)
        {
            DataProvider.Instance().DeleteBenhAn_KeNgoai(crit.MaMay, crit.NguoiSD, crit.MaBA,crit .STTKhoa,  crit.STT, crit.lydohuy );
        }


		/// <summary>
		/// Delete the <see cref="BenhAn_KeNgoai" />.
		/// </summary>
