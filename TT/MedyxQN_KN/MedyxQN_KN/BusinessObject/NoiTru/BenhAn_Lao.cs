...
namespace HTC.Business.NoiTru
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="BenhAn_Lao" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class BenhAn_Lao : BusinessBase<BenhAn_Lao>
    {
        ...
        /// <summary>
        /// Factory method. New <see cref="BenhAn_Lao" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static BenhAn_Lao NewBenhAn_Lao()
        {
            return DataPortal.Create<BenhAn_Lao>();
        }
        public static BenhAn_Lao GetBenhAn_Lao(String maBA, Int32 sTT, Int32 sTTKhoa)
        {
            return DataPortal.Fetch<BenhAn_Lao>(new Criteria(maBA, sTT, sTTKhoa));
        }

        /// <summary>
        /// Marks the <see cref="BenhAn_Lao" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteBenhAn_Lao(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
        {
        ...
        protected internal BenhAn_Lao()
        {
            // Prevent direct creation
        }

        internal BenhAn_Lao(int OrderNumber,
                                 String maBA,
                                 Int32 sTT,
                                 Int32 sTTKhoa,
                                 SmartDate ngayKham,
        ...
        /// <summary>
        /// Retrieve an existing <see cref="BenhAn_Lao" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Lao_GET", _maBA, _sTT, _sTTKhoa));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_Lao(crit.MaBA, crit.STT, crit.STTKhoa)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        /// <summary>
        /// Load a <see cref="BenhAn_Lao" /> Object from given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Insert the new <see cref="BenhAn_Lao" /> Object to underlying database.
        /// </summary>
        /// 
        ...
        /// <summary>
        /// Update all changes made on <see cref="BenhAn_Lao" /> Object to underlying database.
        /// </summary>
        protected override void DataPortal_Update()
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_Lao
            if (IsDirty)
            {
                DataProvider.Instance().UpdateBenhAn_Lao(_maBA, _sTT, _sTTKhoa, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _tuanHoan, _hoHap, _tieuHoa, _ThanTNieuSDuc, _thanKinh, _XuongKhop, _taiMuiHong, _rangHamMat, _mat, _BenhLyKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
                ...
                // {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Lao_UPDATE", _maBA, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhngoaiKhoa, _tuanHoan, _hoHap, _tieuHoa, _ThanTNieuSDuc, _thanKinh, _XuongKhop, _taiMuiHong, _rangHamMat, _mat, _BenhLyKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
                // }				
            }
        }
        ...
        /// <summary>
        /// Delete the <see cref="BenhAn_Lao" />.
        /// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_Lao
            DataProvider.Instance().DeleteBenhAn_Lao(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa);
            // public abstract void DeleteBenhAn_Lao(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
            // public override void DeleteBenhAn_Lao(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Lao_Deleted", _maBA, _sTT, _sTTKhoa);
            // }
        }
