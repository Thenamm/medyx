...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_Mau" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_Mau : BusinessBase<BenhAn_Mau>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_Mau" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static BenhAn_Mau NewBenhAn_Mau()
        {
            return new BenhAn_Mau();
        }
        internal static BenhAn_Mau GetBenhAn_Mau(SafeDataReader dr, int i)
        {
            return new BenhAn_Mau(dr, i);
        }
        public static BenhAn_Mau GetBenhAn_Mau(String maBA, Int32 sTT, Int32 sTTKhoa)
        {
            return DataPortal.Fetch<BenhAn_Mau>(new Criteria(maBA, sTT, sTTKhoa));
        }
        public BenhAn_Mau()
        {
            MarkAsChild();
		...
		/// <summary>
		/// Marks the <see cref="BenhAn_Mau" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteBenhAn_Mau(String maBA, Int32 sTT, Int32 sTTKhoa)
        //{
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_Mau" /> Object based on data in the database.
		/// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_Mau(crit.MaBA, crit.STT, crit.STTKhoa)))
            {
                if (dr.Read()){
                    Fetch(dr);
                    MarkOld();
         ...
         //<summary>
         //Load a <see cref="BenhAn_Mau" /> Object from given SafeDataReader.
         //</summary>
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_Mau" /> Object to underlying database.
		/// </summary>
        /// 

        private BenhAn_Mau(SafeDataReader dr, int i)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
		...
		internal void Update()
        {
            ...
            DataProvider.Instance().UpdateBenhAn_Mau(_maBA, _sTT, _sTTKhoa, _maCPMau, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD,_maMay ,   _huy,_nguoiSD   , _TuNgay, _DenNgay, _thuocpm);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhan_Mau_Update", _maBA, _sTT, _sTTKhoa, _maCPMau, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue,_maMay ,   _huy, _nguoiSD);
				// }	
                MarkOld();
		...
		/// <summary>
		/// Delete the <see cref="BenhAn_Mau" />.
		/// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_Mau
        //    DataProvider.Instance().DeleteBenhAn_Mau(crit.MaBA, crit.STT, crit.STTKhoa);
        //    // public abstract void DeleteBenhAn_Mau(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
        //    // public override void DeleteBenhAn_Mau(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhan_Mau_Deleted", _maBA, _sTT, _sTTKhoa);
        //    // }
        //}
