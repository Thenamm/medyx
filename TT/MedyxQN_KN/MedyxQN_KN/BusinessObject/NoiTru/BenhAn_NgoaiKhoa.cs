...
//
// Ten file        :	BenhAn_NgoaiKhoa
// Kieu doi tuong  :	BenhAn_NgoaiKhoa
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_NgoaiKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_NgoaiKhoa : BusinessBase<BenhAn_NgoaiKhoa>
	{
        ...
        private String _CQMat = String.Empty;
        private String _CQTMH = String.Empty;
        private String _CQRHM = String.Empty;
        ...
        public String CQMat
        {
            get
            {
                CanReadProperty("CQMat", true);
                return _CQMat;
            }
            set
            {
                CanWriteProperty("CQMat", true);
                if (_CQMat != value)
                {
                    _CQMat = value;
                    PropertyHasChanged("CQMat");
                }
            }
        }
        ...
        public String CQTMH
        {
            get
            {
                CanReadProperty("CQTMH", true);
                return _CQTMH;
            }
            set
            {
                CanWriteProperty("CQTMH", true);
                if (_CQTMH != value)
                {
                    _CQTMH = value;
                    PropertyHasChanged("CQTMH");
                }
            }
        }
        ...
        public String CQRHM
        {
            get
            {
                CanReadProperty("CQRHM", true);
                return _CQRHM;
            }
            set
            {
                CanWriteProperty("CQRHM", true);
                if (_CQRHM != value)
                {
                    _CQRHM = value;
                    PropertyHasChanged("CQRHM");
                }
            }
        }
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_NgoaiKhoa" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static BenhAn_NgoaiKhoa NewBenhAn_NgoaiKhoa()
        {
            return DataPortal.Create<BenhAn_NgoaiKhoa>();
        }
        public static BenhAn_NgoaiKhoa GetBenhAn_NgoaiKhoa(String maBA, Int32 sTT, Int32 sTTKhoa)
		{
            return DataPortal.Fetch<BenhAn_NgoaiKhoa>(new Criteria(maBA, sTT, sTTKhoa));
		}
		
		/// <summary>
		/// Marks the <see cref="BenhAn_NgoaiKhoa" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteBenhAn_NgoaiKhoa(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
		{
		...
		protected internal BenhAn_NgoaiKhoa()
		{	
			// Prevent direct creation
		}

        internal BenhAn_NgoaiKhoa(int OrderNumber,
                                 String maBA ,
		                         Int32 sTT ,
		                         Int32 sTTKhoa ,
		                         SmartDate ngayKham ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_NgoaiKhoa" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_NgoaiKhoa_GET", _maBA, _sTT, _sTTKhoa));
			// }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_NgoaiKhoa(crit.MaBA, crit.STT, crit.STTKhoa)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="BenhAn_NgoaiKhoa" /> Object from given SafeDataReader.
		/// </summary>
		private void Fetch(SafeDataReader dr)
		{
            ...
            if (dr.GetString("CQTMH") != null) _CQTMH = dr.GetString("CQTMH");
            if (dr.GetString("CQTamThan") != null) _CQTamThan = dr.GetString("CQTamThan");
            if (dr.GetString("CQRHM") != null) _CQRHM = dr.GetString("CQRHM");
            if (dr.GetString("CQMat") != null) _CQMat = dr.GetString("CQMat");
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_NgoaiKhoa" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertBenhAn_NgoaiKhoa
			// Copy & paste ham duoi day vao file DataProvider.cs
            _maBA = DataProvider.Instance().InsertBenhAn_NgoaiKhoa(_maBA, _sTTKhoa, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhNgoaiKhoa, _CQTuanHoan, _CQHoHap, _CQTieuHoa, _CQTietNieuSD, _CQCoXuongKhop, _CQTamThan, _CQTMH, _CQRHM, _CQMat, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _nguoiSD);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_NgoaiKhoa_CREATE", _maBA, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _CoQuanKhac, _tonThuong, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _ngaySD.DBValue, _nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="BenhAn_NgoaiKhoa" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_NgoaiKhoa
			if (IsDirty){

                DataProvider.Instance().UpdateBenhAn_NgoaiKhoa(_maBA, _sTT, _sTTKhoa, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhNgoaiKhoa, _CQTuanHoan, _CQHoHap, _CQTieuHoa, _CQTietNieuSD, _CQCoXuongKhop, _CQTamThan, _CQTMH, _CQRHM, _CQMat, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_NgoaiKhoa_UPDATE", _maBA, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _CoQuanKhac, _tonThuong, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="BenhAn_NgoaiKhoa" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_NgoaiKhoa
            DataProvider.Instance().DeleteBenhAn_NgoaiKhoa(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa);
			// public abstract void DeleteBenhAn_NgoaiKhoa(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
			// public override void DeleteBenhAn_NgoaiKhoa(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_NgoaiKhoa_Deleted", _maBA, _sTT, _sTTKhoa);
			// }
		}
