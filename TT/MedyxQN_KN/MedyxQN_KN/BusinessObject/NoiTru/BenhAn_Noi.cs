...
namespace HTC.Business.NoiTru
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="BenhAn_Noi" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class BenhAn_Noi : BusinessBase<BenhAn_Noi>
    {
        ...
        private String _maICDPhanBiet = String.Empty;
        private String _tenBSKham = String.Empty;
        private String _tennguoiSD = String.Empty;
        private String _canLamSang = String.Empty;
        private String _tomTatBenhAn = String.Empty;
        ...
        private String _moTaChiTietCoQuanBenhLy = string.Empty;
        ...
        public String TomTatBenhAn
        {
            get
            {
                CanReadProperty("TomtatBenhAn", true);
                return _tomTatBenhAn;
            }
            set
            {
                CanWriteProperty("TomtatBenhAn", true);
                if (_tomTatBenhAn != value)
                {
                    _tomTatBenhAn = value;
                    PropertyHasChanged("TomtatBenhAn");
                }
            }
        }
        public String CanLamSang
        {
            get
            {
                CanReadProperty("CanLamSang", true);
                return _canLamSang;
            }
            set
            {
                CanWriteProperty("CanLamSang", true);
                if (_canLamSang != value)
                {
                    _canLamSang = value;
                    PropertyHasChanged("CanLamSang");
                }
            }
        }
        public String MoTaChiTietCoQuanBenhLy
        {
            get
            {
                CanReadProperty("MoTaChiTietCQBenhLy", true);
                return _moTaChiTietCoQuanBenhLy;
            }
            set
            {
                CanWriteProperty("MoTaChiTietCQBenhLy", true);
                if (_moTaChiTietCoQuanBenhLy != value)
                {
                    _moTaChiTietCoQuanBenhLy = value;
                    PropertyHasChanged("MoTaChiTietCQBenhLy");
                }
            }
        }
        public Int32 STT
        ...
        public String MaICDPhanBiet
        {
            get
            {
                CanReadProperty("MaICDPhanBiet", true);
                return _maICDPhanBiet;
            }
            set
            {
                CanWriteProperty("MaICDPhanBiet", true);
                if (_maICDPhanBiet != value)
                {
                    _maICDPhanBiet = value;
                    PropertyHasChanged("MaICDPhanBiet");
                }
            }
        }
        ...
        /// <summary>
        /// Factory method. New <see cref="BenhAn_Noi" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static BenhAn_Noi NewBenhAn_Noi()
        {
            return DataPortal.Create<BenhAn_Noi>();
        }
        public static BenhAn_Noi GetBenhAn_Noi(String maBA, Int32 sTT, Int32 sTTKhoa)
        {
            return DataPortal.Fetch<BenhAn_Noi>(new Criteria(maBA, sTT, sTTKhoa));
        }

        /// <summary>
        /// Marks the <see cref="BenhAn_Noi" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteBenhAn_Noi(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
        {
        ...
        protected internal BenhAn_Noi()
        {
            // Prevent direct creation
        }

        internal BenhAn_Noi(int OrderNumber,
                                 String maBA,
                                 Int32 sTT,
                                 Int32 sTTKhoa,
                                 SmartDate ngayKham,
                                ...
                                String BenhLyKhac,
                                 ...
                                 String maICD,
                                 String maICDKem,
                                 String maICDPhanBiet,
                                 String tenBSKham,
                                string tennguoisd,
                                   string CanLamSang,
                                string TomTatBenhAn,
                                String maBenhKemTheo,
                                 String maBenhPhanBiet,
                                string tenBenhKemTheo,
                                string tenBenhPhanBiet,
                                    string maBenhChinh,
                                string tenBenhChinh,
                                string motaChiTietCoQuanBenhLy
                                )
        {
            ...
            _maICD = maICD;
            _maICDKem = maICDKem;
            _maICDPhanBiet = maICDPhanBiet;
            _tenBSKham = tenBSKham;
            _tennguoiSD = tennguoisd;
            _canLamSang = CanLamSang;
            _tomTatBenhAn = TomTatBenhAn;
            _maBenhKemTheo = maBenhKemTheo;
            _maBenhPhanBiet = maBenhPhanBiet;
            _tenBenhKemTheo = tenBenhKemTheo;
            _tenBenhPhanBiet = tenBenhPhanBiet;
            _maBenhChinh = maBenhChinh;
            _TenBenhChinh = tenBenhChinh;
            _moTaChiTietCoQuanBenhLy = motaChiTietCoQuanBenhLy;
        }
        ...
        /// <summary>
        /// Retrieve an existing <see cref="BenhAn_Noi" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Noi_GET", _maBA, _sTT, _sTTKhoa));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_Noi(crit.MaBA, crit.STT, crit.STTKhoa)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        /// <summary>
        /// Load a <see cref="BenhAn_Noi" /> Object from given SafeDataReader.
        /// </summary>
        private void Fetch(SafeDataReader dr)
        {
            ...
            if (dr.GetString("MoTaChiTietCQBenhLy") != null) _moTaChiTietCoQuanBenhLy = dr.GetString("MoTaChiTietCQBenhLy");
            ...
            if (dr.GetString("MaICDPhanBiet") != null) _maICDPhanBiet = dr.GetString("MaICDPhanBiet");
            if (dr.GetString("TenBSKham") != null) _tenBSKham = dr.GetString("TenBSKham");
            if (dr.GetString("TenNguoiSD") != null) _tennguoiSD = dr.GetString("TenNguoiSD");

            if (dr.GetString("TenBenhKem") != null) _tenBenhKem = dr.GetString("TenBenhKem");
            if (dr.GetString("TenBenhChanDoan") != null) _tenBenh = dr.GetString("TenBenhChanDoan");
            if (dr.GetString("CanLamSang") != null) _canLamSang = dr.GetString("CanLamSang");
            if (dr.GetString("TomTatBenhAn") != null) _tomTatBenhAn = dr.GetString("TomTatBenhAn");
        ...
        /// <summary>
        /// Insert the new <see cref="BenhAn_Noi" /> Object to underlying database.
        /// </summary>
        /// 
        ...
        /// <summary>
        /// Update all changes made on <see cref="BenhAn_Noi" /> Object to underlying database.
        /// </summary>
        protected override void DataPortal_Update()
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_Noi
            if (IsDirty)
            {
                DataProvider.Instance().UpdateBenhAn_Noi(_maBA, _sTT, _sTTKhoa, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _tuanHoan, _hoHap, _tieuHoa, _ThanTNieuSDuc, _thanKinh, _XuongKhop, _taiMuiHong, _rangHamMat, _mat, _BenhLyKhac, _mota, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD, _tenBenh, _canLamSang, _tomTatBenhAn, _maBenhKemTheo, _maBenhPhanBiet, _tenBenhKemTheo, _tenBenhPhanBiet, _maBenhChinh, _TenBenhChinh, _moTaChiTietCoQuanBenhLy);
                ...
                // {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Noi_UPDATE", _maBA, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhngoaiKhoa, _tuanHoan, _hoHap, _tieuHoa, _ThanTNieuSDuc, _thanKinh, _XuongKhop, _taiMuiHong, _rangHamMat, _mat, _BenhLyKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
                // }				
            }
        }
        ...
        /// <summary>
        /// Delete the <see cref="BenhAn_Noi" />.
        /// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_Noi
            DataProvider.Instance().DeleteBenhAn_Noi(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa);
            // public abstract void DeleteBenhAn_Noi(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
            // public override void DeleteBenhAn_Noi(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_Noi_Deleted", _maBA, _sTT, _sTTKhoa);
            // }
        }
