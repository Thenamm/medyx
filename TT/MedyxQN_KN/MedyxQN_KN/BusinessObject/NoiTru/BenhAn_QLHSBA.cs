...
//
// Ten file        :	BenhAn_QLHSBA
// Kieu doi tuong  :	BenhAn_QLHSBA
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_QLHSBA" /> Business Object.
	/// </summary>
	
	[Serializable()]
    public partial class BenhAn_QLHSBA : BusinessBase<BenhAn_QLHSBA>
	{
        ...
        private String _PhanLoaiHS = string.Empty;
        ...
        public string NgayRaVien
        {
            get
            {
                ...
                _NgayRaVien.FormatString = "MM/dd/yyyy";
        ...
        public String PhanLoaiHS
        {
            get
            {
                CanReadProperty("PhanLoaiHS", true);
                return _PhanLoaiHS;
            }
            set
            {
                CanWriteProperty("PhanLoaiHS", true);
                if (_PhanLoaiHS != value)
                {
                    _PhanLoaiHS = value;
                    PropertyHasChanged("PhanLoaiHS");
                }
            }
        }
        ...
        protected internal BenhAn_QLHSBA()
        {
            // Prevent direct creation
        }
        internal BenhAn_QLHSBA(int OrderNumber,
  String maDT,
  String hoten,
  String sothe,
  String maBV,
 ...
 // SmartDate ngayBANgoaiT,
  ...
  string tenbv,
                             ...
                             SmartDate giatriTN,
            string mabaluu, string TenKhoa, SmartDate NgayRaVien, string MAICD,
            string TenBenh, int ToTal, String MaPhieuGN, String MaPhieuGN_C,String MaQL,String MaHTRa,String PhanLoaiHS, String Thoihan, Int32 NgayQuaHan)
        { 
            ...
            _MaQL = MaQL;
            _MaHTRa = MaHTRa;
            _PhanLoaiHS = PhanLoaiHS;
            thoihan = Thoihan;
            _NgayQuaHan = NgayQuaHan;
        }
        /// <summary>
        /// Factory method. New <see cref="BenhAn_QLHSBA" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static BenhAn_QLHSBA NewBenhAn_QLHSBA()
        {
            //return DataPortal.Create<DMVungLanhTho>();
            return new BenhAn_QLHSBA();
        }
        #endregion
    }
}
