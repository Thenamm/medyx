...
namespace HTC.Business.NoiTru
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="BenhAn_RHM" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class BenhAn_RHM : BusinessBase<BenhAn_RHM>
    {
        ...
        /// <summary>
        /// Factory method. New <see cref="BenhAn_RHM" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static BenhAn_RHM NewBenhAn_RHM()
        {
            return DataPortal.Create<BenhAn_RHM>();
        }
        public static BenhAn_RHM GetBenhAn_RHM(String maBA, Int32 sTT, Int32 sTTKhoa)
        {
            return DataPortal.Fetch<BenhAn_RHM>(new Criteria(maBA, sTT, sTTKhoa));
        }

        /// <summary>
        /// Marks the <see cref="BenhAn_RHM" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteBenhAn_RHM(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
        {
        ...
        protected internal BenhAn_RHM()
        {
            // Prevent direct creation
        }

        internal BenhAn_RHM(int OrderNumber,
                                 String maBA,
                                 Int32 sTT,
                                 Int32 sTTKhoa,
                                 SmartDate ngayKham,
...
String CQDa,
        ...
        /// <summary>
        /// Retrieve an existing <see cref="BenhAn_RHM" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_RHM_GET", _maBA, _sTT, _sTTKhoa));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_RHM(crit.MaBA, crit.STT, crit.STTKhoa)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        /// <summary>
        /// Load a <see cref="BenhAn_RHM" /> Object from given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Insert the new <see cref="BenhAn_RHM" /> Object to underlying database.
        /// </summary>
        /// 
        ...
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertBenhAn_RHM
            // Copy & paste ham duoi day vao file DataProvider.cs
            _maBA = DataProvider.Instance().InsertBenhAn_RHM( _maBA, _sTTKhoa,  _ngayKham,  _bSKHAM,  _lyDoKham,  _mach,  _apHuyet,  _nhietDo,  _nhipTho,  _canNang,  _chieuCao,  _toanThan,  _benhChuyenKhoa,  _tonThuong,  _CQTamThan,  _CQTuanHoan,  _CQHoHap,_CQTieuHoa,  _CQDa,  _CQCoXuongKhop,  _CQTietNieuSD,  _CoQuanKhac,  _dieuTri,  _benhSu,  _huongDT,  _mabenh,  _maBenhKem,  _machuyenkhoa,  _maMay,  _nguoiSD);
            ...
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_RHM_CREATE", _maBA, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa,_tamthan_thankinh,_tuanhoan,_hohap, _tieuhoa,_da_moduoida, _co_xuong_khop,  _than_tietnieu_sinhduc,  _coQuanKhac, _tonThuong, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _ngaySD.DBValue, _nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
            // }
        }

        /// <summary>
        /// Update all changes made on <see cref="BenhAn_RHM" /> Object to underlying database.
        /// </summary>
        protected override void DataPortal_Update()
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_RHM
            if (IsDirty)
            {
                DataProvider.Instance().UpdateBenhAn_RHM(_maBA,_sTT , _sTTKhoa, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _CQTamThan, _CQTuanHoan, _CQHoHap, _CQTieuHoa, _CQDa, _CQCoXuongKhop, _CQTietNieuSD, _CoQuanKhac, _tonThuong, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay,_huy , _nguoiSD);
                // public abstract String UpdateBenhAn_RHM(String _maBA, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa,String _tamthan_thankinh, String _tuanhoan,String _hohap,String _tieuhoa,String _da_moduoida,String _co_xuong_khop, String _tietnieu_sinhduc,String _coQuanKhac, String _tonThuong, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _machuyenkhoa, String _maMay, String _nguoiSD);
                // public override String UpdateBenhAn_RHM(String _maBA, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa,String _tamthan_thankinh, String _tuanhoan,String _hohap,String _tieuhoa, String _da_moduoida, String _co_xuong_khop,String _tietnieu_sinhduc, String _coQuanKhac, String _tonThuong, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _machuyenkhoa, String _maMay, String _nguoiSD)
                // {
                //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_RHM_CREATE", _maBA, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa,_tamthan_thankinh,_tuanhoan,_hohap, _tieuhoa,_da_moduoida, _co_xuong_khop,  _than_tietnieu_sinhduc,  _coQuanKhac, _tonThuong, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _ngaySD.DBValue, _nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
                // }
            }
        ...
        /// <summary>
        /// Delete the <see cref="BenhAn_RHM" />.
        /// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_RHM
            DataProvider.Instance().DeleteBenhAn_RHM(crit.MaMay, crit.NguoiSD, crit.maBA, crit.STT, crit.STTKhoa);
            // public abstract void DeleteBenhAn_RHM(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
            // public override void DeleteBenhAn_RHM(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_RHM_Deleted", _maBA, _sTT, _sTTKhoa);
            // }
        }
