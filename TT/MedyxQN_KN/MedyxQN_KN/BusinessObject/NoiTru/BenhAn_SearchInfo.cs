...
//
// Ten file        :	BenhAn_SearchInfo
// Kieu doi tuong  :	BenhAn_SearchInfo
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_SearchInfo" /> Business Object.
	/// </summary>
	
	[Serializable()]
    public partial class BenhAn_SearchInfo : BusinessBase<BenhAn_SearchInfo>
	{
        ...
        protected internal BenhAn_SearchInfo()
        {
            // Prevent direct creation
        }
        internal BenhAn_SearchInfo(int OrderNumber,
  String maDT,
  String hoten,
  String sothe,
  String maBV,
 ...
 // SmartDate ngayBANgoaiT,
  ...
  string tenbv,
   ...
   _giaTriTN = giatriTN;
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_SearchInfo" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
