...
//
// Ten file        :	BenhAn_SoKet
// Kieu doi tuong  :	BenhAn_SoKet
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_SoKet" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_SoKet : BusinessBase<BenhAn_SoKet>
	{
        ...
        private String _xetNghiem = String.Empty;
        private String _quaTrinh = String.Empty;
        private String _danhGia = String.Empty;
        ...
        public String XetNghiem
        {
            get
            {
                CanReadProperty("XetNghiem", true);
                return _xetNghiem;
            }
            set
            {
                CanWriteProperty("XetNghiem", true);
                if (_xetNghiem != value)
                {
                    _xetNghiem = value;
                    PropertyHasChanged("XetNghiem");
                }
            }
        }
        ...
        public String DanhGia
        {
            get
            {
                CanReadProperty("DanhGia", true);
                return _danhGia;
            }
            set
            {
                CanWriteProperty("DanhGia", true);
                if (_danhGia != value)
                {
                    _danhGia = value;
                    PropertyHasChanged("DanhGia");
                }
            }
        }
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_SoKet" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static BenhAn_SoKet NewBenhAn_SoKet()
        {
            return new BenhAn_SoKet();
        }
        internal static BenhAn_SoKet GetBenhAn_SoKet(SafeDataReader dr, int i)
        {
            return new BenhAn_SoKet(dr, i);
        }
        public BenhAn_SoKet()
        {
            MarkAsChild();
        }
        public static BenhAn_SoKet GetBenhAn_SoKet(String maBA, Int32 sTT, Int32 sTTKhoa)
        {
            return DataPortal.Fetch<BenhAn_SoKet>(new Criteria(maBA, sTT, sTTKhoa,false ));
        }
        public static BenhAn_SoKet GetBenhAn_SoKet(SafeDataReader dr)
        {
            BenhAn_SoKet obj = new BenhAn_SoKet();
            obj.Fetch(dr);
            return obj;
        }
		/// <summary>
		/// Marks the <see cref="BenhAn_SoKet" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteBenhAn_SoKet(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
        {
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_SoKet" /> Object based on data in the database.
		/// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            // public abstract IDataReader GetBenhAn_SoKet(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
            // public override IDataReader GetBenhAn_SoKet(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maBA, _sTT, _sTTKhoa));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_SoKet(crit.MaBA, crit.STT, crit.STTKhoa,crit.QAdmin )))
            {
                if (dr.Read())
                {
                    Fetch(dr);
		...
		/// <summary>
		/// Load a <see cref="BenhAn_SoKet" /> Object from given SafeDataReader.
		/// </summary>
        private void Fetch(SafeDataReader dr)
        {
            ...
            if (dr.GetString("XetNghiem") != null) _xetNghiem = dr.GetString("XetNghiem");
            if (dr.GetString("QuaTrinh") != null) _quaTrinh = dr.GetString("QuaTrinh");
            if (dr.GetString("DanhGia") != null) _danhGia = dr.GetString("DanhGia");
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_SoKet" /> Object to underlying database.
		/// </summary>
        /// 

        private BenhAn_SoKet(SafeDataReader dr, int i)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
        ...
        internal void Insert()
        {
            ...
            _maBA = DataProvider.Instance().InsertBenhAn_SoKet(_maBA, _sTT, _sTTKhoa, _maKhoa , _dienBien,_xetNghiem,_quaTrinh,_danhGia,_huongDT,_bsDieuTri , _ghiChu, _maMay , _nguoiSD ,_tuNgay ,_denNgay,_chanDoan );
			// public abstract String InsertBenhAn_SoKet(String _maBA, Int32 _sTT, Int32 _sTTKhoa, String _maCPMau, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, String _nguoiLap);
			// public override String InsertBenhAn_SoKet(String _maBA, Int32 _sTT, Int32 _sTTKhoa, String _maCPMau, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, String _nguoiLap)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_SoKet_Create", _maBA, _sTT, _sTTKhoa, _maCPMau, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue,_maMay ,   _nguoiLap);
			// }
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="BenhAn_SoKet" /> Object to underlying database.
		/// </summary>
        ...
        {
            DataProvider.Instance().DeleteBenhAn_SoKet(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa);
        }

		/// <summary>
		/// Delete the <see cref="BenhAn_SoKet" />.
		/// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_SoKet
        //    DataProvider.Instance().DeleteBenhAn_SoKet(crit.MaBA, crit.STT, crit.STTKhoa);
        //    // public abstract void DeleteBenhAn_SoKet(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
        //    // public override void DeleteBenhAn_SoKet(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_SoKet_Deleted", _maBA, _sTT, _sTTKhoa);
        //    // }
        //}
