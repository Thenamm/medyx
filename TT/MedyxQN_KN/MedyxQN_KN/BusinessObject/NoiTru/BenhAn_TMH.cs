...
namespace HTC.Business.NoiTru
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="BenhAn_TMH" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class BenhAn_TMH : BusinessBase<BenhAn_TMH>
    {
        ...
        /// <summary>
        /// Factory method. New <see cref="BenhAn_TMH" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static BenhAn_TMH NewBenhAn_TMH()
        {
            return DataPortal.Create<BenhAn_TMH>();
        }
        public static BenhAn_TMH GetBenhAn_TMH(String maBA, Int32 sTT, Int32 sTTKhoa)
        {
            return DataPortal.Fetch<BenhAn_TMH>(new Criteria(maBA, sTT, sTTKhoa));
        }

        /// <summary>
        /// Marks the <see cref="BenhAn_TMH" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteBenhAn_TMH(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
        {
        ...
        protected internal BenhAn_TMH()
        {
            // Prevent direct creation
        }

        internal BenhAn_TMH(int OrderNumber,
                                 String maBA,
                                 Int32 sTT,
                                 Int32 sTTKhoa,
                                 SmartDate ngayKham,
...
String CQDa,
        ...
        /// <summary>
        /// Retrieve an existing <see cref="BenhAn_TMH" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_TMH_GET", _maBA, _sTT, _sTTKhoa));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_TMH(crit.MaBA, crit.STT, crit.STTKhoa)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        /// <summary>
        /// Load a <see cref="BenhAn_TMH" /> Object from given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Insert the new <see cref="BenhAn_TMH" /> Object to underlying database.
        /// </summary>
        /// 
        ...
        protected override void DataPortal_Insert()
        {
            ...
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_TMH_CREATE", _maBA, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa,_tamthan_thankinh,_tuanhoan,_hohap, _tieuhoa,_da_moduoida, _co_xuong_khop,  _than_tietnieu_sinhduc,  _coQuanKhac, _tonThuong, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _ngaySD.DBValue, _nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
            // }
        }

        /// <summary>
        /// Update all changes made on <see cref="BenhAn_TMH" /> Object to underlying database.
        /// </summary>
        protected override void DataPortal_Update()
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_TMH
            if (IsDirty)
            {
                DataProvider.Instance().UpdateBenhAn_TMH(_maBA, _sTT, _sTTKhoa, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _CQTamThan, _CQTuanHoan, _CQHoHap, _CQTieuHoa, _CQDa, _CQCoXuongKhop, _CQTietNieuSD, _CoQuanKhac, _tonThuong, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
                // public abstract String UpdateBenhAn_TMH(String _maBA, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa,String _tamthan_thankinh, String _tuanhoan,String _hohap,String _tieuhoa,String _da_moduoida,String _co_xuong_khop, String _tietnieu_sinhduc,String _coQuanKhac, String _tonThuong, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _machuyenkhoa, String _maMay, String _nguoiSD);
                // public override String UpdateBenhAn_TMH(String _maBA, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa,String _tamthan_thankinh, String _tuanhoan,String _hohap,String _tieuhoa, String _da_moduoida, String _co_xuong_khop,String _tietnieu_sinhduc, String _coQuanKhac, String _tonThuong, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _machuyenkhoa, String _maMay, String _nguoiSD)
                // {
                //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_TMH_CREATE", _maBA, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa,_tamthan_thankinh,_tuanhoan,_hohap, _tieuhoa,_da_moduoida, _co_xuong_khop,  _than_tietnieu_sinhduc,  _coQuanKhac, _tonThuong, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _ngaySD.DBValue, _nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
                // }
            }
        ...
        /// <summary>
        /// Delete the <see cref="BenhAn_TMH" />.
        /// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_TMH
            DataProvider.Instance().DeleteBenhAn_TMH(crit.MaMay, crit.NguoiSD, crit.maBA, crit.STT, crit.STTKhoa);
            // public abstract void DeleteBenhAn_TMH(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
            // public override void DeleteBenhAn_TMH(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_TMH_Deleted", _maBA, _sTT, _sTTKhoa);
            // }
        }
