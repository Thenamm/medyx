...
//
// Ten file        :	BenhAn_VLTL
// Kieu doi tuong  :	BenhAn_VLTL
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_VLTL" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_VLTL : BusinessBase<BenhAn_VLTL>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_VLTL" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static BenhAn_VLTL NewBenhAn_VLTL()
        {
            return DataPortal.Create<BenhAn_VLTL>();
        }
		public static BenhAn_VLTL GetBenhAn_VLTL(String maBA, Int32 sTT, Int32 sTTKhoa)
		{
			return DataPortal.Fetch<BenhAn_VLTL>(new Criteria(maBA, sTT, sTTKhoa));
		}
		
		/// <summary>
		/// Marks the <see cref="BenhAn_VLTL" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteBenhAn_VLTL(String maBA, Int32 sTT, Int32 sTTKhoa, string mamay, string nguoihuy)
		{
		...
		protected internal BenhAn_VLTL()
		{	
			// Prevent direct creation
		}

        internal BenhAn_VLTL(     int OrderNumber,
                                 String maBA ,
		                         Int32 sTT ,
		                         Int32 sTTKhoa ,
		                         SmartDate ngayKham ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_VLTL" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_VLTL_GET", _maBA, _sTT, _sTTKhoa));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_VLTL(crit.MaBA, crit.STT, crit.STTKhoa)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="BenhAn_VLTL" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_VLTL" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertBenhAn_VLTL
			// Copy & paste ham duoi day vao file DataProvider.cs
            _maBA = DataProvider.Instance().InsertBenhAn_VLTL(_maBA, _sTTKhoa, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _nguoiSD);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_VLTL_CREATE", _maBA, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _ngaySD.DBValue, _nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="BenhAn_VLTL" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_VLTL
			if (IsDirty){
                DataProvider.Instance().UpdateBenhAn_VLTL(_maBA, _sTT, _sTTKhoa, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_VLTL_UPDATE", _maBA, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _machuyenkhoa, _maMay, _huy, _nguoiSD);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="BenhAn_VLTL" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_VLTL
            DataProvider.Instance().DeleteBenhAn_VLTL(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa);
			// public abstract void DeleteBenhAn_VLTL(String _maBA, Int32 _sTT, Int32 _sTTKhoa);
			// public override void DeleteBenhAn_VLTL(String _maBA, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhAn_VLTL_Deleted", _maBA, _sTT, _sTTKhoa);
			// }
		}
