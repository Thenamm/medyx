...
//
// Ten file        :	BenhAn_VTTH
// Kieu doi tuong  :	BenhAn_VTTH
// Kieu CSLA       :	EditableRoot
// Ngay tao        :	6/18/2009 11:01:47 AM
// Nguoi tao       :	HCABXT
//
// *****************************************************************************************************
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="BenhAn_VTTH" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class BenhAn_VTTH : BusinessBase<BenhAn_VTTH>
	{
        ...
        public string SoLuongD
        {
            get
            {
                ...
                else if (_SoLuongD - (int)(_SoLuongD) != 0  &&_quyDoi ==1)
                {
		...
		{
			return _sTT.ToString() + "!" + _maBA.ToString().ToString() + "!" + _sTTKhoa.ToString();
		}
		...
		/// <summary>
		/// Factory method. New <see cref="BenhAn_VTTH" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static BenhAn_VTTH NewBenhAn_VTTH()
        {
            return new BenhAn_VTTH();
        }
        internal static BenhAn_VTTH GetBenhAn_VTTH(SafeDataReader dr, int i)
        {
            return new BenhAn_VTTH(dr, i);
        }
        //public static BenhAn_VTTH GetBenhAn_VTTH(Int32 sTT, String maBA, Int32 sTTKhoa)
        //{
        //    return DataPortal.Fetch<BenhAn_VTTH>(new Criteria(sTT, maBA, sTTKhoa));
        //}
		
		/// <summary>
		/// Marks the <see cref="BenhAn_VTTH" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteBenhAn_VTTH(Int32 sTT, String maBA, Int32 sTTKhoa)
        //{
        //    DataPortal.Delete(new Criteria(sTT, maBA, sTTKhoa));
        //}
        public BenhAn_VTTH()
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="BenhAn_VTTH" /> Object based on data in the database.
		/// </summary>
        //protected void DataPortal_Fetch(Criteria crit)
        //{
        //    // public abstract IDataReader GetBenhAn_VTTH(Int32 _sTT, String _maBA, Int32 _sTTKhoa);
        //    // public override IDataReader GetBenhAn_VTTH(Int32 _sTT, String _maBA, Int32 _sTTKhoa)
        //    // {
        //    //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _sTT, _maBA, _sTTKhoa));
        //    // }
        //    using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhAn_VTTH(crit.STT, crit.MaBA, crit.STTKhoa)))
        //    {
        //        if (dr.Read()){
        //            Fetch(dr);
        //            MarkOld();
        ...
        //}
        ///// <summary>
        ///// Load a <see cref="BenhAn_VTTH" /> Object from given SafeDataReader.
        ///// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="BenhAn_VTTH" /> Object to underlying database.
		/// </summary>
        /// 

        private BenhAn_VTTH(SafeDataReader dr, int i)
        {
            MarkAsChild();
            // Value properties
            _OrderNumber = i;
        ...
        internal void Insert()
        {
            ...
            if (_sLKeDon > 0)
          _sTT =   DataProvider.Instance().InsertBenhAn_VTTH(_sTT, _maBA, _sTTKhoa, _maVT, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_MaPTTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP,_ngayD , _maMay ,_nguoiLap,  _TuNgay, _DenNgay, _maKhoa, _thuocpm, _thuocbx,_thuocdx,_maDT,_STTDT,_thuoctutruc  );
            // public abstract Int32 InsertBenhAn_VTTH(Int32 _sTT, String _maBA, Int32 _sTTKhoa, String _maVT, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _MaPTTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, String _nguoiLap);
            // public override Int32 InsertBenhAn_VTTH(Int32 _sTT, String _maBA, Int32 _sTTKhoa, String _maVT, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _MaPTTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, String _nguoiLap);
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier +"spBenhan_VTTH_Create", _sTT, _maBA, _sTTKhoa, _maVT, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue,_maMay ,   _nguoiLap );
			// }
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="BenhAn_VTTH" /> Object to underlying database.
		/// </summary>
		 internal void Update()
        {
            ...
            DataProvider.Instance().UpdateBenhAn_VTTH(_sTT, _maBA, _sTTKhoa, _maVT, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_MaPTTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD,_maMay ,   _huy,_nguoiSD   , _TuNgay, _DenNgay, _thuocpm, _thuocdx, _thuocbx,_thuoctutruc );
				// public abstract void UpdateBenhAn_VTTH(Int32 _sTT, String _maBA, Int32 _sTTKhoa, String _maVT, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _MaPTTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, String _nguoiSD);
				// public override void UpdateBenhAn_VTTH(Int32 _sTT, String _maBA, Int32 _sTTKhoa, String _maVT, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _MaPTTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, Decimal _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, String _nguoiSD)
				// {

            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhan_VTTH_Update", _sTT, _maBA, _sTTKhoa, _maVT, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue,_maMay ,   _huy, _ngayHuy.DBValue, _lyDoHuy, _ngayLap.DBValue,_nguoiSD   , _ngaySD.DBValue,false   ,_nguoiSD, _ngaySD1.DBValue, _nguoiSD1));
				// }				
                MarkOld();
		}
        ...
        {
            DataProvider.Instance().DeleteBenhAn_VTTH(crit.MaMay, crit.NguoiSD, crit.MaBA, crit.STT, crit.STTKhoa, crit.lydohuy);
        }

		/// <summary>
		/// Delete the <see cref="BenhAn_VTTH" />.
		/// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhAn_VTTH
        //    DataProvider.Instance().DeleteBenhAn_VTTH(crit.STT, crit.MaBA, crit.STTKhoa);
        //    // public abstract void DeleteBenhAn_VTTH(Int32 _sTT, String _maBA, Int32 _sTTKhoa);
        //    // public override void DeleteBenhAn_VTTH(Int32 _sTT, String _maBA, Int32 _sTTKhoa);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhan_VTTH_Deleted", _sTT, _maBA, _sTTKhoa);
        //    // }
        //}
