...
//
// Ten file        :	BenhNhan_TienSu_San
// Kieu doi tuong  :	BenhNhan_TienSu_San
...
namespace HTC.Business.NoiTru
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="BenhNhan_TienSu_San" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class BenhNhan_TienSu_San : BusinessBase<BenhNhan_TienSu_San>
    {
        ...
        BenhNhan_TienSu_San_CList _BenhNhan_TienSu_San_CList = BenhNhan_TienSu_San_CList.NewBenhNhan_TienSu_San_CList();

        public BenhNhan_TienSu_San_CList BenhNhan_TienSu_San_CList
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                //CanReadProperty(true);
                return _BenhNhan_TienSu_San_CList;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                //CanWriteProperty(true);
                if (!_BenhNhan_TienSu_San_CList.Equals(value))
                {
                    _BenhNhan_TienSu_San_CList = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _BenhNhan_TienSu_San_CList.IsDirty;
            }
        }
        ...
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _BenhNhan_TienSu_San_CList.IsValid;
            }
        }
        #endregion
        #endregion
        ...
        /// <summary>
        /// Factory method. New <see cref="BenhNhan_TienSu_San" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 
        public static BenhNhan_TienSu_San NewBenhNhan_TienSu_San()
        {
            return DataPortal.Create<BenhNhan_TienSu_San>();
        }
        public static BenhNhan_TienSu_San GetBenhNhan_TienSu_San(String maBN)
        {
            return DataPortal.Fetch<BenhNhan_TienSu_San>(new Criteria(maBN));
        }
        public static BenhNhan_TienSu_San GetBenhNhan_TienSu_San(SafeDataReader dr)
        {
            BenhNhan_TienSu_San obj = new BenhNhan_TienSu_San();
            obj.Fetch(dr);
            return obj;
        }
        public static BenhNhan_TienSu_San GetBenhNhan_TienSu_San(SafeDataReader dr, int i)
        {
            return new BenhNhan_TienSu_San(dr, i);

        }
        /// <summary>
        /// Marks the <see cref="BenhNhan_TienSu_San" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteBenhNhan_TienSu_San(String maBN, string mamay, string nguoihuy)
        {
        ...
        protected internal BenhNhan_TienSu_San()
        {
            // Prevent direct creation
        }
        internal BenhNhan_TienSu_San(
                            int OrderNumber,
                            String maBN,
                         Boolean tSGDSinhdoi,
                         Boolean tSGDDidang,
        ...
        protected BenhNhan_TienSu_San(SafeDataReader dr, int i)
        {
            MarkAsChild();
            ...
            if (dr.NextResult())
                ...
                _BenhNhan_TienSu_San_CList = BenhNhan_TienSu_San_CList.GetBenhNhan_TienSu_San_CList(dr);
            MarkOld();
        }
        #endregion
        ...
        /// <summary>
        /// Retrieve an existing <see cref="BenhNhan_TienSu_San" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhNhan_TienSu_San_GET", _maBN));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetBenhNhan_TienSu_San(crit.MaBN)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        /// <summary>
        /// Load a <see cref="BenhNhan_TienSu_San" /> Object from given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Insert the new <see cref="BenhNhan_TienSu_San" /> Object to underlying database.
        /// </summary>
        /// 
        ...
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertBenhNhan_TienSu_San
            // Copy & paste ham duoi day vao file DataProvider.cs
            
              
            _maBN = DataProvider.Instance().InsertBenhNhan_TienSu_San(_maBN, _tSGDSinhdoi, _tSGDDidang, _tSGDBenhditruyen, _tSGDDaiduong, _tSGDCaoHA, _tSGDKhac, _tSBTCaoHA, _tSBTBenhTim, _tSBTLaoPhoi, _tSBTHenphequan, _tSBTBenhthan, _tSBTBasedow, _tSBTViemtacTM, _tSBTDongkinh, _tSBTMoRuotthua,_diungthuoc, _pTObung, _tuoiCokinh, _chukyKinh, _songayKinh, _tuoiLaychong, _benhphukhoa, _khoiUBT, _uxoTC, _didangSD, _sSD, _tSM, _dieuTriCTC, _catcutCTC, _phauthuatKhac, _pARA, _tSBTKhac, _solancothai, _solansaythai, _solannaothai, _solande, _cachde, _soconsong, _maMay, _nguoiSD , _cuthe);
        ...
        /// <summary>
        /// Delete the <see cref="BenhNhan_TienSu_San" />.
        /// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateBenhNhan_TienSu_San
            DataProvider.Instance().DeleteBenhNhan_TienSu_San(crit.MaMay, crit.NguoiSD, crit.MaBN);
            // public abstract void DeleteBenhNhan_TienSu_San(String _maBN);
            // public override void DeleteBenhNhan_TienSu_San(String _maBN);
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spBenhNhan_TienSu_San_Deleted", _maBN);
            // }
        }
