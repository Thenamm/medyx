...
//
// Ten file        :	KhamBenh_HoaChat
// Kieu doi tuong  :	KhamBenh_HoaChat
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="KhamBenh_HoaChat" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class KhamBenh_HoaChat : BusinessBase<KhamBenh_HoaChat>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="KhamBenh_HoaChat" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static KhamBenh_HoaChat NewKhamBenh_HoaChat()
        {
            return new KhamBenh_HoaChat();
        }
        public static KhamBenh_HoaChat NewKhamBenh_HoaChat(string idCPMau)
        {
            return new KhamBenh_HoaChat(DMHoaChat.GetDMHoaChat(idCPMau));
        }
        public static KhamBenh_HoaChat NewKhamBenh_HoaChat(DMHoaChat _DMHoaChat)
        {
            return new KhamBenh_HoaChat(_DMHoaChat);
        }
		public static KhamBenh_HoaChat GetKhamBenh_HoaChat(String maSoKham, Int32 sTT,string lydohuy)
		{
			return DataPortal.Fetch<KhamBenh_HoaChat>(new Criteria(maSoKham, sTT,lydohuy ));
		}
        public static KhamBenh_HoaChat GetKhamBenh_HoaChat(SafeDataReader dr)
        {
            return new KhamBenh_HoaChat(dr);
        }
		/// <summary>
		/// Marks the <see cref="KhamBenh_HoaChat" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
		public static void DeleteKhamBenh_HoaChat(String maSoKham, Int32 sTT,string lydohuy)
		{
		...
		protected internal KhamBenh_HoaChat()
		...
		protected KhamBenh_HoaChat(DMHoaChat  pro)
        {
            MarkAsChild();
       ...
       //     _tenDV = pro.TenDV;
        ...
        protected KhamBenh_HoaChat(string maSoKham,DMHoaChat  pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_HoaChat(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="KhamBenh_HoaChat" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetKhamBenh_HoaChat(String _maSoKham, Int32 _sTT);
			// public override IDataReader GetKhamBenh_HoaChat(String _maSoKham, Int32 _sTT)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maSoKham, _sTT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetKhamBenh_HoaChat(crit.MaSoKham, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="KhamBenh_HoaChat" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="KhamBenh_HoaChat" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Insert()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_HoaChat
			// Copy & paste ham duoi day vao file DataProvider.cs
             if (_sLMua != 0)

                 _maSoKham = DataProvider.Instance().InsertKhamBenh_HoaChat(_maSoKham, _sTT, _MaHC, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay, _nguoiSD , _makhoa, _dadung, _daTTTT, _ngayTToanTT, _daTTBH, _ngayTToanBH, _noiTTTT, _noiTTBH, _nguoiTTTT, _nguoiTTBH,_maDT);
             MarkOld();
			// public abstract String CriteriaOther(mamay,nguoihuy , _HoaChat(String _maSoKham, Int32 _sTT, String _MaHC, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, String _soHD, String _soSoHD, Int32 _sophieu, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhTien, Byte _dATT, Boolean _tToanSau, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, String _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, SmartDate _ngayHuy, String _lyDoHuy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngaySD, String _nguoiSD, String _nguoiHuy, SmartDate _ngaySD1, String _nguoiSD1);
			// public override String CriteriaOther(mamay,nguoihuy , _HoaChat(String _maSoKham, Int32 _sTT, String _MaHC, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, String _soHD, String _soSoHD, Int32 _sophieu, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhTien, Byte _dATT, Boolean _tToanSau, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, String _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, SmartDate _ngayHuy, String _lyDoHuy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngaySD, String _nguoiSD, String _nguoiHuy, SmartDate _ngaySD1, String _nguoiSD1);
			// {
			//		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maSoKham, _sTT, _MaHC, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue, _maMay, _huy, _ngayHuy.DBValue, _lyDoHuy, _ngayLap.DBValue, _nguoiSD , _ngaySD.DBValue, _nguoiSD , _nguoiSD  , _ngaySD1.DBValue, _nguoiSD1), String);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="KhamBenh_HoaChat" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_HoaChat
			if (IsDirty){
                DataProvider.Instance().UpdateKhamBenh_HoaChat(_maSoKham, _sTT, _MaHC, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay, _huy, _nguoiSD , _soHDTra, _soSoHDTra, _makhoa, _dadung, _daTTTT, _ngayTToanTT, _daTTBH, _ngayTToanBH, _noiTTTT, _noiTTBH, _nguoiTTTT, _nguoiTTBH,_maDT,1);
				...
				// {
				//		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maSoKham, _sTT, _MaHC, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue, _maMay, _huy, _ngayHuy.DBValue, _lyDoHuy, _ngayLap.DBValue, _nguoiSD , _ngaySD.DBValue, _nguoiSD , _nguoiSD  , _ngaySD1.DBValue, _nguoiSD1);
				// }	
                MarkOld();
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="KhamBenh_HoaChat" />.
		/// </summary>
		protected void DataPortal_Delete(Criteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_HoaChat
			DataProvider.Instance().DeleteKhamBenh_HoaChat(crit.NguoiSD,crit.NguoiSD ,crit.MaSoKham, crit.STT,crit.LydoHuy   );
			// public abstract void DeleteKhamBenh_HoaChat(String _maSoKham, Int32 _sTT);
			// public override void DeleteKhamBenh_HoaChat(String _maSoKham, Int32 _sTT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_HoaChat_Deleted", _maSoKham, _sTT);
			// }
		}
        internal virtual void Update(KhamBenh bill)
        {
            ...
            if (IsDirty)
            {
                ...
                DataProvider.Instance().UpdateKhamBenh_HoaChat(bill.MaSoKham, _sTT, _MaHC, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay, _huy, _nguoiSD , _soHDTra, _soSoHDTra, _makhoa, _dadung, _daTTTT, _ngayTToanTT, _daTTBH, _ngayTToanBH, _noiTTTT, _noiTTBH, _nguoiTTTT, _nguoiTTBH,bill.MaDT,bill.loai );
        ...
        internal virtual void Insert(KhamBenh bill)
        {
            ...
            if (IsDirty)
            {
                ...
                _maSoKham = DataProvider.Instance().InsertKhamBenh_HoaChat(bill.MaSoKham, _sTT, _MaHC, bill.MaBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay, _nguoiSD , _makhoa, _dadung, _daTTTT, _ngayTToanTT, _daTTBH, _ngayTToanBH, _noiTTTT, _noiTTBH, _nguoiTTTT, _nguoiTTBH,bill.MaDT);
        ...
        internal void DeleteSelf(KhamBenh bill)
        {
            ...
            DataProvider.Instance().DeleteKhamBenh_HoaChat(_maMay, _nguoiSD , bill.MaSoKham, _sTT, _lyDoHuy);
            MarkNew();
        }
