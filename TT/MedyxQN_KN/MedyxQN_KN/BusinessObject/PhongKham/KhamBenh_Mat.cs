...
//
// Ten file        :	KhamBenh_Mat
// Kieu doi tuong  :	KhamBenh_Mat
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="KhamBenh_Mat" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class KhamBenh_Mat : BusinessBase<KhamBenh_Mat>
	{
        ...
        private String _moTaBenhLy = String.Empty;
        ...
        public String MoTaBenhLy
        {
            get
            {
                CanReadProperty("MoTaBenhLy", true);
                return _moTaBenhLy;
            }
            set
            {
                CanWriteProperty("MoTaBenhLy", true);
                if (_moTaBenhLy != value)
                {
                    _moTaBenhLy = value;
                    PropertyHasChanged("MoTaBenhLy");
                }
            }
        }
        ...
        /// <summary>
        /// Factory method. New <see cref="KhamBenh_Mat" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 

        public static KhamBenh_Mat NewKhamBenh_Mat()
        {
            return new KhamBenh_Mat();
            //return DataPortal.Create<DMDichVu_PhieuIn_C>();
        }
        public static KhamBenh_Mat NewKhamBenh_Mat(string idDMDichvu)
        {
            return new KhamBenh_Mat(DMDichVu.GetDMDichVu(idDMDichvu));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static KhamBenh_Mat NewKhamBenh_Mat(DMDichVu _DMDichvu)
        {
            return new KhamBenh_Mat(_DMDichvu);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static KhamBenh_Mat NewKhamBenh_Mat(string masokham, Int32 stt, string idDMDichvu)
        {
            return new KhamBenh_Mat(masokham, stt, idDMDichvu);
        }

        public static KhamBenh_Mat GetKhamBenh_Mat(String maSoKham, Int32 sTT)
        {
            return DataPortal.Fetch<KhamBenh_Mat>(new Criteria(maSoKham, sTT));
        }

        public static KhamBenh_Mat GetKhamBenh_Mat(SafeDataReader dr)
        {
            return new KhamBenh_Mat(dr);
        }

        /// <summary>
        /// Marks the <see cref="KhamBenh_Mat" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteKhamBenh_Mat(String maSoKham, Int32 sTT, string mamay, string nguoihuy)
        {
		...
		protected internal KhamBenh_Mat()
		{	
			// Prevent direct creation
		}
		
        protected KhamBenh_Mat(DMDichVu pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_Mat(string maSoKham,DMDichVu pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_Mat(string masokham, Int32 stt, string idDMDichvu)
        {
            MarkAsChild();
        ...
        protected KhamBenh_Mat(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="KhamBenh_Mat" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{

            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetKhamBenh_Mat(crit.MaSoKham, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="KhamBenh_Mat" /> Object from given SafeDataReader.
		/// </summary>
        private void Fetch(SafeDataReader dr)
		{
            ...
            if (dr.GetString("MoTaBenhLy") != null) _moTaBenhLy = dr.GetString("MoTaBenhLy");
		...
		/// <summary>
		/// Insert the new <see cref="KhamBenh_Mat" /> Object to underlying database.
		/// </summary>
        /// 
		...
		protected override void DataPortal_Update()
		{
			...
			if (IsDirty){
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_Mat_UPDATE", _MaSoKham, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _thiLucVV, _khongKinhMP, _khongKinhMT, _coKinhMP, _coKinhMT, _nhanAPMP, _nhanApMT, _thiTruongMP, _thiTruongMT, _moTaBenhLy, _tonThuong, _coQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _nguoiSD );
				// }
                MarkOld();
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="KhamBenh_Mat" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_Mat
            DataProvider.Instance().DeleteKhamBenh_Mat (crit.MaMay, crit.NguoiSD, crit.MaSoKham, crit.STT);
			// public abstract void DeleteKhamBenh_Mat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
			// public override void DeleteKhamBenh_Mat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_Mat_Deleted", _MaSoKham, _sTT, _sTTKhoa);
			// }
		}
        ...
        internal virtual void Insert(KhamBenh_C obj)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_Mat
            // Copy & paste ham duoi day vao file DataProvider.cs
            _MaSoKham = DataProvider.Instance().InsertKhamBenh_Mat(obj.MaSoKham, obj.STT, obj.MaDV, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _thiLucVV, _khongKinhMP, _khongKinhMT, _coKinhMP, _coKinhMT, _nhanAPMP, _nhanApMT, _thiTruongMP, _thiTruongMT, _moTaBenhLy, _tonThuong, _coQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV, _maMay , _nguoiSD);
            MarkOld();  // public abstract String InsertKhamBenh_Mat(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _thiLucVV, String _khongKinhMP, String _khongKinhMT, String _coKinhMP, String _coKinhMT, String _nhanAPMP, String _nhanApMT, String _thiTruongMP, String _thiTruongMT, String _moTaBenhLy, String _tonThuong, String _coQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD);
            // public override String InsertKhamBenh_Mat(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _thiLucVV, String _khongKinhMP, String _khongKinhMT, String _coKinhMP, String _coKinhMT, String _nhanAPMP, String _nhanApMT, String _thiTruongMP, String _thiTruongMT, String _moTaBenhLy, String _tonThuong, String _coQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD)
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_Mat_CREATE", _MaSoKham, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _thiLucVV, _khongKinhMP, _khongKinhMT, _coKinhMP, _coKinhMT, _nhanAPMP, _nhanApMT, _thiTruongMP, _thiTruongMT, _moTaBenhLy, _tonThuong, _coQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _ngaySD.DBValue,_nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
       ...
       internal virtual void Update(KhamBenh_C obj)
        {
            ...
            if (IsDirty)
            {
                DataProvider.Instance().UpdateKhamBenh_Mat(obj.MaSoKham, obj.STT, obj.MaDV, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _thiLucVV, _khongKinhMP, _khongKinhMT, _coKinhMP, _coKinhMT, _nhanAPMP, _nhanApMT, _thiTruongMP, _thiTruongMT, _moTaBenhLy, _tonThuong, _coQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV, _maMay , _huy, _nguoiSD);
                // public abstract void UpdateKhamBenh_Mat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _thiLucVV, String _khongKinhMP, String _khongKinhMT, String _coKinhMP, String _coKinhMT, String _nhanAPMP, String _nhanApMT, String _thiTruongMP, String _thiTruongMT, String _moTaBenhLy, String _tonThuong, String _coQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, Boolean _huy, String _nguoiSD);
                // public override void UpdateKhamBenh_Mat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _thiLucVV, String _khongKinhMP, String _khongKinhMT, String _coKinhMP, String _coKinhMT, String _nhanAPMP, String _nhanApMT, String _thiTruongMP, String _thiTruongMT, String _moTaBenhLy, String _tonThuong, String _coQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, Boolean _huy, String _nguoiSD)
                // {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_Mat_UPDATE", _MaSoKham, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _thiLucVV, _khongKinhMP, _khongKinhMT, _coKinhMP, _coKinhMT, _nhanAPMP, _nhanApMT, _thiTruongMP, _thiTruongMT, _moTaBenhLy, _tonThuong, _coQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _nguoiSD );
        ...
        internal void DeleteSelf(KhamBenh_C obj)
        {
            ...
            DataProvider.Instance().DeleteKhamBenh_Mat(_maMay, _nguoiSD , obj.MaSoKham, _sTT);
            MarkNew();
        }
		#endregion
	}
