...
//
// Ten file        :	KhamBenh_TamThan
// Kieu doi tuong  :	KhamBenh_TamThan
...
{	
	...
	[Serializable()]
	public partial class KhamBenh_TamThan : BusinessBase<KhamBenh_TamThan>
	{
        ...
        private String _TamThan = String.Empty;
		...
		public String TamThan
		{
			get 
			{
				CanReadProperty("TamThan", true);
				return _TamThan;
			}
			set 
			{
				CanWriteProperty("TamThan", true);
				if (_TamThan != value) 
				{
					_TamThan = value;
					PropertyHasChanged("TamThan");
				}
			}
		}
        ...
        /// <summary>
        /// Factory method. New <see cref="KhamBenh_TamThan" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 

        public static KhamBenh_TamThan NewKhamBenh_TamThan()
        {
            return new KhamBenh_TamThan();
            //return DataPortal.Create<DMDichVu_PhieuIn_C>();
        }
        public static KhamBenh_TamThan NewKhamBenh_TamThan(string idDMDichvu)
        {
            return new KhamBenh_TamThan(DMDichVu.GetDMDichVu(idDMDichvu));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static KhamBenh_TamThan NewKhamBenh_TamThan(DMDichVu _DMDichvu)
        {
            return new KhamBenh_TamThan(_DMDichvu);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static KhamBenh_TamThan NewKhamBenh_TamThan(string masokham, Int32 stt, string idDMDichvu)
        {
            return new KhamBenh_TamThan(masokham, stt, idDMDichvu);
        }

        public static KhamBenh_TamThan GetKhamBenh_TamThan(String maSoKham, Int32 sTT)
        {
            return DataPortal.Fetch<KhamBenh_TamThan>(new Criteria(maSoKham, sTT));
        }

        public static KhamBenh_TamThan GetKhamBenh_TamThan(SafeDataReader dr)
        {
            return new KhamBenh_TamThan(dr);
        }

        /// <summary>
        /// Marks the <see cref="KhamBenh_TamThan" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteKhamBenh_TamThan(String maSoKham, Int32 sTT, string mamay, string nguoihuy)
        {
		...
		protected internal KhamBenh_TamThan()
		{	
			// Prevent direct creation
		}
		
        protected KhamBenh_TamThan(DMDichVu pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_TamThan(string maSoKham,DMDichVu pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_TamThan(string masokham, Int32 stt, string idDMDichvu)
        {
            MarkAsChild();
        ...
        protected KhamBenh_TamThan(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="KhamBenh_TamThan" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetKhamBenh_TamThan(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
			// public override IDataReader GetKhamBenh_TamThan(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TamThan_GET", _MaSoKham, _sTT, _sTTKhoa));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetKhamBenh_TamThan(crit.MaSoKham, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="KhamBenh_TamThan" /> Object from given SafeDataReader.
		/// </summary>
		private void Fetch(SafeDataReader dr)
		{
            ...
            if (dr.GetString("TamThan") != null) _TamThan = dr.GetString("TamThan");
		...
		/// <summary>
		/// Insert the new <see cref="KhamBenh_TamThan" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_TamThan
			// Copy & paste ham duoi day vao file DataProvider.cs
            _MaSoKham = DataProvider.Instance().InsertKhamBenh_TamThan(_MaSoKham,_sTT,_maDV,  _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _ThanKinh, _TamThan, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _nguoiSD);
            MarkOld(); // public abstract String InsertKhamBenh_TamThan(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _ThanKinh, String _TamThan, String _CoQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD);
            // public override String InsertKhamBenh_TamThan(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _ThanKinh, String _TamThan, String _CoQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TamThan_CREATE", _MaSoKham, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _ThanKinh, _TamThan, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _ngaySD.DBValue,_nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="KhamBenh_TamThan" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_TamThan
			if (IsDirty){
                DataProvider.Instance().UpdateKhamBenh_TamThan(_MaSoKham, _sTT,_maDV,  _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _ThanKinh, _TamThan, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _nguoiSD );
                // public abstract void UpdateKhamBenh_TamThan(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _ThanKinh, String _TamThan, String _CoQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, Boolean _huy, String _nguoiSD);
                // public override void UpdateKhamBenh_TamThan(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _ThanKinh, String _TamThan, String _CoQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, Boolean _huy, String _nguoiSD)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TamThan_UPDATE", _MaSoKham, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _ThanKinh, _TamThan, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _nguoiSD );
				// }
                MarkOld();
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="KhamBenh_TamThan" />.
		/// </summary>
        /// 
        internal virtual void Insert(KhamBenh_C obj)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_TamThan
            // Copy & paste ham duoi day vao file DataProvider.cs
            _MaSoKham = DataProvider.Instance().InsertKhamBenh_TamThan(obj.MaSoKham,obj.STT,obj.MaDV, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _ThanKinh, _TamThan, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV, _maMay , _nguoiSD );
            MarkOld();// public abstract String InsertKhamBenh_TamThan(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _ThanKinh, String _TamThan, String _CoQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD);
            // public override String InsertKhamBenh_TamThan(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _ThanKinh, String _TamThan, String _CoQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD)
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TamThan_CREATE", _MaSoKham, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _ThanKinh, _TamThan, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _ngaySD.DBValue,_nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
       ...
       internal virtual void Update(KhamBenh_C obj)
        {
            ...
            if (IsDirty)
            {
                DataProvider.Instance().UpdateKhamBenh_TamThan(obj.MaSoKham, obj.STT,obj.MaDV, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _ThanKinh, _TamThan, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV, _maMay , _huy, _nguoiSD );
                // public abstract void UpdateKhamBenh_TamThan(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _ThanKinh, String _TamThan, String _CoQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, Boolean _huy, String _nguoiSD);
                // public override void UpdateKhamBenh_TamThan(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _ThanKinh, String _TamThan, String _CoQuanKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, Boolean _huy, String _nguoiSD)
                // {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TamThan_UPDATE", _MaSoKham, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _ThanKinh, _TamThan, _CoQuanKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _nguoiSD );
        ...
        internal void DeleteSelf(KhamBenh_C obj)
        {
            ...
            DataProvider.Instance().DeleteKhamBenh_TamThan(_maMay, _nguoiSD , obj.MaSoKham, _sTT);
            MarkNew();
        }
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_TamThan
            DataProvider.Instance().DeleteKhamBenh_TamThan(crit.MaMay, crit.NguoiSD, crit.MaSoKham, crit.STT);
			// public abstract void DeleteKhamBenh_TamThan(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
			// public override void DeleteKhamBenh_TamThan(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TamThan_Deleted", _MaSoKham, _sTT, _sTTKhoa);
			// }
		}
