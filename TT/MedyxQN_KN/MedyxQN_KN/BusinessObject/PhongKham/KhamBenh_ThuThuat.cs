...
//
// Ten file        :	KhamBenh_ThuThuat
// Kieu doi tuong  :	KhamBenh_ThuThuat
...
namespace HTC.Business.PhongKham
{
    ...
    /// <summary>
    /// This is a base generated class of <see cref="KhamBenh_ThuThuat" /> Business Object.
    /// </summary>

    [Serializable()]
    public partial class KhamBenh_ThuThuat : BusinessBase<KhamBenh_ThuThuat>
    {
        ...
        /// <summary>
        /// Factory method. New <see cref="KhamBenh_ThuThuat" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 

        public static KhamBenh_ThuThuat NewKhamBenh_ThuThuat()
        {
            return DataPortal.Create<KhamBenh_ThuThuat>();
        }
        //public static KhamBenh_ThuThuat NewKhamBenh_ThuThuat(string idDMPhauthuat)
        //{
        //    return new KhamBenh_ThuThuat(DMPhauThuat.GetDMPhauThuat(idDMPhauthuat));
        //}
        public static KhamBenh_ThuThuat GetKhamBenh_ThuThuat(String MaSoKham, Int32 sTT)
        {
            return DataPortal.Fetch<KhamBenh_ThuThuat>(new Criteria(MaSoKham, sTT));
        }
        public static KhamBenh_ThuThuat GetKhamBenh_ThuThuat(SafeDataReader dr)
        {
            KhamBenh_ThuThuat obj = new KhamBenh_ThuThuat();
            obj.Fetch(dr);
            return obj;
        }
        /// <summary>
        /// Marks the <see cref="KhamBenh_ThuThuat" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteKhamBenh_ThuThuat(String MaSoKham, Int32 sTT, string lydohuy, string mamay, string nguoihuy)
        {
        ...
        protected internal KhamBenh_ThuThuat()
        {

        }

        internal KhamBenh_ThuThuat(
  int OrderNumber,
  String MaSoKham,
                                         Int32 sTT,
 ...
 string noidung, string cachgayme, string pphauthuat, string maloaipt, string tenloaipt,
        ...
        // protected KhamBenh_ThuThuat(DMPhauThuat pro)
        // {
        //     MarkAsChild();
        ...
        /// <summary>
        /// Retrieve an existing <see cref="KhamBenh_ThuThuat" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            // public abstract IDataReader GetKhamBenh_ThuThuat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
            // public override IDataReader GetKhamBenh_ThuThuat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa)
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_ThuThuat_GET", _MaSoKham, _sTT, _sTTKhoa));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetKhamBenh_ThuThuat(crit.MaSoKham, crit.STT)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        /// <summary>
        /// Load a <see cref="KhamBenh_ThuThuat" /> Object from given SafeDataReader.
        /// </summary>
        private void Fetch(SafeDataReader dr)
        {
            ...
            if (dr.GetByte("HTThuThuat") != null) _hTPhauThuat = dr.GetByte("HTThuThuat");
            ...
            if (dr.GetString("ppThuThuat") != null) _ppphauthuat = dr.GetString("ppThuThuat");
        ...
        /// <summary>
        /// Insert the new <see cref="KhamBenh_ThuThuat" /> Object to underlying database.
        /// </summary>
        /// 
        ...
        /// <summary>
        /// Update all changes made on <see cref="KhamBenh_ThuThuat" /> Object to underlying database.
        /// </summary>
        protected override void DataPortal_Update()
        {
            ...
            if (IsDirty)
            {
                ...
                DataProvider.Instance().UpdateKhamBenh_ThuThuat(_MaSoKham, _sTT,  _maPT, _maBN, _NgayTH, _cDTruocMo, _cDSauMo, _maGPBenh, _hTPhauThuat, _taibienPT, _maMay, _huy, _nguoiSD, _maChungLoai, _malh, _ptvien, _ptvienc, _ptvien1, _ptvien2, _gayme, _gaymec, _gayme1, _gayme2, _cec, _cecc, _cec1, _cec2, _dungcu, _dungcuc, _dungcu1, _dungcu2, _loai, _cachgayme, _ppphauthuat, _maloaiPT, _tenBenhCDTruocMo, _tenBenhCDSauMo, _noiDung);
                // public abstract void UpdateKhamBenh_ThuThuat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, String _maPT, String _maBN, SmartDate _NgayTH, Boolean _daThucHien, Decimal _sLYCau, Decimal _sLMua, Decimal _dongiaTT, Decimal _dongiaUSD, Decimal _tyGia, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, String _cDTruocMo, String _cDSauMo, String _maGPBenh, Byte _hTPhauThuat, Boolean _taibienPT, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _nguoiTT, SmartDate _ngayTToan, Boolean _aDGIAUSD, String _maMay, Boolean _huy, String _nguoiSD);
                // public override void UpdateKhamBenh_ThuThuat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, String _maPT, String _maBN, SmartDate _NgayTH, Boolean _daThucHien, Decimal _sLYCau, Decimal _sLMua, Decimal _dongiaTT, Decimal _dongiaUSD, Decimal _tyGia, Decimal _donGiaBH, Decimal _giaChenhLech, Decimal _ck, String _bSChiDinh, String _cDTruocMo, String _cDSauMo, String _maGPBenh, Byte _hTPhauThuat, Boolean _taibienPT, Boolean _tinhtien, Boolean _bHTinhtien, Boolean _tinhNgoai, Byte _dATT, String _nguoiTT, SmartDate _ngayTToan, Boolean _aDGIAUSD, String _maMay, Boolean _huy, String _nguoiSD)
                // {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_ThuThuat_Update", _MaSoKham, _sTT, _sTTKhoa, _maPT, _maBN, _NgayTH.DBValue, _daThucHien, _sLYCau, _sLMua, _dongiaTT, _dongiaUSD, _tyGia, _donGiaBH, _giaChenhLech, _ck, _bSChiDinh, _cDTruocMo, _cDSauMo, _maGPBenh, _hTPhauThuat, _taibienPT, _tinhtien, _bHTinhtien, _tinhNgoai, _dATT,_nguoiSD, _ngayTToan.DBValue, _aDGIAUSD,_maMay ,   _huy, _nguoiSD);
                // }			
        ...
        /// <summary>
        /// Delete the <see cref="KhamBenh_ThuThuat" />.
        /// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_ThuThuat
            DataProvider.Instance().DeleteKhamBenh_ThuThuat(crit.MaMay, crit.NguoiSD, crit.MaSoKham, crit.STT,  crit.lydohuy);
            // public abstract void DeleteKhamBenh_ThuThuat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
            // public override void DeleteKhamBenh_ThuThuat(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_ThuThuat_Deleted", _MaSoKham, _sTT, _sTTKhoa);
            // }
        }
        ...
        //    DataProvider.Instance().DeleteKhamBenh_ThuThuat(_maMay,_nguoiSD, obj.MaSoKham, _sTT, _sTTKhoa, _lyDoHuy);
        //    MarkNew();
        //}
        #endregion
    }
