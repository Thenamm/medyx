...
//
// Ten file        :	KhamBenh_TruyenNhiem
// Kieu doi tuong  :	KhamBenh_TruyenNhiem
...
namespace HTC.Business.PhongKham
{
    ...
    [Serializable()]
    public partial class KhamBenh_TruyenNhiem : BusinessBase<KhamBenh_TruyenNhiem>
    {
        ...
        private String _DichTe = String.Empty;
        ...
        public String DichTe
        {
            get
            {
                CanReadProperty("DichTe", true);
                return _DichTe;
            }
            set
            {
                CanWriteProperty("DichTe", true);
                if (_DichTe != value)
                {
                    _DichTe = value;
                    PropertyHasChanged("DichTe");
                }
            }
        }
        ...
        /// <summary>
        /// Factory method. New <see cref="KhamBenh_TruyenNhiem" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 

        public static KhamBenh_TruyenNhiem NewKhamBenh_TruyenNhiem()
        {
            return new KhamBenh_TruyenNhiem();
            //return DataPortal.Create<DMDichVu_PhieuIn_C>();
        }
        public static KhamBenh_TruyenNhiem NewKhamBenh_TruyenNhiem(string idDMDichvu)
        {
            return new KhamBenh_TruyenNhiem(DMDichVu.GetDMDichVu(idDMDichvu));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static KhamBenh_TruyenNhiem NewKhamBenh_TruyenNhiem(DMDichVu _DMDichvu)
        {
            return new KhamBenh_TruyenNhiem(_DMDichvu);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static KhamBenh_TruyenNhiem NewKhamBenh_TruyenNhiem(string masokham, Int32 stt, string idDMDichvu)
        {
            return new KhamBenh_TruyenNhiem(masokham, stt, idDMDichvu);
        }

        public static KhamBenh_TruyenNhiem GetKhamBenh_TruyenNhiem(String maSoKham, Int32 sTT)
        {
            return DataPortal.Fetch<KhamBenh_TruyenNhiem>(new Criteria(maSoKham, sTT));
        }

        public static KhamBenh_TruyenNhiem GetKhamBenh_TruyenNhiem(SafeDataReader dr)
        {
            return new KhamBenh_TruyenNhiem(dr);
        }

        /// <summary>
        /// Marks the <see cref="KhamBenh_TruyenNhiem" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteKhamBenh_TruyenNhiem(String maSoKham, Int32 sTT, string mamay, string nguoihuy)
        {
        ...
        protected internal KhamBenh_TruyenNhiem()
        {
            // Prevent direct creation
        }

        protected KhamBenh_TruyenNhiem(DMDichVu pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_TruyenNhiem(string maSoKham, DMDichVu pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_TruyenNhiem(string masokham, Int32 stt, string idDMDichvu)
        {
            MarkAsChild();
        ...
        protected KhamBenh_TruyenNhiem(SafeDataReader dr)
        {
            MarkAsChild();
        ...
        /// <summary>
        /// Retrieve an existing <see cref="KhamBenh_TruyenNhiem" /> Object based on data in the database.
        /// </summary>
        protected void DataPortal_Fetch(Criteria crit)
        {
            // public abstract IDataReader GetKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
            // public override IDataReader GetKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa)
            // {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TruyenNhiem_GET", _MaSoKham, _sTT, _sTTKhoa));
            // }
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetKhamBenh_TruyenNhiem(crit.MaSoKham, crit.STT)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
        ...
        /// <summary>
        /// Load a <see cref="KhamBenh_TruyenNhiem" /> Object from given SafeDataReader.
        /// </summary>
        private void Fetch(SafeDataReader dr)
        {
            ...
            if (dr.GetString("DichTe") != null) _DichTe = dr.GetString("DichTe");
        ...
        /// <summary>
        /// Insert the new <see cref="KhamBenh_TruyenNhiem" /> Object to underlying database.
        /// </summary>
        /// 
        ...
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_TruyenNhiem
            // Copy & paste ham duoi day vao file DataProvider.cs
            _MaSoKham = DataProvider.Instance().InsertKhamBenh_TruyenNhiem(_MaSoKham, _sTT, _maDV, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _coQuanKhac, _DichTe, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay, _nguoiSD);
            MarkOld(); // public abstract String InsertKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa, String _coQuanKhac, String _DichTe, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD);
            // public override String InsertKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa, String _coQuanKhac, String _DichTe, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD)
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TruyenNhiem_CREATE", _MaSoKham, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _coQuanKhac, _DichTe, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _ngaySD.DBValue,_nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
            // }
        }

        /// <summary>
        /// Update all changes made on <see cref="KhamBenh_TruyenNhiem" /> Object to underlying database.
        /// </summary>
        protected override void DataPortal_Update()
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_TruyenNhiem
            if (IsDirty)
            {
                DataProvider.Instance().UpdateKhamBenh_TruyenNhiem(_MaSoKham, _sTT, _maDV, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _coQuanKhac, _DichTe, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay, _huy, _nguoiSD);
                ...
                // {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TruyenNhiem_UPDATE", _MaSoKham, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _coQuanKhac, _DichTe, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _nguoiSD );
                // }
                MarkOld();
            }
        }
        ...
        /// <summary>
        /// Delete the <see cref="KhamBenh_TruyenNhiem" />.
        /// </summary>
        /// 
        internal virtual void Insert(KhamBenh_C obj)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_TruyenNhiem
            // Copy & paste ham duoi day vao file DataProvider.cs
            _MaSoKham = DataProvider.Instance().InsertKhamBenh_TruyenNhiem(obj.MaSoKham, obj.STT, obj.MaDV, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _coQuanKhac, _DichTe, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV, _maMay, _nguoiSD);
            MarkOld();// public abstract String InsertKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa, String _coQuanKhac, String _DichTe, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD);
            // public override String InsertKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa, String _coQuanKhac, String _DichTe, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, String _nguoiSD)
            // {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TruyenNhiem_CREATE", _MaSoKham, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _coQuanKhac, _DichTe, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _ngaySD.DBValue,_nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
        ...
        internal virtual void Update(KhamBenh_C obj)
        {
            ...
            if (IsDirty)
            {
                DataProvider.Instance().UpdateKhamBenh_TruyenNhiem(obj.MaSoKham, obj.STT, obj.MaDV, _ngayKham, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _coQuanKhac, _DichTe, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV, _maMay, _huy, _nguoiSD);
                // public abstract void UpdateKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa, String _coQuanKhac, String _DichTe, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, Boolean _huy, String _nguoiSD);
                // public override void UpdateKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _toanThan, String _benhChuyenKhoa, String _coQuanKhac, String _DichTe, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _MaBV, String _maMay, Boolean _huy, String _nguoiSD)
                // {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TruyenNhiem_UPDATE", _MaSoKham, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _toanThan, _benhChuyenKhoa, _coQuanKhac, _DichTe, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _MaBV,_maMay ,   _huy, _nguoiSD );
        ...
        internal void DeleteSelf(KhamBenh_C obj)
        {
            ...
            DataProvider.Instance().DeleteKhamBenh_TruyenNhiem(_maMay,_nguoiSD, obj.MaSoKham, _sTT);
            MarkNew();
        }
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_TruyenNhiem
            DataProvider.Instance().DeleteKhamBenh_TruyenNhiem(crit.MaMay, crit.NguoiSD, crit.MaSoKham, crit.STT);
            // public abstract void DeleteKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
            // public override void DeleteKhamBenh_TruyenNhiem(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa)
            // {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_TruyenNhiem_Deleted", _MaSoKham, _sTT, _sTTKhoa);
            // }
        }
