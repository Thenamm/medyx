...
//
// Ten file        :	KhamBenh_VLTL
// Kieu doi tuong  :	KhamBenh_VLTL
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="KhamBenh_VLTL" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class KhamBenh_VLTL : BusinessBase<KhamBenh_VLTL>
	{
        ...
        private String _daMo = String.Empty;
        private String _khop = String.Empty;
        private String _co = String.Empty;
        private String _cotSong = String.Empty;
        private String _tNieuSDuc = String.Empty;
        private String _cQKhac = String.Empty;
        ...
        public String DaMo
        {
            get
            {
                CanReadProperty("DaMo", true);
                return _daMo;
            }
            set
            {
                CanWriteProperty("DaMo", true);
                if (_daMo != value)
                {
                    _daMo = value;
                    PropertyHasChanged("DaMo");
                }
            }
        }
        ...
        public String Khop
        {
            get
            {
                CanReadProperty("Khop", true);
                return _khop;
            }
            set
            {
                CanWriteProperty("Khop", true);
                if (_khop != value)
                {
                    _khop = value;
                    PropertyHasChanged("Khop");
                }
            }
        }
        ...
        public String Co
        {
            get
            {
                CanReadProperty("Co", true);
                return _co;
            }
            set
            {
                CanWriteProperty("Co", true);
                if (_co != value)
                {
                    _co = value;
                    PropertyHasChanged("Co");
                }
            }
        }

        public String CotSong
        {
            get
            {
                CanReadProperty("CotSong", true);
                return _cotSong;
            }
            set
            {
                CanWriteProperty("CotSong", true);
                if (_cotSong != value)
                {
                    _cotSong = value;
                    PropertyHasChanged("CotSong");
                }
            }
        }

        public String TNieuSDuc
        {
            get
            {
                CanReadProperty("TNieuSDuc", true);
                return _tNieuSDuc;
            }
            set
            {
                CanWriteProperty("TNieuSDuc", true);
                if (_tNieuSDuc != value)
                {
                    _tNieuSDuc = value;
                    PropertyHasChanged("TNieuSDuc");
                }
            }
        }

        public String CQKhac
        {
            get
            {
                CanReadProperty("CQKhac", true);
                return _cQKhac;
            }
            set
            {
                CanWriteProperty("CQKhac", true);
                if (_cQKhac != value)
                {
                    _cQKhac = value;
                    PropertyHasChanged("CQKhac");
                }
            }
        }
        ...
        /// <summary>
        /// Factory method. New <see cref="KhamBenh_VLTL" /> Object is loaded from the database, based on given parameters.
        /// </summary> 
        /// 

        public static KhamBenh_VLTL NewKhamBenh_VLTL()
        {
            return new KhamBenh_VLTL();
            //return DataPortal.Create<DMDichVu_PhieuIn_C>();
        }
        public static KhamBenh_VLTL NewKhamBenh_VLTL(string idDMDichvu)
        {
            return new KhamBenh_VLTL(DMDichVu.GetDMDichVu(idDMDichvu));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static KhamBenh_VLTL NewKhamBenh_VLTL(DMDichVu _DMDichvu)
        {
            return new KhamBenh_VLTL(_DMDichvu);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static KhamBenh_VLTL NewKhamBenh_VLTL(string masokham, Int32 stt, string idDMDichvu)
        {
            return new KhamBenh_VLTL(masokham, stt, idDMDichvu);
        }

        public static KhamBenh_VLTL GetKhamBenh_VLTL(String maSoKham, Int32 sTT)
        {
            return DataPortal.Fetch<KhamBenh_VLTL>(new Criteria(maSoKham, sTT));
        }

        public static KhamBenh_VLTL GetKhamBenh_VLTL(SafeDataReader dr)
        {
            return new KhamBenh_VLTL(dr);
        }

        /// <summary>
        /// Marks the <see cref="KhamBenh_VLTL" /> Object for deletion. The Object will be deleted as part of the next save operation.
        /// </summary>
        public static void DeleteKhamBenh_VLTL(String maSoKham, Int32 sTT, string mamay, string nguoihuy)
        {
		...
		protected internal KhamBenh_VLTL()
		{	
			// Prevent direct creation
		}
		
        protected KhamBenh_VLTL(DMDichVu pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_VLTL(string maSoKham,DMDichVu pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_VLTL(string masokham, Int32 stt, string idDMDichvu)
        {
            MarkAsChild();
        ...
        protected KhamBenh_VLTL(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="KhamBenh_VLTL" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetKhamBenh_VLTL(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa);
			// public override IDataReader GetKhamBenh_VLTL(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_VLTL_GET", _MaSoKham, _sTT, _sTTKhoa));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetKhamBenh_VLTL(crit.MaSoKham, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="KhamBenh_VLTL" /> Object from given SafeDataReader.
		/// </summary>
		private void Fetch(SafeDataReader dr)
		{
            ...
            if (dr.GetString("DaMo") != null) _daMo = dr.GetString("DaMo");
            if (dr.GetString("Khop") != null) _khop = dr.GetString("Khop");
            if (dr.GetString("Co") != null) _co = dr.GetString("Co");
            if (dr.GetString("CotSong") != null) _cotSong = dr.GetString("CotSong");
            if (dr.GetString("TNieuSDuc") != null) _tNieuSDuc = dr.GetString("TNieuSDuc");
            if (dr.GetString("CQKhac") != null) _cQKhac = dr.GetString("CQKhac");
		...
		/// <summary>
		/// Insert the new <see cref="KhamBenh_VLTL" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_VLTL
			// Copy & paste ham duoi day vao file DataProvider.cs
            DataProvider.Instance().InsertKhamBenh_VLTL(_MaSoKham, _sTT, _maDV, _ngayKham, _bSKHAM, _lyDoKham,  _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _maBV, _maMay, _nguoiSD);
             MarkOld(); // public abstract String InsertKhamBenh_VLTL(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _thanKinh, String _tuanHoan, String _hoHap, String _tieuHoa, String _daMo, String _khop, String _co, String _cotSong, String _tNieuSDuc, String _cQKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _maBV, String _maMay, String _nguoiSD);
            // public override String InsertKhamBenh_VLTL(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _thanKinh, String _tuanHoan, String _hoHap, String _tieuHoa, String _daMo, String _khop, String _co, String _cotSong, String _tNieuSDuc, String _cQKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _maBV, String _maMay, String _nguoiSD)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_VLTL_CREATE", _MaSoKham, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _maBV, _maMay, _huy, _ngaySD.DBValue, _nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="KhamBenh_VLTL" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_VLTL
			if (IsDirty){
                DataProvider.Instance().UpdateKhamBenh_VLTL(_MaSoKham, _sTT, _maDV, _ngayKham, _bSKHAM, _lyDoKham,  _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _maBV, _maMay, _huy, _nguoiSD);
                // public abstract void UpdateKhamBenh_VLTL(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _thanKinh, String _tuanHoan, String _hoHap, String _tieuHoa, String _daMo, String _khop, String _co, String _cotSong, String _tNieuSDuc, String _cQKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _maBV, String _maMay, Boolean _huy, String _nguoiSD);
                // public override void UpdateKhamBenh_VLTL(String _MaSoKham, Int32 _sTT, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _thanKinh, String _tuanHoan, String _hoHap, String _tieuHoa, String _daMo, String _khop, String _co, String _cotSong, String _tNieuSDuc, String _cQKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _maBV, String _maMay, Boolean _huy, String _nguoiSD)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_VLTL_UPDATE", _MaSoKham, _sTT, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _maBV, _maMay, _huy, _nguoiSD );
				// }	
                MarkOld();
			}
		}
     ...
     internal void DeleteSelf(KhamBenh_C obj)
		  ...
		  internal virtual void Insert(KhamBenh_C obj)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_VLTL
			// Copy & paste ham duoi day vao file DataProvider.cs
            DataProvider.Instance().InsertKhamBenh_VLTL(obj.MaSoKham, obj.STT, obj.MaDV, _ngayKham, _bSKHAM, _lyDoKham,  _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _maBV, _maMay, _nguoiSD);
             MarkOld(); // public abstract String InsertKhamBenh_VLTL(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _thanKinh, String _tuanHoan, String _hoHap, String _tieuHoa, String _daMo, String _khop, String _co, String _cotSong, String _tNieuSDuc, String _cQKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _maBV, String _maMay, String _nguoiSD);
            // public override String InsertKhamBenh_VLTL(String _MaSoKham, Int32 _sTTKhoa, SmartDate _ngayKham, String _bSKHAM, String _lyDoKham, String _mach, String _apHuyet, String _nhietDo, String _nhipTho, String _canNang, String _chieuCao, String _thanKinh, String _tuanHoan, String _hoHap, String _tieuHoa, String _daMo, String _khop, String _co, String _cotSong, String _tNieuSDuc, String _cQKhac, String _dieuTri, String _benhSu, String _huongDT, String _mabenh, String _maBenhKem, String _maBV, String _maMay, String _nguoiSD)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_VLTL_CREATE", _MaSoKham, _sTTKhoa, _ngayKham.DBValue, _bSKHAM, _lyDoKham, _mach, _apHuyet, _nhietDo, _nhipTho, _canNang, _chieuCao, _thanKinh, _tuanHoan, _hoHap, _tieuHoa, _daMo, _khop, _co, _cotSong, _tNieuSDuc, _cQKhac, _dieuTri, _benhSu, _huongDT, _mabenh, _maBenhKem, _maBV, _maMay, _huy, _ngaySD.DBValue, _nguoiSD , _ngaySD1.DBValue, _nguoiSD1), String);
