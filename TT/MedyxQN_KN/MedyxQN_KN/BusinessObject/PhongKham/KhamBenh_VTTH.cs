...
//
// Ten file        :	KhamBenh_VTTH
// Kieu doi tuong  :	KhamBenh_VTTH
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="KhamBenh_VTTH" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class KhamBenh_VTTH : BusinessBase<KhamBenh_VTTH>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="KhamBenh_VTTH" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static KhamBenh_VTTH NewKhamBenh_VTTH()
        {
            return new KhamBenh_VTTH();
        }
        public static KhamBenh_VTTH NewKhamBenh_VTTH(string idCPMau)
        {
            return new KhamBenh_VTTH(DMVTYT.GetDMVTYT(idCPMau));
        }
        public static KhamBenh_VTTH NewKhamBenh_VTTH(DMVTYT _DMVTYT)
        {
            return new KhamBenh_VTTH(_DMVTYT);
        }
		public static KhamBenh_VTTH GetKhamBenh_VTTH(String maSoKham, Int32 sTT,string lydohuy,String mamay)
		{
            return DataPortal.Fetch<KhamBenh_VTTH>(new Criteria(maSoKham, sTT, lydohuy, mamay));
		}
        public static KhamBenh_VTTH GetKhamBenh_VTTH(SafeDataReader dr)
        {
            return new KhamBenh_VTTH(dr);
        }
		/// <summary>
		/// Marks the <see cref="KhamBenh_VTTH" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteKhamBenh_VTTH(String maSoKham, Int32 sTT, string lydohuy, String mamay)
		{
            DataPortal.Delete(new Criteria( maSoKham, sTT,lydohuy,mamay ));
		}
		...
		protected internal KhamBenh_VTTH()
		{	
		...
		protected KhamBenh_VTTH(DMVTYT  pro)
        {
            MarkAsChild();
       ...
       //     _tenDV = pro.TenDV;
        ...
        protected KhamBenh_VTTH(string maSoKham,DMVTYT  pro)
        {
            MarkAsChild();
        ...
        protected KhamBenh_VTTH(SafeDataReader dr)
        {
            MarkAsChild();
		...
		protected class Criteria
		{
			...
			public Criteria(String maSoKham, Int32 sTT,string lydohuy,string mamay)
			{
				_maSoKham = maSoKham;
				_sTT = sTT;
                _LydoHuy = lydohuy;
		...
		/// <summary>
		/// Retrieve an existing <see cref="KhamBenh_VTTH" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetKhamBenh_VTTH(String _maSoKham, Int32 _sTT);
			// public override IDataReader GetKhamBenh_VTTH(String _maSoKham, Int32 _sTT)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maSoKham, _sTT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetKhamBenh_VTTH(crit.MaSoKham, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="KhamBenh_VTTH" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="KhamBenh_VTTH" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Insert()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertKhamBenh_VTTH
			// Copy & paste ham duoi day vao file DataProvider.cs
             if (_sLMua != 0)

                 _maSoKham = DataProvider.Instance().InsertKhamBenh_VTTH(_maSoKham, _sTT, _MaVT, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay, _nguoiSD , _makhoa, _dadung, _daTTTT, _ngayTToanTT, _daTTBH, _ngayTToanBH, _noiTTTT, _noiTTBH, _nguoiTTTT, _nguoiTTBH,_maDT);
             MarkOld();
			...
			// public override String InsertKhamBenh_VTTH(String _maSoKham, Int32 _sTT, String _MaVT, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, String _soHD, String _soSoHD, Int32 _sophieu, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhTien, Byte _dATT, Boolean _tToanSau, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, String _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, SmartDate _ngayHuy, String _lyDoHuy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngaySD, String _nguoiSD, String _nguoiHuy, SmartDate _ngaySD1, String _nguoiSD1);
			// {
			//		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maSoKham, _sTT, _MaVT, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue, _maMay, _huy, _ngayHuy.DBValue, _lyDoHuy, _ngayLap.DBValue, _nguoiSD , _ngaySD.DBValue, _nguoiSD , _nguoiSD  , _ngaySD1.DBValue, _nguoiSD1), String);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="KhamBenh_VTTH" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_VTTH
			if (IsDirty){
                DataProvider.Instance().UpdateKhamBenh_VTTH(_maSoKham, _sTT, _MaVT, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay, _huy,_nguoiSD, _soHDTra, _soSoHDTra, _makhoa, _dadung, _daTTTT, _ngayTToanTT, _daTTBH, _ngayTToanBH, _noiTTTT, _noiTTBH, _nguoiTTTT, _nguoiTTBH, _maDT, 1);
				// public abstract void UpdateKhamBenh_VTTH(String _maSoKham, Int32 _sTT, String _MaVT, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, String _soHD, String _soSoHD, Int32 _sophieu, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhTien, Byte _dATT, Boolean _tToanSau, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, String _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, SmartDate _ngayHuy, String _lyDoHuy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngaySD, String _nguoiSD, String _nguoiHuy, SmartDate _ngaySD1, String _nguoiSD1);
				// public override void UpdateKhamBenh_VTTH(String _maSoKham, Int32 _sTT, String _MaVT, String _maBN, SmartDate _ngayDK, Decimal _sLKeDon, Decimal _sLMua, Decimal _dongiaTT, Decimal _donGiaBH, Decimal _giaChenhLech, String _soHD, String _soSoHD, Int32 _sophieu, Decimal _ck, String _bSChiDinh, Boolean _tinhtien, Boolean _bHTinhTien, Byte _dATT, Boolean _tToanSau, String _nguoiTT, SmartDate _ngayTToan, Boolean _daTra, String _nguoiTra, SmartDate _ngaytra, String _sLTra, Boolean _duyet, Boolean _phat, SmartDate _ngayP, String _nguoiD, String _nguoiP, SmartDate _ngayD, String _maMay, Boolean _huy, SmartDate _ngayHuy, String _lyDoHuy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngaySD, String _nguoiSD, String _nguoiHuy, SmartDate _ngaySD1, String _nguoiSD1);
				// {
				//		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maSoKham, _sTT, _MaVT, _maBN, _ngayDK.DBValue, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan.DBValue, _daTra, _nguoiTra, _ngaytra.DBValue, _sLTra, _duyet, _phat, _ngayP.DBValue, _nguoiD, _nguoiP, _ngayD.DBValue, _maMay, _huy, _ngayHuy.DBValue, _lyDoHuy, _ngayLap.DBValue, _nguoiSD , _ngaySD.DBValue, _nguoiSD , _nguoiSD  , _ngaySD1.DBValue, _nguoiSD1);
				// }				
			}
		}
		protected override void DataPortal_DeleteSelf()
		{
			DataPortal_Delete(new Criteria(_maSoKham, _sTT,_lyDoHuy,_maMay ));
		}

		/// <summary>
		/// Delete the <see cref="KhamBenh_VTTH" />.
		/// </summary>
		protected void DataPortal_Delete(Criteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateKhamBenh_VTTH
			DataProvider.Instance().DeleteKhamBenh_VTTH(crit.MaMay,crit.NguoiSD ,crit.MaSoKham, crit.STT,crit.LydoHuy   );
			// public abstract void DeleteKhamBenh_VTTH(String _maSoKham, Int32 _sTT);
			// public override void DeleteKhamBenh_VTTH(String _maSoKham, Int32 _sTT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spKhamBenh_VTTH_Deleted", _maSoKham, _sTT);
			// }
		}
        internal virtual void Update(KhamBenh bill)
        {
            ...
            if (IsDirty)
            {
                ...
                DataProvider.Instance().UpdateKhamBenh_VTTH(bill.MaSoKham, _sTT, _MaVT, _maBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay, _huy, _nguoiSD , _soHDTra, _soSoHDTra, _makhoa, _dadung, _daTTTT, _ngayTToanTT, _daTTBH, _ngayTToanBH, _noiTTTT, _noiTTBH, _nguoiTTTT, _nguoiTTBH,bill.MaDT,bill.loai );
        ...
        internal virtual void Insert(KhamBenh bill)
        {
            ...
            if (IsDirty)
            {
                ...
                _maSoKham = DataProvider.Instance().InsertKhamBenh_VTTH(bill.MaSoKham, _sTT, _MaVT, bill.MaBN, _ngayDK, _sLKeDon, _sLMua, _dongiaTT, _donGiaBH, _giaChenhLech, _soHD, _soSoHD, _sophieu, _ck, _bSChiDinh, _tinhtien, _bHTinhTien, _dATT, _tToanSau, _nguoiTT, _ngayTToan, _daTra, _nguoiTra, _ngaytra, _sLTra, _duyet, _phat, _ngayP, _nguoiD, _nguoiP, _ngayD, _maMay, _nguoiSD , _makhoa, _dadung, _daTTTT, _ngayTToanTT, _daTTBH, _ngayTToanBH, _noiTTTT, _noiTTBH, _nguoiTTTT, _nguoiTTBH,bill.MaDT);
                MarkOld();
        ...
        internal void DeleteSelf(KhamBenh bill)
        {
            ...
            DataProvider.Instance().DeleteKhamBenh_VTTH(bill.MaSoKham, _nguoiSD, _maMay, _sTT, _lyDoHuy);
            MarkNew();
        }
        ...
        internal void DeleteSelf(KhamBenh_Q bill)
        {
            ...
            DataProvider.Instance().DeleteKhamBenh_VTTH(_maMay, _nguoiSD , bill.MaSoKham, _sTT, _lyDoHuy);
            MarkNew();
        }
		#endregion
	}
