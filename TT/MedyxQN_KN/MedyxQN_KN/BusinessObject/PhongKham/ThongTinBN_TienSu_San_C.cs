...
//
// Ten file        :	ThongTinBN_TienSu_San_C
// Kieu doi tuong  :	ThongTinBN_TienSu_San_C
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="ThongTinBN_TienSu_San_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class ThongTinBN_TienSu_San_C : BusinessBase<ThongTinBN_TienSu_San_C>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="ThongTinBN_TienSu_San_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static ThongTinBN_TienSu_San_C NewThongTinBN_TienSu_San_C()
        {
            return new ThongTinBN_TienSu_San_C();
        ...
        //}
		public static ThongTinBN_TienSu_San_C GetThongTinBN_TienSu_San_C(String maBN, Int32 sTT)
		{
			return DataPortal.Fetch<ThongTinBN_TienSu_San_C>(new Criteria(maBN, sTT));
		}
        public static ThongTinBN_TienSu_San_C GetThongTinBN_TienSu_San_C(SafeDataReader dr)
        {
            return new ThongTinBN_TienSu_San_C(dr);
        }
		/// <summary>
		/// Marks the <see cref="ThongTinBN_TienSu_San_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteThongTinBN_TienSu_San_C(String maBN, Int32 sTT, string mamay, string nguoihuy)
		{
		...
		protected internal ThongTinBN_TienSu_San_C()
		{	
			// Prevent direct creation
		}
        protected ThongTinBN_TienSu_San_C(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="ThongTinBN_TienSu_San_C" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetThongTinBN_TienSu_San_C(crit.MaBN, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="ThongTinBN_TienSu_San_C" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="ThongTinBN_TienSu_San_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Insert(ThongTinBN_TienSu_San  obj)
        {
            // TODO: Kiem tra lai cac tham so truyen vao cho ham InsertBenhAn_PhauThuat_TV
            // Copy & paste ham duoi day vao file DataProvider.cs
            
              
            _sTT = DataProvider.Instance().InsertThongTinBN_TienSu_San_C(obj.MaBN, _thoigianThainghen, _tuoithai, _dienbienThai, _cachde, _tresosinh, _hauSan, _khac, _maMay, _nguoiSD);
            MarkOld();// public abstract String InsertThongTinBN_TienSu_San_C(String _maBN, String _thoigianThainghen, String _tuoithai, String _dienbienThai, String _cachde, String _tresosinh, String _hauSan, String _khac, String _maMay, String _nguoiSD);
			// public override String InsertThongTinBN_TienSu_San_C(String _maBN, String _thoigianThainghen, String _tuoithai, String _dienbienThai, String _cachde, String _tresosinh, String _hauSan, String _khac, String _maMay, String _nguoiSD)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spThongTinBN_TienSu_San_C_CREATE", _maBN, _thoigianThainghen, _tuoithai, _dienbienThai, _cachde, _tresosinh, _hauSan, _khac, _maMay, _nguoiSD));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="ThongTinBN_TienSu_San_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Update(ThongTinBN_TienSu_San obj)
        {
            ...
            if (IsDirty)
            {
                ...
                DataProvider.Instance().UpdateThongTinBN_TienSu_San_C(obj.MaBN,_sTT,  _thoigianThainghen, _tuoithai, _dienbienThai, _cachde, _tresosinh, _hauSan, _khac, _maMay, _huy, _nguoiSD);
        ...
        ///// <summary>
        ///// Delete the <see cref="ThongTinBN_TienSu_San_C" />.
        ///// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateThongTinBN_TienSu_San_C
        //    DataProvider.Instance().DeleteThongTinBN_TienSu_San_C(crit.MaBN, crit.STT);
        //    // public abstract void DeleteThongTinBN_TienSu_San_C(String _maBN, Int32 _sTT);
        //    // public override void DeleteThongTinBN_TienSu_San_C(String _maBN, Int32 _sTT);
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spThongTinBN_TienSu_San_C_Deleted", _maBN, _sTT);
        //    // }
        //}
        internal void DeleteSelf(ThongTinBN_TienSu_San obj)
        {
            ...
            DataProvider.Instance().DeleteThongTinBN_TienSu_San_C(_maMay,_nguoiSD , _maBN, _sTT);
            MarkNew();
        }
		#endregion
	}
