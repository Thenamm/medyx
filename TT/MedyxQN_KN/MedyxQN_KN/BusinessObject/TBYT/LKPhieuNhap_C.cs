...
{
    [Serializable()]
    public partial class LKPhieuNhap_C : BusinessBase<LKPhieuNhap_C>
    {
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule(Csla.Validation.CommonRules.StringMaxLength, new Csla.Validation.CommonRules.MaxLengthRuleArgs("TENLK", 350));
            ValidationRules.AddRule<LKPhieuNhap_C>(StringRequired<LKPhieuNhap_C>, "TENLK");
            ValidationRules.AddRule<LKPhieuNhap_C>(ValidationSoLuong<LKPhieuNhap_C>, "Soluong");
        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : LKPhieuNhap_C
        {

            if (target._TENLK == null || target._TENLK.Trim().Length == 0)
            {
        ...
        private static bool StringRequiredSoLo<T>(T target, Csla.Validation.RuleArgs e) where T : LKPhieuNhap_C
        {
        ...
        private static bool ValidationSoLuong<T>(T target, Csla.Validation.RuleArgs e) where T : LKPhieuNhap_C
        {
		...
		/// </summary> 
        /// 
        public static LKPhieuNhap_C NewLKPhieuNhap_C()
        {
            return new LKPhieuNhap_C();
           
        }
        public static LKPhieuNhap_C NewLKPhieuNhap_C(string idDMTBYT)
        {
            return new LKPhieuNhap_C(DMTBYT.GetDMTBYT(idDMTBYT));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static LKPhieuNhap_C NewLKPhieuNhap_C(DMTBYT _DMTBYT)
        {
            return new LKPhieuNhap_C(_DMTBYT);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static LKPhieuNhap_C GetLKPhieuNhap_C(String maLKPhieuNhap, decimal sTT)
        {
            return DataPortal.Fetch<LKPhieuNhap_C>(new Criteria(maLKPhieuNhap, sTT));
        }
        public static LKPhieuNhap_C GetLKPhieuNhap_C(SafeDataReader dr)
        {
            return new LKPhieuNhap_C(dr);
        }

        public static void DeleteLKPhieuNhap_C(String _maPN, decimal _sTT, string mamay, string nguoisd)
        {
        ...
        protected internal LKPhieuNhap_C()
        {
            // Prevent direct creation
            _chietKhau = 0;
        }
        protected LKPhieuNhap_C(DMTBYT pro)
        {
            MarkAsChild();
        ...
        protected LKPhieuNhap_C(string _idMaPN, DMTBYT pro)
        {
            MarkAsChild();
            _maPN = _idMaPN;
            _maLK = pro.MaTB;
        ...
        protected LKPhieuNhap_C(SafeDataReader dr)//lay nhung thang hien ra tren luoi
        {
            MarkAsChild();
           ...
           _hanSD = new SmartDate(); //dr.GetSmartDate("HanSD", false);
           _hanSDD = new SmartDate(); // dr.GetSmartDate("HanSD", false);
           ...
           _handung = false; // if (dr.GetBoolean("Handung") != null) _handung = dr.GetBoolean("Handung");
        ...
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetLKPhieuNhap_C_Get(crit.MaPN, crit.STT)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
		...
		/// </summary>
        private void Fetch(SafeDataReader dr)//lay o chi tiet thu tuc spLKPhieuNhap_C_Get
        {
            // Value properties
            ...
            if (dr.GetString("TENLK") != null) _TENLK = dr.GetString("TENLK");
        ...
        internal virtual void Insert(LKPhieuNhap bill)
        {
            ...
            _maPN = bill.MaPN;
             DataProvider.Instance().InsertLKPhieuNhap_C(bill.MaPN, _maLK, _soLuong, _hanSD, _donGia, _chietKhau, _soLo, _huy, _ghiChu, _maMay, _nguoiSD);
             MarkOld();
        }
        ...
        internal virtual void Update(LKPhieuNhap bill)
        {
            ...
            if (IsDirty)
            {
                ...
                _maPN = bill.MaPN;
                DataProvider.Instance().UpdateLKPhieuNhap_C(bill.MaPN, _sTT, _maLK, _soLuong, _hanSD, _donGia, _chietKhau, _soLo, _huy, _ghiChu, _ngaySD, _maMay, _nguoiSD);
        ...
        internal void DeleteSelf(LKPhieuNhap bill)
        {
            ...
            DataProvider.Instance().DeleteLKPhieuNhap_C(_maPN, _sTT, _nguoiSD,_maMay  );
            MarkNew();
        }
		#endregion
	}
