...
{	
	...
	[Serializable()]
	public partial class LKPhieuXuat_C : BusinessBase<LKPhieuXuat_C>
	{
        ...
        public static LKPhieuXuat_C NewLKPhieuXuat_C()
        {
            return new LKPhieuXuat_C();
            
        }

        public static LKPhieuXuat_C NewLKPhieuXuat_C(string idDMTBYT)
        {
            return new LKPhieuXuat_C(DMTBYT.GetDMTBYT(idDMTBYT));
        }

        public static LKPhieuXuat_C NewLKPhieuXuat_C(DMTBYT _DMTBYT)
        {
            return new LKPhieuXuat_C(_DMTBYT);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        
        public static LKPhieuXuat_C GetLKPhieuXuat_C(String maLKPhieuXuat, decimal sTT)
        {
            return DataPortal.Fetch<LKPhieuXuat_C>(new Criteria(maLKPhieuXuat, sTT));
        }

        public static LKPhieuXuat_C GetLKPhieuXuat_C(SafeDataReader dr)
        {
            return new LKPhieuXuat_C(dr);
        }

        public static void DeleteLKPhieuXuat_C(String _maPN, decimal _sTT,string _nguoisd,string _mamay)
        {
        ...
        protected internal LKPhieuXuat_C()
        { 
            //
        }
        protected LKPhieuXuat_C(DMTBYT pro)
        {
            MarkAsChild();
            _maLK = pro.MaTB;
            _tenTM = pro.TenTB;
        }
        protected LKPhieuXuat_C(string _idMaPX, DMTBYT pro)
        {
            MarkAsChild();
            _maPX = _idMaPX;            
            _maLK = pro.MaTB;
        ...
        protected LKPhieuXuat_C(SafeDataReader dr)
        {
            MarkAsChild();
        ...
        {
            //using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetLKPhieuXuat_C(crit.MaPX, crit.STT))) 
            //{
            //    if (dr.Read())
            //    {
            //        Fetch(dr);
        ...
        internal virtual void Insert(LKPhieuXuat bill)
        {
            
              
            _maPX = bill.MaPX;
             DataProvider.Instance().InsertLKPhieuXuat_C(bill.MaPX, _maLK, _soLuong, _hanSD, _soLo, _donGia, _soLuongYC, _giaBan, _ghiChu, _nguoiSD , _maMay);
             MarkOld();
        }

        internal virtual void Update(LKPhieuXuat bill)
        {
            if(IsDirty)
            {      
            
              
            DataProvider.Instance().UpdateLKPhieuXuat_C(bill.MaPX, _sTT, _maLK, _soLuong, _hanSD, _soLo, _donGia,  _soLuongYC, _giaBan,  _huy,  _ghiChu, _nguoiSD ,  _maMay);
            }
        }
        internal void DeleteSelf(LKPhieuXuat packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
                return;
            DataProvider.Instance().DeleteLKPhieuXuat_C(_maPX,_sTT,_nguoiSD,_maMay);
            MarkNew();
            
        }
        internal virtual void Insert(LKPhieuXuatDT bill)
        {
        ...
        internal virtual void Update(LKPhieuXuatDT bill)
        {
            if (IsDirty)
            {
        ...
        internal void DeleteSelf(LKPhieuXuatDT packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
