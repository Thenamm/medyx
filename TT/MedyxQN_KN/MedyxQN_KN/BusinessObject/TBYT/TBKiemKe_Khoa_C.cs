...
//
// Ten file        :	TBKiemKe_Khoa_C
// Kieu doi tuong  :	TBKiemKe_Khoa_C
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="TBKiemKe_Khoa_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class TBKiemKe_Khoa_C : BusinessBase<TBKiemKe_Khoa_C>
	{
        ...
        private SmartDate _nGAYBDSD = new SmartDate(true);
        ...
        public string NgayBDSD
        {
            get
            {
                CanReadProperty("NgayBDSD", true);
                return _nGAYBDSD.Text;
            }
            set
            {
                CanWriteProperty("NgayBDSD", true);
                if (_nGAYBDSD.Text != value)
                {
                    _nGAYBDSD.Text = value;
                    PropertyHasChanged("NgayBDSD");
                }
            }
        }
		...
		{
			return _mAKK.ToString() + "!" + _sTT.ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString().ToString();
		}
		...
		/// <summary>
		/// Factory method. New <see cref="TBKiemKe_Khoa_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static TBKiemKe_Khoa_C NewTBKiemKe_Khoa_C()
        {
            return new TBKiemKe_Khoa_C();

        }
        public static TBKiemKe_Khoa_C NewTBKiemKe_Khoa_C(string idDMTB)
        {
            return new TBKiemKe_Khoa_C(DMTBYT.GetDMTBYT(idDMTB));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static TBKiemKe_Khoa_C NewTBKiemKe_Khoa_C(DMTBYT _DMTBYT)
        {
            return new TBKiemKe_Khoa_C(_DMTBYT);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
		public static TBKiemKe_Khoa_C GetTBKiemKe_Khoa_C(String mAKK, Decimal sTT)
		{
			return DataPortal.Fetch<TBKiemKe_Khoa_C>(new Criteria(mAKK, sTT));
		}
        public static TBKiemKe_Khoa_C GetTBKiemKe_Khoa_C(SafeDataReader dr)
        {
            return new TBKiemKe_Khoa_C(dr);
        }
        public static TBKiemKe_Khoa_C GetTBKiemKe_Khoa_C(int i, SafeDataReader dr)
        {
            return new TBKiemKe_Khoa_C(i, dr);
        }
		/// <summary>
		/// Marks the <see cref="TBKiemKe_Khoa_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteTBKiemKe_Khoa_C(String mAKK, Decimal sTT, string mamay, string nguoihuy)
		{
		...
		protected internal TBKiemKe_Khoa_C()
		{	
			// Prevent direct creation
		}
		protected TBKiemKe_Khoa_C(DMTBYT pro)
        {
            MarkAsChild();
        ...
        protected TBKiemKe_Khoa_C(string _idMaKK, DMTBYT pro)
        {
            MarkAsChild();
            _mAKK = _idMaKK;
            _maTBC = pro.MaTB;
        ...
        protected TBKiemKe_Khoa_C(SafeDataReader dr)//lay nhung thang hien ra tren luoi
        {
            MarkAsChild();
		   ...
		   if (dr.GetSmartDate("NAMSX", true) != null) _namSanxuat = DateTime.Parse(dr.GetSmartDate("NAMSX", true).DBValue.ToString()).Year;
           if (dr.GetSmartDate("ngaybaoduong", true) != null) _NgayBaoDuong = dr.GetSmartDate("ngaybaoduong", true);
           if (dr.GetSmartDate("NgayBDSD", true) != null) _nGAYBDSD = dr.GetSmartDate("NgayBDSD", true);
        ...
        protected TBKiemKe_Khoa_C(int i, SafeDataReader dr)//lay nhung thang hien ra tren luoi
        {
            MarkAsChild();
            _sTT = i;
            if (dr.GetString("MAKK") != null) _mAKK = dr.GetString("MAKK");
		...
		/// <summary>
		/// Retrieve an existing <see cref="TBKiemKe_Khoa_C" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetTBKiemKe_Khoa_C(crit.MAKK, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="TBKiemKe_Khoa_C" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="TBKiemKe_Khoa_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Insert(TBKiemKe_Khoa bill)
        {
            ...
            _mAKK = bill.MaKK;
			_maTBC = DataProvider.Instance().InsertTBKiemKe_Khoa_C(bill.MaKK, _maTBC, _sOLUONG, _donGia, _sLSUACHUA, _sLBAODUONG, _sLXINTHANHLY, _sLSUACHUADC, _sLBAODUONGDC, _sLXINTHANHLYDC, _sLDC, _ghichu,_nguoiSD, _maMay, _sudungDN, _serialNo, _model, _NgayBaoDuong, _nGAYBDSD, _namSanxuat);
            MarkOld();// public abstract String InsertTBKiemKe_Khoa_C(String _mAKK, String _maTBC, Decimal _sOLUONG, Decimal _donGia, Decimal _sLSUACHUA, Decimal _sLBAODUONG, Decimal _sLXINTHANHLY, Decimal _sLSUACHUADC, Decimal _sLBAODUONGDC, Decimal _sLXINTHANHLYDC, Decimal _sLDC, String _ghichu, String _nguoiSD, String _maMay);
			// public override String InsertTBKiemKe_Khoa_C(String _mAKK, String _maTBC, Decimal _sOLUONG, Decimal _donGia, Decimal _sLSUACHUA, Decimal _sLBAODUONG, Decimal _sLXINTHANHLY, Decimal _sLSUACHUADC, Decimal _sLBAODUONGDC, Decimal _sLXINTHANHLYDC, Decimal _sLDC, String _ghichu, String _nguoiSD, String _maMay)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spTBKIEMKE_KHOA_C_CREATE", _mAKK, _maTBC, _sOLUONG, _donGia, _sLSUACHUA, _sLBAODUONG, _sLXINTHANHLY, _sLSUACHUADC, _sLBAODUONGDC, _sLXINTHANHLYDC, _sLDC, _ghichu, _nguoiSD , _maMay));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="TBKiemKe_Khoa_C" /> Object to underlying database.
		/// </summary>
        internal virtual void Update(TBKiemKe_Khoa bill)
        {
            ...
            if (IsDirty)
            {
                  ...
                  DataProvider.Instance().UpdateTBKiemKe_Khoa_C(bill.MaKK, _sTT, _maTBC, _sOLUONG, _donGia, _sLSUACHUA, _sLBAODUONG, _sLXINTHANHLY, _sLSUACHUADC, _sLBAODUONGDC, _sLXINTHANHLYDC, _sLDC, _ghichu, _huy,_nguoiSD, _maMay, _sudungDN, _serialNo, _model, _NgayBaoDuong, _nGAYBDSD, _namSanxuat);
				// public abstract void UpdateTBKiemKe_Khoa_C(String _mAKK, Decimal _sTT, String _maTBC, Decimal _sOLUONG, Decimal _donGia, Decimal _sLSUACHUA, Decimal _sLBAODUONG, Decimal _sLXINTHANHLY, Decimal _sLSUACHUADC, Decimal _sLBAODUONGDC, Decimal _sLXINTHANHLYDC, Decimal _sLDC, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay);
				// public override void UpdateTBKiemKe_Khoa_C(String _mAKK, Decimal _sTT, String _maTBC, Decimal _sOLUONG, Decimal _donGia, Decimal _sLSUACHUA, Decimal _sLBAODUONG, Decimal _sLXINTHANHLY, Decimal _sLSUACHUADC, Decimal _sLBAODUONGDC, Decimal _sLXINTHANHLYDC, Decimal _sLDC, String _ghichu, Boolean _huy, String _nguoiSD, String _maMay)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spTBKIEMKE_KHOA_C_UPDATE", _mAKK, _sTT, _maTBC, _sOLUONG, _donGia, _sLSUACHUA, _sLBAODUONG, _sLXINTHANHLY, _sLSUACHUADC, _sLBAODUONGDC, _sLXINTHANHLYDC, _sLDC, _ghichu, _huy, _ngaySD.DBValue, _nguoiSD , _maMay);
				// }				
			}
		}
        //protected override void DataPortal_DeleteSelf()
        //{
        //    DataPortal_Delete(new Criteria(_mAKK, _sTT));
        //}

        ///// <summary>
        ///// Delete the <see cref="TBKiemKe_Khoa_C" />.
        ///// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateTBKiemKe_Khoa_C
        //    DataProvider.Instance().DeleteTBKiemKe_Khoa_C(crit.MAKK, crit.STT);
        //    // public abstract void DeleteTBKiemKe_Khoa_C(String _mAKK, Decimal _sTT);
        //    // public override void DeleteTBKiemKe_Khoa_C(String _mAKK, Decimal _sTT)
        //    // {
        //    //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spTBKIEMKE_KHOA_C_DELETED", _mAKK, _sTT);
        //    // }
        //}
        internal void DeleteSelf(TBKiemKe_Khoa bill)
        {
            ...
            DataProvider.Instance().DeleteTBKiemKe_Khoa_C(_maMay, _nguoiSD , bill.MaKK, _sTT);
            MarkNew();
        }
		#endregion
	}
