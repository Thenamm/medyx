...
{	
	...
	[Serializable()]
	public partial class TBLinhKien_C : BusinessBase<TBLinhKien_C>
	{
        ...
        private int _SuDungDN = Int32.MaxValue;
		#endregion
        ...
        /// </summary> 
        /// 
        public static TBLinhKien_C NewTBLinhkien_C()
        {
            return new TBLinhKien_C();

        }
        public static TBLinhKien_C NewTBLinhkien_C(string MaTBC)
        {
            return new TBLinhKien_C(DMTBYT.GetDMTBYT(MaTBC));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }

        public static TBLinhKien_C GetTBLinhkien_C(String maTBC, decimal sTT)
        {
            return DataPortal.Fetch<TBLinhKien_C>(new Criteria(maTBC, sTT));
        }
        public static TBLinhKien_C GetTBLinhkien_C(SafeDataReader dr)
        {
            return new TBLinhKien_C(dr);
        }
        /// <summary>
		...
		protected internal TBLinhKien_C()
		{	
			// Prevent direct creation
		}
		protected TBLinhKien_C(DMTBYT pro)
        {
            MarkAsChild();
        ...
        protected TBLinhKien_C(SafeDataReader dr)//lay nhung thang hien ra tren luoi
        {
            MarkAsChild();
        ...
        protected TBLinhKien_C(int i, SafeDataReader dr)//lay nhung thang hien ra tren luoi
        {
            MarkAsChild();
            _sTT = i;
            if (dr.GetString("MaLK") != null) _MaLK = dr.GetString("MaLK");
		...
		/// </summary>
        internal virtual void Insert(TBKiemKe_C bill)
        ...
        internal virtual void Update(TBKiemKe_C  bill)
        {
        ...
        internal void DeleteSelf(TBKiemKe_C bill)
        {
