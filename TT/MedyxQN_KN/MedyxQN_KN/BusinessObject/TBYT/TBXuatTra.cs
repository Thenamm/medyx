...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="TBXuatTra" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class TBXuatTra : BusinessBase<TBXuatTra>
	{
        ...
        private SmartDate _ngayXTD = new SmartDate(true);
        ...
        public String NgayXTD
        {
            get
            {
                CanReadProperty("ngayXuatTTD", true);
                _ngayXTD = _ngayXT;
                _ngayXTD.FormatString = "dd/MM/yyyy";
                return _ngayXTD.Text;
            }
        ...
        TBXuatTra_C_List _TBXuatTraCs = TBXuatTra_C_List.NewTBXuatTra_C_List();
        public TBXuatTra_C_List TBXuatTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _TBXuatTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _TBXuatTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<TBXuatTra>(StringRequired<TBXuatTra>, "TenNCC");
        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : TBXuatTra
        {
		...
		/// <summary>
		/// Factory method. New <see cref="TBXuatTra" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static TBXuatTra NewTBXuatTra()
        {
            return DataPortal.Create<TBXuatTra>();
        }
		public static TBXuatTra GetTBXuatTra(String maPXT)
		{
			return DataPortal.Fetch<TBXuatTra>(new Criteria(maPXT));
		}
        public static TBXuatTra GetTBXuatTra(SafeDataReader dr)
        {
            TBXuatTra obj = new TBXuatTra();
            obj.Fetch(dr);
            return obj;

        }
		/// <summary>
		/// Marks the <see cref="TBXuatTra" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteTBXuatTra(String maPXT, string mamay, string nguoihuy)
		{
		...
		/// <summary>
		/// Retrieve an existing <see cref="TBXuatTra" /> Object based on data in the database.
		/// </summary>
        /// 

		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetTBXuatTra(String _maPXT);
			// public override IDataReader GetTBXuatTra(String _maPXT)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spTBXuatTra_GET", _maPXT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetTBXuatTra(crit.MaPXT, crit.Qadmin  )))
			{
				if (dr.Read()){
					Fetch(dr);
                    //MarkOld();
                    ...
                    if (dr.NextResult())
                    {
                        _TBXuatTraCs = TBXuatTra_C_List.GetTBXuatTra_C_List(dr);
                    } 
				}
			}
		}
		/// <summary>
		/// Load a <see cref="TBXuatTra" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="TBXuatTra" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertTBXuatTra
			// Copy & paste ham duoi day vao file DataProvider.cs
            //_maMay = ,_maMay ,;
            //_nguoiLap = HTC.ShareVariables.pub_sNguoiSD;
            _maPXT = DataProvider.Instance().InsertTBXuatTra(_maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _maMay, _nguoiLap, _ngayLap, _nVXuat, _nVNhan, _vAT);
            _TBXuatTraCs.Update(this);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spTBXuatTra_CREATE", _maNCC, _soCT, _ngayXT, _makho,  _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu,  _maMay,  _nguoiLap, _ngayLap, _nVXuat, _nVNhan, _vAT);
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="TBXuatTra" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateTBXuatTra
			if (IsDirty){
                //_maMay = ,_maMay ,;
                //_nguoiSD = HTC.ShareVariables.pub_sNguoiSD;
                DataProvider.Instance().UpdateTBXuatTra(_maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy, _nguoiSD , _maMay, _nVXuat, _nVNhan, _vAT);
                _TBXuatTraCs.Update(this);
				...
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spTBXuatTra_UPDATE", _maPXT, _maNCC, _soCT, _ngayXT, _makho, _thanhtoan, _ngayTToan, _ngayXuatTT, _tong, _ghichu, _huy, _nguoiSD  , _maMay, _nVXuat, _nVNhan, _vAT);
				// }				
			}
		}
		...
		/// <summary>
		/// Delete the <see cref="TBXuatTra" />.
		/// </summary>
		protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateTBXuatTra
            DataProvider.Instance().DeleteTBXuatTra(crit.MaMay, crit.NguoiSD, crit.MaPXT);
			// public abstract void DeleteTBXuatTra(String _maPXT);
			// public override void DeleteTBXuatTra(String _maPXT);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spTBXuatTra_DELETED", _maPXT);
			// }
		}
