...
{
    [Serializable()]
    public class LKPhieuXuats : BusinessListBase<LKPhieuXuats,LKPhieuXuat>
    {
        #region Business Methods
        public LKPhieuXuat this[int i]
        {
            get
            {
        ...
        public static LKPhieuXuats GetAllLKPhieuXuat(Boolean qadmin ,String makho, Byte loaiphieu, Boolean daphat, DateTime tungay, DateTime denngay, String dieukienthem, Boolean daduyet)
        {
            return DataPortal.Fetch<LKPhieuXuats>(new Criteria(qadmin , makho, loaiphieu, daphat , tungay, denngay, dieukienthem,daduyet ));
        }
        //public static LKPhieuXuats FindLKPhieuXuatByKho(string TenKho)
        //{ 
        //    return DataPortal.Fetch<LKPhieuXuats>()
        //}
        public void NewTo(LKPhieuXuat _LKPhieuXuat)
        {
            _LKPhieuXuat.OrderNumber = this.Items[this.Count - 1].OrderNumber + 1;
            this.Add(_LKPhieuXuat);
        }
        public void UpdatedTo(LKPhieuXuat _LKPhieuXuat)
        {
        ...
        public void RemoveTo(LKPhieuXuat _LKPhieuXuat)
        {
            this.Items.Remove(_LKPhieuXuat);

        }

        private LKPhieuXuats()
        {
      ...
      criteria.DenNgay, criteria.DieuKienThem,criteria.DaDuyet   )))
            {
                ...
                while (dr.Read())
                {
                LKPhieuXuat item=new LKPhieuXuat(
     i,
     dr.GetString("MaPX"),
