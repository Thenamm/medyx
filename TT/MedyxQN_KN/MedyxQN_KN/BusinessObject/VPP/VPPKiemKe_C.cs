...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="VPPKiemKe_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class VPPKiemKe_C : BusinessBase<VPPKiemKe_C>
	{
        ...
        public static VPPKiemKe_C NewVPPKiemKe_C()
        {
            return new VPPKiemKe_C();

        }

        public static VPPKiemKe_C NewVPPKiemKe_C(string idDMVPP)
        {
            return new VPPKiemKe_C(DMVPP.GetDMVPP(idDMVPP));
        }

        public static VPPKiemKe_C NewVTKiemKe_C(DMVPP _DMVPP)
        {
            return new VPPKiemKe_C(_DMVPP);
        }
		public static VPPKiemKe_C GetVPPKiemKe_C(String maKK, Decimal sTT)
		{
			return DataPortal.Fetch<VPPKiemKe_C>(new Criteria(maKK, sTT));
		}
        public static VPPKiemKe_C GetVPPKiemKe_C(SafeDataReader dr)
        {
            return new VPPKiemKe_C(dr);
        }
        public static VPPKiemKe_C GetVPPKiemKe_C(SafeDataReader dr, int i)
        {
            return new VPPKiemKe_C(dr, i);
        }
		/// <summary>
		/// Marks the <see cref="VTKiemKe_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteVPPKiemKe_C(String maKK, Decimal sTT)
        {
        ...
        protected internal VPPKiemKe_C()
		{	
			// Prevent direct creation
		}
		protected VPPKiemKe_C(DMVPP pro)
        {
            MarkAsChild();
            _maVT = pro.MaVT;
            _tenTM = pro.TenTM;
        }
        protected VPPKiemKe_C(string maKK, DMVPP pro)
        {
            MarkAsChild();
            _maKK = maKK;            
            _maVT = pro.MaVT;
        ...
        protected VPPKiemKe_C(SafeDataReader dr)
        {
            MarkAsChild();
        ...
        protected VPPKiemKe_C(SafeDataReader dr, int i)
        {
            MarkAsChild();
            _OrderNumber = i;
            _maKK = dr.GetString("maKK");
		...
		protected void DataPortal_Fetch(Criteria crit)
		{
			...
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetVPPKiemKe_C(crit.MaKK, crit.STT)))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
        /// Insert the new <see cref="VPPKiemKe_C" /> Object to underlying database.
		/// </summary>
        /// 
        ...
        internal virtual void Insert(VPPKiemKe  bill)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertVTKiemKe_C
			// Copy & paste ham duoi day vao file DataProvider.cs
            
              
            DataProvider.Instance().InsertVPPKiemKe_C(bill.MaKK, _maVT, _soLuong, _dongia, _sLDC, _ghiChu, _sLton, _nguoiSD , _maMay);
			// public abstract String InsertVTKiemKe_C(String _maKK, String _maVT, Decimal _soLuong, Decimal _dongia, Decimal _sLDC, String _ghiChu, Decimal _sLton, String _nguoiSD, String _maMay);
		...
		/// </summary>
        internal virtual void Update(VPPKiemKe bill)
		{
			...
			if (IsDirty){
                ...
                _maKK = bill.MaKK;
                DataProvider.Instance().UpdateVPPKiemKe_C(bill.MaKK, _sTT, _maVT, _soLuong, _dongia, _sLDC, _ghiChu, _sLton, _huy, _nguoiSD , _maMay);
        ...
        internal void DeleteSelf(VPPKiemKe  packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
            ...
            DataProvider.Instance().DeleteVPPKiemKe_C(_maMay, _nguoiSD , _maKK, _sTT);
            MarkNew();
