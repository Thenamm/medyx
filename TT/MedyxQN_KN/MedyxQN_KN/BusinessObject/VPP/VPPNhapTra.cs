...
{
    [Serializable()]
    public partial class VPPNhapTra : BusinessBase<VPPNhapTra>
    {
       ...
       // private SmartDate _ngayXuatTT = new SmartDate(false);
        ...
        VPPNhapTra_Cs _VPPNhapTraCs = VPPNhapTra_Cs.NewVPPNhapTra_Cs();
        public VPPNhapTra_Cs VPPNhapTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                return _VPPNhapTraCs;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                if (!_VPPNhapTraCs.Equals(value))
                {
                    _VPPNhapTraCs = value;
                    PropertyHasChanged();
                }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _VPPNhapTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _VPPNhapTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<VPPNhapTra>(StringRequired<VPPNhapTra>, "NoiXuat");
            ...
            ValidationRules.AddRule<VPPNhapTra>(StringRequiredNoiNhap<VPPNhapTra>, "Noinhap");


        }
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : VPPNhapTra
        {
        ...
        private static bool StringRequiredNoiNhap<T>(T target, Csla.Validation.RuleArgs e) where T : VPPNhapTra
        {
        ...
        public static VPPNhapTra NewVPPNhapTra()
        { 
            return DataPortal.Create<VPPNhapTra>();
        }

        public static VPPNhapTra GetVPPNhapTra(String MaPNT,byte loaiphieu,byte daphat,Boolean qadmin)
        {
            return DataPortal.Fetch<VPPNhapTra>(new Criteria(MaPNT,loaiphieu ,daphat,qadmin  ));
        }

        public static VPPNhapTra GetVPPNhapTra(SafeDataReader dr)
        {
            VPPNhapTra obj = new VPPNhapTra();
            obj.Fetch(dr);
            return obj;
            
        }

        public static void DeleteVPPNhapTra(String MaPNT, string mamay, string nguoihuy)
        {
        ...
        protected internal VPPNhapTra()
        { 
            //
        }
        internal VPPNhapTra( int OrderNumber,
                            String MaPNT,
                            String noiXuat,
                            //SmartDate ngayXuat,
        ...
        { 
            using (SafeDataReader dr=new SafeDataReader(DataProvider.Instance().GetVPPNhapTra(crit.MaPNT,crit.qadmin,crit.LoaiPhieu,crit.daphat)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
                    if (dr.NextResult())
                    {
                        _VPPNhapTraCs = VPPNhapTra_Cs.GetVPPNhapTra_Cs(dr);  
                    } 
                }
            }
        }
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _MaPNT = DataProvider.Instance().InsertVPPNhapTra(_noiNhap, _ngayNhap, _ngayNhapTT, _noiXuat, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _nguoiSD , _BNTra,_maMay, _daPhat);

            _VPPNhapTraCs.Update(this);
        ...
        protected override void DataPortal_Update()
        {
            ...
            DataProvider.Instance().UpdateVPPNhapTra(_MaPNT, _noiXuat, _ngayNhap, _ngayNhapTT, _noiNhap, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _huy, _maMay, _nguoiSD , _daPhat, _BNTra, _daDuyet);
        ...
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            ...
            DataProvider.Instance().DeleteVPPNhapTra(crit.MaPNT, crit.MaMay, crit.NguoiSD);
