...
//
// Ten file        :	VPPPhieuDTNhap
// Kieu doi tuong  :	VPPPhieuDTNhap
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="VPPPhieuDTNhap" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class VPPPhieuDTNhap : BusinessBase<VPPPhieuDTNhap>
	{
        ...
        VPPPhieuDTNhap_C_List _VPPPhieuDTNhap_Cs = VPPPhieuDTNhap_C_List.NewVPPPhieuDTNhap_C_List();

        public VPPPhieuDTNhap_C_List VPPPhieuDTNhap_Cs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                //CanReadProperty(true);
                return _VPPPhieuDTNhap_Cs;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                //CanWriteProperty(true);
                if (!_VPPPhieuDTNhap_Cs.Equals(value))
                {
                    _VPPPhieuDTNhap_Cs = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _VPPPhieuDTNhap_Cs.IsDirty;
            }
        }
        ...
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _VPPPhieuDTNhap_Cs.IsValid;
            }
        }
		#endregion
		#endregion
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<VPPPhieuDTNhap>(StringRequired<VPPPhieuDTNhap>, "MaKho");
            ValidationRules.AddRule<VPPPhieuDTNhap>(ValidationDateTT<VPPPhieuDTNhap>, "NgayPhieu");
            ValidationRules.AddRule<VPPPhieuDTNhap>(ValidationDateNow<VPPPhieuDTNhap>, "NgayPhieu");
        }
        private static bool ValidationDateTT<T>(T target, Csla.Validation.RuleArgs e) where T : VPPPhieuDTNhap
        {
        ...
        private static bool ValidationDateNow<T>(T target, Csla.Validation.RuleArgs e) where T : VPPPhieuDTNhap
        {
        ...
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : VPPPhieuDTNhap
        {
		...
		/// <summary>
		/// Factory method. New <see cref="VPPPhieuDTNhap" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static VPPPhieuDTNhap NewVPPPhieuDTNhap()
        {
            return DataPortal.Create<VPPPhieuDTNhap>();
        }
		public static VPPPhieuDTNhap GetVPPPhieuDTNhap(String maDuTru)
		{
			return DataPortal.Fetch<VPPPhieuDTNhap>(new Criteria(maDuTru));
		}
        public static VPPPhieuDTNhap GetVPPPhieuDTNhap(SafeDataReader dr)
        {
            VPPPhieuDTNhap obj = new VPPPhieuDTNhap();
            obj.Fetch(dr);
            return obj;
        }
		/// <summary>
		/// Marks the <see cref="VPPPhieuDTNhap" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteVPPPhieuDTNhap(String maDuTru, string mamay, string nguoihuy)
		{
		...
		protected internal VPPPhieuDTNhap()
		{	
			// Prevent direct creation
		}
        internal VPPPhieuDTNhap(
  int OrderNumber,
  String maDuTru ,
  String maNCC,
  string tenNCC,
 ...
 _tenNguoiHuy = tenNguoiHuy;
		...
		/// <summary>
		/// Retrieve an existing <see cref="VPPPhieuDTNhap" /> Object based on data in the database.
		/// </summary>
        /// 

		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetVPPPhieuDTNhap(String _maDuTru);
			// public override IDataReader GetVPPPhieuDTNhap(String _maDuTru)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDuTru));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetVPPPhieuDTNhap(crit.MaDuTru,crit.qadmin  )))
			{
				if (dr.Read()){
					Fetch(dr);
                    if (dr.NextResult())
                    {
                        _VPPPhieuDTNhap_Cs = VPPPhieuDTNhap_C_List.GetVPPPhieuDTNhap_C_List(dr);
                    }
                    //MarkOld();
		...
		/// <summary>
		/// Load a <see cref="VPPPhieuDTNhap" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="VPPPhieuDTNhap" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertVPPPhieuDTNhap
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
			_maDuTru = DataProvider.Instance().InsertVPPPhieuDTNhap(_soCT, _ngayPhieu, _makho, _nguoiDuTru, _tong, _ghichu,  _nguoiLap, _maMay, _maNCC );
            _VPPPhieuDTNhap_Cs.Update(this);
			// public abstract String InsertVPPPhieuDTNhap(String _maDuTru, String _soCT, SmartDate _ngayPhieu, String _makho, String _nguoiDuTru, Decimal _tong, String _ghichu, Boolean _huy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngayHuy, String _nguoiHuy, SmartDate _ngaySD, String _nguoiSD, SmartDate _ngaySD1, String _nguoiSD1, String _maMay);
			// public override String InsertVPPPhieuDTNhap(String _maDuTru, String _soCT, SmartDate _ngayPhieu, String _makho, String _nguoiDuTru, Decimal _tong, String _ghichu, Boolean _huy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngayHuy, String _nguoiHuy, SmartDate _ngaySD, String _nguoiSD, SmartDate _ngaySD1, String _nguoiSD1, String _maMay);
			// {
		...
		/// <summary>
		/// Update all changes made on <see cref="VPPPhieuDTNhap" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateVPPPhieuDTNhap
			if (IsDirty){
                
                
				DataProvider.Instance().UpdateVPPPhieuDTNhap(_maDuTru, _soCT, _ngayPhieu, _makho, _nguoiDuTru, _tong, _ghichu, _huy, _nguoiSD , _maMay, _maNCC );
                _VPPPhieuDTNhap_Cs.Update(this);
				// public abstract void UpdateVPPPhieuDTNhap(String _maDuTru, String _soCT, SmartDate _ngayPhieu, String _makho, String _nguoiDuTru, Decimal _tong, String _ghichu, Boolean _huy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngayHuy, String _nguoiHuy, SmartDate _ngaySD, String _nguoiSD, SmartDate _ngaySD1, String _nguoiSD1, String _maMay);
				// public override void UpdateVPPPhieuDTNhap(String _maDuTru, String _soCT, SmartDate _ngayPhieu, String _makho, String _nguoiDuTru, Decimal _tong, String _ghichu, Boolean _huy, SmartDate _ngayLap, String _nguoiLap, SmartDate _ngayHuy, String _nguoiHuy, SmartDate _ngaySD, String _nguoiSD, SmartDate _ngaySD1, String _nguoiSD1, String _maMay);
				// {
		...
		/// <summary>
		/// Delete the <see cref="VPPPhieuDTNhap" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateVPPPhieuDTNhap
            DataProvider.Instance().DeleteVPPPhieuDTNhap(crit.MaMay, crit.NguoiSD, crit.MaDuTru);
			// public abstract void DeleteVPPPhieuDTNhap(String _maDuTru);
			// public override void DeleteVPPPhieuDTNhap(String _maDuTru);
			// {
