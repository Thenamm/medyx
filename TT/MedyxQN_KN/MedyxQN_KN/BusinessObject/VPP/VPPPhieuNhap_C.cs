...
{
    [Serializable()]
    public partial class VPPPhieuNhap_C : BusinessBase<VPPPhieuNhap_C>
    {
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<VPPPhieuNhap_C>(StringRequired<VPPPhieuNhap_C>, "TENTM");
            ValidationRules.AddRule<VPPPhieuNhap_C>(ValidationSoLuong<VPPPhieuNhap_C>, "Soluong");
        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : VPPPhieuNhap_C
        {
        ...
        private static bool StringRequiredSoLo<T>(T target, Csla.Validation.RuleArgs e) where T : VPPPhieuNhap_C
        {
        ...
        private static bool ValidationSoLuong<T>(T target, Csla.Validation.RuleArgs e) where T : VPPPhieuNhap_C
        {
		...
		/// </summary> 
        /// 
        public static VPPPhieuNhap_C NewVPPPhieuNhap_C()
        {
            return new VPPPhieuNhap_C();
           
        }
        public static VPPPhieuNhap_C NewVPPPhieuNhap_C(string idDMVPP)
        {
            return new VPPPhieuNhap_C(DMVPP.GetDMVPP(idDMVPP));
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static VPPPhieuNhap_C NewVPPPhieuNhap_C(DMVPP _DMVPP)
        {
            return new VPPPhieuNhap_C(_DMVPP);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        public static VPPPhieuNhap_C GetVPPPhieuNhap_C(String maVPPPhieuNhap, decimal sTT)
        {
            return DataPortal.Fetch<VPPPhieuNhap_C>(new Criteria(maVPPPhieuNhap, sTT));
        }
        public static VPPPhieuNhap_C GetVPPPhieuNhap_C(SafeDataReader dr)
        {
            return new VPPPhieuNhap_C(dr);
        }

        public static void DeleteVPPPhieuNhap_C(String _maPN, decimal _sTT, string mamay, string nguoisd)
        {
        ...
        protected internal VPPPhieuNhap_C()
        {
            // Prevent direct creation
            _chietKhau = 0;
        }
        protected VPPPhieuNhap_C(DMVPP pro)
        {
            MarkAsChild();
        ...
        protected VPPPhieuNhap_C(string _idMaPN, DMVPP pro)
        {
            MarkAsChild();
            _maPN = _idMaPN;
            _maVT = pro.MaVT;
        ...
        protected VPPPhieuNhap_C(SafeDataReader dr)//lay nhung thang hien ra tren luoi
        {
            MarkAsChild();
        ...
        protected void DataPortal_Fetch(Criteria crit)
        {
            ...
            using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetVPPPhieuNhap_C_Get(crit.MaPN, crit.STT)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
		...
		/// </summary>
        private void Fetch(SafeDataReader dr)//lay o chi tiet thu tuc spVPPPhieuNhap_C_Get
        {
            // Value properties
        ...
        internal virtual void Insert(VPPPhieuNhap bill)
        {
            ...
            //_maPhieu = DataProvider.Instance().InsertDMDichVu_PhieuIn_C(_maDV, _maMay, _nguoiSD);_ghichu.Substring(0, _ghichu.Length - 2
             ...
             DataProvider.Instance().InsertVPPPhieuNhap_C(bill.MaPN, _maVT, _soLuong, _hanSD, _donGia, _chietKhau, _soLo, _huy, _ghiChu, _maMay, _nguoiSD);
        ...
        internal virtual void Update(VPPPhieuNhap bill)
        {
            ...
            if (IsDirty)
            {
                ...
                _maPN = bill.MaPN;
                DataProvider.Instance().UpdateVPPPhieuNhap_C(bill.MaPN, _sTT, _maVT, _soLuong, _hanSD, _donGia, _chietKhau, _soLo, _huy, _ghiChu, _ngaySD, _maMay, _nguoiSD);
        ...
        internal void DeleteSelf(VPPPhieuNhap bill)
        {
            ...
            DataProvider.Instance().DeleteVPPPhieuNhap_C(_maPN, _sTT,_nguoiSD , _maMay  );
            MarkNew();
        }
		#endregion
	}
