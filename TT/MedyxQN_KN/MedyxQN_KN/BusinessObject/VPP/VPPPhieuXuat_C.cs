...
{	
	...
	[Serializable()]
	public partial class VPPPhieuXuat_C : BusinessBase<VPPPhieuXuat_C>
	{
        ...
        public static VPPPhieuXuat_C NewVPPPhieuXuat_C()
        {
            return new VPPPhieuXuat_C();
            
        }

        public static VPPPhieuXuat_C NewVPPPhieuXuat_C(string idDMVPP)
        {
            return new VPPPhieuXuat_C(DMVPP.GetDMVPP(idDMVPP));
        }

        public static VPPPhieuXuat_C NewVPPPhieuXuat_C(DMVPP _DMVPP)
        {
            return new VPPPhieuXuat_C(_DMVPP);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        
        public static VPPPhieuXuat_C GetVPPPhieuXuat_C(String maVPPPhieuXuat, decimal sTT)
        {
            return DataPortal.Fetch<VPPPhieuXuat_C>(new Criteria(maVPPPhieuXuat, sTT));
        }

        public static VPPPhieuXuat_C GetVPPPhieuXuat_C(SafeDataReader dr)
        {
            return new VPPPhieuXuat_C(dr);
        }

        public static void DeleteVPPPhieuXuat_C(String _maPN, decimal _sTT,string nguoisd,string mamay)
        {
        ...
        protected internal VPPPhieuXuat_C()
        { 
            //
        }
        protected VPPPhieuXuat_C(DMVPP pro)
        {
            MarkAsChild();
            _maVT = pro.MaVT;
            _tenTM = pro.TenTM;
        }
        protected VPPPhieuXuat_C(string _idMaPX, DMVPP pro)
        {
            MarkAsChild();
            _maPX = _idMaPX;            
            _maVT = pro.MaVT;
        ...
        protected VPPPhieuXuat_C(SafeDataReader dr)
        {
            MarkAsChild();
        ...
        {
            //using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetVPPPhieuXuat_C(crit.MaPX, crit.STT))) 
            //{
            //    if (dr.Read())
            //    {
            //        Fetch(dr);
        ...
        internal virtual void Insert(VPPPhieuXuat bill)
        {
            
              
            _maPX = bill.MaPX;
             DataProvider.Instance().InsertVPPPhieuXuat_C(bill.MaPX, _maVT, _soLuong, _hanSD, _soLo, _donGia, _soLuongYC, _giaBan, _ghiChu, _nguoiSD , _maMay);
        }

        internal virtual void Update(VPPPhieuXuat bill)
        {
            if(IsDirty)
            {      
            
              
            DataProvider.Instance().UpdateVPPPhieuXuat_C(bill.MaPX, _sTT, _maVT, _soLuong, _hanSD, _soLo, _donGia,  _soLuongYC, _giaBan,  _huy,  _ghiChu, _nguoiSD ,  _maMay);
            }
        }
        internal void DeleteSelf(VPPPhieuXuat packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
            ...
            DataProvider.Instance().DeleteVPPPhieuXuat_C(_maPX,_sTT,_nguoiSD,_maMay);
            MarkNew();
