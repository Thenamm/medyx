...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="VPPTonKhoa" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class VPPTonKhoa : BusinessBase<VPPTonKhoa>
	{
        ...
        public string TonKK
        {
            get
            {
                CanReadProperty("TonKK", true);

                return _TonKK.ToString("###,###.00");
            }
            set
            {
                CanWriteProperty("TonKK", true);

                if (_TonKK.ToString() != value)
                {
                    _TonKK = decimal.Parse(value);
                    PropertyHasChanged("TonKK");
                }
            }
        }
		...
		/// <summary>
		/// Factory method. New <see cref="VPPTonKhoa" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static VPPTonKhoa NewVPPTonKhoa()
        {
            return new VPPTonKhoa();
        }
        //public static VPPTonKhoa GetVPPTonKhoa(String makhoa, String MaVT, SmartDate thang)
        //{
        //    return DataPortal.Fetch<VPPTonKhoa>(new Criteria(makhoa, MaVT, thang));
        //}
        internal static VPPTonKhoa GetVPPTonKhoa(SafeDataReader dr)
        {
            return new VPPTonKhoa(dr);
        }
        internal static VPPTonKhoa GetVPPTonKhoa(SafeDataReader dr,int i)
        {
            return new VPPTonKhoa(dr,i);
        }
		/// <summary>
		/// Marks the <see cref="VPPTonKhoa" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteVPPTonKhoa(String makhoa, String MaVPP, SmartDate thang)
        //{
        //    DataPortal.Delete(new Criteria(makhoa, MaVPP, thang));
        //}
        ...
        //}
		/// <summary>
		/// Load a <see cref="VPPTonKhoa" /> Object from given SafeDataReader.
		/// </summary>
        /// 
        public VPPTonKhoa()
        {
        ...
        private VPPTonKhoa(SafeDataReader dr)
        {
            // Value properties
            MarkAsChild();
            ...
            if (dr.GetDecimal("TonKK") != null) _TonKK = dr.GetDecimal("TonKK");

            MarkOld();
        }

        private VPPTonKhoa(SafeDataReader dr,int i)
        {
            // Value properties
            MarkAsChild();
            _OrderNumber = i;
        ...
        internal void Insert()
		{
            ...
            DataProvider.Instance().InsertVPPTonKhoa(_makhoa, _mathuoc, _thang, _soDK, _sLN, _sLX, _sLNT, _sLXT, _sLDC, _tonCK, _giaNhap, _nguoiSD , _maMay, _TonKK);
			// public abstract String InsertVPPTonKhoa(String _makhoa, String _mathuoc, SmartDate _thang, Decimal _soDK, Decimal _sLN, Decimal _sLX, Decimal _sLNT, Decimal _sLXT, Decimal _sLDC, Decimal _tonCK, Decimal _giaNhap, String _nguoiSD, String _maMay);
			// public override String InsertVPPTonKhoa(String _makhoa, String _mathuoc, SmartDate _thang, Decimal _soDK, Decimal _sLN, Decimal _sLX, Decimal _sLNT, Decimal _sLXT, Decimal _sLDC, Decimal _tonCK, Decimal _giaNhap, String _nguoiSD, String _maMay)
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spVPPTonKhoa_CREATE", _makhoa, _mathuoc, _thang.DBValue, _soDK, _sLN, _sLX, _sLNT, _sLXT, _sLDC, _tonCK, _giaNhap, _nguoiSD , _maMay));
			// }
            MarkOld();
		}
		
		/// <summary>
		/// Update all changes made on <see cref="VPPTonKhoa" /> Object to underlying database.
		/// </summary>
        internal void Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateVPPTonKhoa
            if (!this.IsDirty)
                return;
            DataProvider.Instance().UpdateVPPTonKhoa(_makhoa, _mathuoc, _thang, _soDK, _sLN, _sLX, _sLNT, _sLXT, _sLDC, _tonCK, _giaNhap, _nguoiSD , _maMay, _TonKK);
				// public abstract void UpdateVPPTonKhoa(String _makhoa, String _mathuoc, SmartDate _thang, Decimal _soDK, Decimal _sLN, Decimal _sLX, Decimal _sLNT, Decimal _sLXT, Decimal _sLDC, Decimal _tonCK, Decimal _giaNhap, String _nguoiSD, String _maMay);
				// public override void UpdateVPPTonKhoa(String _makhoa, String _mathuoc, SmartDate _thang, Decimal _soDK, Decimal _sLN, Decimal _sLX, Decimal _sLNT, Decimal _sLXT, Decimal _sLDC, Decimal _tonCK, Decimal _giaNhap, String _nguoiSD, String _maMay)
				// {
                //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spVPPTonKhoa_UPDATE", _makhoa, _mathuoc, _thang.DBValue, _soDK, _sLN, _sLX, _sLNT, _sLXT, _sLDC, _tonCK, _giaNhap, _nguoiSD , _maMay);
				// }				
                MarkOld();
		}
        ...
        ///// <summary>
        ///// Delete the <see cref="VPPTonKhoa" />.
        ///// </summary>
        //protected void DataPortal_Delete(Criteria crit)
        //{
        //    // TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateVPPTonKhoa
        //    DataProvider.Instance().DeleteVPPTonKhoa(crit.Makhoa, crit.MaVPP, crit.Thang.DBValue);
        //    // public abstract void DeleteVPPTonKhoa(String _makhoa, String _mathuoc, SmartDate _thang);
        //    // public override void DeleteVPPTonKhoa(String _makhoa, String _mathuoc, SmartDate _thang);
        //    // {
