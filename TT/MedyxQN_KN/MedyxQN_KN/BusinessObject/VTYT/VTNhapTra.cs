...
{
    [Serializable()]
    public partial class VTNhapTra : BusinessBase<VTNhapTra>
    {
       ...
       // private SmartDate _ngayXuatTT = new SmartDate(false);
        ...
        VTNhapTra_Cs _VTNhapTraCs = VTNhapTra_Cs.NewVTNhapTra_Cs();
        public VTNhapTra_Cs VTNhapTraCs
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _VTNhapTraCs.IsDirty;
            }
        }
        public override bool IsValid
        {
            get
            {
                return base.IsValid && _VTNhapTraCs.IsValid;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<VTNhapTra>(StringRequired<VTNhapTra>, "NoiXuat");
            ...
            ValidationRules.AddRule<VTNhapTra>(StringRequiredNoiNhap<VTNhapTra>, "Noinhap");


        }
        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : VTNhapTra
        {
        ...
        private static bool StringRequiredNoiNhap<T>(T target, Csla.Validation.RuleArgs e) where T : VTNhapTra
        {
        ...
        public static VTNhapTra NewVTNhapTra()
        { 
            return DataPortal.Create<VTNhapTra>();
        }

        public static VTNhapTra GetVTNhapTra(String MaPNT,byte loaiphieu,byte daphat,Boolean qadmin)
        {
            return DataPortal.Fetch<VTNhapTra>(new Criteria(MaPNT,loaiphieu ,daphat,qadmin  ));
        }

        public static VTNhapTra GetVTNhapTra(SafeDataReader dr)
        {
            VTNhapTra obj = new VTNhapTra();
            obj.Fetch(dr);
            return obj;
            
        }

        public static void DeleteVTNhapTra(String MaPNT, string mamay, string nguoihuy)
        {
        ...
        protected internal VTNhapTra()
        { 
            //
        }
        internal VTNhapTra( int OrderNumber,
                            String MaPNT,
                            String noiXuat,
                            //SmartDate ngayXuat,
        ...
        { 
            using (SafeDataReader dr=new SafeDataReader(DataProvider.Instance().GetVTNhapTra(crit.MaPNT,crit.qadmin,crit.LoaiPhieu,crit.daphat)))
            {
                if (dr.Read())
                {
                    Fetch(dr);
                    if (dr.NextResult())
                    {
                        _VTNhapTraCs = VTNhapTra_Cs.GetVTNhapTra_Cs(dr);  
                    } 
                }
            }
        }
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _MaPNT = DataProvider.Instance().InsertVTNhapTra(_noiNhap, _ngayNhap, _ngayNhapTT, _noiXuat, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _nguoiSD , _BNTra,_maMay, _daPhat);
            MarkOld();
            _VTNhapTraCs.Update(this);
        ...
        protected override void DataPortal_Update()
        {
            ...
            DataProvider.Instance().UpdateVTNhapTra(_MaPNT, _noiXuat, _ngayNhap, _ngayNhapTT, _noiNhap, _loaiPhieu, _soCT, _nvXuat, _nvNhan, _ghiChu, _huy, _maMay, _nguoiSD , _daPhat, _BNTra, _daDuyet);
        ...
        protected void DataPortal_Delete(OtherCriteria crit)
        {
            ...
            DataProvider.Instance().DeleteVTNhapTra(crit.MaPNT, crit.MaMay, crit.NguoiSD);
