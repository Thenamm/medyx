...
//
// Ten file        :	VTPhieuDoiThuoc
// Kieu doi tuong  :	VTPhieuDoiThuoc
...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="VTPhieuDoiThuoc" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class VTPhieuDoiThuoc : BusinessBase<VTPhieuDoiThuoc>
	{
        ...
        VTPhieuDoiThuoc_C_List _VTPhieuDoiThuoc_C_List = VTPhieuDoiThuoc_C_List.NewVTPhieuDoiThuoc_C_List();
        public VTPhieuDoiThuoc_C_List VTPhieuDoiThuoc_C_List
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                return _VTPhieuDoiThuoc_C_List;
            }
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            set
            {
                if (!_VTPhieuDoiThuoc_C_List.Equals(value))
                {
                    _VTPhieuDoiThuoc_C_List = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public override bool IsDirty
        {
            get
            {
                return base.IsDirty || _VTPhieuDoiThuoc_C_List.IsDirty ;
            }
        }
        public override bool IsValid
        {
            ...
            {
                return base.IsValid && _VTPhieuDoiThuoc_C_List.IsValid ;
            }
        }
        ...
        protected override void AddBusinessRules()
        {
            ...
            ValidationRules.AddRule<VTPhieuDoiThuoc>(StringRequired<VTPhieuDoiThuoc>, "MaNCC");
            //ValidationRules.AddRule(Csla.Validation.CommonRules.StringMaxLength, new Csla.Validation.CommonRules.MaxLengthRuleArgs("TenTM", 350));
            //ValidationRules.AddRule<VTPhieuDoiThuoc>(StringRequiredCT<VTPhieuDoiThuoc>, "SoCT");

        }

        private static bool StringRequired<T>(T target, Csla.Validation.RuleArgs e) where T : VTPhieuDoiThuoc
        {
        ...
        private static bool StringRequiredCT<T>(T target, Csla.Validation.RuleArgs e) where T : VTPhieuDoiThuoc
        {
		...
		/// <summary>
		/// Factory method. New <see cref="VTPhieuDoiThuoc" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 
        public static VTPhieuDoiThuoc NewVTPhieuDoiThuoc()
        {
            return DataPortal.Create<VTPhieuDoiThuoc>();
        }

		public static VTPhieuDoiThuoc GetVTPhieuDoiThuoc(String maDThuoc)
		{
			return DataPortal.Fetch<VTPhieuDoiThuoc>(new Criteria(maDThuoc));
		}
        public static VTPhieuDoiThuoc GetVTPhieuDoiThuoc(SafeDataReader dr)
        {
            VTPhieuDoiThuoc obj = new VTPhieuDoiThuoc();
            obj.Fetch(dr);
            return obj;

        }
		/// <summary>
		/// Marks the <see cref="VTPhieuDoiThuoc" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        public static void DeleteVTPhieuDoiThuoc(String maDThuoc, string mamay, string nguoihuy)
		{
		...
		protected internal VTPhieuDoiThuoc()
		{	
			// Prevent direct creation
		}
        internal VTPhieuDoiThuoc( 
                                int OrderNumber,
                                String maDThuoc,
		                     String maNCC ,
		                     String soCT ,
		...
		/// <summary>
		/// Retrieve an existing <see cref="VTPhieuDoiThuoc" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetVTPhieuDoiThuoc(String _maDThuoc);
			// public override IDataReader GetVTPhieuDoiThuoc(String _maDThuoc)
			// {
			//	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "", _maDThuoc));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetVTPhieuDoiThuoc(crit.MaDThuoc,crit.qadmin )))
			{
				if (dr.Read()){
					Fetch(dr);
                    if (dr.NextResult())
                    {
                        _VTPhieuDoiThuoc_C_List = VTPhieuDoiThuoc_C_List.GetVTPhieuDoiThuoc_C_List(dr);
                    }
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="VTPhieuDoiThuoc" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// <summary>
		/// Insert the new <see cref="VTPhieuDoiThuoc" /> Object to underlying database.
		/// </summary>
        /// 
		...
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham InsertVTPhieuDoiThuoc
			// Copy & paste ham duoi day vao file DataProvider.cs
            
            
			_maDThuoc = DataProvider.Instance().InsertVTPhieuDoiThuoc(_maNCC, _soCT, _ngayDThuoc, _makho, _ghichu, _nguoiSD , _maMay);
            MarkOld();
            _VTPhieuDoiThuoc_C_List.Update(this);
			...
			// {
            //		return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner + ObjectQualifier + "spVTPhieuDoiThuoc_CREATE", _maNCC, _soCT, _ngayDThuoc.DBValue, _makho, _ghichu, _nguoiSD , _maMay));
			// }
		}
		
		/// <summary>
		/// Update all changes made on <see cref="VTPhieuDoiThuoc" /> Object to underlying database.
		/// </summary>
		protected override void DataPortal_Update()
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateVTPhieuDoiThuoc
			if (IsDirty){
                
                  
				DataProvider.Instance().UpdateVTPhieuDoiThuoc(_maDThuoc, _maNCC, _soCT, _ngayDThuoc, _makho, _ghichu, _huy, _nguoiSD , _maMay);
                _VTPhieuDoiThuoc_C_List.Update(this);
		...
		/// <summary>
		/// Delete the <see cref="VTPhieuDoiThuoc" />.
		/// </summary>
        protected void DataPortal_Delete(OtherCriteria crit)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateVTPhieuDoiThuoc
            DataProvider.Instance().DeleteVTPhieuDoiThuoc(crit.MaMay, crit.NguoiSD, crit.MaDThuoc);
			// public abstract void DeleteVTPhieuDoiThuoc(String _maDThuoc);
			// public override void DeleteVTPhieuDoiThuoc(String _maDThuoc);
			// {
            //		SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spVTPhieuDoiThuoc_DELETED", _maDThuoc);
			// }
		}
