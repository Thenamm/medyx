...
{	
	...
	[Serializable()]
	public partial class VTPhieuXuat_Xe_C : BusinessBase<VTPhieuXuat_Xe_C>
	{
        ...
        private Decimal _tuso = 0;
        private Decimal _denso = 0;
        ...
        public string tuso
        {
            get
            {
                ...
                else if ((_tuso - int.Parse(_tuso.ToString("###"))) == 0)
                {
                    return _tuso.ToString("###,###");
                }
                else
                {
                    return _tuso.ToString("###,###.##");
            ...
            set
            {
                ...
                if (_tuso.ToString() != value)
                {
                    _tuso = decimal.Parse(value);
        ...
        public string denso
        {
            get
            {
                ...
                else if (_denso - (int)(_denso) != 0)
                {
                    return _denso.ToString("###,###.###");
                }
                else
                {
                    return _denso.ToString("###,###");
            ...
            set
            {
                ...
                if (_denso.ToString() != value)
                {
                    _denso = decimal.Parse(value);
        ...
        public static VTPhieuXuat_Xe_C NewVTPhieuXuat_C()
        {
            return new VTPhieuXuat_Xe_C();
            
        }

        public static VTPhieuXuat_Xe_C NewVTPhieuXuat_C(string idDMVTYT)
        {
            return new VTPhieuXuat_Xe_C(DMVTYT.GetDMVTYT(idDMVTYT));
        }

        public static VTPhieuXuat_Xe_C NewVTPhieuXuat_C(DMVTYT _DMVTYT)
        {
            return new VTPhieuXuat_Xe_C(_DMVTYT);
            //return DataPortal.Create<DMDichVu_PhieuIn_C>(DMDichVu.GetDMDichVu(idDMDichvu));
        }
        
        public static VTPhieuXuat_Xe_C GetVTPhieuXuat_C(String maVTPhieuXuat, decimal sTT)
        {
            return DataPortal.Fetch<VTPhieuXuat_Xe_C>(new Criteria(maVTPhieuXuat, sTT));
        }

        public static VTPhieuXuat_Xe_C GetVTPhieuXuat_C(SafeDataReader dr)
        {
            return new VTPhieuXuat_Xe_C(dr);
        }

        public static void DeleteVTPhieuXuat_Xe_C(String _maPN, decimal _sTT, string _nguoiSD, string _mamay)
        {
        ...
        protected internal VTPhieuXuat_Xe_C()
        { 
            //
        }
        protected VTPhieuXuat_Xe_C(DMVTYT pro)
        {
            MarkAsChild();
            _maVT = pro.MaVT;
            _tenTM = pro.TenTM;
        }
        protected VTPhieuXuat_Xe_C(string _idMaPX, DMVTYT pro)
        {
            MarkAsChild();
            _maPX = _idMaPX;            
            _maVT = pro.MaVT;
        ...
        protected VTPhieuXuat_Xe_C(SafeDataReader dr)
        {
            MarkAsChild();
        ...
        protected void Fetch(SafeDataReader dr)
        {
            ...
            if (dr.GetBoolean("Handung") != null) _handung = dr.GetBoolean("Handung");
            if (dr.GetDecimal("tuso") != null) _tuso = dr.GetDecimal("tuso");
            if (dr.GetDecimal("denso") != null) _denso = dr.GetDecimal("denso");
        ...
        {
            //using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetVTPhieuXuat_C(crit.MaPX, crit.STT))) 
            //{
            //    if (dr.Read())
            //    {
            //        Fetch(dr);
        ...
        internal virtual void Insert(VTPhieuXuat_Xe bill)
        {
            
              
            _maPX = bill.MaPX;
             DataProvider.Instance().InsertVTPhieuXuat_Xe_C(bill.MaPX, _maVT, _soLuong, _hanSD, _soLo, _donGia, _soLuongYC, _giaBan, _ghiChu, _nguoiSD , _maMay,_MaXeOto,_tuso ,_denso ,_MaNVQL );
             MarkOld();
        }

        internal virtual void Update(VTPhieuXuat_Xe bill)
        {
            if(IsDirty)
            {      
            
              
            DataProvider.Instance().UpdateVTPhieuXuat_Xe_C(bill.MaPX, _sTT, _maVT, _soLuong, _hanSD, _soLo, _donGia, _soLuongYC, _giaBan, _huy, _ghiChu, _nguoiSD , _maMay, _MaXeOto, _tuso, _denso, _MaNVQL);
            }
        }
        internal void DeleteSelf(VTPhieuXuat_Xe packet)
        {
            if (!this.IsDirty)
                return;
            if (this.IsNew)
                return;
            DataProvider.Instance().DeleteVTPhieuXuat_Xe_C(_maPX,_sTT,_nguoiSD,_maMay);
            MarkNew();
