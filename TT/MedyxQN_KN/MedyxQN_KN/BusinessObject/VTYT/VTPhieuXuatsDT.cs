...
{
    [Serializable()]
    public class VTPhieuXuatsDT : BusinessListBase<VTPhieuXuatsDT,VTPhieuXuatDT>
    {
        #region Business Methods
        public VTPhieuXuatDT this[int i]
        {
            get
            {
        ...
        public static VTPhieuXuatsDT GetAllVTPhieuXuat(Boolean qadmin ,String makho, Byte loaiphieu, Boolean daphat, DateTime tungay, DateTime denngay, String dieukienthem, Boolean daduyet)
        {
            return DataPortal.Fetch<VTPhieuXuatsDT>(new Criteria(qadmin , makho, loaiphieu, daphat , tungay, denngay, dieukienthem,daduyet ));
        }
        //public static VTPhieuXuatsDT FindVTPhieuXuatByKho(string TenKho)
        //{ 
        //    return DataPortal.Fetch<VTPhieuXuatsDT>()
        //}
        public void NewTo(VTPhieuXuatDT _VTPhieuXuat)
        {
            _VTPhieuXuat.OrderNumber = this.Items[this.Count - 1].OrderNumber + 1;
            this.Add(_VTPhieuXuat);
        }
        public void UpdatedTo(VTPhieuXuatDT _VTPhieuXuat)
        {
        ...
        public void RemoveTo(VTPhieuXuatDT _VTPhieuXuat)
        {
            this.Items.Remove(_VTPhieuXuat);

        }

        private VTPhieuXuatsDT()
        {
      ...
      criteria.DenNgay, criteria.DieuKienThem,criteria.DaDuyet   )))
            {
                ...
                while (dr.Read())
                {
                VTPhieuXuatDT item=new VTPhieuXuatDT(
     i,
     dr.GetString("MaPX"),
