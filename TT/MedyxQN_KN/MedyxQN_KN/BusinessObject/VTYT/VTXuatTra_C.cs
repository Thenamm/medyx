...
{	
	...
	/// <summary>
	/// This is a base generated class of <see cref="VTXuatTra_C" /> Business Object.
	/// </summary>
	
	[Serializable()]
	public partial class VTXuatTra_C : BusinessBase<VTXuatTra_C>
	{
		...
		/// <summary>
		/// Factory method. New <see cref="VTXuatTra_C" /> Object is loaded from the database, based on given parameters.
		/// </summary> 
        /// 

        public static VTXuatTra_C NewVTXuatTra_C()
        {
            return new VTXuatTra_C();

        }

        public static VTXuatTra_C NewVTXuatTra_C(string idDMVTYT)
        {
            return new VTXuatTra_C(DMVTYT.GetDMVTYT(idDMVTYT));
        }

        public static VTXuatTra_C NewVTXuatTra_C(DMVTYT _DMVTYT)
        {
            return new VTXuatTra_C(_DMVTYT);
        }
        //public static VTXuatTra_C GetVTXuatTra_C(String maPN)
        //{
        //    return DataPortal.Fetch<VTXuatTra_C>(new Criteria(maPN,qadmin ))

        //}
        public static VTXuatTra_C GetVTXuatTra_C(String MaVT, Decimal sTT)
        {
            return DataPortal.Fetch<VTXuatTra_C>(new Criteria(MaVT, sTT));
        }
        public static VTXuatTra_C GetVTXuatTra_C(SafeDataReader dr)
        {
            return new VTXuatTra_C(dr);
        }
		/// <summary>
		/// Marks the <see cref="VTXuatTra_C" /> Object for deletion. The Object will be deleted as part of the next save operation.
		/// </summary>
        //public static void DeleteVTXuatTra_C(String maPN)
        //{
		...
		protected internal VTXuatTra_C()
		{	
			// Prevent direct creation
		}
		protected VTXuatTra_C(DMVTYT pro)
        {
            MarkAsChild();
            _maVT = pro.MaVT;
            _tenTM = pro.TenTM;
        }
        protected VTXuatTra_C(string _idMaPXT, DMVTYT pro)
        {
            MarkAsChild();
            _maPXT = _idMaPXT;            
            _maVT = pro.MaVT;
        ...
        protected VTXuatTra_C(SafeDataReader dr)
        {
            MarkAsChild();
		...
		/// <summary>
		/// Retrieve an existing <see cref="VTXuatTra_C" /> Object based on data in the database.
		/// </summary>
		protected void DataPortal_Fetch(Criteria crit)
		{
			// public abstract IDataReader GetVTXuatTra_C(String _maPXT, Byte STT);
            // public override IDataReader GetVTXuatTra_C(String _maPXT, Byte STT)
			// {
            //	   return ((IDataReader)SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "spVTXuatTra_C_GET", _maPXT,STT));
			// }
			using (SafeDataReader dr = new SafeDataReader(DataProvider.Instance().GetVTXuatTra_C(crit.MaPXT, crit.STT  )))
			{
				if (dr.Read()){
					Fetch(dr);
					MarkOld();
		...
		/// <summary>
		/// Load a <see cref="VTXuatTra_C" /> Object from given SafeDataReader.
		/// </summary>
		...
		/// </summary>
        internal virtual void Insert(VTXuatTra bill)
		{
            ...
            _maPXT = bill.MaPXT;
           DataProvider.Instance().InsertVTXuatTra_C(_maVT, _soluong, _hanSD, _donGia, _soLo, _ghichu, _nguoiSD , _maMay, bill.MaPXT, _vAT);
           MarkOld();// public abstract String InsertVTXuatTra_C(String _maVT, Decimal _soluong, SmartDate _hanSD, Decimal _donGia, String _soLo, String _ghichu, String _nguoiSD, String _maMay, String _maPXT, Decimal _vAT);
		...
		/// <summary>
		/// Update all changes made on <see cref="VTXuatTra_C" /> Object to underlying database.
		/// </summary>
        internal virtual void  Update(VTXuatTra bill)
		{
			// TODO: Kiem tra lai cac tham so truyen vao cho ham UpdateVTXuatTra_C
			if (IsDirty){
                
                  
                DataProvider.Instance().UpdateVTXuatTra_C(_sTT, _maVT, _soluong, _hanSD, _donGia, _soLo, _huy, _ghichu, _nguoiSD , _maMay, bill.MaPXT, _vAT);
		...
		/// <summary>
		/// Delete the <see cref="VTXuatTra_C" />.
		/// </summary>
        ...
        internal void DeleteSelf(VTXuatTra bill)
        {
            ...
            DataProvider.Instance().DeleteVTXuatTra_C(_maMay, _nguoiSD , bill.MaPXT, _sTT);
            MarkNew();
        }
