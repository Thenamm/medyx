<%@ Page Language="C#" MasterPageFile="AdminCode.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Default" %>
    ...
    <div class="grid_12 header-repeat">
        <div id="branding1">
            <div class="floatleft">                                    
                ...
                -->
                <asp:Image runat="server" ImageUrl="~/img/BenhVienPhuSan.png" width="700px" height="100px"  />                                  
            </div>
            <div class="floatright" style="background-image:url() repeat-x;">                
                <div class="floatleft">                                                    
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadToolBar ID="baraction" runat="server"
           EnableRoundedCorners="true" style="display:none"
