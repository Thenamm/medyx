<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmDMCachGayMe.cs" Inherits="UI_Category_DMHanhChinh_frmDMCachGayMe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <telerik:RadGrid AllowFilteringByColumn="True" Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"         ID="grdChiTiet" runat="server"
            ...
            <MasterTableView NoMasterRecordsText ="" NoDetailRecordsText="" AutoGenerateColumns="False" CommandItemDisplay="Top" EditMode="InPlace" HorizontalAlign="Center" DataKeyNames="MaCGM">
                <CommandItemSettings
                ...
                <SortExpressions>
                    ...
                    <telerik:GridSortExpression FieldName="MaCGM" />
                    <telerik:GridSortExpression FieldName="TenCGM" />
                </SortExpressions>
                <Columns>
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaCGM" FilterControlAltText="Filter MaCGM column" HeaderText="Mã Cách Gây Mê" SortExpression="MaCGM" UniqueName="MaCGM">
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TenCGM" FilterControlAltText="Filter TenCGM column" HeaderText="Tên Cách Gây Mê" SortExpression="TenCGM" UniqueName="TenCGM">
                        <ColumnValidationSettings EnableRequiredFieldValidation="true">
                            <RequiredFieldValidator Display="Dynamic" ForeColor="Red" Text="Yêu cầu phải nhập">
                            </RequiredFieldValidator>
                        </ColumnValidationSettings>
...
<%--                  <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="PP_VO_CAM" FilterControlAltText="Filter PP_VO_CAM column" HeaderText="Phương pháp vô cảm" SortExpression="PP_VO_CAM" UniqueName="PP_VO_CAM">                   
