<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmDMDOITUONGKHAMBENH.cs" Inherits="UI_Category_DMHanhChinh_frmDMDOITUONGKHAMBENH" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <telerik:RadGrid AllowFilteringByColumn="True" Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"         ID="grdChiTiet" runat="server"
            ...
            <MasterTableView NoMasterRecordsText ="" NoDetailRecordsText="" AutoGenerateColumns="False" CommandItemDisplay="Top" EditMode="InPlace" HorizontalAlign="Center" DataKeyNames="MA_DOITUONG_KCB">
                <CommandItemSettings
                ...
                <SortExpressions>
                    ...
                    <telerik:GridSortExpression FieldName="MA_DOITUONG_KCB" />
                    <telerik:GridSortExpression FieldName="TEN_DOITUONG_KCB" />
                    <telerik:GridSortExpression FieldName="DIEN_GIAI" />
                    <telerik:GridSortExpression FieldName="TRICH_DAN" />
                    <telerik:GridSortExpression FieldName="MaDT" />
                    <telerik:GridSortExpression FieldName="MaBHXH" />
...
<%--                    <telerik:GridBoundColumn   CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MA_DOITUONG_KCB" ItemStyle-Width="80px" HeaderStyle-Width="80px" FilterControlAltText="Filter MA_DOITUONG_KCB column" HeaderText="Mã đối tượng KCB" ReadOnly="true" SortExpression="MA_DOITUONG_KCB" UniqueName="MA_DOITUONG_KCB">
                    </telerik:GridBoundColumn>--%>

                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MA_DOITUONG_KCB" FilterControlAltText="Filter MA_DOITUONG_KCB column" HeaderText="Mã đối tượng KCB" SortExpression="MA_DOITUONG_KCB" UniqueName="MA_DOITUONG_KCB">
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TEN_DOITUONG_KCB" FilterControlAltText="Filter TEN_DOITUONG_KCB column" HeaderText="Tên đối tượng KCB" SortExpression="TEN_DOITUONG_KCB" UniqueName="TEN_DOITUONG_KCB">
                        <ColumnValidationSettings EnableRequiredFieldValidation="true">
                            <RequiredFieldValidator Display="Dynamic" ForeColor="Red" Text="Yêu cầu phải nhập">
                            </RequiredFieldValidator>
                        </ColumnValidationSettings>
                  ...
                  <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="DIEN_GIAI" FilterControlAltText="Filter DIEN_GIAI column" HeaderText=" Diễn giải " SortExpression="DIEN_GIAI" UniqueName="DIEN_GIAI">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TRICH_DAN" FilterControlAltText="Filter TRICH_DAN column" HeaderText=" Trích dẫn " SortExpression="TRICH_DAN" UniqueName="TRICH_DAN">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaDT" FilterControlAltText="Filter MaDT column" HeaderText=" Mã DT " SortExpression="MaDT" UniqueName="MaDT">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaBHXH" FilterControlAltText="Filter MaBHXH column" HeaderText=" Mã BHXH" SortExpression="MaBHXH" UniqueName="MaBHXH">
                    </telerik:GridBoundColumn>
