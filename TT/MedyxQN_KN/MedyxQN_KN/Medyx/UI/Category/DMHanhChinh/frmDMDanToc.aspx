<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmDMDanToc.cs" Inherits="UI_Category_DMHanhChinh_frmDMDanToc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <telerik:RadGrid AllowFilteringByColumn="True" Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"         ID="grdChiTiet" runat="server"
            ...
            <MasterTableView NoMasterRecordsText ="" NoDetailRecordsText="" AutoGenerateColumns="False" CommandItemDisplay="Top" EditMode="InPlace" HorizontalAlign="Center" DataKeyNames="MaDanToc">
                <CommandItemSettings
                ...
                <SortExpressions>
                    ...
                    <telerik:GridSortExpression FieldName="MaDanToc" />
                    <telerik:GridSortExpression FieldName="TenDanToc" />
                </SortExpressions>
                <Columns>
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaDanToc" FilterControlAltText="Filter MaDanToc column" HeaderText="Mã Dân Tộc" SortExpression="MaDanToc" UniqueName="MaDanToc">
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TenDanToc" FilterControlAltText="Filter TenDanToc column" HeaderText="Tên Dân Tộc" SortExpression="TenDanToc" UniqueName="TenDanToc">
                        <ColumnValidationSettings EnableRequiredFieldValidation="true">
                            <RequiredFieldValidator Display="Dynamic" ForeColor="Red" Text="Yêu cầu phải nhập">
                            </RequiredFieldValidator>
                        </ColumnValidationSettings>
                  ...
                  <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaQL" FilterControlAltText="Filter MaQL column" HeaderText="Mã Quản Lý" SortExpression="MaQL" UniqueName="MaQL">
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaBYTe" FilterControlAltText="Filter MaBYTe column" HeaderText="Mã BYTe" SortExpression="MaBYTe" UniqueName="MaBYTe">
                    </telerik:GridBoundColumn>
