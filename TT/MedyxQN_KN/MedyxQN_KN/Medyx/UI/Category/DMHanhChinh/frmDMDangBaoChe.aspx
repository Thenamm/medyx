<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmDMDangBaoChe.cs" Inherits="UI_Category_DMHanhChinh_frmDMDangBaoChe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <telerik:RadGrid AllowFilteringByColumn="True" Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"         ID="grdChiTiet" runat="server"
            ...
            <MasterTableView NoMasterRecordsText ="" NoDetailRecordsText="" AutoGenerateColumns="False" CommandItemDisplay="Top" EditMode="InPlace" HorizontalAlign="Center" DataKeyNames="MaDangBC">
                <CommandItemSettings
                ...
                <SortExpressions>
                    ...
                    <telerik:GridSortExpression FieldName="MaDangBC" />
                    <telerik:GridSortExpression FieldName="TenDangBC" />
                </SortExpressions>
                <Columns>
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaDangBC" FilterControlAltText="Filter MaDangBC column" HeaderText="Mã Dạng Bào Chế" SortExpression="MaDangBC" UniqueName="MaDangBC">
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TenDangBC" FilterControlAltText="Filter TenDangBC column" HeaderText="Tên Dạng Bào Chế" SortExpression="TenDangBC" UniqueName="TenDangBC">
                        <ColumnValidationSettings EnableRequiredFieldValidation="true">
                            <RequiredFieldValidator Display="Dynamic" ForeColor="Red" Text="Yêu cầu phải nhập">
                            </RequiredFieldValidator>
                        </ColumnValidationSettings>
                  ...
                  <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MotaDangBC" FilterControlAltText="Filter MotaDangBC column" HeaderText="Mô tả Dạng Bào Chế" SortExpression="MotaDangBC" UniqueName="MotaDangBC">
                    </telerik:GridBoundColumn>
