<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmDMDichVu_MayCLS.cs" Inherits="UI_Category_DMHanhChinh_frmDMDichVu_MayCLS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <telerik:RadGrid AllowFilteringByColumn="True" Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"         ID="grdChiTiet" runat="server"
            ...
            <MasterTableView NoMasterRecordsText ="" NoDetailRecordsText="" AutoGenerateColumns="False" CommandItemDisplay="Top" EditMode="InPlace" HorizontalAlign="Center" DataKeyNames="MaMayCLS">
                <CommandItemSettings
                ...
                <SortExpressions>
                    ...
                    <telerik:GridSortExpression FieldName="MaMayCLS" />
                    <telerik:GridSortExpression FieldName="TenDichVu" />
...
<%--                    <telerik:GridBoundColumn   CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MA_DOITUONG_KCB" ItemStyle-Width="80px" HeaderStyle-Width="80px" FilterControlAltText="Filter MA_DOITUONG_KCB column" HeaderText="Mã đối tượng KCB" ReadOnly="true" SortExpression="MA_DOITUONG_KCB" UniqueName="MA_DOITUONG_KCB">
                    ...
                    <telerik:GridTemplateColumn
                        ...
                        HeaderText=" Máy cận lâm sàng " UniqueName="MaMayCLS" ItemStyle-Width="150px" HeaderStyle-Width="200px" HeaderStyle-Font-Bold="true"
                        AllowFiltering="false">                       
    <EditItemTemplate>
        <telerik:RadComboBox ID="cboMaMayCLS" runat="server" DataTextField="TEN_TB" DataValueField="MA_MAY" Width="100%">
        </telerik:RadComboBox>
    </EditItemTemplate>
</telerik:GridTemplateColumn>


                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TenDichVu" FilterControlAltText="Filter TenDichVu column" HeaderText="Tên dịch vụ" SortExpression="TenDichVu" UniqueName="TenDichVu">
