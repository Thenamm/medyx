<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmDMLyDoVaoVien.cs" Inherits="UI_Category_DMHanhChinh_frmDMLyDoVaoVien" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <telerik:RadGrid AllowFilteringByColumn="True" Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"         ID="grdChiTiet" runat="server"
            ...
            <MasterTableView NoMasterRecordsText ="" NoDetailRecordsText="" AutoGenerateColumns="False" CommandItemDisplay="Top" EditMode="InPlace" HorizontalAlign="Center" DataKeyNames="MA_LY_DO_VNT">
                <CommandItemSettings
                ...
                <SortExpressions>
                    ...
                    <telerik:GridSortExpression FieldName="MA_LY_DO_VNT" />
                    <telerik:GridSortExpression FieldName="TEN_LY_DO_VNT" />
...
<%--                    <telerik:GridBoundColumn   CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MA_LY_DO_VNT" ItemStyle-Width="80px" HeaderStyle-Width="80px" FilterControlAltText="Filter MA_LY_DO_VNT column" HeaderText="Mã lí do VV" ReadOnly="true" SortExpression="MA_LY_DO_VNT" UniqueName="MA_LY_DO_VNT">
                    </telerik:GridBoundColumn>--%>

                                        <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MA_LY_DO_VNT" FilterControlAltText="Filter MA_LY_DO_VNT column" HeaderText="Mã lí do VV" SortExpression="MA_LY_DO_VNT" UniqueName="MA_LY_DO_VNT">
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TEN_LY_DO_VNT" FilterControlAltText="Filter TEN_LY_DO_VNT column" HeaderText="Tên lí do VV" SortExpression="TEN_LY_DO_VNT" UniqueName="TEN_LY_DO_VNT">
                        <ColumnValidationSettings EnableRequiredFieldValidation="true">
                            <RequiredFieldValidator Display="Dynamic" ForeColor="Red" Text="Yêu cầu phải nhập">
                            </RequiredFieldValidator>
                        </ColumnValidationSettings>
