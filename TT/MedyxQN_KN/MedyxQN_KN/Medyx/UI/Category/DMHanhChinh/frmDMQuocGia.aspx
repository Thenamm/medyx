<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmDMQuocGia.cs" Inherits="UI_Category_DMHanhChinh_frmDMQuocGia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <telerik:RadGrid AllowFilteringByColumn="True" Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"         ID="grdChiTiet" runat="server"
            ...
            <MasterTableView NoMasterRecordsText ="" NoDetailRecordsText="" AutoGenerateColumns="False" CommandItemDisplay="Top" EditMode="InPlace" HorizontalAlign="Center" DataKeyNames="MaQG">
                <CommandItemSettings
                ...
                <SortExpressions>
                    ...
                    <telerik:GridSortExpression FieldName="MaQG" />
                    <telerik:GridSortExpression FieldName="TenQG" />
                </SortExpressions>
                <Columns>
                    ...
                    <%--<telerik:GridBoundColumn   CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaPPCB" ItemStyle-Width="80px" HeaderStyle-Width="80px" FilterControlAltText="Filter MaPPCB column" HeaderText="Mã pp Chế Biến" ReadOnly="true" SortExpression="MaPPCB" UniqueName="MaPPCB">

                    </telerik:GridBoundColumn>--%>

                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaQG" FilterControlAltText="Filter MaQG column" HeaderText="Mã Quốc Gia" SortExpression="MaQG" UniqueName="MaQG">
                    ...
                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TenQG" FilterControlAltText="Filter TenQG column" HeaderText="Tên Quốc Gia" SortExpression="TenQG" UniqueName="TenQG">
                        <ColumnValidationSettings EnableRequiredFieldValidation="true">
                            <RequiredFieldValidator Display="Dynamic" ForeColor="Red" Text="Yêu cầu phải nhập">
                            </RequiredFieldValidator>
                        </ColumnValidationSettings>
                  ...
                  <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaQuocTich" FilterControlAltText="Filter MaQuocTich column" HeaderText="Mã Quốc Tịch" SortExpression="MaQuocTich" UniqueName="MaQuocTich">
                    </telerik:GridBoundColumn>




                  <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaQL" FilterControlAltText="Filter MaQL column" HeaderText="Mã Quản Lý" SortExpression="MaQL" UniqueName="MaQL">
                    </telerik:GridBoundColumn>
<%--                    <telerik:GridBoundColumn  CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="TenNhom" FilterControlAltText="Filter TenNhom column" HeaderText="Tên Nhóm" SortExpression="TenNhom" UniqueName="TenNhom">
                    </telerik:GridBoundColumn>--%>
