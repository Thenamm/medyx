...
public partial class UI_Category_DMVTYT_frmDMLoaiHinh : HTC.Common.Web.WebBase
{
    ...
    public List<DMLoaiHinhM> _DMLoaiHinhList
    {
        get
        {
    ...
    {
        grdChiTiet.DataSource = _DMLoaiHinhList;
        grdChiTiet.DataBind();
    ...
    protected void grdChiTiet_DeletedCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            if (editedItem != null)
            {
                string _maLH = editedItem.GetDataKeyValue("MaLH").ToString();

                HTC.Business.DataProvider.Instance().DeleteDMLoaiHinh(Pub_sMaMay, Pub_sNguoiSD, _maLH);
                _DMLoaiHinhList = null;
                grdChiTiet.DataSource = _DMLoaiHinhList;
                grdChiTiet.DataBind();
    ...
    private void UpdateData()
    {
        try
        {
            //_DMLoaiHinh.MaLH = "";
            //_DMLoaiHinh.TenLH = "";
            //_DMLoaiHinh.MaChungLoai = "";
            _DMLoaiHinh.Ma_BCTH = GetDMNhomChiPhi().Count;
            if (_action != FormAction.DELETE)
            {
                _DMLoaiHinh.ApplyEdit();
                DMLoaiHinh tmp = _DMLoaiHinh.Clone();
                _DMLoaiHinh = tmp.Save();

            }
            else
            {
                //_DMLoaiHinh.NguoiHuy = Pub_sNguoiSD;
                _DMLoaiHinh.MaMay = Pub_sMaMay;


                DMLoaiHinh.DeleteDMLoaiHinh(_DMLoaiHinh.MaLH, Pub_sMaMay, Pub_sNguoiSD);
            }
            if (_action == FormAction.EDIT)
            {

                _DMLoaiHinh.NguoiSD = Pub_sNguoiSD;
                _DMLoaiHinh.MaMay = Pub_sMaMay;
               // _DMLoaiHinhList.UpdatedTo(_DMLoaiHinh);
                _DMLoaiHinh.ApplyEdit();
                _DMLoaiHinh.Save();
            ...
            {
               // _DMLoaiHinh.NguoiLap = Pub_sNguoiSD;
    ...
    public  class DMLoaiHinh : BusinessBase<DMLoaiHinh>
    {
        ...
        protected override void DataPortal_Insert()
        {
            ...
            _maLH =  InsertDMLoaiHinhM(_maLH, _tenLH, _maChungLoai, _Ma_BCTH, _maMay, _nguoiSD);
        ...
        public String InsertDMLoaiHinhM(String _MaLH, String _TenLH, String _MaChungLoai, int _Ma_BCTH, string _maMay, String _nguoiSD)
        {
            string ConnectionString = ConfigurationManager.ConnectionStrings["SqlDataProvider"].ConnectionString + "; connection timeout=600; pooling=true; Max Pool Size=6000;Timeout=600;MultipleActiveResultSets=True";
            string DatabaseOwner = "dbo.";
            string ObjectQualifier = "";
        ...
        protected override void DataPortal_Update()
        {
            ...
            if (IsDirty)
            {
                ...
                //DataProvider.Instance().UpdateDMLoaiHinh(_maLH, _tenLH, _maChungLoai,  _maMay, _huy, _nguoiSD);
                 ...
                 UpdateDMLoaiHinhM(_maLH, _tenLH, _maChungLoai, _Ma_BCTH, _maMay, _huy, _nguoiSD);
        ...
        public void UpdateDMLoaiHinhM(String _MaLH, String _TenLH, String _MaChungLoai, int _Ma_BCTH, string _maMay,bool _huy, String _nguoiSD)
        {
            string ConnectionString = ConfigurationManager.ConnectionStrings["SqlDataProvider"].ConnectionString + "; connection timeout=600; pooling=true; Max Pool Size=6000;Timeout=600;MultipleActiveResultSets=True";
            string DatabaseOwner = "dbo.";
            string ObjectQualifier = "";
            SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "spDMLoaiHinh_update_130", _MaLH, _TenLH, _MaChungLoai, _Ma_BCTH, _maMay, _huy, _nguoiSD);
        }
