...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
   ...
   <script type="text/javascript">
       ...
       $(function () {
           $("#<%= dtNGAY_CAP_CCCD_NND.ClientID %>").datetimepicker({
       ...
       $(document).ready(function () {
           $("#<%= dtNGAYSINH_NND.ClientID %>").mask("99/99/9999");
                $("#<%= dtNGAY_CAP_CCCD_NND.ClientID %>").mask("99/99/9999 99:99");
...
<%--                 <telerik:RadToolBarButton ImageUrl="~/img/icon/print.gif"
             ...
             <telerik:RadToolBarButton ImageUrl="~/img/icon/View.png"
                ...
                Text="F7-Ký"   CssClass="ButtonCSS" Value ="cmdKy">
            </telerik:RadToolBarButton>
    ...
    <div style="align-content:center!important">
        <table  align="left" >
            ...
            <tr>
                <td>
                       <asp:Label ID="Label4" runat="server" Text="Mã BHXH NDD "></asp:Label>
                      </td>
                    <td Width="5%">
...
<%--                <td>
                ...
                <td Width="5%">
                    ...
                    <td Width="5%">
                    <asp:TextBox runat="server" ID="dtNGAY_CAP_CCCD_NND"></asp:TextBox>
                    </td>
                    <td>
                       <asp:Label ID="Label38" runat="server" Text="Nơi cấp: "></asp:Label>
                      </td>
                    <td colspan="2">
                    <asp:TextBox runat="server" ID="txtNOI_CAP_CCCD_NND"></asp:TextBox>
                    </td>
            </tr>
            ...
            <tr>
                             <td Width="5%">
                                ...
                                <td colspan ="6">
                                    <asp:TextBox runat="server" TabIndex="1" ID="txtNOI_DK_THUONGTRU_NDD"  ></asp:TextBox>
                                </td>
            </tr>
                        ...
                        <tr>
                             <td Width="5%">
                                    <asp:Label ID="Label7" runat="server" Text="Họ tên bố" ></asp:Label>
                                </td>
                                <td Width="10%">
                                    <asp:TextBox runat="server" TabIndex="1" ID="txtHO_TEN_BO" ></asp:TextBox>
                                </td>
            </tr>
                            <tr>
<%--                                <td>
                            ...
                            <tr>
                                ...
                                <td>
<%--                                    <asp:Label ID="Label35" runat="server" Text="Ngày tử vong:" ></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" TabIndex="1" ID="dtNgayTV" 
                                         Enabled="false" AutoPostBack="false" 
                                       style="width:96% !important"></asp:TextBox>
                                </td>--%>
                                <td Width="5%">
                                    <asp:Label ID="Label33" runat="server" Text="Số giấy chứng sinh" ></asp:Label>
                                </td>
                                <td colspan="3">
                                ...
                                <td>
                    <asp:CheckBox ID="chkHuy" runat="server" Text="Hủy" Enabled="false"/>
                    </td>
                            </tr>
...
<%--                                <td Width="5%">
                                    <asp:Label ID="Label8" runat="server" Text="Giới tính con" Width="70px"></asp:Label>
                                </td>--%>
<%--                                <td colspan ="2"  Width="10%" > 
                                   <asp:RadioButtonList TabIndex="1" ID="rblGIOI_TINH_CON" runat="server" RepeatDirection="Horizontal" Enabled="false">
                                        <asp:ListItem Value="1">Nam</asp:ListItem>
                                       <asp:ListItem Value="2">Nữ</asp:ListItem>
                                        <asp:ListItem Value="3" Selected ="True">Chưa xác định</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>--%>

                                                        <td><asp:Label ID="Label21" runat="server" Text="Giới tính con"></asp:Label></td>
                        <td colspan="2"><asp:RadioButtonList ID="rblGIOI_TINH_CON" runat="server" RepeatDirection="Horizontal">  
                                <asp:ListItem Value="1" >Nam</asp:ListItem>  
                                <asp:ListItem  Value="2">Nữ</asp:ListItem>  
            ...
            <tr>
                        ...
                        <td colspan="2"><asp:RadioButtonList ID="rblSINHCON_DUOI32TUAN" runat="server" RepeatDirection="Horizontal">  
                                <asp:ListItem>Có</asp:ListItem>  
                                <asp:ListItem>Không</asp:ListItem>  
                            </asp:RadioButtonList>  </td>
            </tr>
