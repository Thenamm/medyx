 ...
 <%-- <script type="text/javascript" src='<%: ResolveUrl("~/js/jquery.min.js") %>'></script>
    ...
    <link href='<%: ResolveUrl("~/css/datetimepicker/jquery.datetimepicker.css")%>' rel="stylesheet" />
        ...
        <script type="text/javascript">
            ...
            $(function () {
                $("#<%= dtNgayLuu.ClientID %>,#<%= dtNGAYCAP_CMND.ClientID %>").datetimepicker({
                        dateFormat: 'dd/mm/yy',
                        altFormat: "dd/mm/yy",
                        timepicker: false,
                        format: 'd.m.Y',
            ...
            $(document).ready(function () {
                ...
                $("#<%= dtNgayVV.ClientID %>,#<%= dtNGAYCAP_CMND.ClientID %>").mask("99/99/9999");
                    ...
                    <fieldset align="center">
                      ...
                      <td colspan ="7">
                                ...
                                <tr id="GhichuChanDoan" runat="server">
                                    ...
                                    <td  colspan="2">
                         <asp:CheckBox ID="chkVET_THUONG_TP" runat="server" Text="Vết thương tái phát" AutoPostBack="false" />
                     </td>         
                                </tr>
                            </table>
                         </div>
