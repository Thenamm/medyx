<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCode.master" AutoEventWireup="true"  CodeFile="CKS.cs" Inherits="UI_Category_DMHanhChinh_CKS" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function SignXMlCallback(data) {
            ...
            i++;
            var xmlIn = document.getElementById('<%= xmlPath.ClientID %>').value;
            ...
            //SignXML(xmlIn, serial, SignXMlCallback);

        }
       

        //xử lí ký 
        function SignBase64XML() {
        ...
        function VerifyXMLBase64Callback(data) {
            var iRet = parseInt(data);
            CheckVerifyResult(iRet);
        }
        // hàm lấy giá trị verify
        function VerifyBase64XML() {
            var xmlIn = document.getElementById('xmlVerifyPath').value;
            VerifyXML(xmlIn, VerifyXMLBase64Callback);
        }
        ...
        <table class="input" style="width:100%!important;" >
            <tr>
                <td style="width:40%!important;">
                    <asp:Label ID="Label15" runat="server" Style="font-size: 20px" Text="XML Cần Ký:"></asp:Label>
                </td>
                <td style="width:20%!important;">
                <asp:Label ID="Label40" runat="server" Style="font-size: 20px" Text="Tên Chứng Thư  :"> </asp:Label></td>
            <td style="width:39%!important;">
                            <asp:Label  Font-Size="20px" ID="Label5" runat="server" Text="XML Đã Ký : "></asp:Label>
                        </td>
            ...
            <tr>
                 ...
                 <td>
                    ...
                    <textarea id="xmlPath" cols="1" rows="6" placeholder="Dữ liệu cần ký" runat="server" class="textxml"></textarea>
                </td>
                <td>
                    <table>
                    ...
                    <option value="">Chọn chứng thư số</option>
                        ...
                        <tr><td><input id="selectCertSerial" type="text" class="form-control text-custom" placeholder="Số serial của chứng thư số" aria-describedby="sizing-addon2" readonly="readonly">
                </td></tr>
                        ...
                        <tr><td>
                            ...
                            <button  id="btnSier"   onclick="event.preventDefault(); SignBase64XML();" class ="btn btn-primary"><img src="https://scontent.fhan17-1.fna.fbcdn.net/v/t1.15752-9/367590202_105037362697190_21838221117176382_n.png?stp=cp0_dst-png&_nc_cat=106&ccb=1-7&_nc_sid=ae9488&_nc_ohc=stHaq181288AX-cc7zv&_nc_oc=AQmNGb6gN4ka6WN948o5vcRXAoUACr8zc--AukzvYhCWTLRTfLcHgPc_R60gRnYVguI&_nc_ht=scontent.fhan17-1.fna&oh=03_AdTuFw0U92CoZgrlQ9ZCO9B6GUO0UlXJEfbixQKWiAEwww&oe=6503C9B0" />Ký</button>
                            <button  id="btnSign1" onserverclick="btnSign_Click" runat="server"  class ="btn btn-primary" ><img src="https://scontent.fhan17-1.fna.fbcdn.net/v/t1.15752-9/367760462_690230495802274_1680078543315747279_n.png?stp=cp0_dst-png&_nc_cat=108&ccb=1-7&_nc_sid=ae9488&_nc_ohc=SMR7gLPs0loAX8Q2ZNo&_nc_ht=scontent.fhan17-1.fna&oh=03_AdRYMJGBev-Jenq1n2KZCiDUlOD7mdiL3tFbD1g-ncZ19A&oe=650BB034"/>Lưu</button>
                            <button  id="Button1" onserverclick="btnEXIT_Click" runat="server" class ="btn btn-primary" ><img src="https://scontent.fhan17-1.fna.fbcdn.net/v/t1.15752-9/369464690_252277354311160_2183451971016584645_n.png?stp=cp0_dst-png&_nc_cat=100&ccb=1-7&_nc_sid=ae9488&_nc_ohc=2n9ugkUvA08AX8gnQ1-&_nc_ht=scontent.fhan17-1.fna&oh=03_AdT9iaGoXzf6Pfr37F0dQdrhQ-5CacuSM4XwxjtRJBo6aw&oe=650BA23E"/>Thoát</button>
                ...
                <td>
                            <textarea cols="1" id="SigningResult" rows="32" class="textxml"  placeholder=""  runat="server" onchange="Change"></textarea>
