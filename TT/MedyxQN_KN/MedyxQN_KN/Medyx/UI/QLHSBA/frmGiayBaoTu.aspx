<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmGiayBaoTu.aspx.cs" Inherits="UI_QLHSBA_frmGiayBaoTu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
   ...
   <script type="text/javascript">
       $(document).ready(function () {
           $("#<%= dtNgayChanThuong.ClientID %>,#<%= dtNgayPhauThuat.ClientID %>,#<%= dtNGAYCAP_CMND.ClientID %>").mask("99/99/9999");
       });
       $(function () {
           $("#<%= dtNgayChanThuong.ClientID %>,#<%= dtNgayPhauThuat.ClientID %>,#<%= dtNGAYCAP_CMND.ClientID %>").datepicker({
               dateFormat: 'dd/mm/yy',
               altFormat: "dd/mm/yy",
               minDate: '01/01/1900',
               maxDate: '31/12/2100'
        ...
        EnableShadows="true" OnButtonClick="baraction_ButtonClick" Width ="100%" >
             <Items >  
                 ...
                 <telerik:RadToolBarButton ImageUrl="~/img/icon/print.gif"
                  ...
                  <telerik:RadToolBarButton ImageUrl="~/img/icon/print.gif"
                    Text="In Giấy báo tử" CheckOnClick="false" Value="cmdPrint">
                </telerik:RadToolBarButton>
                 <telerik:RadToolBarButton ImageUrl="~/img/icon/print.gif"
                ...
                <td>
                    ...
                    <asp:TextBox runat="server" ID="txtNoiCapCMND"></asp:TextBox>
                            ...
                            <tr>
                               ...
                               <td>
                                ...
                                <td>
                                    ...
                                    <td colspan ="6">
                                    <asp:TextBox runat="server" TabIndex="1" ID="txtDiaChi" Enabled="false" Width="100%"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:Label ID="Label33" runat="server" Text="Số giấy báo tử " ></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" TabIndex="1" ID="txtSoGiayBT" 
                                         Enabled="false" AutoPostBack="false" 
                                       style="width:96% !important"></asp:TextBox>
                                </td>
