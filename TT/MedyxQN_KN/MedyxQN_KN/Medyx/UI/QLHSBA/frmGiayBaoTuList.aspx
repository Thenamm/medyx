<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmGiayBaoTuList.aspx.cs" Inherits="UI_QLHSBA_frmGiayBaoTuList" %>
            ...
            <tr>
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Hoten"
                                    ...
                                    <HeaderStyle Width="200px" />
                                                                ...
                                                                <telerik:GridBoundColumn AllowFiltering="false" DataField="NgayTVong" DataFormatString="{0:dd/MM/yyyy}"
                                    FilterControlAltText="Filter NgayTVong column" HeaderText="Ngày tử vong" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="true" ShowFilterIcon="false"  
                                    SortExpression="NgayTVong" UniqueName="NgayTVong">
                ...
                <telerik:RadGrid Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true" 
                    ...
                    <MasterTableView  TableLayout="Fixed" AllowAutomaticDeletes="True" AllowAutomaticInserts="True"
                       ...
                       DataKeyNames="MaBN, MaBA,SoGiayBaoTu"
                        ...
                        <Columns>   
                            ...
                            <telerik:GridBoundColumn DataField="SoGiayBaoTu"
                                FilterControlAltText="Filter SoGiayBaoTu column"
                                HeaderText="Số giấy báo tử" ReadOnly="true" SortExpression="SoGiayBaoTu"
                                UniqueName="SoGiayBaoTu" AllowFiltering="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
