<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmGiayNghiThaiList.aspx.cs" Inherits="UI_QLHSBA_frmGiayNghiThaiList" %>
                    ...
                    <telerik:RadGrid Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"          
                        ...
                        <MasterTableView  AutoGenerateColumns="False" DataKeyNames="MaBN, MaBA"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="TenBenh"
                                    FilterControlAltText="Filter TenBenh column" HeaderText="Tên bệnh"   CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"   
                       ...
                       DataKeyNames="MaBN, MaBA,SoGiayNghiThai"
                        ...
                        <Columns>   
                            ...
                            <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" UniqueName="Delete"
                                ConfirmDialogType="RadWindow" ConfirmText="Xóa phiếu ?" ConfirmTitle="Delete"
                                HeaderText="" Text="Delete">
                                <HeaderStyle Width="20px" HorizontalAlign="Center" />
                            </telerik:GridButtonColumn>
                            <telerik:GridBoundColumn DataField="SoGiayNghiThai"
                                FilterControlAltText="Filter SoGiayNghiThai column"
                                HeaderText="Số giấy báo tử" ReadOnly="true" SortExpression="SoGiayNghiThai"
                                UniqueName="SoGiayNghiThai" AllowFiltering="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
                                 ShowFilterIcon="false">
                                <HeaderStyle Width="50px" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="MaBN"
                                FilterControlAltText="Filter MaBN column" Display="false"
                            ...
                            <telerik:GridBoundColumn DataField="NGAY_VAO"
                                FilterControlAltText="Filter NGAY_VAO column"
                                HeaderText="Ngày bắt đầu nghỉ" ReadOnly="true" SortExpression="TenBN"
                                UniqueName="NGAY_VAO" AllowFiltering="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                                <HeaderStyle Width="100px" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="NGAY_RA"
                                FilterControlAltText="Filter NGAY_RA column"
                                HeaderText="Ngày kết thúc nghỉ" ReadOnly="true" SortExpression="TenBN"
                                UniqueName="NGAY_RA" AllowFiltering="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                                <HeaderStyle Width="100px" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="NGAY_CT"
                                FilterControlAltText="Filter NGAY_CT column"
                                HeaderText="Ngày cấp giấy" ReadOnly="true" SortExpression="TenBN"
                                UniqueName="NGAY_CT" AllowFiltering="true" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                                <HeaderStyle Width="100px" />
                            </telerik:GridBoundColumn>
