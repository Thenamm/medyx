...
// Returns : [String] the HTML
{
	...
	a[j++]='<tbody><tr>'+
		'<td class="treeNormal" style="border-right:1px solid #A0A0A0;" align="center" valign="micboe">'+lab+'</td><td style="width:70px;padding-bottom:2px;padding-left:4px">'
...
{	
	...
	if(extraHTML)
		...
		bodyHTML = '<table '+attr("id",txtId)+' class="'+cls+'" cellpadding="0" cellspacing="0" border="0"><tr valign="micboe"><td>'+extraHTML+'</td></tr></table>'
	else
		bodyHTML = '<nobr '+attr("id",txtId)+' class="'+cls+'">'+convStr(text,true)+'</nobr>'
		
	return '<tbody><tr valign="micboe"><td width="'+w+'">'+imgOffset(url,w,h,0,dy)+'</td>'+
...
{	
	var o=this,s="";
	s+='<table class="treeNormal" border="0" cellspacing="0" cellpadding="0"><tr valign="micboe"><td>';	
	s+=o.text+'</td><td>';	
...
function newAdvFilterDef(id)
{
	...
	o.LoadData=AdvFilterDef_LoadData
...
function AdvFilterDef_LoadData()
{
	var o=this;
