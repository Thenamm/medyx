...
// Returns : [String] the HTML
{
    with (this) {
        ...
        var closeBtn = '<td class="dlgCloseArea" align="left" valign="micboe">'
        ...
        var dlgtitle = '<table style="height:' + _dlgTitleHeight
                ...
                + 'px;" width="100%" valign="micboe" align="left">' + '<nobr><span id="titledialog_' + id
...
// Returns : [String] the HTML
{
	with (this)
	{
		...
		return mdl+
			...
			'<td '+moveableCb+' style="cursor:move;'+titleBG+'" class="titlezone" width="100%" valign="micboe" align="left"><nobr><span id="titledialog_'+id+'" tabIndex="0" class="titlezone">'+convStr(title)+'</span></nobr></td>'+
