...
// returns [String] widget HTML
{
	with (this)
	{
		...
		return '<table onmouseover="return true" '+attr('id',id)+' '+addPar+' border="0" cellspacing="0" cellpadding="0"><tr valign="micboe">'+
...
// url [String] combined image url
{
	...
	if (show)
	{
		...
		o.setHTML('<table border="0" cellspacing="0" cellpadding="0"><tr valign="micboe">'+(s?'<td align="center">'+s+'</td>':'')+'<td class="dragTxt"><nobr>'+(isHTML?str:convStr(str))+'</nobr></td></tr></table>')
		o.setPos(null,e)
