...
// Return [String] the HTML
{
	...
	{		
		...
		ar[i++] = '<tr onmousedown="'+_codeWinName+'._minb(event)" onmouseup="'+_codeWinName+'._minb(event)" id="'+(o.par.id+'_item_'+o.id)+'" style="'+(!o.isShown?'display:none;':'')+'height:'+_mitemH+'px;width:24px;cursor:'+(o.disabled?'default':_hand)+'" '+invertCbs+keysCbs+' valign="micboe">'
...
//	o.acboastUsed=MenuColorWidget_acboastUsed
...
//// ================================================================================
//
//function MenuColorWidget_acboastUsed(text,lastUsedColorsAr,cb, beforeShowCB)
...
//
//	if (first)
//		s+='<tr valign="micboe" align="center">'
//
