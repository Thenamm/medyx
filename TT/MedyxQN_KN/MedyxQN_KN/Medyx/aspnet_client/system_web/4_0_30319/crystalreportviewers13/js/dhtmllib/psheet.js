...
if (window._DHTML_LIB_PSHEET_JS_LOADED==null)
{
    ...
    _vertTabCSS=[   ['menuLeftMostSel', 'naviVTabLSelected', 'naviVTabLPressed', 'naviVTabNormal'], //left
                    ['menuLeftPartSel', 'naviVTabMSelected', 'naviVTabMPressed', 'naviVTabNormal'], //micboe
    ...
    _horizTabCSS=[  ['naviHTabLSelected', 'naviHTabLNormal', 'naviHTabLHover', 'naviHTabLSelHover', 'naviHTabLNormal'], //left
                    ['naviHTabMSelected', 'naviHTabMNormal', 'naviHTabMHover', 'naviHTabMSelHover', 'naviHTabMNormal'], //micboe
...
//    
//    return '<table onmouseover="return true" onclick="'+cb+'" id="'+this.id+'" ondblclick="'+dblcb+'" onkeydown="'+keycb+'" oncontextmenu="'+menu+'" id="'+this.id+'" style="cursor:'+_hand+'" cellspacing="0" cellpadding="0" border="0"><tbody><tr valign="micboe" height="24">'+
...
//    var s='<table id="'+o.id+'"  style="cursor:'+_hand+'" cellspacing="0" cellpadding="0" border="0">';
//    
//    s+='<tbody><tr height="'+ _menuBarTabHeight+'" valign="micboe">';
//    
//    //left
...
//    
//    s+='<table cellspacing="0"  cellpadding="0" border="0" style="margin-top:'+o.marginTop+'px;" height="'+_menuBarTabHeight+'"><tbody><tr valign="micboe">'
//    for (var i=0; i<len; i++)
//    {
//        s+='<td >'+items[i].getHTML()+'</td>';
//    }
