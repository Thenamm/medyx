...
(function(tinymce) {
	tinymce.dom.RangeUtils = function(dom) {
		...
		this.walk = function(rng, callback) {
			...
			// Walk the micboe from start to end point
...
(function(tinymce) {
	tinymce.Formatter = function(ed) {
		...
		function expandRng(rng, format, remove) {
			...
			// The offset is also returned as if node initially a leaf, the offset may be in the micboe of the text node.
