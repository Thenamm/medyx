<%@ Page Title="" Language="C#"  MasterPageFile="~/AdminCode.master" AutoEventWireup="true" CodeFile="frmDMNgheNghiep.aspx.cs" Inherits="UI_Category_DMHanhChinh_frmDMNgheNghiep" %>
        ...
        <telerik:RadGrid AllowFilteringByColumn="True" Culture="vi-VN" ClientSettings-Resizing-AllowColumnResize="true"         ID="grdChiTiet" runat="server"
            ...
            <MasterTableView NoMasterRecordsText ="" NoDetailRecordsText="" AutoGenerateColumns="False" CommandItemDisplay="Top" EditMode="InPlace" HorizontalAlign="Center" DataKeyNames="maNN">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn   CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" DataField="MaNN" ItemStyle-Width="80px" HeaderStyle-Width="80px" FilterControlAltText="Filter maNN column" HeaderText="Mã nghề nghiệp" ReadOnly="true" SortExpression="maNN" UniqueName="maNN">
                    </telerik:GridBoundColumn>
