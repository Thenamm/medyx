...
public partial class Default2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string portdnlaydt = "http://beta.donthuocquocgia.vn";
        ...
        string iddoctor = "011622BP-CCHN";
        string passdoctor = "Fuv1R0LWlk";
        string tokenlogin = logintoken;
       // string themdoctor = dt.themBS(portdn, iddoctor, tokenlogin);

      //  string xoadoctor = dt.xoaBS(portdn, iddoctor, tokenlogin);
         
        string signdoctor = dt.dangnhapBS(portdn, iddoctor, passdoctor, userdn);

        string tokendoctor = signdoctor;

        var madonthuoc = "40618R001935-c";


        donthuoc dtc = new donthuoc();
        dtc.loai_don_thuoc = "c";
        dtc.ma_don_thuoc = madonthuoc;
        dtc.ho_ten_benh_nhan = "Nguyễn Hữu Việt ";
        dtc.ma_dinh_danh_y_te = "1234567891";
        dtc.ma_dinh_danh_cong_dan = "038201015868";
        dtc.ngay_sinh_benh_nhan = "22/06/2021";
        dtc.can_nang = 60;
        dtc.gioi_tinh = "2";
        dtc.ma_so_the_bao_hiem_y_te = "0035020993";
        dtc.thong_tin_nguoi_giam_ho = "lê văn nhi thạch thất ";
        dtc.dia_chi = "thái hà  hà nội ";

        List<chandoan> cd = new List<chandoan>();
        chandoan cdc = new chandoan();
        cdc.ma_chan_doan = "A00-A09";
        cdc.ten_chan_doan = "Bệnh nhiễm trùng đường ruột";
        cdc.ket_luan = "Kết luận của bác sĩ.";
       
        cd.Add(cdc);
        dtc.chan_doan = cd;

        dtc.luu_y = "Lưu ý của bác sĩ";
        dtc.hinh_thuc_dieu_tri = "1";

        List<dot_dung_thuoc> ddt = new List<dot_dung_thuoc>();
        dot_dung_thuoc ddtc = new dot_dung_thuoc();
        ddtc.dot = 4;
        ddtc.tu_ngay = "2021-05-4";
        ddtc.den_ngay = "2021-06-3";
        ddtc.so_thang_thuoc = 0;
        ddt.Add(ddtc);
        dtc.dot_dung_thuoc = ddt;

        List<thongtindonthuoc> ttdt = new List<thongtindonthuoc>();
        thongtindonthuoc tdttc = new thongtindonthuoc();
        tdttc.ma_thuoc = "VN-14215-11";
        tdttc.biet_duoc = "xyanua kali";
        tdttc.ten_thuoc = "phara";
        tdttc.don_vi_tinh = "viên";
        tdttc.so_luong = 23;
        tdttc.cach_dung = "uống , 2 viên  , 3 ngày 10 lần";
        ttdt.Add(tdttc);
        dtc.thong_tin_don_thuoc = ttdt;

        dtc.loi_dan = "uong nhanh vo ";
        dtc.so_dien_thoai_nguoi_kham_benh = "0976798526";
        dtc.ngay_tai_kham = 20;
        dtc.ngay_gio_ke_don = "2022-11-02 06:07:00";
        dtc.signature = "5647382hfhfhf";

     

        string sendmedicine = dt.Gui_don_thuoc(portdn, tokendoctor,dtc);


        string appname = "HTTest";
        string appkey = "zegWYYek3L4oVuWXJ3LJAiSVJ5e4rlbvTxqRWfRWlmz3sPX9m0MHoKjPzaJv";

        donthuocget takemedicines = dt.laydonthuoc(portdnlaydt, madonthuoc, appname, appkey);

        donthuocUpdate dtcn = new donthuocUpdate();
        dtcn.ma_don_thuoc = madonthuoc;

        List<thongtinthuoc> ttt = new List<thongtinthuoc>();
        thongtinthuoc tttcn = new thongtinthuoc();
        tttcn.ma_thuoc_da_ke_don = "A00-A10";
        tttcn.ma_thuoc = "erihsuw";
        tttcn.biet_duoc = "tao meo ";
        tttcn.ten_thuoc = "syan kali ";
        tttcn.don_vi_tinh = "usd";
        tttcn.so_luong = 200;
        tttcn.cach_dung = "uong het ";
        tttcn.so_luong_ban = 20;

        ttt.Add(tttcn);
        dtcn.thong_tin_thuoc = ttt;

        dtcn.ma_dinh_danh_co_so_cung_ung_thuoc = "hgew";
        dtcn.ten_co_so_cung_ung_thuoc = "thai ha ";
        dtcn.so_dien_thoai_co_so_cung_ung_thuoc = "0953672822";
        dtcn.dia_chi_co_so_cung_ung_thuoc = "noi bai ";
        dtcn.ma_hoa_don = "ydbeuwbdu";

        string  updatedt = dt.capnhatdonthuoc(portdnlaydt, appname, appkey, dtcn);
    }
    ...
    public class DTDTAPI
    {
        ...
        {
            string url = port + "/api/auth/dang-nhap-bac-si";
